...
var ramlexerLexerStaticData struct {
	once                   sync.Once
	serializedATN          []int32
	channelNames           []string
	modeNames              []string
...
func ramlexerLexerInit() {
	staticData := &ramlexerLexerStaticData
	...
	staticData.serializedATN = []int32{
		...
		17, 18, 5, 71, 0, 0, 18, 19, 5, 66, 0, 0, 19, 2, 1, 0, 0, 0, 20, 21, 5,
		36, 0, 0, 21, 22, 5, 126, 0, 0, 22, 23, 5, 36, 0, 0, 23, 4, 1, 0, 0, 0,
		24, 25, 5, 32, 0, 0, 25, 26, 5, 33, 0, 0, 26, 27, 5, 36, 0, 0, 27, 28,
...
// RamLexerInit initializes any static state used to implement RamLexer. By default the
// static state used to implement the lexer is lazily initialized during the first call to
// NewRamLexer(). You can call this function if you wish to initialize the static state ahead
// of time.
func RamLexerInit() {
	staticData := &ramlexerLexerStaticData
	staticData.once.Do(ramlexerLexerInit)
}

// NewRamLexer produces a new lexer instance for the optional input antlr.CharStream.
func NewRamLexer(input antlr.CharStream) *RamLexer {
	RamLexerInit()
	l := new(RamLexer)
