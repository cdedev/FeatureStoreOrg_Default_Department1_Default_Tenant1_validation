...
type InternetAccessLexer struct {
	*antlr.BaseLexer
	channelNames []string
	modeNames    []string
	// TODO: EOF string
...
var internetaccesslexerLexerStaticData struct {
	once                   sync.Once
	serializedATN          []int32
	channelNames           []string
	modeNames              []string
...
func internetaccesslexerLexerInit() {
	staticData := &internetaccesslexerLexerStaticData
...
// InternetAccessLexerInit initializes any static state used to implement InternetAccessLexer. By default the
// static state used to implement the lexer is lazily initialized during the first call to
// NewInternetAccessLexer(). You can call this function if you wish to initialize the static state ahead
// of time.
func InternetAccessLexerInit() {
	staticData := &internetaccesslexerLexerStaticData
	staticData.once.Do(internetaccesslexerLexerInit)
}

// NewInternetAccessLexer produces a new lexer instance for the optional input antlr.CharStream.
func NewInternetAccessLexer(input antlr.CharStream) *InternetAccessLexer {
	InternetAccessLexerInit()
	l := new(InternetAccessLexer)
	...
	l.GrammarFileName = "InternetAccess.g4"
	// TODO: l.EOF = antlr.TokenEOF

	return l
}

// InternetAccessLexer tokens.
const (
	InternetAccessLexerINTERNETACCESS = 1
	InternetAccessLexerOWNKEY         = 2
	InternetAccessLexerSPLITKEY       = 3
	InternetAccessLexerWS             = 4
)
