...
type Respiration_rateLexer struct {
	*antlr.BaseLexer
	channelNames []string
	modeNames    []string
	// TODO: EOF string
...
var respiration_ratelexerLexerStaticData struct {
	once                   sync.Once
	serializedATN          []int32
	channelNames           []string
	modeNames              []string
...
func respiration_ratelexerLexerInit() {
	staticData := &respiration_ratelexerLexerStaticData
...
// Respiration_rateLexerInit initializes any static state used to implement Respiration_rateLexer. By default the
// static state used to implement the lexer is lazily initialized during the first call to
// NewRespiration_rateLexer(). You can call this function if you wish to initialize the static state ahead
// of time.
func Respiration_rateLexerInit() {
	staticData := &respiration_ratelexerLexerStaticData
	staticData.once.Do(respiration_ratelexerLexerInit)
}

// NewRespiration_rateLexer produces a new lexer instance for the optional input antlr.CharStream.
func NewRespiration_rateLexer(input antlr.CharStream) *Respiration_rateLexer {
	Respiration_rateLexerInit()
	l := new(Respiration_rateLexer)
	...
	l.GrammarFileName = "Respiration_rate.g4"
	// TODO: l.EOF = antlr.TokenEOF

	return l
}

// Respiration_rateLexer tokens.
const (
	Respiration_rateLexerRESPIRATION_RATE = 1
	Respiration_rateLexerOWNKEY           = 2
	Respiration_rateLexerSPLITKEY         = 3
	Respiration_rateLexerWS               = 4
)
