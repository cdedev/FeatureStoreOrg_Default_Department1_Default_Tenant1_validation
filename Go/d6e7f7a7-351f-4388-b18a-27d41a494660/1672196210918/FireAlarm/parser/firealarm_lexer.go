...
var firealarmlexerLexerStaticData struct {
	once                   sync.Once
	serializedATN          []int32
	channelNames           []string
	modeNames              []string
...
func firealarmlexerLexerInit() {
	staticData := &firealarmlexerLexerStaticData
...
// FireAlarmLexerInit initializes any static state used to implement FireAlarmLexer. By default the
// static state used to implement the lexer is lazily initialized during the first call to
// NewFireAlarmLexer(). You can call this function if you wish to initialize the static state ahead
// of time.
func FireAlarmLexerInit() {
	staticData := &firealarmlexerLexerStaticData
	staticData.once.Do(firealarmlexerLexerInit)
}

// NewFireAlarmLexer produces a new lexer instance for the optional input antlr.CharStream.
func NewFireAlarmLexer(input antlr.CharStream) *FireAlarmLexer {
	FireAlarmLexerInit()
	l := new(FireAlarmLexer)
	...
	l.GrammarFileName = "FireAlarm.g4"
	// TODO: l.EOF = antlr.TokenEOF

	return l
}

// FireAlarmLexer tokens.
const (
	FireAlarmLexerFIREALARM = 1
	FireAlarmLexerOWNKEY    = 2
	FireAlarmLexerSPLITKEY  = 3
	FireAlarmLexerWS        = 4
)
