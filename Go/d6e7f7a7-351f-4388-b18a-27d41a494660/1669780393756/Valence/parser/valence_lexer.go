...
var valencelexerLexerStaticData struct {
	once                   sync.Once
	serializedATN          []int32
	channelNames           []string
	modeNames              []string
...
func valencelexerLexerInit() {
	staticData := &valencelexerLexerStaticData
...
// ValenceLexerInit initializes any static state used to implement ValenceLexer. By default the
// static state used to implement the lexer is lazily initialized during the first call to
// NewValenceLexer(). You can call this function if you wish to initialize the static state ahead
// of time.
func ValenceLexerInit() {
	staticData := &valencelexerLexerStaticData
	staticData.once.Do(valencelexerLexerInit)
}

// NewValenceLexer produces a new lexer instance for the optional input antlr.CharStream.
func NewValenceLexer(input antlr.CharStream) *ValenceLexer {
	ValenceLexerInit()
	l := new(ValenceLexer)
...
// ValenceLexer tokens.
const (
	ValenceLexerVALENCE  = 1
	ValenceLexerOWNKEY   = 2
	ValenceLexerSPLITKEY = 3
	ValenceLexerWS       = 4
)
