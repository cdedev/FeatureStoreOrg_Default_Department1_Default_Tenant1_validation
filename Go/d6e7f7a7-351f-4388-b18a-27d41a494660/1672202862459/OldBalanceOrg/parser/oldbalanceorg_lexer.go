...
type OldBalanceOrgLexer struct {
	*antlr.BaseLexer
	channelNames []string
	modeNames    []string
	// TODO: EOF string
...
var oldbalanceorglexerLexerStaticData struct {
	once                   sync.Once
	serializedATN          []int32
	channelNames           []string
	modeNames              []string
...
func oldbalanceorglexerLexerInit() {
	staticData := &oldbalanceorglexerLexerStaticData
...
// OldBalanceOrgLexerInit initializes any static state used to implement OldBalanceOrgLexer. By default the
// static state used to implement the lexer is lazily initialized during the first call to
// NewOldBalanceOrgLexer(). You can call this function if you wish to initialize the static state ahead
// of time.
func OldBalanceOrgLexerInit() {
	staticData := &oldbalanceorglexerLexerStaticData
	staticData.once.Do(oldbalanceorglexerLexerInit)
}

// NewOldBalanceOrgLexer produces a new lexer instance for the optional input antlr.CharStream.
func NewOldBalanceOrgLexer(input antlr.CharStream) *OldBalanceOrgLexer {
	OldBalanceOrgLexerInit()
	l := new(OldBalanceOrgLexer)
	...
	l.GrammarFileName = "OldBalanceOrg.g4"
	// TODO: l.EOF = antlr.TokenEOF

	return l
}

// OldBalanceOrgLexer tokens.
const (
	OldBalanceOrgLexerOLDBALANCEORG = 1
	OldBalanceOrgLexerOWNKEY        = 2
	OldBalanceOrgLexerSPLITKEY      = 3
	OldBalanceOrgLexerWS            = 4
)
