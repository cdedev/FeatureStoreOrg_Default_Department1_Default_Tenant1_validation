...
var levylexerLexerStaticData struct {
	once                   sync.Once
	serializedATN          []int32
	channelNames           []string
	modeNames              []string
...
func levylexerLexerInit() {
	staticData := &levylexerLexerStaticData
...
// LevyLexerInit initializes any static state used to implement LevyLexer. By default the
// static state used to implement the lexer is lazily initialized during the first call to
// NewLevyLexer(). You can call this function if you wish to initialize the static state ahead
// of time.
func LevyLexerInit() {
	staticData := &levylexerLexerStaticData
	staticData.once.Do(levylexerLexerInit)
}

// NewLevyLexer produces a new lexer instance for the optional input antlr.CharStream.
func NewLevyLexer(input antlr.CharStream) *LevyLexer {
	LevyLexerInit()
	l := new(LevyLexer)
