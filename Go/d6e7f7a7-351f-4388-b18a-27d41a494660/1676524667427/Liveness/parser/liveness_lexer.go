...
var livenesslexerLexerStaticData struct {
	once                   sync.Once
	serializedATN          []int32
	channelNames           []string
	modeNames              []string
...
func livenesslexerLexerInit() {
	staticData := &livenesslexerLexerStaticData
...
// LivenessLexerInit initializes any static state used to implement LivenessLexer. By default the
// static state used to implement the lexer is lazily initialized during the first call to
// NewLivenessLexer(). You can call this function if you wish to initialize the static state ahead
// of time.
func LivenessLexerInit() {
	staticData := &livenesslexerLexerStaticData
	staticData.once.Do(livenesslexerLexerInit)
}

// NewLivenessLexer produces a new lexer instance for the optional input antlr.CharStream.
func NewLivenessLexer(input antlr.CharStream) *LivenessLexer {
	LivenessLexerInit()
	l := new(LivenessLexer)
	...
	l.GrammarFileName = "Liveness.g4"
	// TODO: l.EOF = antlr.TokenEOF

	return l
}

// LivenessLexer tokens.
const (
	LivenessLexerLIVENESS = 1
	LivenessLexerOWNKEY   = 2
	LivenessLexerSPLITKEY = 3
	LivenessLexerWS       = 4
)
