...
var ticketlexerLexerStaticData struct {
	once                   sync.Once
	serializedATN          []int32
	channelNames           []string
	modeNames              []string
...
func ticketlexerLexerInit() {
	staticData := &ticketlexerLexerStaticData
	...
	staticData.serializedATN = []int32{
		...
		0, 4, 1, 1, 3, 2, 5, 3, 7, 4, 1, 0, 2, 2, 0, 46, 57, 65, 90, 3, 0, 9, 10,
...
// TicketLexerInit initializes any static state used to implement TicketLexer. By default the
// static state used to implement the lexer is lazily initialized during the first call to
// NewTicketLexer(). You can call this function if you wish to initialize the static state ahead
// of time.
func TicketLexerInit() {
	staticData := &ticketlexerLexerStaticData
	staticData.once.Do(ticketlexerLexerInit)
}

// NewTicketLexer produces a new lexer instance for the optional input antlr.CharStream.
func NewTicketLexer(input antlr.CharStream) *TicketLexer {
	TicketLexerInit()
	l := new(TicketLexer)
