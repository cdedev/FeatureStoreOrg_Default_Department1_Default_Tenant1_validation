...
var venomouslexerLexerStaticData struct {
	once                   sync.Once
	serializedATN          []int32
	channelNames           []string
	modeNames              []string
...
func venomouslexerLexerInit() {
	staticData := &venomouslexerLexerStaticData
...
// VenomousLexerInit initializes any static state used to implement VenomousLexer. By default the
// static state used to implement the lexer is lazily initialized during the first call to
// NewVenomousLexer(). You can call this function if you wish to initialize the static state ahead
// of time.
func VenomousLexerInit() {
	staticData := &venomouslexerLexerStaticData
	staticData.once.Do(venomouslexerLexerInit)
}

// NewVenomousLexer produces a new lexer instance for the optional input antlr.CharStream.
func NewVenomousLexer(input antlr.CharStream) *VenomousLexer {
	VenomousLexerInit()
	l := new(VenomousLexer)
	...
	l.GrammarFileName = "Venomous.g4"
	// TODO: l.EOF = antlr.TokenEOF

	return l
}

// VenomousLexer tokens.
const (
	VenomousLexerVENOMOUS = 1
	VenomousLexerOWNKEY   = 2
	VenomousLexerSPLITKEY = 3
	VenomousLexerWS       = 4
)
