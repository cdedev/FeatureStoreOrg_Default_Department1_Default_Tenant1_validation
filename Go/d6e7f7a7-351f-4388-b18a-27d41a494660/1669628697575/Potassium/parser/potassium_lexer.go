...
var potassiumlexerLexerStaticData struct {
	once                   sync.Once
	serializedATN          []int32
	channelNames           []string
	modeNames              []string
...
func potassiumlexerLexerInit() {
	staticData := &potassiumlexerLexerStaticData
...
// PotassiumLexerInit initializes any static state used to implement PotassiumLexer. By default the
// static state used to implement the lexer is lazily initialized during the first call to
// NewPotassiumLexer(). You can call this function if you wish to initialize the static state ahead
// of time.
func PotassiumLexerInit() {
	staticData := &potassiumlexerLexerStaticData
	staticData.once.Do(potassiumlexerLexerInit)
}

// NewPotassiumLexer produces a new lexer instance for the optional input antlr.CharStream.
func NewPotassiumLexer(input antlr.CharStream) *PotassiumLexer {
	PotassiumLexerInit()
	l := new(PotassiumLexer)
	...
	l.GrammarFileName = "Potassium.g4"
	// TODO: l.EOF = antlr.TokenEOF

	return l
}

// PotassiumLexer tokens.
const (
	PotassiumLexerPOTASSIUM = 1
	PotassiumLexerOWNKEY    = 2
	PotassiumLexerSPLITKEY  = 3
	PotassiumLexerWS        = 4
)
