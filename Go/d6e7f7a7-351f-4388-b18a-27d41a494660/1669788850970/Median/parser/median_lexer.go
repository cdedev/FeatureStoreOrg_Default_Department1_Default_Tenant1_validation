...
var medianlexerLexerStaticData struct {
	once                   sync.Once
	serializedATN          []int32
	channelNames           []string
	modeNames              []string
...
func medianlexerLexerInit() {
	staticData := &medianlexerLexerStaticData
...
// MedianLexerInit initializes any static state used to implement MedianLexer. By default the
// static state used to implement the lexer is lazily initialized during the first call to
// NewMedianLexer(). You can call this function if you wish to initialize the static state ahead
// of time.
func MedianLexerInit() {
	staticData := &medianlexerLexerStaticData
	staticData.once.Do(medianlexerLexerInit)
}

// NewMedianLexer produces a new lexer instance for the optional input antlr.CharStream.
func NewMedianLexer(input antlr.CharStream) *MedianLexer {
	MedianLexerInit()
	l := new(MedianLexer)
