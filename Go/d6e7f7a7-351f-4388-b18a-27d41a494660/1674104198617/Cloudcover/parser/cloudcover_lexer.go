...
var cloudcoverlexerLexerStaticData struct {
	once                   sync.Once
	serializedATN          []int32
	channelNames           []string
	modeNames              []string
...
func cloudcoverlexerLexerInit() {
	staticData := &cloudcoverlexerLexerStaticData
...
// CloudcoverLexerInit initializes any static state used to implement CloudcoverLexer. By default the
// static state used to implement the lexer is lazily initialized during the first call to
// NewCloudcoverLexer(). You can call this function if you wish to initialize the static state ahead
// of time.
func CloudcoverLexerInit() {
	staticData := &cloudcoverlexerLexerStaticData
	staticData.once.Do(cloudcoverlexerLexerInit)
}

// NewCloudcoverLexer produces a new lexer instance for the optional input antlr.CharStream.
func NewCloudcoverLexer(input antlr.CharStream) *CloudcoverLexer {
	CloudcoverLexerInit()
	l := new(CloudcoverLexer)
	...
	l.GrammarFileName = "Cloudcover.g4"
	// TODO: l.EOF = antlr.TokenEOF

	return l
}

// CloudcoverLexer tokens.
const (
	CloudcoverLexerCLOUDCOVER = 1
	CloudcoverLexerOWNKEY     = 2
	CloudcoverLexerSPLITKEY   = 3
	CloudcoverLexerWS         = 4
)
