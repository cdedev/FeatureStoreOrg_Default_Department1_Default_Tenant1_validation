...
type AvgDailyPageviewsLexer struct {
	*antlr.BaseLexer
	channelNames []string
	modeNames    []string
	// TODO: EOF string
...
var avgdailypageviewslexerLexerStaticData struct {
	once                   sync.Once
	serializedATN          []int32
	channelNames           []string
	modeNames              []string
...
func avgdailypageviewslexerLexerInit() {
	staticData := &avgdailypageviewslexerLexerStaticData
...
// AvgDailyPageviewsLexerInit initializes any static state used to implement AvgDailyPageviewsLexer. By default the
// static state used to implement the lexer is lazily initialized during the first call to
// NewAvgDailyPageviewsLexer(). You can call this function if you wish to initialize the static state ahead
// of time.
func AvgDailyPageviewsLexerInit() {
	staticData := &avgdailypageviewslexerLexerStaticData
	staticData.once.Do(avgdailypageviewslexerLexerInit)
}

// NewAvgDailyPageviewsLexer produces a new lexer instance for the optional input antlr.CharStream.
func NewAvgDailyPageviewsLexer(input antlr.CharStream) *AvgDailyPageviewsLexer {
	AvgDailyPageviewsLexerInit()
	l := new(AvgDailyPageviewsLexer)
	...
	l.GrammarFileName = "AvgDailyPageviews.g4"
	// TODO: l.EOF = antlr.TokenEOF

	return l
}

// AvgDailyPageviewsLexer tokens.
const (
	AvgDailyPageviewsLexerAVGDAILYPAGEVIEWS = 1
	AvgDailyPageviewsLexerOWNKEY            = 2
	AvgDailyPageviewsLexerSPLITKEY          = 3
	AvgDailyPageviewsLexerWS                = 4
)
