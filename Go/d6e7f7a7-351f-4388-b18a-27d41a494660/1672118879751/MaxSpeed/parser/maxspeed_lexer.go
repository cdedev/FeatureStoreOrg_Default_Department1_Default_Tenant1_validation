...
var maxspeedlexerLexerStaticData struct {
	once                   sync.Once
	serializedATN          []int32
	channelNames           []string
	modeNames              []string
...
func maxspeedlexerLexerInit() {
	staticData := &maxspeedlexerLexerStaticData
...
// MaxSpeedLexerInit initializes any static state used to implement MaxSpeedLexer. By default the
// static state used to implement the lexer is lazily initialized during the first call to
// NewMaxSpeedLexer(). You can call this function if you wish to initialize the static state ahead
// of time.
func MaxSpeedLexerInit() {
	staticData := &maxspeedlexerLexerStaticData
	staticData.once.Do(maxspeedlexerLexerInit)
}

// NewMaxSpeedLexer produces a new lexer instance for the optional input antlr.CharStream.
func NewMaxSpeedLexer(input antlr.CharStream) *MaxSpeedLexer {
	MaxSpeedLexerInit()
	l := new(MaxSpeedLexer)
	...
	l.GrammarFileName = "MaxSpeed.g4"
	// TODO: l.EOF = antlr.TokenEOF

	return l
}

// MaxSpeedLexer tokens.
const (
	MaxSpeedLexerMAXSPEED = 1
	MaxSpeedLexerOWNKEY   = 2
	MaxSpeedLexerSPLITKEY = 3
	MaxSpeedLexerWS       = 4
)
