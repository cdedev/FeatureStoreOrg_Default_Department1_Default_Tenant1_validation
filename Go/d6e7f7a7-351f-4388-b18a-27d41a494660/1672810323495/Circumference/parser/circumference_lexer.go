...
type CircumferenceLexer struct {
	*antlr.BaseLexer
	channelNames []string
	modeNames    []string
	// TODO: EOF string
...
var circumferencelexerLexerStaticData struct {
	once                   sync.Once
	serializedATN          []int32
	channelNames           []string
	modeNames              []string
...
func circumferencelexerLexerInit() {
	staticData := &circumferencelexerLexerStaticData
...
// CircumferenceLexerInit initializes any static state used to implement CircumferenceLexer. By default the
// static state used to implement the lexer is lazily initialized during the first call to
// NewCircumferenceLexer(). You can call this function if you wish to initialize the static state ahead
// of time.
func CircumferenceLexerInit() {
	staticData := &circumferencelexerLexerStaticData
	staticData.once.Do(circumferencelexerLexerInit)
}

// NewCircumferenceLexer produces a new lexer instance for the optional input antlr.CharStream.
func NewCircumferenceLexer(input antlr.CharStream) *CircumferenceLexer {
	CircumferenceLexerInit()
	l := new(CircumferenceLexer)
	...
	l.GrammarFileName = "Circumference.g4"
	// TODO: l.EOF = antlr.TokenEOF

	return l
}

// CircumferenceLexer tokens.
const (
	CircumferenceLexerCIRCUMFERENCE = 1
	CircumferenceLexerOWNKEY        = 2
	CircumferenceLexerSPLITKEY      = 3
	CircumferenceLexerWS            = 4
)
