...
var debtlexerLexerStaticData struct {
	once                   sync.Once
	serializedATN          []int32
	channelNames           []string
	modeNames              []string
...
func debtlexerLexerInit() {
	staticData := &debtlexerLexerStaticData
...
// DebtLexerInit initializes any static state used to implement DebtLexer. By default the
// static state used to implement the lexer is lazily initialized during the first call to
// NewDebtLexer(). You can call this function if you wish to initialize the static state ahead
// of time.
func DebtLexerInit() {
	staticData := &debtlexerLexerStaticData
	staticData.once.Do(debtlexerLexerInit)
}

// NewDebtLexer produces a new lexer instance for the optional input antlr.CharStream.
func NewDebtLexer(input antlr.CharStream) *DebtLexer {
	DebtLexerInit()
	l := new(DebtLexer)
