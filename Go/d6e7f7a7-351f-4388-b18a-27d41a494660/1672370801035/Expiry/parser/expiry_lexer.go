...
var expirylexerLexerStaticData struct {
	once                   sync.Once
	serializedATN          []int32
	channelNames           []string
	modeNames              []string
...
func expirylexerLexerInit() {
	staticData := &expirylexerLexerStaticData
	...
	staticData.serializedATN = []int32{
		...
		0, 4, 1, 1, 3, 2, 5, 3, 7, 4, 1, 0, 2, 2, 0, 45, 45, 48, 58, 3, 0, 9, 10,
...
// ExpiryLexerInit initializes any static state used to implement ExpiryLexer. By default the
// static state used to implement the lexer is lazily initialized during the first call to
// NewExpiryLexer(). You can call this function if you wish to initialize the static state ahead
// of time.
func ExpiryLexerInit() {
	staticData := &expirylexerLexerStaticData
	staticData.once.Do(expirylexerLexerInit)
}

// NewExpiryLexer produces a new lexer instance for the optional input antlr.CharStream.
func NewExpiryLexer(input antlr.CharStream) *ExpiryLexer {
	ExpiryLexerInit()
	l := new(ExpiryLexer)
