...
var sitelimitlexerLexerStaticData struct {
	once                   sync.Once
	serializedATN          []int32
	channelNames           []string
	modeNames              []string
...
func sitelimitlexerLexerInit() {
	staticData := &sitelimitlexerLexerStaticData
...
// SiteLimitLexerInit initializes any static state used to implement SiteLimitLexer. By default the
// static state used to implement the lexer is lazily initialized during the first call to
// NewSiteLimitLexer(). You can call this function if you wish to initialize the static state ahead
// of time.
func SiteLimitLexerInit() {
	staticData := &sitelimitlexerLexerStaticData
	staticData.once.Do(sitelimitlexerLexerInit)
}

// NewSiteLimitLexer produces a new lexer instance for the optional input antlr.CharStream.
func NewSiteLimitLexer(input antlr.CharStream) *SiteLimitLexer {
	SiteLimitLexerInit()
	l := new(SiteLimitLexer)
	...
	l.GrammarFileName = "SiteLimit.g4"
	// TODO: l.EOF = antlr.TokenEOF

	return l
}

// SiteLimitLexer tokens.
const (
	SiteLimitLexerSITELIMIT = 1
	SiteLimitLexerOWNKEY    = 2
	SiteLimitLexerSPLITKEY  = 3
	SiteLimitLexerWS        = 4
)
