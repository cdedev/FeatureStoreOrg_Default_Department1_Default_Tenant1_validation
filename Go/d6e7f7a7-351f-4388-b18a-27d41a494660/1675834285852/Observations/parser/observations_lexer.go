...
var observationslexerLexerStaticData struct {
	once                   sync.Once
	serializedATN          []int32
	channelNames           []string
	modeNames              []string
...
func observationslexerLexerInit() {
	staticData := &observationslexerLexerStaticData
...
// ObservationsLexerInit initializes any static state used to implement ObservationsLexer. By default the
// static state used to implement the lexer is lazily initialized during the first call to
// NewObservationsLexer(). You can call this function if you wish to initialize the static state ahead
// of time.
func ObservationsLexerInit() {
	staticData := &observationslexerLexerStaticData
	staticData.once.Do(observationslexerLexerInit)
}

// NewObservationsLexer produces a new lexer instance for the optional input antlr.CharStream.
func NewObservationsLexer(input antlr.CharStream) *ObservationsLexer {
	ObservationsLexerInit()
	l := new(ObservationsLexer)
	...
	l.GrammarFileName = "Observations.g4"
	// TODO: l.EOF = antlr.TokenEOF

	return l
}

// ObservationsLexer tokens.
const (
	ObservationsLexerOBSERVATIONS = 1
	ObservationsLexerOWNKEY       = 2
	ObservationsLexerSPLITKEY     = 3
	ObservationsLexerWS           = 4
)
