...
var diastoliclexerLexerStaticData struct {
	once                   sync.Once
	serializedATN          []int32
	channelNames           []string
	modeNames              []string
...
func diastoliclexerLexerInit() {
	staticData := &diastoliclexerLexerStaticData
...
// DiastolicLexerInit initializes any static state used to implement DiastolicLexer. By default the
// static state used to implement the lexer is lazily initialized during the first call to
// NewDiastolicLexer(). You can call this function if you wish to initialize the static state ahead
// of time.
func DiastolicLexerInit() {
	staticData := &diastoliclexerLexerStaticData
	staticData.once.Do(diastoliclexerLexerInit)
}

// NewDiastolicLexer produces a new lexer instance for the optional input antlr.CharStream.
func NewDiastolicLexer(input antlr.CharStream) *DiastolicLexer {
	DiastolicLexerInit()
	l := new(DiastolicLexer)
	...
	l.GrammarFileName = "Diastolic.g4"
	// TODO: l.EOF = antlr.TokenEOF

	return l
}

// DiastolicLexer tokens.
const (
	DiastolicLexerDIASTOLIC = 1
	DiastolicLexerOWNKEY    = 2
	DiastolicLexerSPLITKEY  = 3
	DiastolicLexerWS        = 4
)
