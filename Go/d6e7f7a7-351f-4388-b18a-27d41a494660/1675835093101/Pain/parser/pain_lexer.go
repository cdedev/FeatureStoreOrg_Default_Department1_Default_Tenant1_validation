...
var painlexerLexerStaticData struct {
	once                   sync.Once
	serializedATN          []int32
	channelNames           []string
	modeNames              []string
...
func painlexerLexerInit() {
	staticData := &painlexerLexerStaticData
...
// PainLexerInit initializes any static state used to implement PainLexer. By default the
// static state used to implement the lexer is lazily initialized during the first call to
// NewPainLexer(). You can call this function if you wish to initialize the static state ahead
// of time.
func PainLexerInit() {
	staticData := &painlexerLexerStaticData
	staticData.once.Do(painlexerLexerInit)
}

// NewPainLexer produces a new lexer instance for the optional input antlr.CharStream.
func NewPainLexer(input antlr.CharStream) *PainLexer {
	PainLexerInit()
	l := new(PainLexer)
