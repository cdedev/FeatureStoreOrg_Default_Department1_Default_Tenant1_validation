...
var cobaltlexerLexerStaticData struct {
	once                   sync.Once
	serializedATN          []int32
	channelNames           []string
	modeNames              []string
...
func cobaltlexerLexerInit() {
	staticData := &cobaltlexerLexerStaticData
...
// CobaltLexerInit initializes any static state used to implement CobaltLexer. By default the
// static state used to implement the lexer is lazily initialized during the first call to
// NewCobaltLexer(). You can call this function if you wish to initialize the static state ahead
// of time.
func CobaltLexerInit() {
	staticData := &cobaltlexerLexerStaticData
	staticData.once.Do(cobaltlexerLexerInit)
}

// NewCobaltLexer produces a new lexer instance for the optional input antlr.CharStream.
func NewCobaltLexer(input antlr.CharStream) *CobaltLexer {
	CobaltLexerInit()
	l := new(CobaltLexer)
