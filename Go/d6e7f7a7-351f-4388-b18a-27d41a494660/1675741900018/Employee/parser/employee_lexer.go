...
var employeelexerLexerStaticData struct {
	once                   sync.Once
	serializedATN          []int32
	channelNames           []string
	modeNames              []string
...
func employeelexerLexerInit() {
	staticData := &employeelexerLexerStaticData
...
// EmployeeLexerInit initializes any static state used to implement EmployeeLexer. By default the
// static state used to implement the lexer is lazily initialized during the first call to
// NewEmployeeLexer(). You can call this function if you wish to initialize the static state ahead
// of time.
func EmployeeLexerInit() {
	staticData := &employeelexerLexerStaticData
	staticData.once.Do(employeelexerLexerInit)
}

// NewEmployeeLexer produces a new lexer instance for the optional input antlr.CharStream.
func NewEmployeeLexer(input antlr.CharStream) *EmployeeLexer {
	EmployeeLexerInit()
	l := new(EmployeeLexer)
	...
	l.GrammarFileName = "Employee.g4"
	// TODO: l.EOF = antlr.TokenEOF

	return l
}

// EmployeeLexer tokens.
const (
	EmployeeLexerEMPLOYEE = 1
	EmployeeLexerOWNKEY   = 2
	EmployeeLexerSPLITKEY = 3
	EmployeeLexerWS       = 4
)
