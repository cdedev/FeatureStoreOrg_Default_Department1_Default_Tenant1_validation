...
var pregnantlexerLexerStaticData struct {
	once                   sync.Once
	serializedATN          []int32
	channelNames           []string
	modeNames              []string
...
func pregnantlexerLexerInit() {
	staticData := &pregnantlexerLexerStaticData
...
// PregnantLexerInit initializes any static state used to implement PregnantLexer. By default the
// static state used to implement the lexer is lazily initialized during the first call to
// NewPregnantLexer(). You can call this function if you wish to initialize the static state ahead
// of time.
func PregnantLexerInit() {
	staticData := &pregnantlexerLexerStaticData
	staticData.once.Do(pregnantlexerLexerInit)
}

// NewPregnantLexer produces a new lexer instance for the optional input antlr.CharStream.
func NewPregnantLexer(input antlr.CharStream) *PregnantLexer {
	PregnantLexerInit()
	l := new(PregnantLexer)
	...
	l.GrammarFileName = "Pregnant.g4"
	// TODO: l.EOF = antlr.TokenEOF

	return l
}

// PregnantLexer tokens.
const (
	PregnantLexerPREGNANT = 1
	PregnantLexerOWNKEY   = 2
	PregnantLexerSPLITKEY = 3
	PregnantLexerWS       = 4
)
