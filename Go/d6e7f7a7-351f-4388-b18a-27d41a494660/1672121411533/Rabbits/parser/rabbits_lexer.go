...
var rabbitslexerLexerStaticData struct {
	once                   sync.Once
	serializedATN          []int32
	channelNames           []string
	modeNames              []string
...
func rabbitslexerLexerInit() {
	staticData := &rabbitslexerLexerStaticData
...
// RabbitsLexerInit initializes any static state used to implement RabbitsLexer. By default the
// static state used to implement the lexer is lazily initialized during the first call to
// NewRabbitsLexer(). You can call this function if you wish to initialize the static state ahead
// of time.
func RabbitsLexerInit() {
	staticData := &rabbitslexerLexerStaticData
	staticData.once.Do(rabbitslexerLexerInit)
}

// NewRabbitsLexer produces a new lexer instance for the optional input antlr.CharStream.
func NewRabbitsLexer(input antlr.CharStream) *RabbitsLexer {
	RabbitsLexerInit()
	l := new(RabbitsLexer)
...
// RabbitsLexer tokens.
const (
	RabbitsLexerRABBITS  = 1
	RabbitsLexerOWNKEY   = 2
	RabbitsLexerSPLITKEY = 3
	RabbitsLexerWS       = 4
)
