...
var tenurelexerLexerStaticData struct {
	once                   sync.Once
	serializedATN          []int32
	channelNames           []string
	modeNames              []string
...
func tenurelexerLexerInit() {
	staticData := &tenurelexerLexerStaticData
...
// TenureLexerInit initializes any static state used to implement TenureLexer. By default the
// static state used to implement the lexer is lazily initialized during the first call to
// NewTenureLexer(). You can call this function if you wish to initialize the static state ahead
// of time.
func TenureLexerInit() {
	staticData := &tenurelexerLexerStaticData
	staticData.once.Do(tenurelexerLexerInit)
}

// NewTenureLexer produces a new lexer instance for the optional input antlr.CharStream.
func NewTenureLexer(input antlr.CharStream) *TenureLexer {
	TenureLexerInit()
	l := new(TenureLexer)
