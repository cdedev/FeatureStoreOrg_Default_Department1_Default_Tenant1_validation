...
var displacementlexerLexerStaticData struct {
	once                   sync.Once
	serializedATN          []int32
	channelNames           []string
	modeNames              []string
...
func displacementlexerLexerInit() {
	staticData := &displacementlexerLexerStaticData
...
// DisplacementLexerInit initializes any static state used to implement DisplacementLexer. By default the
// static state used to implement the lexer is lazily initialized during the first call to
// NewDisplacementLexer(). You can call this function if you wish to initialize the static state ahead
// of time.
func DisplacementLexerInit() {
	staticData := &displacementlexerLexerStaticData
	staticData.once.Do(displacementlexerLexerInit)
}

// NewDisplacementLexer produces a new lexer instance for the optional input antlr.CharStream.
func NewDisplacementLexer(input antlr.CharStream) *DisplacementLexer {
	DisplacementLexerInit()
	l := new(DisplacementLexer)
	...
	l.GrammarFileName = "Displacement.g4"
	// TODO: l.EOF = antlr.TokenEOF

	return l
}

// DisplacementLexer tokens.
const (
	DisplacementLexerDISPLACEMENT = 1
	DisplacementLexerOWNKEY       = 2
	DisplacementLexerSPLITKEY     = 3
	DisplacementLexerWS           = 4
)
