...
var confidencelexerLexerStaticData struct {
	once                   sync.Once
	serializedATN          []int32
	channelNames           []string
	modeNames              []string
...
func confidencelexerLexerInit() {
	staticData := &confidencelexerLexerStaticData
...
// ConfidenceLexerInit initializes any static state used to implement ConfidenceLexer. By default the
// static state used to implement the lexer is lazily initialized during the first call to
// NewConfidenceLexer(). You can call this function if you wish to initialize the static state ahead
// of time.
func ConfidenceLexerInit() {
	staticData := &confidencelexerLexerStaticData
	staticData.once.Do(confidencelexerLexerInit)
}

// NewConfidenceLexer produces a new lexer instance for the optional input antlr.CharStream.
func NewConfidenceLexer(input antlr.CharStream) *ConfidenceLexer {
	ConfidenceLexerInit()
	l := new(ConfidenceLexer)
	...
	l.GrammarFileName = "Confidence.g4"
	// TODO: l.EOF = antlr.TokenEOF

	return l
}

// ConfidenceLexer tokens.
const (
	ConfidenceLexerCONFIDENCE = 1
	ConfidenceLexerOWNKEY     = 2
	ConfidenceLexerSPLITKEY   = 3
	ConfidenceLexerWS         = 4
)
