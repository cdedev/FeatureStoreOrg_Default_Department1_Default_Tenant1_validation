...
type AlcoholViolenceLexer struct {
	*antlr.BaseLexer
	channelNames []string
	modeNames    []string
	// TODO: EOF string
...
var alcoholviolencelexerLexerStaticData struct {
	once                   sync.Once
	serializedATN          []int32
	channelNames           []string
	modeNames              []string
...
func alcoholviolencelexerLexerInit() {
	staticData := &alcoholviolencelexerLexerStaticData
...
// AlcoholViolenceLexerInit initializes any static state used to implement AlcoholViolenceLexer. By default the
// static state used to implement the lexer is lazily initialized during the first call to
// NewAlcoholViolenceLexer(). You can call this function if you wish to initialize the static state ahead
// of time.
func AlcoholViolenceLexerInit() {
	staticData := &alcoholviolencelexerLexerStaticData
	staticData.once.Do(alcoholviolencelexerLexerInit)
}

// NewAlcoholViolenceLexer produces a new lexer instance for the optional input antlr.CharStream.
func NewAlcoholViolenceLexer(input antlr.CharStream) *AlcoholViolenceLexer {
	AlcoholViolenceLexerInit()
	l := new(AlcoholViolenceLexer)
	...
	l.GrammarFileName = "AlcoholViolence.g4"
	// TODO: l.EOF = antlr.TokenEOF

	return l
}

// AlcoholViolenceLexer tokens.
const (
	AlcoholViolenceLexerALCOHOLVIOLENCE = 1
	AlcoholViolenceLexerOWNKEY          = 2
	AlcoholViolenceLexerSPLITKEY        = 3
	AlcoholViolenceLexerWS              = 4
)
