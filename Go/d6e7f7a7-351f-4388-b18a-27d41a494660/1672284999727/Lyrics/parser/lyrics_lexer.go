...
var lyricslexerLexerStaticData struct {
	once                   sync.Once
	serializedATN          []int32
	channelNames           []string
	modeNames              []string
...
func lyricslexerLexerInit() {
	staticData := &lyricslexerLexerStaticData
...
// LyricsLexerInit initializes any static state used to implement LyricsLexer. By default the
// static state used to implement the lexer is lazily initialized during the first call to
// NewLyricsLexer(). You can call this function if you wish to initialize the static state ahead
// of time.
func LyricsLexerInit() {
	staticData := &lyricslexerLexerStaticData
	staticData.once.Do(lyricslexerLexerInit)
}

// NewLyricsLexer produces a new lexer instance for the optional input antlr.CharStream.
func NewLyricsLexer(input antlr.CharStream) *LyricsLexer {
	LyricsLexerInit()
	l := new(LyricsLexer)
