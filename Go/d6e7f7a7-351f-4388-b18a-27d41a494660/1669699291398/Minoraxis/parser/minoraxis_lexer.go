...
var minoraxislexerLexerStaticData struct {
	once                   sync.Once
	serializedATN          []int32
	channelNames           []string
	modeNames              []string
...
func minoraxislexerLexerInit() {
	staticData := &minoraxislexerLexerStaticData
...
// MinoraxisLexerInit initializes any static state used to implement MinoraxisLexer. By default the
// static state used to implement the lexer is lazily initialized during the first call to
// NewMinoraxisLexer(). You can call this function if you wish to initialize the static state ahead
// of time.
func MinoraxisLexerInit() {
	staticData := &minoraxislexerLexerStaticData
	staticData.once.Do(minoraxislexerLexerInit)
}

// NewMinoraxisLexer produces a new lexer instance for the optional input antlr.CharStream.
func NewMinoraxisLexer(input antlr.CharStream) *MinoraxisLexer {
	MinoraxisLexerInit()
	l := new(MinoraxisLexer)
	...
	l.GrammarFileName = "Minoraxis.g4"
	// TODO: l.EOF = antlr.TokenEOF

	return l
}

// MinoraxisLexer tokens.
const (
	MinoraxisLexerMINORAXIS = 1
	MinoraxisLexerOWNKEY    = 2
	MinoraxisLexerSPLITKEY  = 3
	MinoraxisLexerWS        = 4
)
