...
type IndoorAirPollutionLexer struct {
	*antlr.BaseLexer
	channelNames []string
	modeNames    []string
	// TODO: EOF string
...
var indoorairpollutionlexerLexerStaticData struct {
	once                   sync.Once
	serializedATN          []int32
	channelNames           []string
	modeNames              []string
...
func indoorairpollutionlexerLexerInit() {
	staticData := &indoorairpollutionlexerLexerStaticData
...
// IndoorAirPollutionLexerInit initializes any static state used to implement IndoorAirPollutionLexer. By default the
// static state used to implement the lexer is lazily initialized during the first call to
// NewIndoorAirPollutionLexer(). You can call this function if you wish to initialize the static state ahead
// of time.
func IndoorAirPollutionLexerInit() {
	staticData := &indoorairpollutionlexerLexerStaticData
	staticData.once.Do(indoorairpollutionlexerLexerInit)
}

// NewIndoorAirPollutionLexer produces a new lexer instance for the optional input antlr.CharStream.
func NewIndoorAirPollutionLexer(input antlr.CharStream) *IndoorAirPollutionLexer {
	IndoorAirPollutionLexerInit()
	l := new(IndoorAirPollutionLexer)
	...
	l.GrammarFileName = "IndoorAirPollution.g4"
	// TODO: l.EOF = antlr.TokenEOF

	return l
}

// IndoorAirPollutionLexer tokens.
const (
	IndoorAirPollutionLexerFIELD0   = 1
	IndoorAirPollutionLexerOWNKEY   = 2
	IndoorAirPollutionLexerSPLITKEY = 3
	IndoorAirPollutionLexerWS       = 4
)
