...
type NonHumanPrimatesLexer struct {
	*antlr.BaseLexer
	channelNames []string
	modeNames    []string
	// TODO: EOF string
...
var nonhumanprimateslexerLexerStaticData struct {
	once                   sync.Once
	serializedATN          []int32
	channelNames           []string
	modeNames              []string
...
func nonhumanprimateslexerLexerInit() {
	staticData := &nonhumanprimateslexerLexerStaticData
...
// NonHumanPrimatesLexerInit initializes any static state used to implement NonHumanPrimatesLexer. By default the
// static state used to implement the lexer is lazily initialized during the first call to
// NewNonHumanPrimatesLexer(). You can call this function if you wish to initialize the static state ahead
// of time.
func NonHumanPrimatesLexerInit() {
	staticData := &nonhumanprimateslexerLexerStaticData
	staticData.once.Do(nonhumanprimateslexerLexerInit)
}

// NewNonHumanPrimatesLexer produces a new lexer instance for the optional input antlr.CharStream.
func NewNonHumanPrimatesLexer(input antlr.CharStream) *NonHumanPrimatesLexer {
	NonHumanPrimatesLexerInit()
	l := new(NonHumanPrimatesLexer)
	...
	l.GrammarFileName = "NonHumanPrimates.g4"
	// TODO: l.EOF = antlr.TokenEOF

	return l
}

// NonHumanPrimatesLexer tokens.
const (
	NonHumanPrimatesLexerNONHUMANPRIMATES = 1
	NonHumanPrimatesLexerOWNKEY           = 2
	NonHumanPrimatesLexerSPLITKEY         = 3
	NonHumanPrimatesLexerWS               = 4
)
