...
var legslexerLexerStaticData struct {
	once                   sync.Once
	serializedATN          []int32
	channelNames           []string
	modeNames              []string
...
func legslexerLexerInit() {
	staticData := &legslexerLexerStaticData
	...
	staticData.serializedATN = []int32{
		...
		0, 4, 1, 1, 3, 2, 5, 3, 7, 4, 1, 0, 2, 1, 0, 48, 56, 3, 0, 9, 10, 13, 13,
...
// LegsLexerInit initializes any static state used to implement LegsLexer. By default the
// static state used to implement the lexer is lazily initialized during the first call to
// NewLegsLexer(). You can call this function if you wish to initialize the static state ahead
// of time.
func LegsLexerInit() {
	staticData := &legslexerLexerStaticData
	staticData.once.Do(legslexerLexerInit)
}

// NewLegsLexer produces a new lexer instance for the optional input antlr.CharStream.
func NewLegsLexer(input antlr.CharStream) *LegsLexer {
	LegsLexerInit()
	l := new(LegsLexer)
