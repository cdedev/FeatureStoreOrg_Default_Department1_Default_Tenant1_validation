...
var citationslexerLexerStaticData struct {
	once                   sync.Once
	serializedATN          []int32
	channelNames           []string
	modeNames              []string
...
func citationslexerLexerInit() {
	staticData := &citationslexerLexerStaticData
...
// CitationsLexerInit initializes any static state used to implement CitationsLexer. By default the
// static state used to implement the lexer is lazily initialized during the first call to
// NewCitationsLexer(). You can call this function if you wish to initialize the static state ahead
// of time.
func CitationsLexerInit() {
	staticData := &citationslexerLexerStaticData
	staticData.once.Do(citationslexerLexerInit)
}

// NewCitationsLexer produces a new lexer instance for the optional input antlr.CharStream.
func NewCitationsLexer(input antlr.CharStream) *CitationsLexer {
	CitationsLexerInit()
	l := new(CitationsLexer)
	...
	l.GrammarFileName = "Citations.g4"
	// TODO: l.EOF = antlr.TokenEOF

	return l
}

// CitationsLexer tokens.
const (
	CitationsLexerCITATIONS = 1
	CitationsLexerOWNKEY    = 2
	CitationsLexerSPLITKEY  = 3
	CitationsLexerWS        = 4
)
