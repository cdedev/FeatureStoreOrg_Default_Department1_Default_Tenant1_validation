...
var cholestrollexerLexerStaticData struct {
	once                   sync.Once
	serializedATN          []int32
	channelNames           []string
	modeNames              []string
...
func cholestrollexerLexerInit() {
	staticData := &cholestrollexerLexerStaticData
...
// CholestrolLexerInit initializes any static state used to implement CholestrolLexer. By default the
// static state used to implement the lexer is lazily initialized during the first call to
// NewCholestrolLexer(). You can call this function if you wish to initialize the static state ahead
// of time.
func CholestrolLexerInit() {
	staticData := &cholestrollexerLexerStaticData
	staticData.once.Do(cholestrollexerLexerInit)
}

// NewCholestrolLexer produces a new lexer instance for the optional input antlr.CharStream.
func NewCholestrolLexer(input antlr.CharStream) *CholestrolLexer {
	CholestrolLexerInit()
	l := new(CholestrolLexer)
	...
	l.GrammarFileName = "Cholestrol.g4"
	// TODO: l.EOF = antlr.TokenEOF

	return l
}

// CholestrolLexer tokens.
const (
	CholestrolLexerCHOLESTROL = 1
	CholestrolLexerOWNKEY     = 2
	CholestrolLexerSPLITKEY   = 3
	CholestrolLexerWS         = 4
)
