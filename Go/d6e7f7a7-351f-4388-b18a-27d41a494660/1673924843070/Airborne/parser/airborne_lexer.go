...
var airbornelexerLexerStaticData struct {
	once                   sync.Once
	serializedATN          []int32
	channelNames           []string
	modeNames              []string
...
func airbornelexerLexerInit() {
	staticData := &airbornelexerLexerStaticData
...
// AirborneLexerInit initializes any static state used to implement AirborneLexer. By default the
// static state used to implement the lexer is lazily initialized during the first call to
// NewAirborneLexer(). You can call this function if you wish to initialize the static state ahead
// of time.
func AirborneLexerInit() {
	staticData := &airbornelexerLexerStaticData
	staticData.once.Do(airbornelexerLexerInit)
}

// NewAirborneLexer produces a new lexer instance for the optional input antlr.CharStream.
func NewAirborneLexer(input antlr.CharStream) *AirborneLexer {
	AirborneLexerInit()
	l := new(AirborneLexer)
	...
	l.GrammarFileName = "Airborne.g4"
	// TODO: l.EOF = antlr.TokenEOF

	return l
}

// AirborneLexer tokens.
const (
	AirborneLexerAIRBORNE = 1
	AirborneLexerOWNKEY   = 2
	AirborneLexerSPLITKEY = 3
	AirborneLexerWS       = 4
)
