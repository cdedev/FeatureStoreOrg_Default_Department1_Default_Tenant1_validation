...
var balancelexerLexerStaticData struct {
	once                   sync.Once
	serializedATN          []int32
	channelNames           []string
	modeNames              []string
...
func balancelexerLexerInit() {
	staticData := &balancelexerLexerStaticData
...
// BalanceLexerInit initializes any static state used to implement BalanceLexer. By default the
// static state used to implement the lexer is lazily initialized during the first call to
// NewBalanceLexer(). You can call this function if you wish to initialize the static state ahead
// of time.
func BalanceLexerInit() {
	staticData := &balancelexerLexerStaticData
	staticData.once.Do(balancelexerLexerInit)
}

// NewBalanceLexer produces a new lexer instance for the optional input antlr.CharStream.
func NewBalanceLexer(input antlr.CharStream) *BalanceLexer {
	BalanceLexerInit()
	l := new(BalanceLexer)
...
// BalanceLexer tokens.
const (
	BalanceLexerBALANCE  = 1
	BalanceLexerOWNKEY   = 2
	BalanceLexerSPLITKEY = 3
	BalanceLexerWS       = 4
)
