...
var octmintemplexerLexerStaticData struct {
	once                   sync.Once
	serializedATN          []int32
	channelNames           []string
	modeNames              []string
...
func octmintemplexerLexerInit() {
	staticData := &octmintemplexerLexerStaticData
...
// OctMintempLexerInit initializes any static state used to implement OctMintempLexer. By default the
// static state used to implement the lexer is lazily initialized during the first call to
// NewOctMintempLexer(). You can call this function if you wish to initialize the static state ahead
// of time.
func OctMintempLexerInit() {
	staticData := &octmintemplexerLexerStaticData
	staticData.once.Do(octmintemplexerLexerInit)
}

// NewOctMintempLexer produces a new lexer instance for the optional input antlr.CharStream.
func NewOctMintempLexer(input antlr.CharStream) *OctMintempLexer {
	OctMintempLexerInit()
	l := new(OctMintempLexer)
	...
	l.GrammarFileName = "OctMintemp.g4"
	// TODO: l.EOF = antlr.TokenEOF

	return l
}

// OctMintempLexer tokens.
const (
	OctMintempLexerOCTMINTEMP = 1
	OctMintempLexerOWNKEY     = 2
	OctMintempLexerSPLITKEY   = 3
	OctMintempLexerWS         = 4
)
