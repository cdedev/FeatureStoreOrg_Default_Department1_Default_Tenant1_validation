...
var diplopialexerLexerStaticData struct {
	once                   sync.Once
	serializedATN          []int32
	channelNames           []string
	modeNames              []string
...
func diplopialexerLexerInit() {
	staticData := &diplopialexerLexerStaticData
...
// DiplopiaLexerInit initializes any static state used to implement DiplopiaLexer. By default the
// static state used to implement the lexer is lazily initialized during the first call to
// NewDiplopiaLexer(). You can call this function if you wish to initialize the static state ahead
// of time.
func DiplopiaLexerInit() {
	staticData := &diplopialexerLexerStaticData
	staticData.once.Do(diplopialexerLexerInit)
}

// NewDiplopiaLexer produces a new lexer instance for the optional input antlr.CharStream.
func NewDiplopiaLexer(input antlr.CharStream) *DiplopiaLexer {
	DiplopiaLexerInit()
	l := new(DiplopiaLexer)
	...
	l.GrammarFileName = "Diplopia.g4"
	// TODO: l.EOF = antlr.TokenEOF

	return l
}

// DiplopiaLexer tokens.
const (
	DiplopiaLexerDIPLOPIA = 1
	DiplopiaLexerOWNKEY   = 2
	DiplopiaLexerSPLITKEY = 3
	DiplopiaLexerWS       = 4
)
