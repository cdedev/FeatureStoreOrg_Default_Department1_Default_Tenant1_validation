...
type MonthAsCustomerLexer struct {
	*antlr.BaseLexer
	channelNames []string
	modeNames    []string
	// TODO: EOF string
...
var monthascustomerlexerLexerStaticData struct {
	once                   sync.Once
	serializedATN          []int32
	channelNames           []string
	modeNames              []string
...
func monthascustomerlexerLexerInit() {
	staticData := &monthascustomerlexerLexerStaticData
...
// MonthAsCustomerLexerInit initializes any static state used to implement MonthAsCustomerLexer. By default the
// static state used to implement the lexer is lazily initialized during the first call to
// NewMonthAsCustomerLexer(). You can call this function if you wish to initialize the static state ahead
// of time.
func MonthAsCustomerLexerInit() {
	staticData := &monthascustomerlexerLexerStaticData
	staticData.once.Do(monthascustomerlexerLexerInit)
}

// NewMonthAsCustomerLexer produces a new lexer instance for the optional input antlr.CharStream.
func NewMonthAsCustomerLexer(input antlr.CharStream) *MonthAsCustomerLexer {
	MonthAsCustomerLexerInit()
	l := new(MonthAsCustomerLexer)
	...
	l.GrammarFileName = "MonthAsCustomer.g4"
	// TODO: l.EOF = antlr.TokenEOF

	return l
}

// MonthAsCustomerLexer tokens.
const (
	MonthAsCustomerLexerMONTHASCUSTOMER = 1
	MonthAsCustomerLexerOWNKEY          = 2
	MonthAsCustomerLexerSPLITKEY        = 3
	MonthAsCustomerLexerWS              = 4
)
