...
type GlobalRadiationLexer struct {
	*antlr.BaseLexer
	channelNames []string
	modeNames    []string
	// TODO: EOF string
...
var globalradiationlexerLexerStaticData struct {
	once                   sync.Once
	serializedATN          []int32
	channelNames           []string
	modeNames              []string
...
func globalradiationlexerLexerInit() {
	staticData := &globalradiationlexerLexerStaticData
...
// GlobalRadiationLexerInit initializes any static state used to implement GlobalRadiationLexer. By default the
// static state used to implement the lexer is lazily initialized during the first call to
// NewGlobalRadiationLexer(). You can call this function if you wish to initialize the static state ahead
// of time.
func GlobalRadiationLexerInit() {
	staticData := &globalradiationlexerLexerStaticData
	staticData.once.Do(globalradiationlexerLexerInit)
}

// NewGlobalRadiationLexer produces a new lexer instance for the optional input antlr.CharStream.
func NewGlobalRadiationLexer(input antlr.CharStream) *GlobalRadiationLexer {
	GlobalRadiationLexerInit()
	l := new(GlobalRadiationLexer)
	...
	l.GrammarFileName = "GlobalRadiation.g4"
	// TODO: l.EOF = antlr.TokenEOF

	return l
}

// GlobalRadiationLexer tokens.
const (
	GlobalRadiationLexerGLOBALRADIATION = 1
	GlobalRadiationLexerOWNKEY          = 2
	GlobalRadiationLexerSPLITKEY        = 3
	GlobalRadiationLexerWS              = 4
)
