...
var taillexerLexerStaticData struct {
	once                   sync.Once
	serializedATN          []int32
	channelNames           []string
	modeNames              []string
...
func taillexerLexerInit() {
	staticData := &taillexerLexerStaticData
...
// TailLexerInit initializes any static state used to implement TailLexer. By default the
// static state used to implement the lexer is lazily initialized during the first call to
// NewTailLexer(). You can call this function if you wish to initialize the static state ahead
// of time.
func TailLexerInit() {
	staticData := &taillexerLexerStaticData
	staticData.once.Do(taillexerLexerInit)
}

// NewTailLexer produces a new lexer instance for the optional input antlr.CharStream.
func NewTailLexer(input antlr.CharStream) *TailLexer {
	TailLexerInit()
	l := new(TailLexer)
