...
var heartratelexerLexerStaticData struct {
	once                   sync.Once
	serializedATN          []int32
	channelNames           []string
	modeNames              []string
...
func heartratelexerLexerInit() {
	staticData := &heartratelexerLexerStaticData
...
// HeartrateLexerInit initializes any static state used to implement HeartrateLexer. By default the
// static state used to implement the lexer is lazily initialized during the first call to
// NewHeartrateLexer(). You can call this function if you wish to initialize the static state ahead
// of time.
func HeartrateLexerInit() {
	staticData := &heartratelexerLexerStaticData
	staticData.once.Do(heartratelexerLexerInit)
}

// NewHeartrateLexer produces a new lexer instance for the optional input antlr.CharStream.
func NewHeartrateLexer(input antlr.CharStream) *HeartrateLexer {
	HeartrateLexerInit()
	l := new(HeartrateLexer)
	...
	l.GrammarFileName = "Heartrate.g4"
	// TODO: l.EOF = antlr.TokenEOF

	return l
}

// HeartrateLexer tokens.
const (
	HeartrateLexerHEARTRATE = 1
	HeartrateLexerOWNKEY    = 2
	HeartrateLexerSPLITKEY  = 3
	HeartrateLexerWS        = 4
)
