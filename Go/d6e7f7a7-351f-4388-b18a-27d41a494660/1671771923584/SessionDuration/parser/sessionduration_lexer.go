...
type SessionDurationLexer struct {
	*antlr.BaseLexer
	channelNames []string
	modeNames    []string
	// TODO: EOF string
...
var sessiondurationlexerLexerStaticData struct {
	once                   sync.Once
	serializedATN          []int32
	channelNames           []string
	modeNames              []string
...
func sessiondurationlexerLexerInit() {
	staticData := &sessiondurationlexerLexerStaticData
...
// SessionDurationLexerInit initializes any static state used to implement SessionDurationLexer. By default the
// static state used to implement the lexer is lazily initialized during the first call to
// NewSessionDurationLexer(). You can call this function if you wish to initialize the static state ahead
// of time.
func SessionDurationLexerInit() {
	staticData := &sessiondurationlexerLexerStaticData
	staticData.once.Do(sessiondurationlexerLexerInit)
}

// NewSessionDurationLexer produces a new lexer instance for the optional input antlr.CharStream.
func NewSessionDurationLexer(input antlr.CharStream) *SessionDurationLexer {
	SessionDurationLexerInit()
	l := new(SessionDurationLexer)
	...
	l.GrammarFileName = "SessionDuration.g4"
	// TODO: l.EOF = antlr.TokenEOF

	return l
}

// SessionDurationLexer tokens.
const (
	SessionDurationLexerSESSIONDURATION = 1
	SessionDurationLexerOWNKEY          = 2
	SessionDurationLexerSPLITKEY        = 3
	SessionDurationLexerWS              = 4
)
