...
var assetslexerLexerStaticData struct {
	once                   sync.Once
	serializedATN          []int32
	channelNames           []string
	modeNames              []string
...
func assetslexerLexerInit() {
	staticData := &assetslexerLexerStaticData
...
// AssetsLexerInit initializes any static state used to implement AssetsLexer. By default the
// static state used to implement the lexer is lazily initialized during the first call to
// NewAssetsLexer(). You can call this function if you wish to initialize the static state ahead
// of time.
func AssetsLexerInit() {
	staticData := &assetslexerLexerStaticData
	staticData.once.Do(assetslexerLexerInit)
}

// NewAssetsLexer produces a new lexer instance for the optional input antlr.CharStream.
func NewAssetsLexer(input antlr.CharStream) *AssetsLexer {
	AssetsLexerInit()
	l := new(AssetsLexer)
