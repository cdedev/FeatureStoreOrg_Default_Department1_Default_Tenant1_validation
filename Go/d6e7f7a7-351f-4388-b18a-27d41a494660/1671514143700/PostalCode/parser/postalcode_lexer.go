...
var postalcodelexerLexerStaticData struct {
	once                   sync.Once
	serializedATN          []int32
	channelNames           []string
	modeNames              []string
...
func postalcodelexerLexerInit() {
	staticData := &postalcodelexerLexerStaticData
...
// PostalCodeLexerInit initializes any static state used to implement PostalCodeLexer. By default the
// static state used to implement the lexer is lazily initialized during the first call to
// NewPostalCodeLexer(). You can call this function if you wish to initialize the static state ahead
// of time.
func PostalCodeLexerInit() {
	staticData := &postalcodelexerLexerStaticData
	staticData.once.Do(postalcodelexerLexerInit)
}
...
const (
	PostalCodeLexerPOSTALCODE = 1
	PostalCodeLexerOWNKEY     = 2
	PostalCodeLexerSPLITKEY   = 3
	PostalCodeLexerWS         = 4
)
