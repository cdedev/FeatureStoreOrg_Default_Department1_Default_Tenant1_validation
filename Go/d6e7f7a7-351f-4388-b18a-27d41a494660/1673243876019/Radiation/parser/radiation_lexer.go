...
var radiationlexerLexerStaticData struct {
	once                   sync.Once
	serializedATN          []int32
	channelNames           []string
	modeNames              []string
...
func radiationlexerLexerInit() {
	staticData := &radiationlexerLexerStaticData
...
// RadiationLexerInit initializes any static state used to implement RadiationLexer. By default the
// static state used to implement the lexer is lazily initialized during the first call to
// NewRadiationLexer(). You can call this function if you wish to initialize the static state ahead
// of time.
func RadiationLexerInit() {
	staticData := &radiationlexerLexerStaticData
	staticData.once.Do(radiationlexerLexerInit)
}

// NewRadiationLexer produces a new lexer instance for the optional input antlr.CharStream.
func NewRadiationLexer(input antlr.CharStream) *RadiationLexer {
	RadiationLexerInit()
	l := new(RadiationLexer)
	...
	l.GrammarFileName = "Radiation.g4"
	// TODO: l.EOF = antlr.TokenEOF

	return l
}

// RadiationLexer tokens.
const (
	RadiationLexerRADIATION = 1
	RadiationLexerOWNKEY    = 2
	RadiationLexerSPLITKEY  = 3
	RadiationLexerWS        = 4
)
