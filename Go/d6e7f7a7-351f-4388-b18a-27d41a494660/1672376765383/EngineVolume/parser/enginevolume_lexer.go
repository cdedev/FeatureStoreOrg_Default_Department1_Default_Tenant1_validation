...
var enginevolumelexerLexerStaticData struct {
	once                   sync.Once
	serializedATN          []int32
	channelNames           []string
	modeNames              []string
...
func enginevolumelexerLexerInit() {
	staticData := &enginevolumelexerLexerStaticData
...
// EngineVolumeLexerInit initializes any static state used to implement EngineVolumeLexer. By default the
// static state used to implement the lexer is lazily initialized during the first call to
// NewEngineVolumeLexer(). You can call this function if you wish to initialize the static state ahead
// of time.
func EngineVolumeLexerInit() {
	staticData := &enginevolumelexerLexerStaticData
	staticData.once.Do(enginevolumelexerLexerInit)
}

// NewEngineVolumeLexer produces a new lexer instance for the optional input antlr.CharStream.
func NewEngineVolumeLexer(input antlr.CharStream) *EngineVolumeLexer {
	EngineVolumeLexerInit()
	l := new(EngineVolumeLexer)
	...
	l.GrammarFileName = "EngineVolume.g4"
	// TODO: l.EOF = antlr.TokenEOF

	return l
}

// EngineVolumeLexer tokens.
const (
	EngineVolumeLexerENGINEVOLUME = 1
	EngineVolumeLexerOWNKEY       = 2
	EngineVolumeLexerSPLITKEY     = 3
	EngineVolumeLexerWS           = 4
)
