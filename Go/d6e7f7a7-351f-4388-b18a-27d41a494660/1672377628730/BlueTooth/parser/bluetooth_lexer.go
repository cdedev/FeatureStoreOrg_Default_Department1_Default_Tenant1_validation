...
var bluetoothlexerLexerStaticData struct {
	once                   sync.Once
	serializedATN          []int32
	channelNames           []string
	modeNames              []string
...
func bluetoothlexerLexerInit() {
	staticData := &bluetoothlexerLexerStaticData
...
// BlueToothLexerInit initializes any static state used to implement BlueToothLexer. By default the
// static state used to implement the lexer is lazily initialized during the first call to
// NewBlueToothLexer(). You can call this function if you wish to initialize the static state ahead
// of time.
func BlueToothLexerInit() {
	staticData := &bluetoothlexerLexerStaticData
	staticData.once.Do(bluetoothlexerLexerInit)
}

// NewBlueToothLexer produces a new lexer instance for the optional input antlr.CharStream.
func NewBlueToothLexer(input antlr.CharStream) *BlueToothLexer {
	BlueToothLexerInit()
	l := new(BlueToothLexer)
	...
	l.GrammarFileName = "BlueTooth.g4"
	// TODO: l.EOF = antlr.TokenEOF

	return l
}

// BlueToothLexer tokens.
const (
	BlueToothLexerBLUETOOTH = 1
	BlueToothLexerOWNKEY    = 2
	BlueToothLexerSPLITKEY  = 3
	BlueToothLexerWS        = 4
)
