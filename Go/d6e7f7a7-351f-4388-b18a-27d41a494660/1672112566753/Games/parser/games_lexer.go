...
var gameslexerLexerStaticData struct {
	once                   sync.Once
	serializedATN          []int32
	channelNames           []string
	modeNames              []string
...
func gameslexerLexerInit() {
	staticData := &gameslexerLexerStaticData
...
// GamesLexerInit initializes any static state used to implement GamesLexer. By default the
// static state used to implement the lexer is lazily initialized during the first call to
// NewGamesLexer(). You can call this function if you wish to initialize the static state ahead
// of time.
func GamesLexerInit() {
	staticData := &gameslexerLexerStaticData
	staticData.once.Do(gameslexerLexerInit)
}

// NewGamesLexer produces a new lexer instance for the optional input antlr.CharStream.
func NewGamesLexer(input antlr.CharStream) *GamesLexer {
	GamesLexerInit()
	l := new(GamesLexer)
