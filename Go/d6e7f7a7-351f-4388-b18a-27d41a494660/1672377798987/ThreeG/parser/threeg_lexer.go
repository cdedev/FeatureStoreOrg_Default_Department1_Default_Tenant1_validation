...
var threeglexerLexerStaticData struct {
	once                   sync.Once
	serializedATN          []int32
	channelNames           []string
	modeNames              []string
...
func threeglexerLexerInit() {
	staticData := &threeglexerLexerStaticData
...
// ThreeGLexerInit initializes any static state used to implement ThreeGLexer. By default the
// static state used to implement the lexer is lazily initialized during the first call to
// NewThreeGLexer(). You can call this function if you wish to initialize the static state ahead
// of time.
func ThreeGLexerInit() {
	staticData := &threeglexerLexerStaticData
	staticData.once.Do(threeglexerLexerInit)
}

// NewThreeGLexer produces a new lexer instance for the optional input antlr.CharStream.
func NewThreeGLexer(input antlr.CharStream) *ThreeGLexer {
	ThreeGLexerInit()
	l := new(ThreeGLexer)
