...
var nooforderslexerLexerStaticData struct {
	once                   sync.Once
	serializedATN          []int32
	channelNames           []string
	modeNames              []string
...
func nooforderslexerLexerInit() {
	staticData := &nooforderslexerLexerStaticData
...
// NoOfOrdersLexerInit initializes any static state used to implement NoOfOrdersLexer. By default the
// static state used to implement the lexer is lazily initialized during the first call to
// NewNoOfOrdersLexer(). You can call this function if you wish to initialize the static state ahead
// of time.
func NoOfOrdersLexerInit() {
	staticData := &nooforderslexerLexerStaticData
	staticData.once.Do(nooforderslexerLexerInit)
}

// NewNoOfOrdersLexer produces a new lexer instance for the optional input antlr.CharStream.
func NewNoOfOrdersLexer(input antlr.CharStream) *NoOfOrdersLexer {
	NoOfOrdersLexerInit()
	l := new(NoOfOrdersLexer)
	...
	l.GrammarFileName = "NoOfOrders.g4"
	// TODO: l.EOF = antlr.TokenEOF

	return l
}

// NoOfOrdersLexer tokens.
const (
	NoOfOrdersLexerNOOFORDERS = 1
	NoOfOrdersLexerOWNKEY     = 2
	NoOfOrdersLexerSPLITKEY   = 3
	NoOfOrdersLexerWS         = 4
)
