...
type ReportingPeriodLexer struct {
	*antlr.BaseLexer
	channelNames []string
	modeNames    []string
	// TODO: EOF string
...
var reportingperiodlexerLexerStaticData struct {
	once                   sync.Once
	serializedATN          []int32
	channelNames           []string
	modeNames              []string
...
func reportingperiodlexerLexerInit() {
	staticData := &reportingperiodlexerLexerStaticData
	...
	staticData.serializedATN = []int32{
		...
		0, 4, 1, 1, 3, 2, 5, 3, 7, 4, 1, 0, 2, 2, 0, 45, 45, 48, 57, 3, 0, 9, 10,
...
// ReportingPeriodLexerInit initializes any static state used to implement ReportingPeriodLexer. By default the
// static state used to implement the lexer is lazily initialized during the first call to
// NewReportingPeriodLexer(). You can call this function if you wish to initialize the static state ahead
// of time.
func ReportingPeriodLexerInit() {
	staticData := &reportingperiodlexerLexerStaticData
	staticData.once.Do(reportingperiodlexerLexerInit)
}

// NewReportingPeriodLexer produces a new lexer instance for the optional input antlr.CharStream.
func NewReportingPeriodLexer(input antlr.CharStream) *ReportingPeriodLexer {
	ReportingPeriodLexerInit()
	l := new(ReportingPeriodLexer)
	...
	l.GrammarFileName = "ReportingPeriod.g4"
	// TODO: l.EOF = antlr.TokenEOF

	return l
}

// ReportingPeriodLexer tokens.
const (
	ReportingPeriodLexerREPORTINGPERIOD = 1
	ReportingPeriodLexerOWNKEY          = 2
	ReportingPeriodLexerSPLITKEY        = 3
	ReportingPeriodLexerWS              = 4
)
