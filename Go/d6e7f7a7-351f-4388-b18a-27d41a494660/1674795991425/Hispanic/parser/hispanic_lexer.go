...
var hispaniclexerLexerStaticData struct {
	once                   sync.Once
	serializedATN          []int32
	channelNames           []string
	modeNames              []string
...
func hispaniclexerLexerInit() {
	staticData := &hispaniclexerLexerStaticData
...
// HispanicLexerInit initializes any static state used to implement HispanicLexer. By default the
// static state used to implement the lexer is lazily initialized during the first call to
// NewHispanicLexer(). You can call this function if you wish to initialize the static state ahead
// of time.
func HispanicLexerInit() {
	staticData := &hispaniclexerLexerStaticData
	staticData.once.Do(hispaniclexerLexerInit)
}

// NewHispanicLexer produces a new lexer instance for the optional input antlr.CharStream.
func NewHispanicLexer(input antlr.CharStream) *HispanicLexer {
	HispanicLexerInit()
	l := new(HispanicLexer)
	...
	l.GrammarFileName = "Hispanic.g4"
	// TODO: l.EOF = antlr.TokenEOF

	return l
}

// HispanicLexer tokens.
const (
	HispanicLexerHISPANIC = 1
	HispanicLexerOWNKEY   = 2
	HispanicLexerSPLITKEY = 3
	HispanicLexerWS       = 4
)
