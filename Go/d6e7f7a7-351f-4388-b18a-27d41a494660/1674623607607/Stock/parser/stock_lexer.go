...
var stocklexerLexerStaticData struct {
	once                   sync.Once
	serializedATN          []int32
	channelNames           []string
	modeNames              []string
...
func stocklexerLexerInit() {
	staticData := &stocklexerLexerStaticData
...
// StockLexerInit initializes any static state used to implement StockLexer. By default the
// static state used to implement the lexer is lazily initialized during the first call to
// NewStockLexer(). You can call this function if you wish to initialize the static state ahead
// of time.
func StockLexerInit() {
	staticData := &stocklexerLexerStaticData
	staticData.once.Do(stocklexerLexerInit)
}

// NewStockLexer produces a new lexer instance for the optional input antlr.CharStream.
func NewStockLexer(input antlr.CharStream) *StockLexer {
	StockLexerInit()
	l := new(StockLexer)
