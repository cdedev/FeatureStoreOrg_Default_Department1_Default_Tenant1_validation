...
var paymentlexerLexerStaticData struct {
	once                   sync.Once
	serializedATN          []int32
	channelNames           []string
	modeNames              []string
...
func paymentlexerLexerInit() {
	staticData := &paymentlexerLexerStaticData
...
// PaymentLexerInit initializes any static state used to implement PaymentLexer. By default the
// static state used to implement the lexer is lazily initialized during the first call to
// NewPaymentLexer(). You can call this function if you wish to initialize the static state ahead
// of time.
func PaymentLexerInit() {
	staticData := &paymentlexerLexerStaticData
	staticData.once.Do(paymentlexerLexerInit)
}

// NewPaymentLexer produces a new lexer instance for the optional input antlr.CharStream.
func NewPaymentLexer(input antlr.CharStream) *PaymentLexer {
	PaymentLexerInit()
	l := new(PaymentLexer)
...
// PaymentLexer tokens.
const (
	PaymentLexerPAYMENT  = 1
	PaymentLexerOWNKEY   = 2
	PaymentLexerSPLITKEY = 3
	PaymentLexerWS       = 4
)
