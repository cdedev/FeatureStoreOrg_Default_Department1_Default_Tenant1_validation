...
var drylexerLexerStaticData struct {
	once                   sync.Once
	serializedATN          []int32
	channelNames           []string
	modeNames              []string
...
func drylexerLexerInit() {
	staticData := &drylexerLexerStaticData
...
// DryLexerInit initializes any static state used to implement DryLexer. By default the
// static state used to implement the lexer is lazily initialized during the first call to
// NewDryLexer(). You can call this function if you wish to initialize the static state ahead
// of time.
func DryLexerInit() {
	staticData := &drylexerLexerStaticData
	staticData.once.Do(drylexerLexerInit)
}

// NewDryLexer produces a new lexer instance for the optional input antlr.CharStream.
func NewDryLexer(input antlr.CharStream) *DryLexer {
	DryLexerInit()
	l := new(DryLexer)
