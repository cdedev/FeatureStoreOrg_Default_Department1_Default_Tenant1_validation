...
var pointslexerLexerStaticData struct {
	once                   sync.Once
	serializedATN          []int32
	channelNames           []string
	modeNames              []string
...
func pointslexerLexerInit() {
	staticData := &pointslexerLexerStaticData
...
// PointsLexerInit initializes any static state used to implement PointsLexer. By default the
// static state used to implement the lexer is lazily initialized during the first call to
// NewPointsLexer(). You can call this function if you wish to initialize the static state ahead
// of time.
func PointsLexerInit() {
	staticData := &pointslexerLexerStaticData
	staticData.once.Do(pointslexerLexerInit)
}

// NewPointsLexer produces a new lexer instance for the optional input antlr.CharStream.
func NewPointsLexer(input antlr.CharStream) *PointsLexer {
	PointsLexerInit()
	l := new(PointsLexer)
