...
var calciumlexerLexerStaticData struct {
	once                   sync.Once
	serializedATN          []int32
	channelNames           []string
	modeNames              []string
...
func calciumlexerLexerInit() {
	staticData := &calciumlexerLexerStaticData
...
// CalciumLexerInit initializes any static state used to implement CalciumLexer. By default the
// static state used to implement the lexer is lazily initialized during the first call to
// NewCalciumLexer(). You can call this function if you wish to initialize the static state ahead
// of time.
func CalciumLexerInit() {
	staticData := &calciumlexerLexerStaticData
	staticData.once.Do(calciumlexerLexerInit)
}

// NewCalciumLexer produces a new lexer instance for the optional input antlr.CharStream.
func NewCalciumLexer(input antlr.CharStream) *CalciumLexer {
	CalciumLexerInit()
	l := new(CalciumLexer)
...
// CalciumLexer tokens.
const (
	CalciumLexerCALCIUM  = 1
	CalciumLexerOWNKEY   = 2
	CalciumLexerSPLITKEY = 3
	CalciumLexerWS       = 4
)
