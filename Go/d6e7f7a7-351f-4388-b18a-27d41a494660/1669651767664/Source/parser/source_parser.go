...
const (
	...
	SourceParserSOURCE   = 1
	SourceParserOWNKEY   = 2
	SourceParserSPLITKEY = 3
	SourceParserWS       = 4
)

// SourceParser rules.
const (
	SourceParserRULE_expression = 0
	SourceParserRULE_source     = 1
)
...
func NewEmptyExpressionContext() *ExpressionContext {
	...
	p.RuleIndex = SourceParserRULE_expression
	return p
}
...
func (s *ExpressionContext) Source() ISourceContext {
...
func (p *SourceParser) Expression() (localctx IExpressionContext) {
	this := p
	_ = this

	localctx = NewExpressionContext(p, p.GetParserRuleContext(), p.GetState())
	p.EnterRule(localctx, 0, SourceParserRULE_expression)
...
func NewEmptySourceContext() *SourceContext {
	...
	p.BaseParserRuleContext = antlr.NewBaseParserRuleContext(nil, -1)
	p.RuleIndex = SourceParserRULE_source
	return p
}
...
func (s *SourceContext) SOURCE() antlr.TerminalNode {
	return s.GetToken(SourceParserSOURCE, 0)
}
...
func (p *SourceParser) Source() (localctx ISourceContext) {
	this := p
	_ = this

	localctx = NewSourceContext(p, p.GetParserRuleContext(), p.GetState())
	p.EnterRule(localctx, 2, SourceParserRULE_source)
