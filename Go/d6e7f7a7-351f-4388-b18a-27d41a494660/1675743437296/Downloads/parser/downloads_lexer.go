...
var downloadslexerLexerStaticData struct {
	once                   sync.Once
	serializedATN          []int32
	channelNames           []string
	modeNames              []string
...
func downloadslexerLexerInit() {
	staticData := &downloadslexerLexerStaticData
...
// DownloadsLexerInit initializes any static state used to implement DownloadsLexer. By default the
// static state used to implement the lexer is lazily initialized during the first call to
// NewDownloadsLexer(). You can call this function if you wish to initialize the static state ahead
// of time.
func DownloadsLexerInit() {
	staticData := &downloadslexerLexerStaticData
	staticData.once.Do(downloadslexerLexerInit)
}

// NewDownloadsLexer produces a new lexer instance for the optional input antlr.CharStream.
func NewDownloadsLexer(input antlr.CharStream) *DownloadsLexer {
	DownloadsLexerInit()
	l := new(DownloadsLexer)
	...
	l.GrammarFileName = "Downloads.g4"
	// TODO: l.EOF = antlr.TokenEOF

	return l
}

// DownloadsLexer tokens.
const (
	DownloadsLexerDOWNLOADS = 1
	DownloadsLexerOWNKEY    = 2
	DownloadsLexerSPLITKEY  = 3
	DownloadsLexerWS        = 4
)
