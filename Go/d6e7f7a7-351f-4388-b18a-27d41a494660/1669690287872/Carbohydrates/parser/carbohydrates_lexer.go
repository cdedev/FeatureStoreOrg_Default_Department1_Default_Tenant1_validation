...
type CarbohydratesLexer struct {
	*antlr.BaseLexer
	channelNames []string
	modeNames    []string
	// TODO: EOF string
...
var carbohydrateslexerLexerStaticData struct {
	once                   sync.Once
	serializedATN          []int32
	channelNames           []string
	modeNames              []string
...
func carbohydrateslexerLexerInit() {
	staticData := &carbohydrateslexerLexerStaticData
...
// CarbohydratesLexerInit initializes any static state used to implement CarbohydratesLexer. By default the
// static state used to implement the lexer is lazily initialized during the first call to
// NewCarbohydratesLexer(). You can call this function if you wish to initialize the static state ahead
// of time.
func CarbohydratesLexerInit() {
	staticData := &carbohydrateslexerLexerStaticData
	staticData.once.Do(carbohydrateslexerLexerInit)
}

// NewCarbohydratesLexer produces a new lexer instance for the optional input antlr.CharStream.
func NewCarbohydratesLexer(input antlr.CharStream) *CarbohydratesLexer {
	CarbohydratesLexerInit()
	l := new(CarbohydratesLexer)
	...
	l.GrammarFileName = "Carbohydrates.g4"
	// TODO: l.EOF = antlr.TokenEOF

	return l
}

// CarbohydratesLexer tokens.
const (
	CarbohydratesLexerCARBOHYDRATES = 1
	CarbohydratesLexerOWNKEY        = 2
	CarbohydratesLexerSPLITKEY      = 3
	CarbohydratesLexerWS            = 4
)
