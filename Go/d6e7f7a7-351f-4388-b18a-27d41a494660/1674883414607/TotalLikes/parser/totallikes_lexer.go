...
var totallikeslexerLexerStaticData struct {
	once                   sync.Once
	serializedATN          []int32
	channelNames           []string
	modeNames              []string
...
func totallikeslexerLexerInit() {
	staticData := &totallikeslexerLexerStaticData
...
// TotalLikesLexerInit initializes any static state used to implement TotalLikesLexer. By default the
// static state used to implement the lexer is lazily initialized during the first call to
// NewTotalLikesLexer(). You can call this function if you wish to initialize the static state ahead
// of time.
func TotalLikesLexerInit() {
	staticData := &totallikeslexerLexerStaticData
	staticData.once.Do(totallikeslexerLexerInit)
}

// NewTotalLikesLexer produces a new lexer instance for the optional input antlr.CharStream.
func NewTotalLikesLexer(input antlr.CharStream) *TotalLikesLexer {
	TotalLikesLexerInit()
	l := new(TotalLikesLexer)
	...
	l.GrammarFileName = "TotalLikes.g4"
	// TODO: l.EOF = antlr.TokenEOF

	return l
}

// TotalLikesLexer tokens.
const (
	TotalLikesLexerTOTALLIKES = 1
	TotalLikesLexerOWNKEY     = 2
	TotalLikesLexerSPLITKEY   = 3
	TotalLikesLexerWS         = 4
)
