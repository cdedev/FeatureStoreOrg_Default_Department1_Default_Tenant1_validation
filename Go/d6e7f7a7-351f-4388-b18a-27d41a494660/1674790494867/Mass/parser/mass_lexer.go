...
var masslexerLexerStaticData struct {
	once                   sync.Once
	serializedATN          []int32
	channelNames           []string
	modeNames              []string
...
func masslexerLexerInit() {
	staticData := &masslexerLexerStaticData
...
// MassLexerInit initializes any static state used to implement MassLexer. By default the
// static state used to implement the lexer is lazily initialized during the first call to
// NewMassLexer(). You can call this function if you wish to initialize the static state ahead
// of time.
func MassLexerInit() {
	staticData := &masslexerLexerStaticData
	staticData.once.Do(masslexerLexerInit)
}

// NewMassLexer produces a new lexer instance for the optional input antlr.CharStream.
func NewMassLexer(input antlr.CharStream) *MassLexer {
	MassLexerInit()
	l := new(MassLexer)
