...
var ranklexerLexerStaticData struct {
	once                   sync.Once
	serializedATN          []int32
	channelNames           []string
	modeNames              []string
...
func ranklexerLexerInit() {
	staticData := &ranklexerLexerStaticData
...
// RankLexerInit initializes any static state used to implement RankLexer. By default the
// static state used to implement the lexer is lazily initialized during the first call to
// NewRankLexer(). You can call this function if you wish to initialize the static state ahead
// of time.
func RankLexerInit() {
	staticData := &ranklexerLexerStaticData
	staticData.once.Do(ranklexerLexerInit)
}

// NewRankLexer produces a new lexer instance for the optional input antlr.CharStream.
func NewRankLexer(input antlr.CharStream) *RankLexer {
	RankLexerInit()
	l := new(RankLexer)
