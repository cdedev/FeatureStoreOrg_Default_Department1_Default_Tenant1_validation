// Code generated from /usr/local/lib/Go/d6e7f7a7-351f-4388-b18a-27d41a494660/1675670532554/Memory.g4 by ANTLR 4.10.1. DO NOT EDIT.
...
var memorylexerLexerStaticData struct {
	once                   sync.Once
	serializedATN          []int32
	channelNames           []string
	modeNames              []string
...
func memorylexerLexerInit() {
	staticData := &memorylexerLexerStaticData
...
// MemoryLexerInit initializes any static state used to implement MemoryLexer. By default the
// static state used to implement the lexer is lazily initialized during the first call to
// NewMemoryLexer(). You can call this function if you wish to initialize the static state ahead
// of time.
func MemoryLexerInit() {
	staticData := &memorylexerLexerStaticData
	staticData.once.Do(memorylexerLexerInit)
}

// NewMemoryLexer produces a new lexer instance for the optional input antlr.CharStream.
func NewMemoryLexer(input antlr.CharStream) *MemoryLexer {
	MemoryLexerInit()
	l := new(MemoryLexer)
