...
var brominelexerLexerStaticData struct {
	once                   sync.Once
	serializedATN          []int32
	channelNames           []string
	modeNames              []string
...
func brominelexerLexerInit() {
	staticData := &brominelexerLexerStaticData
...
// BromineLexerInit initializes any static state used to implement BromineLexer. By default the
// static state used to implement the lexer is lazily initialized during the first call to
// NewBromineLexer(). You can call this function if you wish to initialize the static state ahead
// of time.
func BromineLexerInit() {
	staticData := &brominelexerLexerStaticData
	staticData.once.Do(brominelexerLexerInit)
}

// NewBromineLexer produces a new lexer instance for the optional input antlr.CharStream.
func NewBromineLexer(input antlr.CharStream) *BromineLexer {
	BromineLexerInit()
	l := new(BromineLexer)
...
// BromineLexer tokens.
const (
	BromineLexerBROMINE  = 1
	BromineLexerOWNKEY   = 2
	BromineLexerSPLITKEY = 3
	BromineLexerWS       = 4
)
