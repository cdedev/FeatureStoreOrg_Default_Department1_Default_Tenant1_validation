...
var lightbilllexerLexerStaticData struct {
	once                   sync.Once
	serializedATN          []int32
	channelNames           []string
	modeNames              []string
...
func lightbilllexerLexerInit() {
	staticData := &lightbilllexerLexerStaticData
...
// LightbillLexerInit initializes any static state used to implement LightbillLexer. By default the
// static state used to implement the lexer is lazily initialized during the first call to
// NewLightbillLexer(). You can call this function if you wish to initialize the static state ahead
// of time.
func LightbillLexerInit() {
	staticData := &lightbilllexerLexerStaticData
	staticData.once.Do(lightbilllexerLexerInit)
}

// NewLightbillLexer produces a new lexer instance for the optional input antlr.CharStream.
func NewLightbillLexer(input antlr.CharStream) *LightbillLexer {
	LightbillLexerInit()
	l := new(LightbillLexer)
	...
	l.GrammarFileName = "Lightbill.g4"
	// TODO: l.EOF = antlr.TokenEOF

	return l
}

// LightbillLexer tokens.
const (
	LightbillLexerLIGHTBILL = 1
	LightbillLexerOWNKEY    = 2
	LightbillLexerSPLITKEY  = 3
	LightbillLexerWS        = 4
)
