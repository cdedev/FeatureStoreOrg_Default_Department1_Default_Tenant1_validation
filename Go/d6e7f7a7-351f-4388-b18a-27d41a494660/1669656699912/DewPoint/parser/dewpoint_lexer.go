...
var dewpointlexerLexerStaticData struct {
	once                   sync.Once
	serializedATN          []int32
	channelNames           []string
	modeNames              []string
...
func dewpointlexerLexerInit() {
	staticData := &dewpointlexerLexerStaticData
...
// DewPointLexerInit initializes any static state used to implement DewPointLexer. By default the
// static state used to implement the lexer is lazily initialized during the first call to
// NewDewPointLexer(). You can call this function if you wish to initialize the static state ahead
// of time.
func DewPointLexerInit() {
	staticData := &dewpointlexerLexerStaticData
	staticData.once.Do(dewpointlexerLexerInit)
}

// NewDewPointLexer produces a new lexer instance for the optional input antlr.CharStream.
func NewDewPointLexer(input antlr.CharStream) *DewPointLexer {
	DewPointLexerInit()
	l := new(DewPointLexer)
	...
	l.GrammarFileName = "DewPoint.g4"
	// TODO: l.EOF = antlr.TokenEOF

	return l
}

// DewPointLexer tokens.
const (
	DewPointLexerDEWPOINT = 1
	DewPointLexerOWNKEY   = 2
	DewPointLexerSPLITKEY = 3
	DewPointLexerWS       = 4
)
