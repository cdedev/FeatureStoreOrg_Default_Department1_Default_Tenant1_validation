...
var boronlexerLexerStaticData struct {
	once                   sync.Once
	serializedATN          []int32
	channelNames           []string
	modeNames              []string
...
func boronlexerLexerInit() {
	staticData := &boronlexerLexerStaticData
...
// BoronLexerInit initializes any static state used to implement BoronLexer. By default the
// static state used to implement the lexer is lazily initialized during the first call to
// NewBoronLexer(). You can call this function if you wish to initialize the static state ahead
// of time.
func BoronLexerInit() {
	staticData := &boronlexerLexerStaticData
	staticData.once.Do(boronlexerLexerInit)
}

// NewBoronLexer produces a new lexer instance for the optional input antlr.CharStream.
func NewBoronLexer(input antlr.CharStream) *BoronLexer {
	BoronLexerInit()
	l := new(BoronLexer)
