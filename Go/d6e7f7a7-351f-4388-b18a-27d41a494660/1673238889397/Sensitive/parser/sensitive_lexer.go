...
var sensitivelexerLexerStaticData struct {
	once                   sync.Once
	serializedATN          []int32
	channelNames           []string
	modeNames              []string
...
func sensitivelexerLexerInit() {
	staticData := &sensitivelexerLexerStaticData
...
// SensitiveLexerInit initializes any static state used to implement SensitiveLexer. By default the
// static state used to implement the lexer is lazily initialized during the first call to
// NewSensitiveLexer(). You can call this function if you wish to initialize the static state ahead
// of time.
func SensitiveLexerInit() {
	staticData := &sensitivelexerLexerStaticData
	staticData.once.Do(sensitivelexerLexerInit)
}

// NewSensitiveLexer produces a new lexer instance for the optional input antlr.CharStream.
func NewSensitiveLexer(input antlr.CharStream) *SensitiveLexer {
	SensitiveLexerInit()
	l := new(SensitiveLexer)
	...
	l.GrammarFileName = "Sensitive.g4"
	// TODO: l.EOF = antlr.TokenEOF

	return l
}

// SensitiveLexer tokens.
const (
	SensitiveLexerSENSITIVE = 1
	SensitiveLexerOWNKEY    = 2
	SensitiveLexerSPLITKEY  = 3
	SensitiveLexerWS        = 4
)
