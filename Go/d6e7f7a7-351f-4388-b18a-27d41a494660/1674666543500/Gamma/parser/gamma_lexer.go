...
var gammalexerLexerStaticData struct {
	once                   sync.Once
	serializedATN          []int32
	channelNames           []string
	modeNames              []string
...
func gammalexerLexerInit() {
	staticData := &gammalexerLexerStaticData
...
// GammaLexerInit initializes any static state used to implement GammaLexer. By default the
// static state used to implement the lexer is lazily initialized during the first call to
// NewGammaLexer(). You can call this function if you wish to initialize the static state ahead
// of time.
func GammaLexerInit() {
	staticData := &gammalexerLexerStaticData
	staticData.once.Do(gammalexerLexerInit)
}

// NewGammaLexer produces a new lexer instance for the optional input antlr.CharStream.
func NewGammaLexer(input antlr.CharStream) *GammaLexer {
	GammaLexerInit()
	l := new(GammaLexer)
