...
var systoliclexerLexerStaticData struct {
	once                   sync.Once
	serializedATN          []int32
	channelNames           []string
	modeNames              []string
...
func systoliclexerLexerInit() {
	staticData := &systoliclexerLexerStaticData
...
// SystolicLexerInit initializes any static state used to implement SystolicLexer. By default the
// static state used to implement the lexer is lazily initialized during the first call to
// NewSystolicLexer(). You can call this function if you wish to initialize the static state ahead
// of time.
func SystolicLexerInit() {
	staticData := &systoliclexerLexerStaticData
	staticData.once.Do(systoliclexerLexerInit)
}

// NewSystolicLexer produces a new lexer instance for the optional input antlr.CharStream.
func NewSystolicLexer(input antlr.CharStream) *SystolicLexer {
	SystolicLexerInit()
	l := new(SystolicLexer)
	...
	l.GrammarFileName = "Systolic.g4"
	// TODO: l.EOF = antlr.TokenEOF

	return l
}

// SystolicLexer tokens.
const (
	SystolicLexerSYSTOLIC = 1
	SystolicLexerOWNKEY   = 2
	SystolicLexerSPLITKEY = 3
	SystolicLexerWS       = 4
)
