...
var breatheslexerLexerStaticData struct {
	once                   sync.Once
	serializedATN          []int32
	channelNames           []string
	modeNames              []string
...
func breatheslexerLexerInit() {
	staticData := &breatheslexerLexerStaticData
...
// BreathesLexerInit initializes any static state used to implement BreathesLexer. By default the
// static state used to implement the lexer is lazily initialized during the first call to
// NewBreathesLexer(). You can call this function if you wish to initialize the static state ahead
// of time.
func BreathesLexerInit() {
	staticData := &breatheslexerLexerStaticData
	staticData.once.Do(breatheslexerLexerInit)
}

// NewBreathesLexer produces a new lexer instance for the optional input antlr.CharStream.
func NewBreathesLexer(input antlr.CharStream) *BreathesLexer {
	BreathesLexerInit()
	l := new(BreathesLexer)
	...
	l.GrammarFileName = "Breathes.g4"
	// TODO: l.EOF = antlr.TokenEOF

	return l
}

// BreathesLexer tokens.
const (
	BreathesLexerBREATHES = 1
	BreathesLexerOWNKEY   = 2
	BreathesLexerSPLITKEY = 3
	BreathesLexerWS       = 4
)
