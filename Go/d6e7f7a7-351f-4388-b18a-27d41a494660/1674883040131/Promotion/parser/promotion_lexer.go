...
var promotionlexerLexerStaticData struct {
	once                   sync.Once
	serializedATN          []int32
	channelNames           []string
	modeNames              []string
...
func promotionlexerLexerInit() {
	staticData := &promotionlexerLexerStaticData
...
// PromotionLexerInit initializes any static state used to implement PromotionLexer. By default the
// static state used to implement the lexer is lazily initialized during the first call to
// NewPromotionLexer(). You can call this function if you wish to initialize the static state ahead
// of time.
func PromotionLexerInit() {
	staticData := &promotionlexerLexerStaticData
	staticData.once.Do(promotionlexerLexerInit)
}

// NewPromotionLexer produces a new lexer instance for the optional input antlr.CharStream.
func NewPromotionLexer(input antlr.CharStream) *PromotionLexer {
	PromotionLexerInit()
	l := new(PromotionLexer)
	...
	l.GrammarFileName = "Promotion.g4"
	// TODO: l.EOF = antlr.TokenEOF

	return l
}

// PromotionLexer tokens.
const (
	PromotionLexerPROMOTION = 1
	PromotionLexerOWNKEY    = 2
	PromotionLexerSPLITKEY  = 3
	PromotionLexerWS        = 4
)
