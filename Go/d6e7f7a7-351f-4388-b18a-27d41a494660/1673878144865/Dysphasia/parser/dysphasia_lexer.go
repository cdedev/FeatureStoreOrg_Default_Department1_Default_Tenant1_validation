...
var dysphasialexerLexerStaticData struct {
	once                   sync.Once
	serializedATN          []int32
	channelNames           []string
	modeNames              []string
...
func dysphasialexerLexerInit() {
	staticData := &dysphasialexerLexerStaticData
...
// DysphasiaLexerInit initializes any static state used to implement DysphasiaLexer. By default the
// static state used to implement the lexer is lazily initialized during the first call to
// NewDysphasiaLexer(). You can call this function if you wish to initialize the static state ahead
// of time.
func DysphasiaLexerInit() {
	staticData := &dysphasialexerLexerStaticData
	staticData.once.Do(dysphasialexerLexerInit)
}

// NewDysphasiaLexer produces a new lexer instance for the optional input antlr.CharStream.
func NewDysphasiaLexer(input antlr.CharStream) *DysphasiaLexer {
	DysphasiaLexerInit()
	l := new(DysphasiaLexer)
	...
	l.GrammarFileName = "Dysphasia.g4"
	// TODO: l.EOF = antlr.TokenEOF

	return l
}

// DysphasiaLexer tokens.
const (
	DysphasiaLexerDYSPHASIA = 1
	DysphasiaLexerOWNKEY    = 2
	DysphasiaLexerSPLITKEY  = 3
	DysphasiaLexerWS        = 4
)
