...
var diarrhealexerLexerStaticData struct {
	once                   sync.Once
	serializedATN          []int32
	channelNames           []string
	modeNames              []string
...
func diarrhealexerLexerInit() {
	staticData := &diarrhealexerLexerStaticData
...
// DiarrheaLexerInit initializes any static state used to implement DiarrheaLexer. By default the
// static state used to implement the lexer is lazily initialized during the first call to
// NewDiarrheaLexer(). You can call this function if you wish to initialize the static state ahead
// of time.
func DiarrheaLexerInit() {
	staticData := &diarrhealexerLexerStaticData
	staticData.once.Do(diarrhealexerLexerInit)
}

// NewDiarrheaLexer produces a new lexer instance for the optional input antlr.CharStream.
func NewDiarrheaLexer(input antlr.CharStream) *DiarrheaLexer {
	DiarrheaLexerInit()
	l := new(DiarrheaLexer)
	...
	l.GrammarFileName = "Diarrhea.g4"
	// TODO: l.EOF = antlr.TokenEOF

	return l
}

// DiarrheaLexer tokens.
const (
	DiarrheaLexerDIARRHEA = 1
	DiarrheaLexerOWNKEY   = 2
	DiarrheaLexerSPLITKEY = 3
	DiarrheaLexerWS       = 4
)
