...
var ironlexerLexerStaticData struct {
	once                   sync.Once
	serializedATN          []int32
	channelNames           []string
	modeNames              []string
...
func ironlexerLexerInit() {
	staticData := &ironlexerLexerStaticData
...
// IronLexerInit initializes any static state used to implement IronLexer. By default the
// static state used to implement the lexer is lazily initialized during the first call to
// NewIronLexer(). You can call this function if you wish to initialize the static state ahead
// of time.
func IronLexerInit() {
	staticData := &ironlexerLexerStaticData
	staticData.once.Do(ironlexerLexerInit)
}

// NewIronLexer produces a new lexer instance for the optional input antlr.CharStream.
func NewIronLexer(input antlr.CharStream) *IronLexer {
	IronLexerInit()
	l := new(IronLexer)
