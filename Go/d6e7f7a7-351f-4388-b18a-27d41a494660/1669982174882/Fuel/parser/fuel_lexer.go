...
var fuellexerLexerStaticData struct {
	once                   sync.Once
	serializedATN          []int32
	channelNames           []string
	modeNames              []string
...
func fuellexerLexerInit() {
	staticData := &fuellexerLexerStaticData
...
// FuelLexerInit initializes any static state used to implement FuelLexer. By default the
// static state used to implement the lexer is lazily initialized during the first call to
// NewFuelLexer(). You can call this function if you wish to initialize the static state ahead
// of time.
func FuelLexerInit() {
	staticData := &fuellexerLexerStaticData
	staticData.once.Do(fuellexerLexerInit)
}

// NewFuelLexer produces a new lexer instance for the optional input antlr.CharStream.
func NewFuelLexer(input antlr.CharStream) *FuelLexer {
	FuelLexerInit()
	l := new(FuelLexer)
