...
var centroidlexerLexerStaticData struct {
	once                   sync.Once
	serializedATN          []int32
	channelNames           []string
	modeNames              []string
...
func centroidlexerLexerInit() {
	staticData := &centroidlexerLexerStaticData
...
// CentroidLexerInit initializes any static state used to implement CentroidLexer. By default the
// static state used to implement the lexer is lazily initialized during the first call to
// NewCentroidLexer(). You can call this function if you wish to initialize the static state ahead
// of time.
func CentroidLexerInit() {
	staticData := &centroidlexerLexerStaticData
	staticData.once.Do(centroidlexerLexerInit)
}

// NewCentroidLexer produces a new lexer instance for the optional input antlr.CharStream.
func NewCentroidLexer(input antlr.CharStream) *CentroidLexer {
	CentroidLexerInit()
	l := new(CentroidLexer)
	...
	l.GrammarFileName = "Centroid.g4"
	// TODO: l.EOF = antlr.TokenEOF

	return l
}

// CentroidLexer tokens.
const (
	CentroidLexerCENTROID = 1
	CentroidLexerOWNKEY   = 2
	CentroidLexerSPLITKEY = 3
	CentroidLexerWS       = 4
)
