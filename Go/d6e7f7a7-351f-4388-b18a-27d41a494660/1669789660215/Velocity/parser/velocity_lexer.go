...
var velocitylexerLexerStaticData struct {
	once                   sync.Once
	serializedATN          []int32
	channelNames           []string
	modeNames              []string
...
func velocitylexerLexerInit() {
	staticData := &velocitylexerLexerStaticData
...
// VelocityLexerInit initializes any static state used to implement VelocityLexer. By default the
// static state used to implement the lexer is lazily initialized during the first call to
// NewVelocityLexer(). You can call this function if you wish to initialize the static state ahead
// of time.
func VelocityLexerInit() {
	staticData := &velocitylexerLexerStaticData
	staticData.once.Do(velocitylexerLexerInit)
}

// NewVelocityLexer produces a new lexer instance for the optional input antlr.CharStream.
func NewVelocityLexer(input antlr.CharStream) *VelocityLexer {
	VelocityLexerInit()
	l := new(VelocityLexer)
	...
	l.GrammarFileName = "Velocity.g4"
	// TODO: l.EOF = antlr.TokenEOF

	return l
}

// VelocityLexer tokens.
const (
	VelocityLexerVELOCITY = 1
	VelocityLexerOWNKEY   = 2
	VelocityLexerSPLITKEY = 3
	VelocityLexerWS       = 4
)
