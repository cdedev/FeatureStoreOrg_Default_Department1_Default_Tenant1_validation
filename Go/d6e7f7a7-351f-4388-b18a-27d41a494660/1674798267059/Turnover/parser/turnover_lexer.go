...
var turnoverlexerLexerStaticData struct {
	once                   sync.Once
	serializedATN          []int32
	channelNames           []string
	modeNames              []string
...
func turnoverlexerLexerInit() {
	staticData := &turnoverlexerLexerStaticData
...
// TurnoverLexerInit initializes any static state used to implement TurnoverLexer. By default the
// static state used to implement the lexer is lazily initialized during the first call to
// NewTurnoverLexer(). You can call this function if you wish to initialize the static state ahead
// of time.
func TurnoverLexerInit() {
	staticData := &turnoverlexerLexerStaticData
	staticData.once.Do(turnoverlexerLexerInit)
}

// NewTurnoverLexer produces a new lexer instance for the optional input antlr.CharStream.
func NewTurnoverLexer(input antlr.CharStream) *TurnoverLexer {
	TurnoverLexerInit()
	l := new(TurnoverLexer)
	...
	l.GrammarFileName = "Turnover.g4"
	// TODO: l.EOF = antlr.TokenEOF

	return l
}

// TurnoverLexer tokens.
const (
	TurnoverLexerTURNOVER = 1
	TurnoverLexerOWNKEY   = 2
	TurnoverLexerSPLITKEY = 3
	TurnoverLexerWS       = 4
)
