...
var waterlevellexerLexerStaticData struct {
	once                   sync.Once
	serializedATN          []int32
	channelNames           []string
	modeNames              []string
...
func waterlevellexerLexerInit() {
	staticData := &waterlevellexerLexerStaticData
...
// WaterLevelLexerInit initializes any static state used to implement WaterLevelLexer. By default the
// static state used to implement the lexer is lazily initialized during the first call to
// NewWaterLevelLexer(). You can call this function if you wish to initialize the static state ahead
// of time.
func WaterLevelLexerInit() {
	staticData := &waterlevellexerLexerStaticData
	staticData.once.Do(waterlevellexerLexerInit)
}

// NewWaterLevelLexer produces a new lexer instance for the optional input antlr.CharStream.
func NewWaterLevelLexer(input antlr.CharStream) *WaterLevelLexer {
	WaterLevelLexerInit()
	l := new(WaterLevelLexer)
	...
	l.GrammarFileName = "WaterLevel.g4"
	// TODO: l.EOF = antlr.TokenEOF

	return l
}

// WaterLevelLexer tokens.
const (
	WaterLevelLexerWATERLEVEL = 1
	WaterLevelLexerOWNKEY     = 2
	WaterLevelLexerSPLITKEY   = 3
	WaterLevelLexerWS         = 4
)
