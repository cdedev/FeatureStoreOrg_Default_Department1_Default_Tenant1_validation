...
var yearlexerLexerStaticData struct {
	once                   sync.Once
	serializedATN          []int32
	channelNames           []string
	modeNames              []string
...
func yearlexerLexerInit() {
	staticData := &yearlexerLexerStaticData
...
// YearLexerInit initializes any static state used to implement YearLexer. By default the
// static state used to implement the lexer is lazily initialized during the first call to
// NewYearLexer(). You can call this function if you wish to initialize the static state ahead
// of time.
func YearLexerInit() {
	staticData := &yearlexerLexerStaticData
	staticData.once.Do(yearlexerLexerInit)
}

// NewYearLexer produces a new lexer instance for the optional input antlr.CharStream.
func NewYearLexer(input antlr.CharStream) *YearLexer {
	YearLexerInit()
	l := new(YearLexer)
