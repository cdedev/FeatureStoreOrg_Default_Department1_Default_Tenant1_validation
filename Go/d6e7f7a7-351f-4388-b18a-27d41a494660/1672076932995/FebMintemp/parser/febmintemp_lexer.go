...
var febmintemplexerLexerStaticData struct {
	once                   sync.Once
	serializedATN          []int32
	channelNames           []string
	modeNames              []string
...
func febmintemplexerLexerInit() {
	staticData := &febmintemplexerLexerStaticData
...
// FebMintempLexerInit initializes any static state used to implement FebMintempLexer. By default the
// static state used to implement the lexer is lazily initialized during the first call to
// NewFebMintempLexer(). You can call this function if you wish to initialize the static state ahead
// of time.
func FebMintempLexerInit() {
	staticData := &febmintemplexerLexerStaticData
	staticData.once.Do(febmintemplexerLexerInit)
}

// NewFebMintempLexer produces a new lexer instance for the optional input antlr.CharStream.
func NewFebMintempLexer(input antlr.CharStream) *FebMintempLexer {
	FebMintempLexerInit()
	l := new(FebMintempLexer)
	...
	l.GrammarFileName = "FebMintemp.g4"
	// TODO: l.EOF = antlr.TokenEOF

	return l
}

// FebMintempLexer tokens.
const (
	FebMintempLexerFEBMINTEMP = 1
	FebMintempLexerOWNKEY     = 2
	FebMintempLexerSPLITKEY   = 3
	FebMintempLexerWS         = 4
)
