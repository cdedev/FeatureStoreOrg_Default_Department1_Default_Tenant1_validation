...
var deathcaseslexerLexerStaticData struct {
	once                   sync.Once
	serializedATN          []int32
	channelNames           []string
	modeNames              []string
...
func deathcaseslexerLexerInit() {
	staticData := &deathcaseslexerLexerStaticData
...
// DeathcasesLexerInit initializes any static state used to implement DeathcasesLexer. By default the
// static state used to implement the lexer is lazily initialized during the first call to
// NewDeathcasesLexer(). You can call this function if you wish to initialize the static state ahead
// of time.
func DeathcasesLexerInit() {
	staticData := &deathcaseslexerLexerStaticData
	staticData.once.Do(deathcaseslexerLexerInit)
}

// NewDeathcasesLexer produces a new lexer instance for the optional input antlr.CharStream.
func NewDeathcasesLexer(input antlr.CharStream) *DeathcasesLexer {
	DeathcasesLexerInit()
	l := new(DeathcasesLexer)
	...
	l.GrammarFileName = "Deathcases.g4"
	// TODO: l.EOF = antlr.TokenEOF

	return l
}

// DeathcasesLexer tokens.
const (
	DeathcasesLexerDEATHCASES = 1
	DeathcasesLexerOWNKEY     = 2
	DeathcasesLexerSPLITKEY   = 3
	DeathcasesLexerWS         = 4
)
