...
var citelexerLexerStaticData struct {
	once                   sync.Once
	serializedATN          []int32
	channelNames           []string
	modeNames              []string
...
func citelexerLexerInit() {
	staticData := &citelexerLexerStaticData
...
// CiteLexerInit initializes any static state used to implement CiteLexer. By default the
// static state used to implement the lexer is lazily initialized during the first call to
// NewCiteLexer(). You can call this function if you wish to initialize the static state ahead
// of time.
func CiteLexerInit() {
	staticData := &citelexerLexerStaticData
	staticData.once.Do(citelexerLexerInit)
}

// NewCiteLexer produces a new lexer instance for the optional input antlr.CharStream.
func NewCiteLexer(input antlr.CharStream) *CiteLexer {
	CiteLexerInit()
	l := new(CiteLexer)
