...
var skewlexerLexerStaticData struct {
	once                   sync.Once
	serializedATN          []int32
	channelNames           []string
	modeNames              []string
...
func skewlexerLexerInit() {
	staticData := &skewlexerLexerStaticData
...
// SkewLexerInit initializes any static state used to implement SkewLexer. By default the
// static state used to implement the lexer is lazily initialized during the first call to
// NewSkewLexer(). You can call this function if you wish to initialize the static state ahead
// of time.
func SkewLexerInit() {
	staticData := &skewlexerLexerStaticData
	staticData.once.Do(skewlexerLexerInit)
}

// NewSkewLexer produces a new lexer instance for the optional input antlr.CharStream.
func NewSkewLexer(input antlr.CharStream) *SkewLexer {
	SkewLexerInit()
	l := new(SkewLexer)
