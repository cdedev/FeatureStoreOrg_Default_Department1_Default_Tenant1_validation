...
var contractionslexerLexerStaticData struct {
	once                   sync.Once
	serializedATN          []int32
	channelNames           []string
	modeNames              []string
...
func contractionslexerLexerInit() {
	staticData := &contractionslexerLexerStaticData
...
// ContractionsLexerInit initializes any static state used to implement ContractionsLexer. By default the
// static state used to implement the lexer is lazily initialized during the first call to
// NewContractionsLexer(). You can call this function if you wish to initialize the static state ahead
// of time.
func ContractionsLexerInit() {
	staticData := &contractionslexerLexerStaticData
	staticData.once.Do(contractionslexerLexerInit)
}

// NewContractionsLexer produces a new lexer instance for the optional input antlr.CharStream.
func NewContractionsLexer(input antlr.CharStream) *ContractionsLexer {
	ContractionsLexerInit()
	l := new(ContractionsLexer)
	...
	l.GrammarFileName = "Contractions.g4"
	// TODO: l.EOF = antlr.TokenEOF

	return l
}

// ContractionsLexer tokens.
const (
	ContractionsLexerCONTRACTIONS = 1
	ContractionsLexerOWNKEY       = 2
	ContractionsLexerSPLITKEY     = 3
	ContractionsLexerWS           = 4
)
