...
var sodiumlexerLexerStaticData struct {
	once                   sync.Once
	serializedATN          []int32
	channelNames           []string
	modeNames              []string
...
func sodiumlexerLexerInit() {
	staticData := &sodiumlexerLexerStaticData
...
// SodiumLexerInit initializes any static state used to implement SodiumLexer. By default the
// static state used to implement the lexer is lazily initialized during the first call to
// NewSodiumLexer(). You can call this function if you wish to initialize the static state ahead
// of time.
func SodiumLexerInit() {
	staticData := &sodiumlexerLexerStaticData
	staticData.once.Do(sodiumlexerLexerInit)
}

// NewSodiumLexer produces a new lexer instance for the optional input antlr.CharStream.
func NewSodiumLexer(input antlr.CharStream) *SodiumLexer {
	SodiumLexerInit()
	l := new(SodiumLexer)
