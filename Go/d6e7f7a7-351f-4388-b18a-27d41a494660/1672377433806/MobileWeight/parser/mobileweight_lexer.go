...
var mobileweightlexerLexerStaticData struct {
	once                   sync.Once
	serializedATN          []int32
	channelNames           []string
	modeNames              []string
...
func mobileweightlexerLexerInit() {
	staticData := &mobileweightlexerLexerStaticData
...
// MobileWeightLexerInit initializes any static state used to implement MobileWeightLexer. By default the
// static state used to implement the lexer is lazily initialized during the first call to
// NewMobileWeightLexer(). You can call this function if you wish to initialize the static state ahead
// of time.
func MobileWeightLexerInit() {
	staticData := &mobileweightlexerLexerStaticData
	staticData.once.Do(mobileweightlexerLexerInit)
}

// NewMobileWeightLexer produces a new lexer instance for the optional input antlr.CharStream.
func NewMobileWeightLexer(input antlr.CharStream) *MobileWeightLexer {
	MobileWeightLexerInit()
	l := new(MobileWeightLexer)
	...
	l.GrammarFileName = "MobileWeight.g4"
	// TODO: l.EOF = antlr.TokenEOF

	return l
}

// MobileWeightLexer tokens.
const (
	MobileWeightLexerMOBILEWEIGHT = 1
	MobileWeightLexerOWNKEY       = 2
	MobileWeightLexerSPLITKEY     = 3
	MobileWeightLexerWS           = 4
)
