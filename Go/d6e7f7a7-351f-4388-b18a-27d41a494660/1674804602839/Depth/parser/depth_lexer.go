...
var depthlexerLexerStaticData struct {
	once                   sync.Once
	serializedATN          []int32
	channelNames           []string
	modeNames              []string
...
func depthlexerLexerInit() {
	staticData := &depthlexerLexerStaticData
...
// DepthLexerInit initializes any static state used to implement DepthLexer. By default the
// static state used to implement the lexer is lazily initialized during the first call to
// NewDepthLexer(). You can call this function if you wish to initialize the static state ahead
// of time.
func DepthLexerInit() {
	staticData := &depthlexerLexerStaticData
	staticData.once.Do(depthlexerLexerInit)
}

// NewDepthLexer produces a new lexer instance for the optional input antlr.CharStream.
func NewDepthLexer(input antlr.CharStream) *DepthLexer {
	DepthLexerInit()
	l := new(DepthLexer)
