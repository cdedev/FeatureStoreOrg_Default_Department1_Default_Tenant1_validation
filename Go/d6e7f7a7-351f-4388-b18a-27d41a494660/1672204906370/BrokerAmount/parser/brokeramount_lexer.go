...
var brokeramountlexerLexerStaticData struct {
	once                   sync.Once
	serializedATN          []int32
	channelNames           []string
	modeNames              []string
...
func brokeramountlexerLexerInit() {
	staticData := &brokeramountlexerLexerStaticData
...
// BrokerAmountLexerInit initializes any static state used to implement BrokerAmountLexer. By default the
// static state used to implement the lexer is lazily initialized during the first call to
// NewBrokerAmountLexer(). You can call this function if you wish to initialize the static state ahead
// of time.
func BrokerAmountLexerInit() {
	staticData := &brokeramountlexerLexerStaticData
	staticData.once.Do(brokeramountlexerLexerInit)
}

// NewBrokerAmountLexer produces a new lexer instance for the optional input antlr.CharStream.
func NewBrokerAmountLexer(input antlr.CharStream) *BrokerAmountLexer {
	BrokerAmountLexerInit()
	l := new(BrokerAmountLexer)
	...
	l.GrammarFileName = "BrokerAmount.g4"
	// TODO: l.EOF = antlr.TokenEOF

	return l
}

// BrokerAmountLexer tokens.
const (
	BrokerAmountLexerFIELD0   = 1
	BrokerAmountLexerOWNKEY   = 2
	BrokerAmountLexerSPLITKEY = 3
	BrokerAmountLexerWS       = 4
)
