...
var smoothnesslexerLexerStaticData struct {
	once                   sync.Once
	serializedATN          []int32
	channelNames           []string
	modeNames              []string
...
func smoothnesslexerLexerInit() {
	staticData := &smoothnesslexerLexerStaticData
...
// SmoothnessLexerInit initializes any static state used to implement SmoothnessLexer. By default the
// static state used to implement the lexer is lazily initialized during the first call to
// NewSmoothnessLexer(). You can call this function if you wish to initialize the static state ahead
// of time.
func SmoothnessLexerInit() {
	staticData := &smoothnesslexerLexerStaticData
	staticData.once.Do(smoothnesslexerLexerInit)
}

// NewSmoothnessLexer produces a new lexer instance for the optional input antlr.CharStream.
func NewSmoothnessLexer(input antlr.CharStream) *SmoothnessLexer {
	SmoothnessLexerInit()
	l := new(SmoothnessLexer)
	...
	l.GrammarFileName = "Smoothness.g4"
	// TODO: l.EOF = antlr.TokenEOF

	return l
}

// SmoothnessLexer tokens.
const (
	SmoothnessLexerSMOOTHNESS = 1
	SmoothnessLexerOWNKEY     = 2
	SmoothnessLexerSPLITKEY   = 3
	SmoothnessLexerWS         = 4
)
