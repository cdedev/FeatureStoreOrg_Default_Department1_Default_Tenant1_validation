...
var sourceidlexerLexerStaticData struct {
	once                   sync.Once
	serializedATN          []int32
	channelNames           []string
	modeNames              []string
...
func sourceidlexerLexerInit() {
	staticData := &sourceidlexerLexerStaticData
...
// SourceIDLexerInit initializes any static state used to implement SourceIDLexer. By default the
// static state used to implement the lexer is lazily initialized during the first call to
// NewSourceIDLexer(). You can call this function if you wish to initialize the static state ahead
// of time.
func SourceIDLexerInit() {
	staticData := &sourceidlexerLexerStaticData
	staticData.once.Do(sourceidlexerLexerInit)
}

// NewSourceIDLexer produces a new lexer instance for the optional input antlr.CharStream.
func NewSourceIDLexer(input antlr.CharStream) *SourceIDLexer {
	SourceIDLexerInit()
	l := new(SourceIDLexer)
	...
	l.GrammarFileName = "SourceID.g4"
	// TODO: l.EOF = antlr.TokenEOF

	return l
}

// SourceIDLexer tokens.
const (
	SourceIDLexerSOURCEID = 1
	SourceIDLexerOWNKEY   = 2
	SourceIDLexerSPLITKEY = 3
	SourceIDLexerWS       = 4
)
