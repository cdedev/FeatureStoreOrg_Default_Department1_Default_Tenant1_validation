...
var tp1lexerLexerStaticData struct {
	once                   sync.Once
	serializedATN          []int32
	channelNames           []string
	modeNames              []string
...
func tp1lexerLexerInit() {
	staticData := &tp1lexerLexerStaticData
...
// Tp1LexerInit initializes any static state used to implement Tp1Lexer. By default the
// static state used to implement the lexer is lazily initialized during the first call to
// NewTp1Lexer(). You can call this function if you wish to initialize the static state ahead
// of time.
func Tp1LexerInit() {
	staticData := &tp1lexerLexerStaticData
	staticData.once.Do(tp1lexerLexerInit)
}

// NewTp1Lexer produces a new lexer instance for the optional input antlr.CharStream.
func NewTp1Lexer(input antlr.CharStream) *Tp1Lexer {
	Tp1LexerInit()
	l := new(Tp1Lexer)
