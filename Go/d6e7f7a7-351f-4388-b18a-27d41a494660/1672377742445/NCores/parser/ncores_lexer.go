...
var ncoreslexerLexerStaticData struct {
	once                   sync.Once
	serializedATN          []int32
	channelNames           []string
	modeNames              []string
...
func ncoreslexerLexerInit() {
	staticData := &ncoreslexerLexerStaticData
...
// NCoresLexerInit initializes any static state used to implement NCoresLexer. By default the
// static state used to implement the lexer is lazily initialized during the first call to
// NewNCoresLexer(). You can call this function if you wish to initialize the static state ahead
// of time.
func NCoresLexerInit() {
	staticData := &ncoreslexerLexerStaticData
	staticData.once.Do(ncoreslexerLexerInit)
}

// NewNCoresLexer produces a new lexer instance for the optional input antlr.CharStream.
func NewNCoresLexer(input antlr.CharStream) *NCoresLexer {
	NCoresLexerInit()
	l := new(NCoresLexer)
