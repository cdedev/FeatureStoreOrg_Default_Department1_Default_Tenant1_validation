...
var deathratelexerLexerStaticData struct {
	once                   sync.Once
	serializedATN          []int32
	channelNames           []string
	modeNames              []string
...
func deathratelexerLexerInit() {
	staticData := &deathratelexerLexerStaticData
...
// DeathRateLexerInit initializes any static state used to implement DeathRateLexer. By default the
// static state used to implement the lexer is lazily initialized during the first call to
// NewDeathRateLexer(). You can call this function if you wish to initialize the static state ahead
// of time.
func DeathRateLexerInit() {
	staticData := &deathratelexerLexerStaticData
	staticData.once.Do(deathratelexerLexerInit)
}

// NewDeathRateLexer produces a new lexer instance for the optional input antlr.CharStream.
func NewDeathRateLexer(input antlr.CharStream) *DeathRateLexer {
	DeathRateLexerInit()
	l := new(DeathRateLexer)
	...
	l.GrammarFileName = "DeathRate.g4"
	// TODO: l.EOF = antlr.TokenEOF

	return l
}

// DeathRateLexer tokens.
const (
	DeathRateLexerDEATHRATE = 1
	DeathRateLexerOWNKEY    = 2
	DeathRateLexerSPLITKEY  = 3
	DeathRateLexerWS        = 4
)
