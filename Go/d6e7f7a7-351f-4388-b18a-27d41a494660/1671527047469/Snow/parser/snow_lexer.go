...
var snowlexerLexerStaticData struct {
	once                   sync.Once
	serializedATN          []int32
	channelNames           []string
	modeNames              []string
...
func snowlexerLexerInit() {
	staticData := &snowlexerLexerStaticData
...
// SnowLexerInit initializes any static state used to implement SnowLexer. By default the
// static state used to implement the lexer is lazily initialized during the first call to
// NewSnowLexer(). You can call this function if you wish to initialize the static state ahead
// of time.
func SnowLexerInit() {
	staticData := &snowlexerLexerStaticData
	staticData.once.Do(snowlexerLexerInit)
}

// NewSnowLexer produces a new lexer instance for the optional input antlr.CharStream.
func NewSnowLexer(input antlr.CharStream) *SnowLexer {
	SnowLexerInit()
	l := new(SnowLexer)
