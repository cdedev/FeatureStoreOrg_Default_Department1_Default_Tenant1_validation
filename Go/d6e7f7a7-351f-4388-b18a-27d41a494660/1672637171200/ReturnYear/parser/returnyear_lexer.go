...
var returnyearlexerLexerStaticData struct {
	once                   sync.Once
	serializedATN          []int32
	channelNames           []string
	modeNames              []string
...
func returnyearlexerLexerInit() {
	staticData := &returnyearlexerLexerStaticData
...
// ReturnYearLexerInit initializes any static state used to implement ReturnYearLexer. By default the
// static state used to implement the lexer is lazily initialized during the first call to
// NewReturnYearLexer(). You can call this function if you wish to initialize the static state ahead
// of time.
func ReturnYearLexerInit() {
	staticData := &returnyearlexerLexerStaticData
	staticData.once.Do(returnyearlexerLexerInit)
}

// NewReturnYearLexer produces a new lexer instance for the optional input antlr.CharStream.
func NewReturnYearLexer(input antlr.CharStream) *ReturnYearLexer {
	ReturnYearLexerInit()
	l := new(ReturnYearLexer)
	...
	l.GrammarFileName = "ReturnYear.g4"
	// TODO: l.EOF = antlr.TokenEOF

	return l
}

// ReturnYearLexer tokens.
const (
	ReturnYearLexerRETURNYEAR = 1
	ReturnYearLexerOWNKEY     = 2
	ReturnYearLexerSPLITKEY   = 3
	ReturnYearLexerWS         = 4
)
