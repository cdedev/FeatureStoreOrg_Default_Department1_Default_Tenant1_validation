...
var batterylevellexerLexerStaticData struct {
	once                   sync.Once
	serializedATN          []int32
	channelNames           []string
	modeNames              []string
...
func batterylevellexerLexerInit() {
	staticData := &batterylevellexerLexerStaticData
	...
	staticData.serializedATN = []int32{
		...
		0, 4, 1, 1, 3, 2, 5, 3, 7, 4, 1, 0, 2, 2, 0, 37, 37, 48, 57, 3, 0, 9, 10,
...
// BatteryLevelLexerInit initializes any static state used to implement BatteryLevelLexer. By default the
// static state used to implement the lexer is lazily initialized during the first call to
// NewBatteryLevelLexer(). You can call this function if you wish to initialize the static state ahead
// of time.
func BatteryLevelLexerInit() {
	staticData := &batterylevellexerLexerStaticData
	staticData.once.Do(batterylevellexerLexerInit)
}

// NewBatteryLevelLexer produces a new lexer instance for the optional input antlr.CharStream.
func NewBatteryLevelLexer(input antlr.CharStream) *BatteryLevelLexer {
	BatteryLevelLexerInit()
	l := new(BatteryLevelLexer)
	...
	l.GrammarFileName = "BatteryLevel.g4"
	// TODO: l.EOF = antlr.TokenEOF

	return l
}

// BatteryLevelLexer tokens.
const (
	BatteryLevelLexerBATTERYLEVEL = 1
	BatteryLevelLexerOWNKEY       = 2
	BatteryLevelLexerSPLITKEY     = 3
	BatteryLevelLexerWS           = 4
)
