...
type WorklifebalanceLexer struct {
	*antlr.BaseLexer
	channelNames []string
	modeNames    []string
	// TODO: EOF string
...
var worklifebalancelexerLexerStaticData struct {
	once                   sync.Once
	serializedATN          []int32
	channelNames           []string
	modeNames              []string
...
func worklifebalancelexerLexerInit() {
	staticData := &worklifebalancelexerLexerStaticData
...
// WorklifebalanceLexerInit initializes any static state used to implement WorklifebalanceLexer. By default the
// static state used to implement the lexer is lazily initialized during the first call to
// NewWorklifebalanceLexer(). You can call this function if you wish to initialize the static state ahead
// of time.
func WorklifebalanceLexerInit() {
	staticData := &worklifebalancelexerLexerStaticData
	staticData.once.Do(worklifebalancelexerLexerInit)
}

// NewWorklifebalanceLexer produces a new lexer instance for the optional input antlr.CharStream.
func NewWorklifebalanceLexer(input antlr.CharStream) *WorklifebalanceLexer {
	WorklifebalanceLexerInit()
	l := new(WorklifebalanceLexer)
	...
	l.GrammarFileName = "Worklifebalance.g4"
	// TODO: l.EOF = antlr.TokenEOF

	return l
}

// WorklifebalanceLexer tokens.
const (
	WorklifebalanceLexerWORKLIFEBALANCE = 1
	WorklifebalanceLexerOWNKEY          = 2
	WorklifebalanceLexerSPLITKEY        = 3
	WorklifebalanceLexerWS              = 4
)
