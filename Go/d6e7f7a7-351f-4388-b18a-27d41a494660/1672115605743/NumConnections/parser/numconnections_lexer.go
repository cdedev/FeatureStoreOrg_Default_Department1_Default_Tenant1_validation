...
type NumConnectionsLexer struct {
	*antlr.BaseLexer
	channelNames []string
	modeNames    []string
	// TODO: EOF string
...
var numconnectionslexerLexerStaticData struct {
	once                   sync.Once
	serializedATN          []int32
	channelNames           []string
	modeNames              []string
...
func numconnectionslexerLexerInit() {
	staticData := &numconnectionslexerLexerStaticData
...
// NumConnectionsLexerInit initializes any static state used to implement NumConnectionsLexer. By default the
// static state used to implement the lexer is lazily initialized during the first call to
// NewNumConnectionsLexer(). You can call this function if you wish to initialize the static state ahead
// of time.
func NumConnectionsLexerInit() {
	staticData := &numconnectionslexerLexerStaticData
	staticData.once.Do(numconnectionslexerLexerInit)
}

// NewNumConnectionsLexer produces a new lexer instance for the optional input antlr.CharStream.
func NewNumConnectionsLexer(input antlr.CharStream) *NumConnectionsLexer {
	NumConnectionsLexerInit()
	l := new(NumConnectionsLexer)
	...
	l.GrammarFileName = "NumConnections.g4"
	// TODO: l.EOF = antlr.TokenEOF

	return l
}

// NumConnectionsLexer tokens.
const (
	NumConnectionsLexerNUMCONNECTIONS = 1
	NumConnectionsLexerOWNKEY         = 2
	NumConnectionsLexerSPLITKEY       = 3
	NumConnectionsLexerWS             = 4
)
