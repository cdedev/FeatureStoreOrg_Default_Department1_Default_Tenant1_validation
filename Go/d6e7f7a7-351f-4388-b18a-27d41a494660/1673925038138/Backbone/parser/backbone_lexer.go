...
var backbonelexerLexerStaticData struct {
	once                   sync.Once
	serializedATN          []int32
	channelNames           []string
	modeNames              []string
...
func backbonelexerLexerInit() {
	staticData := &backbonelexerLexerStaticData
...
// BackboneLexerInit initializes any static state used to implement BackboneLexer. By default the
// static state used to implement the lexer is lazily initialized during the first call to
// NewBackboneLexer(). You can call this function if you wish to initialize the static state ahead
// of time.
func BackboneLexerInit() {
	staticData := &backbonelexerLexerStaticData
	staticData.once.Do(backbonelexerLexerInit)
}

// NewBackboneLexer produces a new lexer instance for the optional input antlr.CharStream.
func NewBackboneLexer(input antlr.CharStream) *BackboneLexer {
	BackboneLexerInit()
	l := new(BackboneLexer)
	...
	l.GrammarFileName = "Backbone.g4"
	// TODO: l.EOF = antlr.TokenEOF

	return l
}

// BackboneLexer tokens.
const (
	BackboneLexerBACKBONE = 1
	BackboneLexerOWNKEY   = 2
	BackboneLexerSPLITKEY = 3
	BackboneLexerWS       = 4
)
