...
var symmetrylexerLexerStaticData struct {
	once                   sync.Once
	serializedATN          []int32
	channelNames           []string
	modeNames              []string
...
func symmetrylexerLexerInit() {
	staticData := &symmetrylexerLexerStaticData
...
// SymmetryLexerInit initializes any static state used to implement SymmetryLexer. By default the
// static state used to implement the lexer is lazily initialized during the first call to
// NewSymmetryLexer(). You can call this function if you wish to initialize the static state ahead
// of time.
func SymmetryLexerInit() {
	staticData := &symmetrylexerLexerStaticData
	staticData.once.Do(symmetrylexerLexerInit)
}

// NewSymmetryLexer produces a new lexer instance for the optional input antlr.CharStream.
func NewSymmetryLexer(input antlr.CharStream) *SymmetryLexer {
	SymmetryLexerInit()
	l := new(SymmetryLexer)
	...
	l.GrammarFileName = "Symmetry.g4"
	// TODO: l.EOF = antlr.TokenEOF

	return l
}

// SymmetryLexer tokens.
const (
	SymmetryLexerSYMMETRY = 1
	SymmetryLexerOWNKEY   = 2
	SymmetryLexerSPLITKEY = 3
	SymmetryLexerWS       = 4
)
