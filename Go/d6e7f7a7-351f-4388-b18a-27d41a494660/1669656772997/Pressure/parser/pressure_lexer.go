...
var pressurelexerLexerStaticData struct {
	once                   sync.Once
	serializedATN          []int32
	channelNames           []string
	modeNames              []string
...
func pressurelexerLexerInit() {
	staticData := &pressurelexerLexerStaticData
...
// PressureLexerInit initializes any static state used to implement PressureLexer. By default the
// static state used to implement the lexer is lazily initialized during the first call to
// NewPressureLexer(). You can call this function if you wish to initialize the static state ahead
// of time.
func PressureLexerInit() {
	staticData := &pressurelexerLexerStaticData
	staticData.once.Do(pressurelexerLexerInit)
}

// NewPressureLexer produces a new lexer instance for the optional input antlr.CharStream.
func NewPressureLexer(input antlr.CharStream) *PressureLexer {
	PressureLexerInit()
	l := new(PressureLexer)
	...
	l.GrammarFileName = "Pressure.g4"
	// TODO: l.EOF = antlr.TokenEOF

	return l
}

// PressureLexer tokens.
const (
	PressureLexerPRESSURE = 1
	PressureLexerOWNKEY   = 2
	PressureLexerSPLITKEY = 3
	PressureLexerWS       = 4
)
