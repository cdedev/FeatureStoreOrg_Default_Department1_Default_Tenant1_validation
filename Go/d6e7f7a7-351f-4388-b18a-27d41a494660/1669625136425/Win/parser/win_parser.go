...
var winParserStaticData struct {
	once                   sync.Once
	serializedATN          []int32
	literalNames           []string
...
func winParserInit() {
	staticData := &winParserStaticData
...
// WinParserInit initializes any static state used to implement WinParser. By default the
// static state used to implement the parser is lazily initialized during the first call to
// NewWinParser(). You can call this function if you wish to initialize the static state ahead
// of time.
func WinParserInit() {
	staticData := &winParserStaticData
	staticData.once.Do(winParserInit)
}

// NewWinParser produces a new parser instance for the optional input antlr.TokenStream.
func NewWinParser(input antlr.TokenStream) *WinParser {
	WinParserInit()
	this := new(WinParser)
...
// WinParser rules.
const (
	WinParserRULE_expression = 0
	WinParserRULE_field0     = 1
)
...
func NewEmptyExpressionContext() *ExpressionContext {
	...
	p.RuleIndex = WinParserRULE_expression
	return p
}
...
func (s *ExpressionContext) EOF() antlr.TerminalNode {
	return s.GetToken(WinParserEOF, 0)
}
...
func (s *ExpressionContext) EnterRule(listener antlr.ParseTreeListener) {
	if listenerT, ok := listener.(WinListener); ok {
...
func (p *WinParser) Expression() (localctx IExpressionContext) {
	this := p
	_ = this

	localctx = NewExpressionContext(p, p.GetParserRuleContext(), p.GetState())
	p.EnterRule(localctx, 0, WinParserRULE_expression)
...
func NewEmptyField0Context() *Field0Context {
	...
	p.BaseParserRuleContext = antlr.NewBaseParserRuleContext(nil, -1)
	p.RuleIndex = WinParserRULE_field0
	return p
}
...
func (s *Field0Context) FIELD0() antlr.TerminalNode {
	return s.GetToken(WinParserFIELD0, 0)
}
...
func (p *WinParser) Field0() (localctx IField0Context) {
	this := p
	_ = this

	localctx = NewField0Context(p, p.GetParserRuleContext(), p.GetState())
	p.EnterRule(localctx, 2, WinParserRULE_field0)
