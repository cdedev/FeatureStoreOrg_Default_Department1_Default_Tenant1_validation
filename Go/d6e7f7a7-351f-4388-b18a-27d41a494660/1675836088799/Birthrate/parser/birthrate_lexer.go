...
var birthratelexerLexerStaticData struct {
	once                   sync.Once
	serializedATN          []int32
	channelNames           []string
	modeNames              []string
...
func birthratelexerLexerInit() {
	staticData := &birthratelexerLexerStaticData
...
// BirthrateLexerInit initializes any static state used to implement BirthrateLexer. By default the
// static state used to implement the lexer is lazily initialized during the first call to
// NewBirthrateLexer(). You can call this function if you wish to initialize the static state ahead
// of time.
func BirthrateLexerInit() {
	staticData := &birthratelexerLexerStaticData
	staticData.once.Do(birthratelexerLexerInit)
}

// NewBirthrateLexer produces a new lexer instance for the optional input antlr.CharStream.
func NewBirthrateLexer(input antlr.CharStream) *BirthrateLexer {
	BirthrateLexerInit()
	l := new(BirthrateLexer)
	...
	l.GrammarFileName = "Birthrate.g4"
	// TODO: l.EOF = antlr.TokenEOF

	return l
}

// BirthrateLexer tokens.
const (
	BirthrateLexerBIRTHRATE = 1
	BirthrateLexerOWNKEY    = 2
	BirthrateLexerSPLITKEY  = 3
	BirthrateLexerWS        = 4
)
