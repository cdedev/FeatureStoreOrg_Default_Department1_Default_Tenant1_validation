...
var liabilitieslexerLexerStaticData struct {
	once                   sync.Once
	serializedATN          []int32
	channelNames           []string
	modeNames              []string
...
func liabilitieslexerLexerInit() {
	staticData := &liabilitieslexerLexerStaticData
...
// LiabilitiesLexerInit initializes any static state used to implement LiabilitiesLexer. By default the
// static state used to implement the lexer is lazily initialized during the first call to
// NewLiabilitiesLexer(). You can call this function if you wish to initialize the static state ahead
// of time.
func LiabilitiesLexerInit() {
	staticData := &liabilitieslexerLexerStaticData
	staticData.once.Do(liabilitieslexerLexerInit)
}

// NewLiabilitiesLexer produces a new lexer instance for the optional input antlr.CharStream.
func NewLiabilitiesLexer(input antlr.CharStream) *LiabilitiesLexer {
	LiabilitiesLexerInit()
	l := new(LiabilitiesLexer)
	...
	l.GrammarFileName = "Liabilities.g4"
	// TODO: l.EOF = antlr.TokenEOF

	return l
}

// LiabilitiesLexer tokens.
const (
	LiabilitiesLexerLIABILITIES = 1
	LiabilitiesLexerOWNKEY      = 2
	LiabilitiesLexerSPLITKEY    = 3
	LiabilitiesLexerWS          = 4
)
