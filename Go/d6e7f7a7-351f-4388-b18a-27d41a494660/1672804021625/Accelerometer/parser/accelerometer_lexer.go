...
type AccelerometerLexer struct {
	*antlr.BaseLexer
	channelNames []string
	modeNames    []string
	// TODO: EOF string
...
var accelerometerlexerLexerStaticData struct {
	once                   sync.Once
	serializedATN          []int32
	channelNames           []string
	modeNames              []string
...
func accelerometerlexerLexerInit() {
	staticData := &accelerometerlexerLexerStaticData
...
// AccelerometerLexerInit initializes any static state used to implement AccelerometerLexer. By default the
// static state used to implement the lexer is lazily initialized during the first call to
// NewAccelerometerLexer(). You can call this function if you wish to initialize the static state ahead
// of time.
func AccelerometerLexerInit() {
	staticData := &accelerometerlexerLexerStaticData
	staticData.once.Do(accelerometerlexerLexerInit)
}

// NewAccelerometerLexer produces a new lexer instance for the optional input antlr.CharStream.
func NewAccelerometerLexer(input antlr.CharStream) *AccelerometerLexer {
	AccelerometerLexerInit()
	l := new(AccelerometerLexer)
	...
	l.GrammarFileName = "Accelerometer.g4"
	// TODO: l.EOF = antlr.TokenEOF

	return l
}

// AccelerometerLexer tokens.
const (
	AccelerometerLexerACCELEROMETER = 1
	AccelerometerLexerOWNKEY        = 2
	AccelerometerLexerSPLITKEY      = 3
	AccelerometerLexerWS            = 4
)
