...
var bloodsodiumlexerLexerStaticData struct {
	once                   sync.Once
	serializedATN          []int32
	channelNames           []string
	modeNames              []string
...
func bloodsodiumlexerLexerInit() {
	staticData := &bloodsodiumlexerLexerStaticData
...
// BloodSodiumLexerInit initializes any static state used to implement BloodSodiumLexer. By default the
// static state used to implement the lexer is lazily initialized during the first call to
// NewBloodSodiumLexer(). You can call this function if you wish to initialize the static state ahead
// of time.
func BloodSodiumLexerInit() {
	staticData := &bloodsodiumlexerLexerStaticData
	staticData.once.Do(bloodsodiumlexerLexerInit)
}

// NewBloodSodiumLexer produces a new lexer instance for the optional input antlr.CharStream.
func NewBloodSodiumLexer(input antlr.CharStream) *BloodSodiumLexer {
	BloodSodiumLexerInit()
	l := new(BloodSodiumLexer)
	...
	l.GrammarFileName = "BloodSodium.g4"
	// TODO: l.EOF = antlr.TokenEOF

	return l
}

// BloodSodiumLexer tokens.
const (
	BloodSodiumLexerBLOODSODIUM = 1
	BloodSodiumLexerOWNKEY      = 2
	BloodSodiumLexerSPLITKEY    = 3
	BloodSodiumLexerWS          = 4
)
