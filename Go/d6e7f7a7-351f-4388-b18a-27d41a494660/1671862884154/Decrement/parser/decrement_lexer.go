...
var decrementlexerLexerStaticData struct {
	once                   sync.Once
	serializedATN          []int32
	channelNames           []string
	modeNames              []string
...
func decrementlexerLexerInit() {
	staticData := &decrementlexerLexerStaticData
...
// DecrementLexerInit initializes any static state used to implement DecrementLexer. By default the
// static state used to implement the lexer is lazily initialized during the first call to
// NewDecrementLexer(). You can call this function if you wish to initialize the static state ahead
// of time.
func DecrementLexerInit() {
	staticData := &decrementlexerLexerStaticData
	staticData.once.Do(decrementlexerLexerInit)
}

// NewDecrementLexer produces a new lexer instance for the optional input antlr.CharStream.
func NewDecrementLexer(input antlr.CharStream) *DecrementLexer {
	DecrementLexerInit()
	l := new(DecrementLexer)
	...
	l.GrammarFileName = "Decrement.g4"
	// TODO: l.EOF = antlr.TokenEOF

	return l
}

// DecrementLexer tokens.
const (
	DecrementLexerDECREMENT = 1
	DecrementLexerOWNKEY    = 2
	DecrementLexerSPLITKEY  = 3
	DecrementLexerWS        = 4
)
