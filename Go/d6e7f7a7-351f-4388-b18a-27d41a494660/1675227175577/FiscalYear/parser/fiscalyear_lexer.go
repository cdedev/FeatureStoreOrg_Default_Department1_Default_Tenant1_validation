...
var fiscalyearlexerLexerStaticData struct {
	once                   sync.Once
	serializedATN          []int32
	channelNames           []string
	modeNames              []string
...
func fiscalyearlexerLexerInit() {
	staticData := &fiscalyearlexerLexerStaticData
...
// FiscalYearLexerInit initializes any static state used to implement FiscalYearLexer. By default the
// static state used to implement the lexer is lazily initialized during the first call to
// NewFiscalYearLexer(). You can call this function if you wish to initialize the static state ahead
// of time.
func FiscalYearLexerInit() {
	staticData := &fiscalyearlexerLexerStaticData
	staticData.once.Do(fiscalyearlexerLexerInit)
}

// NewFiscalYearLexer produces a new lexer instance for the optional input antlr.CharStream.
func NewFiscalYearLexer(input antlr.CharStream) *FiscalYearLexer {
	FiscalYearLexerInit()
	l := new(FiscalYearLexer)
	...
	l.GrammarFileName = "FiscalYear.g4"
	// TODO: l.EOF = antlr.TokenEOF

	return l
}

// FiscalYearLexer tokens.
const (
	FiscalYearLexerFISCALYEAR = 1
	FiscalYearLexerOWNKEY     = 2
	FiscalYearLexerSPLITKEY   = 3
	FiscalYearLexerWS         = 4
)
