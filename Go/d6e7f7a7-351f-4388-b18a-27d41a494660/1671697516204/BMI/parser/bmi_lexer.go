// Code generated from /usr/local/lib/Go/d6e7f7a7-351f-4388-b18a-27d41a494660/1671697516204/BMI.g4 by ANTLR 4.10.1. DO NOT EDIT.
...
var bmilexerLexerStaticData struct {
	once                   sync.Once
	serializedATN          []int32
	channelNames           []string
	modeNames              []string
...
func bmilexerLexerInit() {
	staticData := &bmilexerLexerStaticData
...
// BMILexerInit initializes any static state used to implement BMILexer. By default the
// static state used to implement the lexer is lazily initialized during the first call to
// NewBMILexer(). You can call this function if you wish to initialize the static state ahead
// of time.
func BMILexerInit() {
	staticData := &bmilexerLexerStaticData
	staticData.once.Do(bmilexerLexerInit)
}

// NewBMILexer produces a new lexer instance for the optional input antlr.CharStream.
func NewBMILexer(input antlr.CharStream) *BMILexer {
	BMILexerInit()
	l := new(BMILexer)
