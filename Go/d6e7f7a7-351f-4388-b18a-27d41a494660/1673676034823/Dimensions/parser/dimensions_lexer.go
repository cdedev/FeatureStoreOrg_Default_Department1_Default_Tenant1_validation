...
var dimensionslexerLexerStaticData struct {
	once                   sync.Once
	serializedATN          []int32
	channelNames           []string
	modeNames              []string
...
func dimensionslexerLexerInit() {
	staticData := &dimensionslexerLexerStaticData
...
// DimensionsLexerInit initializes any static state used to implement DimensionsLexer. By default the
// static state used to implement the lexer is lazily initialized during the first call to
// NewDimensionsLexer(). You can call this function if you wish to initialize the static state ahead
// of time.
func DimensionsLexerInit() {
	staticData := &dimensionslexerLexerStaticData
	staticData.once.Do(dimensionslexerLexerInit)
}

// NewDimensionsLexer produces a new lexer instance for the optional input antlr.CharStream.
func NewDimensionsLexer(input antlr.CharStream) *DimensionsLexer {
	DimensionsLexerInit()
	l := new(DimensionsLexer)
	...
	l.GrammarFileName = "Dimensions.g4"
	// TODO: l.EOF = antlr.TokenEOF

	return l
}

// DimensionsLexer tokens.
const (
	DimensionsLexerDIMENSIONS = 1
	DimensionsLexerOWNKEY     = 2
	DimensionsLexerSPLITKEY   = 3
	DimensionsLexerWS         = 4
)
