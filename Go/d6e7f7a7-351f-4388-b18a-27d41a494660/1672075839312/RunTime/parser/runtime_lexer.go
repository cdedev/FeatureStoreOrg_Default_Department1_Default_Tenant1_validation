...
var runtimelexerLexerStaticData struct {
	once                   sync.Once
	serializedATN          []int32
	channelNames           []string
	modeNames              []string
...
func runtimelexerLexerInit() {
	staticData := &runtimelexerLexerStaticData
...
// RunTimeLexerInit initializes any static state used to implement RunTimeLexer. By default the
// static state used to implement the lexer is lazily initialized during the first call to
// NewRunTimeLexer(). You can call this function if you wish to initialize the static state ahead
// of time.
func RunTimeLexerInit() {
	staticData := &runtimelexerLexerStaticData
	staticData.once.Do(runtimelexerLexerInit)
}

// NewRunTimeLexer produces a new lexer instance for the optional input antlr.CharStream.
func NewRunTimeLexer(input antlr.CharStream) *RunTimeLexer {
	RunTimeLexerInit()
	l := new(RunTimeLexer)
...
// RunTimeLexer tokens.
const (
	RunTimeLexerRUNTIME  = 1
	RunTimeLexerOWNKEY   = 2
	RunTimeLexerSPLITKEY = 3
	RunTimeLexerWS       = 4
)
