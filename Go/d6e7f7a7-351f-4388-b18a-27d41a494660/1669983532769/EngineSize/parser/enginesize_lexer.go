...
var enginesizelexerLexerStaticData struct {
	once                   sync.Once
	serializedATN          []int32
	channelNames           []string
	modeNames              []string
...
func enginesizelexerLexerInit() {
	staticData := &enginesizelexerLexerStaticData
...
// EngineSizeLexerInit initializes any static state used to implement EngineSizeLexer. By default the
// static state used to implement the lexer is lazily initialized during the first call to
// NewEngineSizeLexer(). You can call this function if you wish to initialize the static state ahead
// of time.
func EngineSizeLexerInit() {
	staticData := &enginesizelexerLexerStaticData
	staticData.once.Do(enginesizelexerLexerInit)
}

// NewEngineSizeLexer produces a new lexer instance for the optional input antlr.CharStream.
func NewEngineSizeLexer(input antlr.CharStream) *EngineSizeLexer {
	EngineSizeLexerInit()
	l := new(EngineSizeLexer)
	...
	l.GrammarFileName = "EngineSize.g4"
	// TODO: l.EOF = antlr.TokenEOF

	return l
}

// EngineSizeLexer tokens.
const (
	EngineSizeLexerENGINESIZE = 1
	EngineSizeLexerOWNKEY     = 2
	EngineSizeLexerSPLITKEY   = 3
	EngineSizeLexerWS         = 4
)
