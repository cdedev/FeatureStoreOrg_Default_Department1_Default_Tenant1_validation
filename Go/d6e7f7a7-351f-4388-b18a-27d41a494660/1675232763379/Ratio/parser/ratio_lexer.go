...
var ratiolexerLexerStaticData struct {
	once                   sync.Once
	serializedATN          []int32
	channelNames           []string
	modeNames              []string
...
func ratiolexerLexerInit() {
	staticData := &ratiolexerLexerStaticData
...
// RatioLexerInit initializes any static state used to implement RatioLexer. By default the
// static state used to implement the lexer is lazily initialized during the first call to
// NewRatioLexer(). You can call this function if you wish to initialize the static state ahead
// of time.
func RatioLexerInit() {
	staticData := &ratiolexerLexerStaticData
	staticData.once.Do(ratiolexerLexerInit)
}

// NewRatioLexer produces a new lexer instance for the optional input antlr.CharStream.
func NewRatioLexer(input antlr.CharStream) *RatioLexer {
	RatioLexerInit()
	l := new(RatioLexer)
