...
var addedsugarlexerLexerStaticData struct {
	once                   sync.Once
	serializedATN          []int32
	channelNames           []string
	modeNames              []string
...
func addedsugarlexerLexerInit() {
	staticData := &addedsugarlexerLexerStaticData
...
// AddedSugarLexerInit initializes any static state used to implement AddedSugarLexer. By default the
// static state used to implement the lexer is lazily initialized during the first call to
// NewAddedSugarLexer(). You can call this function if you wish to initialize the static state ahead
// of time.
func AddedSugarLexerInit() {
	staticData := &addedsugarlexerLexerStaticData
	staticData.once.Do(addedsugarlexerLexerInit)
}

// NewAddedSugarLexer produces a new lexer instance for the optional input antlr.CharStream.
func NewAddedSugarLexer(input antlr.CharStream) *AddedSugarLexer {
	AddedSugarLexerInit()
	l := new(AddedSugarLexer)
	...
	l.GrammarFileName = "AddedSugar.g4"
	// TODO: l.EOF = antlr.TokenEOF

	return l
}

// AddedSugarLexer tokens.
const (
	AddedSugarLexerADDEDSUGAR = 1
	AddedSugarLexerOWNKEY     = 2
	AddedSugarLexerSPLITKEY   = 3
	AddedSugarLexerWS         = 4
)
