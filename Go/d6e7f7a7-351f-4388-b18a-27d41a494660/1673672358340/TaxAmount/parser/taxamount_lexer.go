...
var taxamountlexerLexerStaticData struct {
	once                   sync.Once
	serializedATN          []int32
	channelNames           []string
	modeNames              []string
...
func taxamountlexerLexerInit() {
	staticData := &taxamountlexerLexerStaticData
...
// TaxAmountLexerInit initializes any static state used to implement TaxAmountLexer. By default the
// static state used to implement the lexer is lazily initialized during the first call to
// NewTaxAmountLexer(). You can call this function if you wish to initialize the static state ahead
// of time.
func TaxAmountLexerInit() {
	staticData := &taxamountlexerLexerStaticData
	staticData.once.Do(taxamountlexerLexerInit)
}

// NewTaxAmountLexer produces a new lexer instance for the optional input antlr.CharStream.
func NewTaxAmountLexer(input antlr.CharStream) *TaxAmountLexer {
	TaxAmountLexerInit()
	l := new(TaxAmountLexer)
	...
	l.GrammarFileName = "TaxAmount.g4"
	// TODO: l.EOF = antlr.TokenEOF

	return l
}

// TaxAmountLexer tokens.
const (
	TaxAmountLexerTAXAMOUNT = 1
	TaxAmountLexerOWNKEY    = 2
	TaxAmountLexerSPLITKEY  = 3
	TaxAmountLexerWS        = 4
)
