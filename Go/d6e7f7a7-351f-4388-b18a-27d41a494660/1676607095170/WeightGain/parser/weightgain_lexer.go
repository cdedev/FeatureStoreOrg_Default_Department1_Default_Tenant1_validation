...
var weightgainlexerLexerStaticData struct {
	once                   sync.Once
	serializedATN          []int32
	channelNames           []string
	modeNames              []string
...
func weightgainlexerLexerInit() {
	staticData := &weightgainlexerLexerStaticData
...
// WeightGainLexerInit initializes any static state used to implement WeightGainLexer. By default the
// static state used to implement the lexer is lazily initialized during the first call to
// NewWeightGainLexer(). You can call this function if you wish to initialize the static state ahead
// of time.
func WeightGainLexerInit() {
	staticData := &weightgainlexerLexerStaticData
	staticData.once.Do(weightgainlexerLexerInit)
}

// NewWeightGainLexer produces a new lexer instance for the optional input antlr.CharStream.
func NewWeightGainLexer(input antlr.CharStream) *WeightGainLexer {
	WeightGainLexerInit()
	l := new(WeightGainLexer)
	...
	l.GrammarFileName = "WeightGain.g4"
	// TODO: l.EOF = antlr.TokenEOF

	return l
}

// WeightGainLexer tokens.
const (
	WeightGainLexerWEIGHTGAIN = 1
	WeightGainLexerOWNKEY     = 2
	WeightGainLexerSPLITKEY   = 3
	WeightGainLexerWS         = 4
)
