...
var survivedlexerLexerStaticData struct {
	once                   sync.Once
	serializedATN          []int32
	channelNames           []string
	modeNames              []string
...
func survivedlexerLexerInit() {
	staticData := &survivedlexerLexerStaticData
...
// SurvivedLexerInit initializes any static state used to implement SurvivedLexer. By default the
// static state used to implement the lexer is lazily initialized during the first call to
// NewSurvivedLexer(). You can call this function if you wish to initialize the static state ahead
// of time.
func SurvivedLexerInit() {
	staticData := &survivedlexerLexerStaticData
	staticData.once.Do(survivedlexerLexerInit)
}

// NewSurvivedLexer produces a new lexer instance for the optional input antlr.CharStream.
func NewSurvivedLexer(input antlr.CharStream) *SurvivedLexer {
	SurvivedLexerInit()
	l := new(SurvivedLexer)
	...
	l.GrammarFileName = "Survived.g4"
	// TODO: l.EOF = antlr.TokenEOF

	return l
}

// SurvivedLexer tokens.
const (
	SurvivedLexerSURVIVED = 1
	SurvivedLexerOWNKEY   = 2
	SurvivedLexerSPLITKEY = 3
	SurvivedLexerWS       = 4
)
