...
var lifespanlexerLexerStaticData struct {
	once                   sync.Once
	serializedATN          []int32
	channelNames           []string
	modeNames              []string
...
func lifespanlexerLexerInit() {
	staticData := &lifespanlexerLexerStaticData
...
// LifespanLexerInit initializes any static state used to implement LifespanLexer. By default the
// static state used to implement the lexer is lazily initialized during the first call to
// NewLifespanLexer(). You can call this function if you wish to initialize the static state ahead
// of time.
func LifespanLexerInit() {
	staticData := &lifespanlexerLexerStaticData
	staticData.once.Do(lifespanlexerLexerInit)
}

// NewLifespanLexer produces a new lexer instance for the optional input antlr.CharStream.
func NewLifespanLexer(input antlr.CharStream) *LifespanLexer {
	LifespanLexerInit()
	l := new(LifespanLexer)
	...
	l.GrammarFileName = "Lifespan.g4"
	// TODO: l.EOF = antlr.TokenEOF

	return l
}

// LifespanLexer tokens.
const (
	LifespanLexerLIFESPAN = 1
	LifespanLexerOWNKEY   = 2
	LifespanLexerSPLITKEY = 3
	LifespanLexerWS       = 4
)
