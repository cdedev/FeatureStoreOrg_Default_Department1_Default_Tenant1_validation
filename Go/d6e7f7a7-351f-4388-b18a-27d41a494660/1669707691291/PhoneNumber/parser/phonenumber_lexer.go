...
var phonenumberlexerLexerStaticData struct {
	once                   sync.Once
	serializedATN          []int32
	channelNames           []string
	modeNames              []string
...
func phonenumberlexerLexerInit() {
	staticData := &phonenumberlexerLexerStaticData
...
// PhoneNumberLexerInit initializes any static state used to implement PhoneNumberLexer. By default the
// static state used to implement the lexer is lazily initialized during the first call to
// NewPhoneNumberLexer(). You can call this function if you wish to initialize the static state ahead
// of time.
func PhoneNumberLexerInit() {
	staticData := &phonenumberlexerLexerStaticData
	staticData.once.Do(phonenumberlexerLexerInit)
}

// NewPhoneNumberLexer produces a new lexer instance for the optional input antlr.CharStream.
func NewPhoneNumberLexer(input antlr.CharStream) *PhoneNumberLexer {
	PhoneNumberLexerInit()
	l := new(PhoneNumberLexer)
	...
	l.GrammarFileName = "PhoneNumber.g4"
	// TODO: l.EOF = antlr.TokenEOF

	return l
}

// PhoneNumberLexer tokens.
const (
	PhoneNumberLexerPHONENUMBER = 1
	PhoneNumberLexerOWNKEY      = 2
	PhoneNumberLexerSPLITKEY    = 3
	PhoneNumberLexerWS          = 4
)
