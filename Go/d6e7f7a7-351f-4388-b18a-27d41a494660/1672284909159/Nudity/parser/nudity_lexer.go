...
var nuditylexerLexerStaticData struct {
	once                   sync.Once
	serializedATN          []int32
	channelNames           []string
	modeNames              []string
...
func nuditylexerLexerInit() {
	staticData := &nuditylexerLexerStaticData
...
// NudityLexerInit initializes any static state used to implement NudityLexer. By default the
// static state used to implement the lexer is lazily initialized during the first call to
// NewNudityLexer(). You can call this function if you wish to initialize the static state ahead
// of time.
func NudityLexerInit() {
	staticData := &nuditylexerLexerStaticData
	staticData.once.Do(nuditylexerLexerInit)
}

// NewNudityLexer produces a new lexer instance for the optional input antlr.CharStream.
func NewNudityLexer(input antlr.CharStream) *NudityLexer {
	NudityLexerInit()
	l := new(NudityLexer)
