// Code generated from /usr/local/lib/Go/d6e7f7a7-351f-4388-b18a-27d41a494660/1669789942503/Altitude.g4 by ANTLR 4.10.1. DO NOT EDIT.
...
var altitudelexerLexerStaticData struct {
	once                   sync.Once
	serializedATN          []int32
	channelNames           []string
	modeNames              []string
...
func altitudelexerLexerInit() {
	staticData := &altitudelexerLexerStaticData
...
// AltitudeLexerInit initializes any static state used to implement AltitudeLexer. By default the
// static state used to implement the lexer is lazily initialized during the first call to
// NewAltitudeLexer(). You can call this function if you wish to initialize the static state ahead
// of time.
func AltitudeLexerInit() {
	staticData := &altitudelexerLexerStaticData
	staticData.once.Do(altitudelexerLexerInit)
}

// NewAltitudeLexer produces a new lexer instance for the optional input antlr.CharStream.
func NewAltitudeLexer(input antlr.CharStream) *AltitudeLexer {
	AltitudeLexerInit()
	l := new(AltitudeLexer)
	...
	l.GrammarFileName = "Altitude.g4"
	// TODO: l.EOF = antlr.TokenEOF

	return l
}

// AltitudeLexer tokens.
const (
	AltitudeLexerALTITUDE = 1
	AltitudeLexerOWNKEY   = 2
	AltitudeLexerSPLITKEY = 3
	AltitudeLexerWS       = 4
)
