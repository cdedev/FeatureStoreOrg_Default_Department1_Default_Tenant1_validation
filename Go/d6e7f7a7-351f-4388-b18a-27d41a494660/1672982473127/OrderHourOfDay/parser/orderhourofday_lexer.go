...
type OrderHourOfDayLexer struct {
	*antlr.BaseLexer
	channelNames []string
	modeNames    []string
	// TODO: EOF string
...
var orderhourofdaylexerLexerStaticData struct {
	once                   sync.Once
	serializedATN          []int32
	channelNames           []string
	modeNames              []string
...
func orderhourofdaylexerLexerInit() {
	staticData := &orderhourofdaylexerLexerStaticData
...
// OrderHourOfDayLexerInit initializes any static state used to implement OrderHourOfDayLexer. By default the
// static state used to implement the lexer is lazily initialized during the first call to
// NewOrderHourOfDayLexer(). You can call this function if you wish to initialize the static state ahead
// of time.
func OrderHourOfDayLexerInit() {
	staticData := &orderhourofdaylexerLexerStaticData
	staticData.once.Do(orderhourofdaylexerLexerInit)
}

// NewOrderHourOfDayLexer produces a new lexer instance for the optional input antlr.CharStream.
func NewOrderHourOfDayLexer(input antlr.CharStream) *OrderHourOfDayLexer {
	OrderHourOfDayLexerInit()
	l := new(OrderHourOfDayLexer)
	...
	l.GrammarFileName = "OrderHourOfDay.g4"
	// TODO: l.EOF = antlr.TokenEOF

	return l
}

// OrderHourOfDayLexer tokens.
const (
	OrderHourOfDayLexerORDERHOUROFDAY = 1
	OrderHourOfDayLexerOWNKEY         = 2
	OrderHourOfDayLexerSPLITKEY       = 3
	OrderHourOfDayLexerWS             = 4
)
