...
var photophobialexerLexerStaticData struct {
	once                   sync.Once
	serializedATN          []int32
	channelNames           []string
	modeNames              []string
...
func photophobialexerLexerInit() {
	staticData := &photophobialexerLexerStaticData
...
// PhotophobiaLexerInit initializes any static state used to implement PhotophobiaLexer. By default the
// static state used to implement the lexer is lazily initialized during the first call to
// NewPhotophobiaLexer(). You can call this function if you wish to initialize the static state ahead
// of time.
func PhotophobiaLexerInit() {
	staticData := &photophobialexerLexerStaticData
	staticData.once.Do(photophobialexerLexerInit)
}

// NewPhotophobiaLexer produces a new lexer instance for the optional input antlr.CharStream.
func NewPhotophobiaLexer(input antlr.CharStream) *PhotophobiaLexer {
	PhotophobiaLexerInit()
	l := new(PhotophobiaLexer)
	...
	l.GrammarFileName = "Photophobia.g4"
	// TODO: l.EOF = antlr.TokenEOF

	return l
}

// PhotophobiaLexer tokens.
const (
	PhotophobiaLexerPHOTOPHOBIA = 1
	PhotophobiaLexerOWNKEY      = 2
	PhotophobiaLexerSPLITKEY    = 3
	PhotophobiaLexerWS          = 4
)
