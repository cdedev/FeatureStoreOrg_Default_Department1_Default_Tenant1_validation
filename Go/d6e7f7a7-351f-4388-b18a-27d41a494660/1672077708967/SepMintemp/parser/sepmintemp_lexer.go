...
var sepmintemplexerLexerStaticData struct {
	once                   sync.Once
	serializedATN          []int32
	channelNames           []string
	modeNames              []string
...
func sepmintemplexerLexerInit() {
	staticData := &sepmintemplexerLexerStaticData
...
// SepMintempLexerInit initializes any static state used to implement SepMintempLexer. By default the
// static state used to implement the lexer is lazily initialized during the first call to
// NewSepMintempLexer(). You can call this function if you wish to initialize the static state ahead
// of time.
func SepMintempLexerInit() {
	staticData := &sepmintemplexerLexerStaticData
	staticData.once.Do(sepmintemplexerLexerInit)
}

// NewSepMintempLexer produces a new lexer instance for the optional input antlr.CharStream.
func NewSepMintempLexer(input antlr.CharStream) *SepMintempLexer {
	SepMintempLexerInit()
	l := new(SepMintempLexer)
	...
	l.GrammarFileName = "SepMintemp.g4"
	// TODO: l.EOF = antlr.TokenEOF

	return l
}

// SepMintempLexer tokens.
const (
	SepMintempLexerSEPMINTEMP = 1
	SepMintempLexerOWNKEY     = 2
	SepMintempLexerSPLITKEY   = 3
	SepMintempLexerWS         = 4
)
