...
var branchcodelexerLexerStaticData struct {
	once                   sync.Once
	serializedATN          []int32
	channelNames           []string
	modeNames              []string
...
func branchcodelexerLexerInit() {
	staticData := &branchcodelexerLexerStaticData
...
// BranchCodeLexerInit initializes any static state used to implement BranchCodeLexer. By default the
// static state used to implement the lexer is lazily initialized during the first call to
// NewBranchCodeLexer(). You can call this function if you wish to initialize the static state ahead
// of time.
func BranchCodeLexerInit() {
	staticData := &branchcodelexerLexerStaticData
	staticData.once.Do(branchcodelexerLexerInit)
}

// NewBranchCodeLexer produces a new lexer instance for the optional input antlr.CharStream.
func NewBranchCodeLexer(input antlr.CharStream) *BranchCodeLexer {
	BranchCodeLexerInit()
	l := new(BranchCodeLexer)
	...
	l.GrammarFileName = "BranchCode.g4"
	// TODO: l.EOF = antlr.TokenEOF

	return l
}

// BranchCodeLexer tokens.
const (
	BranchCodeLexerBRANCHCODE = 1
	BranchCodeLexerOWNKEY     = 2
	BranchCodeLexerSPLITKEY   = 3
	BranchCodeLexerWS         = 4
)
