...
var weeklexerLexerStaticData struct {
	once                   sync.Once
	serializedATN          []int32
	channelNames           []string
	modeNames              []string
...
func weeklexerLexerInit() {
	staticData := &weeklexerLexerStaticData
...
// WeekLexerInit initializes any static state used to implement WeekLexer. By default the
// static state used to implement the lexer is lazily initialized during the first call to
// NewWeekLexer(). You can call this function if you wish to initialize the static state ahead
// of time.
func WeekLexerInit() {
	staticData := &weeklexerLexerStaticData
	staticData.once.Do(weeklexerLexerInit)
}

// NewWeekLexer produces a new lexer instance for the optional input antlr.CharStream.
func NewWeekLexer(input antlr.CharStream) *WeekLexer {
	WeekLexerInit()
	l := new(WeekLexer)
