...
type YearsInCurrentRoleLexer struct {
	*antlr.BaseLexer
	channelNames []string
	modeNames    []string
	// TODO: EOF string
...
var yearsincurrentrolelexerLexerStaticData struct {
	once                   sync.Once
	serializedATN          []int32
	channelNames           []string
	modeNames              []string
...
func yearsincurrentrolelexerLexerInit() {
	staticData := &yearsincurrentrolelexerLexerStaticData
...
// YearsInCurrentRoleLexerInit initializes any static state used to implement YearsInCurrentRoleLexer. By default the
// static state used to implement the lexer is lazily initialized during the first call to
// NewYearsInCurrentRoleLexer(). You can call this function if you wish to initialize the static state ahead
// of time.
func YearsInCurrentRoleLexerInit() {
	staticData := &yearsincurrentrolelexerLexerStaticData
	staticData.once.Do(yearsincurrentrolelexerLexerInit)
}

// NewYearsInCurrentRoleLexer produces a new lexer instance for the optional input antlr.CharStream.
func NewYearsInCurrentRoleLexer(input antlr.CharStream) *YearsInCurrentRoleLexer {
	YearsInCurrentRoleLexerInit()
	l := new(YearsInCurrentRoleLexer)
	...
	l.GrammarFileName = "YearsInCurrentRole.g4"
	// TODO: l.EOF = antlr.TokenEOF

	return l
}

// YearsInCurrentRoleLexer tokens.
const (
	YearsInCurrentRoleLexerYEARSINCURRENTROLE = 1
	YearsInCurrentRoleLexerOWNKEY             = 2
	YearsInCurrentRoleLexerSPLITKEY           = 3
	YearsInCurrentRoleLexerWS                 = 4
)
