...
var aprmaxtemplexerLexerStaticData struct {
	once                   sync.Once
	serializedATN          []int32
	channelNames           []string
	modeNames              []string
...
func aprmaxtemplexerLexerInit() {
	staticData := &aprmaxtemplexerLexerStaticData
...
// AprMaxtempLexerInit initializes any static state used to implement AprMaxtempLexer. By default the
// static state used to implement the lexer is lazily initialized during the first call to
// NewAprMaxtempLexer(). You can call this function if you wish to initialize the static state ahead
// of time.
func AprMaxtempLexerInit() {
	staticData := &aprmaxtemplexerLexerStaticData
	staticData.once.Do(aprmaxtemplexerLexerInit)
}

// NewAprMaxtempLexer produces a new lexer instance for the optional input antlr.CharStream.
func NewAprMaxtempLexer(input antlr.CharStream) *AprMaxtempLexer {
	AprMaxtempLexerInit()
	l := new(AprMaxtempLexer)
	...
	l.GrammarFileName = "AprMaxtemp.g4"
	// TODO: l.EOF = antlr.TokenEOF

	return l
}

// AprMaxtempLexer tokens.
const (
	AprMaxtempLexerAPRMAXTEMP = 1
	AprMaxtempLexerOWNKEY     = 2
	AprMaxtempLexerSPLITKEY   = 3
	AprMaxtempLexerWS         = 4
)
