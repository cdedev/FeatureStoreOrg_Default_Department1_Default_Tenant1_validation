...
type FinancialDistressLexer struct {
	*antlr.BaseLexer
	channelNames []string
	modeNames    []string
	// TODO: EOF string
...
var financialdistresslexerLexerStaticData struct {
	once                   sync.Once
	serializedATN          []int32
	channelNames           []string
	modeNames              []string
...
func financialdistresslexerLexerInit() {
	staticData := &financialdistresslexerLexerStaticData
...
// FinancialDistressLexerInit initializes any static state used to implement FinancialDistressLexer. By default the
// static state used to implement the lexer is lazily initialized during the first call to
// NewFinancialDistressLexer(). You can call this function if you wish to initialize the static state ahead
// of time.
func FinancialDistressLexerInit() {
	staticData := &financialdistresslexerLexerStaticData
	staticData.once.Do(financialdistresslexerLexerInit)
}

// NewFinancialDistressLexer produces a new lexer instance for the optional input antlr.CharStream.
func NewFinancialDistressLexer(input antlr.CharStream) *FinancialDistressLexer {
	FinancialDistressLexerInit()
	l := new(FinancialDistressLexer)
	...
	l.GrammarFileName = "FinancialDistress.g4"
	// TODO: l.EOF = antlr.TokenEOF

	return l
}

// FinancialDistressLexer tokens.
const (
	FinancialDistressLexerFINANCIALDISTRESS = 1
	FinancialDistressLexerOWNKEY            = 2
	FinancialDistressLexerSPLITKEY          = 3
	FinancialDistressLexerWS                = 4
)
