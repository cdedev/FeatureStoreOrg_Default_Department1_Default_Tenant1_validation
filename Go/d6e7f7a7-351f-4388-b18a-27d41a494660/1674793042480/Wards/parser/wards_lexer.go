...
var wardslexerLexerStaticData struct {
	once                   sync.Once
	serializedATN          []int32
	channelNames           []string
	modeNames              []string
...
func wardslexerLexerInit() {
	staticData := &wardslexerLexerStaticData
...
// WardsLexerInit initializes any static state used to implement WardsLexer. By default the
// static state used to implement the lexer is lazily initialized during the first call to
// NewWardsLexer(). You can call this function if you wish to initialize the static state ahead
// of time.
func WardsLexerInit() {
	staticData := &wardslexerLexerStaticData
	staticData.once.Do(wardslexerLexerInit)
}

// NewWardsLexer produces a new lexer instance for the optional input antlr.CharStream.
func NewWardsLexer(input antlr.CharStream) *WardsLexer {
	WardsLexerInit()
	l := new(WardsLexer)
