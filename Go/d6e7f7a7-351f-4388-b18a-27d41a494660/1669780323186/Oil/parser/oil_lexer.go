...
var oillexerLexerStaticData struct {
	once                   sync.Once
	serializedATN          []int32
	channelNames           []string
	modeNames              []string
...
func oillexerLexerInit() {
	staticData := &oillexerLexerStaticData
...
// OilLexerInit initializes any static state used to implement OilLexer. By default the
// static state used to implement the lexer is lazily initialized during the first call to
// NewOilLexer(). You can call this function if you wish to initialize the static state ahead
// of time.
func OilLexerInit() {
	staticData := &oillexerLexerStaticData
	staticData.once.Do(oillexerLexerInit)
}

// NewOilLexer produces a new lexer instance for the optional input antlr.CharStream.
func NewOilLexer(input antlr.CharStream) *OilLexer {
	OilLexerInit()
	l := new(OilLexer)
