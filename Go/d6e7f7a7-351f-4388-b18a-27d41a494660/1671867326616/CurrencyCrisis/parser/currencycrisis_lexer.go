...
type CurrencyCrisisLexer struct {
	*antlr.BaseLexer
	channelNames []string
	modeNames    []string
	// TODO: EOF string
...
var currencycrisislexerLexerStaticData struct {
	once                   sync.Once
	serializedATN          []int32
	channelNames           []string
	modeNames              []string
...
func currencycrisislexerLexerInit() {
	staticData := &currencycrisislexerLexerStaticData
...
// CurrencyCrisisLexerInit initializes any static state used to implement CurrencyCrisisLexer. By default the
// static state used to implement the lexer is lazily initialized during the first call to
// NewCurrencyCrisisLexer(). You can call this function if you wish to initialize the static state ahead
// of time.
func CurrencyCrisisLexerInit() {
	staticData := &currencycrisislexerLexerStaticData
	staticData.once.Do(currencycrisislexerLexerInit)
}

// NewCurrencyCrisisLexer produces a new lexer instance for the optional input antlr.CharStream.
func NewCurrencyCrisisLexer(input antlr.CharStream) *CurrencyCrisisLexer {
	CurrencyCrisisLexerInit()
	l := new(CurrencyCrisisLexer)
	...
	l.GrammarFileName = "CurrencyCrisis.g4"
	// TODO: l.EOF = antlr.TokenEOF

	return l
}

// CurrencyCrisisLexer tokens.
const (
	CurrencyCrisisLexerCURRENCYCRISIS = 1
	CurrencyCrisisLexerOWNKEY         = 2
	CurrencyCrisisLexerSPLITKEY       = 3
	CurrencyCrisisLexerWS             = 4
)
