...
var rawethanollexerLexerStaticData struct {
	once                   sync.Once
	serializedATN          []int32
	channelNames           []string
	modeNames              []string
...
func rawethanollexerLexerInit() {
	staticData := &rawethanollexerLexerStaticData
...
// RawEthanolLexerInit initializes any static state used to implement RawEthanolLexer. By default the
// static state used to implement the lexer is lazily initialized during the first call to
// NewRawEthanolLexer(). You can call this function if you wish to initialize the static state ahead
// of time.
func RawEthanolLexerInit() {
	staticData := &rawethanollexerLexerStaticData
	staticData.once.Do(rawethanollexerLexerInit)
}

// NewRawEthanolLexer produces a new lexer instance for the optional input antlr.CharStream.
func NewRawEthanolLexer(input antlr.CharStream) *RawEthanolLexer {
	RawEthanolLexerInit()
	l := new(RawEthanolLexer)
	...
	l.GrammarFileName = "RawEthanol.g4"
	// TODO: l.EOF = antlr.TokenEOF

	return l
}

// RawEthanolLexer tokens.
const (
	RawEthanolLexerRAWETHANOL = 1
	RawEthanolLexerOWNKEY     = 2
	RawEthanolLexerSPLITKEY   = 3
	RawEthanolLexerWS         = 4
)
