...
var noticeperiodlexerLexerStaticData struct {
	once                   sync.Once
	serializedATN          []int32
	channelNames           []string
	modeNames              []string
...
func noticeperiodlexerLexerInit() {
	staticData := &noticeperiodlexerLexerStaticData
...
// NoticePeriodLexerInit initializes any static state used to implement NoticePeriodLexer. By default the
// static state used to implement the lexer is lazily initialized during the first call to
// NewNoticePeriodLexer(). You can call this function if you wish to initialize the static state ahead
// of time.
func NoticePeriodLexerInit() {
	staticData := &noticeperiodlexerLexerStaticData
	staticData.once.Do(noticeperiodlexerLexerInit)
}

// NewNoticePeriodLexer produces a new lexer instance for the optional input antlr.CharStream.
func NewNoticePeriodLexer(input antlr.CharStream) *NoticePeriodLexer {
	NoticePeriodLexerInit()
	l := new(NoticePeriodLexer)
	...
	l.GrammarFileName = "NoticePeriod.g4"
	// TODO: l.EOF = antlr.TokenEOF

	return l
}

// NoticePeriodLexer tokens.
const (
	NoticePeriodLexerNOTICEPERIOD = 1
	NoticePeriodLexerOWNKEY       = 2
	NoticePeriodLexerSPLITKEY     = 3
	NoticePeriodLexerWS           = 4
)
