...
var avgnoiselvllexerLexerStaticData struct {
	once                   sync.Once
	serializedATN          []int32
	channelNames           []string
	modeNames              []string
...
func avgnoiselvllexerLexerInit() {
	staticData := &avgnoiselvllexerLexerStaticData
...
// AvgNoiseLvlLexerInit initializes any static state used to implement AvgNoiseLvlLexer. By default the
// static state used to implement the lexer is lazily initialized during the first call to
// NewAvgNoiseLvlLexer(). You can call this function if you wish to initialize the static state ahead
// of time.
func AvgNoiseLvlLexerInit() {
	staticData := &avgnoiselvllexerLexerStaticData
	staticData.once.Do(avgnoiselvllexerLexerInit)
}

// NewAvgNoiseLvlLexer produces a new lexer instance for the optional input antlr.CharStream.
func NewAvgNoiseLvlLexer(input antlr.CharStream) *AvgNoiseLvlLexer {
	AvgNoiseLvlLexerInit()
	l := new(AvgNoiseLvlLexer)
	...
	l.GrammarFileName = "AvgNoiseLvl.g4"
	// TODO: l.EOF = antlr.TokenEOF

	return l
}

// AvgNoiseLvlLexer tokens.
const (
	AvgNoiseLvlLexerAVGNOISELVL = 1
	AvgNoiseLvlLexerOWNKEY      = 2
	AvgNoiseLvlLexerSPLITKEY    = 3
	AvgNoiseLvlLexerWS          = 4
)
