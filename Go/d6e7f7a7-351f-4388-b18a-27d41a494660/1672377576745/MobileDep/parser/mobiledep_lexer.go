...
var mobiledeplexerLexerStaticData struct {
	once                   sync.Once
	serializedATN          []int32
	channelNames           []string
	modeNames              []string
...
func mobiledeplexerLexerInit() {
	staticData := &mobiledeplexerLexerStaticData
...
// MobileDepLexerInit initializes any static state used to implement MobileDepLexer. By default the
// static state used to implement the lexer is lazily initialized during the first call to
// NewMobileDepLexer(). You can call this function if you wish to initialize the static state ahead
// of time.
func MobileDepLexerInit() {
	staticData := &mobiledeplexerLexerStaticData
	staticData.once.Do(mobiledeplexerLexerInit)
}

// NewMobileDepLexer produces a new lexer instance for the optional input antlr.CharStream.
func NewMobileDepLexer(input antlr.CharStream) *MobileDepLexer {
	MobileDepLexerInit()
	l := new(MobileDepLexer)
	...
	l.GrammarFileName = "MobileDep.g4"
	// TODO: l.EOF = antlr.TokenEOF

	return l
}

// MobileDepLexer tokens.
const (
	MobileDepLexerMOBILEDEP = 1
	MobileDepLexerOWNKEY    = 2
	MobileDepLexerSPLITKEY  = 3
	MobileDepLexerWS        = 4
)
