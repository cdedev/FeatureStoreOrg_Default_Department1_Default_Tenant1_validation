...
var arseniclexerLexerStaticData struct {
	once                   sync.Once
	serializedATN          []int32
	channelNames           []string
	modeNames              []string
...
func arseniclexerLexerInit() {
	staticData := &arseniclexerLexerStaticData
...
// ArsenicLexerInit initializes any static state used to implement ArsenicLexer. By default the
// static state used to implement the lexer is lazily initialized during the first call to
// NewArsenicLexer(). You can call this function if you wish to initialize the static state ahead
// of time.
func ArsenicLexerInit() {
	staticData := &arseniclexerLexerStaticData
	staticData.once.Do(arseniclexerLexerInit)
}

// NewArsenicLexer produces a new lexer instance for the optional input antlr.CharStream.
func NewArsenicLexer(input antlr.CharStream) *ArsenicLexer {
	ArsenicLexerInit()
	l := new(ArsenicLexer)
...
// ArsenicLexer tokens.
const (
	ArsenicLexerARSENIC  = 1
	ArsenicLexerOWNKEY   = 2
	ArsenicLexerSPLITKEY = 3
	ArsenicLexerWS       = 4
)
