...
type AgreeablenessLexer struct {
	*antlr.BaseLexer
	channelNames []string
	modeNames    []string
	// TODO: EOF string
...
var agreeablenesslexerLexerStaticData struct {
	once                   sync.Once
	serializedATN          []int32
	channelNames           []string
	modeNames              []string
...
func agreeablenesslexerLexerInit() {
	staticData := &agreeablenesslexerLexerStaticData
...
// AgreeablenessLexerInit initializes any static state used to implement AgreeablenessLexer. By default the
// static state used to implement the lexer is lazily initialized during the first call to
// NewAgreeablenessLexer(). You can call this function if you wish to initialize the static state ahead
// of time.
func AgreeablenessLexerInit() {
	staticData := &agreeablenesslexerLexerStaticData
	staticData.once.Do(agreeablenesslexerLexerInit)
}

// NewAgreeablenessLexer produces a new lexer instance for the optional input antlr.CharStream.
func NewAgreeablenessLexer(input antlr.CharStream) *AgreeablenessLexer {
	AgreeablenessLexerInit()
	l := new(AgreeablenessLexer)
	...
	l.GrammarFileName = "Agreeableness.g4"
	// TODO: l.EOF = antlr.TokenEOF

	return l
}

// AgreeablenessLexer tokens.
const (
	AgreeablenessLexerAGREEABLENESS = 1
	AgreeablenessLexerOWNKEY        = 2
	AgreeablenessLexerSPLITKEY      = 3
	AgreeablenessLexerWS            = 4
)
