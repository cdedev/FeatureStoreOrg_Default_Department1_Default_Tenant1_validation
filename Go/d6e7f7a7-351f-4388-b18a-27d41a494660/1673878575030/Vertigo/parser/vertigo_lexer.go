...
var vertigolexerLexerStaticData struct {
	once                   sync.Once
	serializedATN          []int32
	channelNames           []string
	modeNames              []string
...
func vertigolexerLexerInit() {
	staticData := &vertigolexerLexerStaticData
...
// VertigoLexerInit initializes any static state used to implement VertigoLexer. By default the
// static state used to implement the lexer is lazily initialized during the first call to
// NewVertigoLexer(). You can call this function if you wish to initialize the static state ahead
// of time.
func VertigoLexerInit() {
	staticData := &vertigolexerLexerStaticData
	staticData.once.Do(vertigolexerLexerInit)
}

// NewVertigoLexer produces a new lexer instance for the optional input antlr.CharStream.
func NewVertigoLexer(input antlr.CharStream) *VertigoLexer {
	VertigoLexerInit()
	l := new(VertigoLexer)
...
// VertigoLexer tokens.
const (
	VertigoLexerVERTIGO  = 1
	VertigoLexerOWNKEY   = 2
	VertigoLexerSPLITKEY = 3
	VertigoLexerWS       = 4
)
