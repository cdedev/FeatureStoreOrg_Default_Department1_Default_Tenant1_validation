...
var expenseslexerLexerStaticData struct {
	once                   sync.Once
	serializedATN          []int32
	channelNames           []string
	modeNames              []string
...
func expenseslexerLexerInit() {
	staticData := &expenseslexerLexerStaticData
...
// ExpensesLexerInit initializes any static state used to implement ExpensesLexer. By default the
// static state used to implement the lexer is lazily initialized during the first call to
// NewExpensesLexer(). You can call this function if you wish to initialize the static state ahead
// of time.
func ExpensesLexerInit() {
	staticData := &expenseslexerLexerStaticData
	staticData.once.Do(expenseslexerLexerInit)
}

// NewExpensesLexer produces a new lexer instance for the optional input antlr.CharStream.
func NewExpensesLexer(input antlr.CharStream) *ExpensesLexer {
	ExpensesLexerInit()
	l := new(ExpensesLexer)
	...
	l.GrammarFileName = "Expenses.g4"
	// TODO: l.EOF = antlr.TokenEOF

	return l
}

// ExpensesLexer tokens.
const (
	ExpensesLexerEXPENSES = 1
	ExpensesLexerOWNKEY   = 2
	ExpensesLexerSPLITKEY = 3
	ExpensesLexerWS       = 4
)
