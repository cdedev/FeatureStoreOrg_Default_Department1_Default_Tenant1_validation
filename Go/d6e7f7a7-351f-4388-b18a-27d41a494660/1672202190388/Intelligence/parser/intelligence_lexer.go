...
var intelligencelexerLexerStaticData struct {
	once                   sync.Once
	serializedATN          []int32
	channelNames           []string
	modeNames              []string
...
func intelligencelexerLexerInit() {
	staticData := &intelligencelexerLexerStaticData
...
// IntelligenceLexerInit initializes any static state used to implement IntelligenceLexer. By default the
// static state used to implement the lexer is lazily initialized during the first call to
// NewIntelligenceLexer(). You can call this function if you wish to initialize the static state ahead
// of time.
func IntelligenceLexerInit() {
	staticData := &intelligencelexerLexerStaticData
	staticData.once.Do(intelligencelexerLexerInit)
}

// NewIntelligenceLexer produces a new lexer instance for the optional input antlr.CharStream.
func NewIntelligenceLexer(input antlr.CharStream) *IntelligenceLexer {
	IntelligenceLexerInit()
	l := new(IntelligenceLexer)
	...
	l.GrammarFileName = "Intelligence.g4"
	// TODO: l.EOF = antlr.TokenEOF

	return l
}

// IntelligenceLexer tokens.
const (
	IntelligenceLexerINTELLIGENCE = 1
	IntelligenceLexerOWNKEY       = 2
	IntelligenceLexerSPLITKEY     = 3
	IntelligenceLexerWS           = 4
)
