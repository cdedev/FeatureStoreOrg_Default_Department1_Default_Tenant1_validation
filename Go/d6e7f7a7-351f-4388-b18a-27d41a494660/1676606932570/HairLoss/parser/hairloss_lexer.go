...
var hairlosslexerLexerStaticData struct {
	once                   sync.Once
	serializedATN          []int32
	channelNames           []string
	modeNames              []string
...
func hairlosslexerLexerInit() {
	staticData := &hairlosslexerLexerStaticData
...
// HairLossLexerInit initializes any static state used to implement HairLossLexer. By default the
// static state used to implement the lexer is lazily initialized during the first call to
// NewHairLossLexer(). You can call this function if you wish to initialize the static state ahead
// of time.
func HairLossLexerInit() {
	staticData := &hairlosslexerLexerStaticData
	staticData.once.Do(hairlosslexerLexerInit)
}

// NewHairLossLexer produces a new lexer instance for the optional input antlr.CharStream.
func NewHairLossLexer(input antlr.CharStream) *HairLossLexer {
	HairLossLexerInit()
	l := new(HairLossLexer)
	...
	l.GrammarFileName = "HairLoss.g4"
	// TODO: l.EOF = antlr.TokenEOF

	return l
}

// HairLossLexer tokens.
const (
	HairLossLexerHAIRLOSS = 1
	HairLossLexerOWNKEY   = 2
	HairLossLexerSPLITKEY = 3
	HairLossLexerWS       = 4
)
