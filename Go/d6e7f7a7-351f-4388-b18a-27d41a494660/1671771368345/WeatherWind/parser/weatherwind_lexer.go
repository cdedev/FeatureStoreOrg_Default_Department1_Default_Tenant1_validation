...
var weatherwindlexerLexerStaticData struct {
	once                   sync.Once
	serializedATN          []int32
	channelNames           []string
	modeNames              []string
...
func weatherwindlexerLexerInit() {
	staticData := &weatherwindlexerLexerStaticData
...
// WeatherWindLexerInit initializes any static state used to implement WeatherWindLexer. By default the
// static state used to implement the lexer is lazily initialized during the first call to
// NewWeatherWindLexer(). You can call this function if you wish to initialize the static state ahead
// of time.
func WeatherWindLexerInit() {
	staticData := &weatherwindlexerLexerStaticData
	staticData.once.Do(weatherwindlexerLexerInit)
}

// NewWeatherWindLexer produces a new lexer instance for the optional input antlr.CharStream.
func NewWeatherWindLexer(input antlr.CharStream) *WeatherWindLexer {
	WeatherWindLexerInit()
	l := new(WeatherWindLexer)
	...
	l.GrammarFileName = "WeatherWind.g4"
	// TODO: l.EOF = antlr.TokenEOF

	return l
}

// WeatherWindLexer tokens.
const (
	WeatherWindLexerWEATHERWIND = 1
	WeatherWindLexerOWNKEY      = 2
	WeatherWindLexerSPLITKEY    = 3
	WeatherWindLexerWS          = 4
)
