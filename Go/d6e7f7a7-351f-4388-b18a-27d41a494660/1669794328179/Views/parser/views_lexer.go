...
var viewslexerLexerStaticData struct {
	once                   sync.Once
	serializedATN          []int32
	channelNames           []string
	modeNames              []string
...
func viewslexerLexerInit() {
	staticData := &viewslexerLexerStaticData
...
// ViewsLexerInit initializes any static state used to implement ViewsLexer. By default the
// static state used to implement the lexer is lazily initialized during the first call to
// NewViewsLexer(). You can call this function if you wish to initialize the static state ahead
// of time.
func ViewsLexerInit() {
	staticData := &viewslexerLexerStaticData
	staticData.once.Do(viewslexerLexerInit)
}

// NewViewsLexer produces a new lexer instance for the optional input antlr.CharStream.
func NewViewsLexer(input antlr.CharStream) *ViewsLexer {
	ViewsLexerInit()
	l := new(ViewsLexer)
