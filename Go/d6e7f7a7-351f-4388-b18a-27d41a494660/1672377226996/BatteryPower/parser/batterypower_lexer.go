...
var batterypowerlexerLexerStaticData struct {
	once                   sync.Once
	serializedATN          []int32
	channelNames           []string
	modeNames              []string
...
func batterypowerlexerLexerInit() {
	staticData := &batterypowerlexerLexerStaticData
...
// BatteryPowerLexerInit initializes any static state used to implement BatteryPowerLexer. By default the
// static state used to implement the lexer is lazily initialized during the first call to
// NewBatteryPowerLexer(). You can call this function if you wish to initialize the static state ahead
// of time.
func BatteryPowerLexerInit() {
	staticData := &batterypowerlexerLexerStaticData
	staticData.once.Do(batterypowerlexerLexerInit)
}

// NewBatteryPowerLexer produces a new lexer instance for the optional input antlr.CharStream.
func NewBatteryPowerLexer(input antlr.CharStream) *BatteryPowerLexer {
	BatteryPowerLexerInit()
	l := new(BatteryPowerLexer)
	...
	l.GrammarFileName = "BatteryPower.g4"
	// TODO: l.EOF = antlr.TokenEOF

	return l
}

// BatteryPowerLexer tokens.
const (
	BatteryPowerLexerBATTERYPOWER = 1
	BatteryPowerLexerOWNKEY       = 2
	BatteryPowerLexerSPLITKEY     = 3
	BatteryPowerLexerWS           = 4
)
