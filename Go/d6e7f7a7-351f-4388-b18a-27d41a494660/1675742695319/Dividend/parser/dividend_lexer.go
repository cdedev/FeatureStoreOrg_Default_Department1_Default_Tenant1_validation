...
var dividendlexerLexerStaticData struct {
	once                   sync.Once
	serializedATN          []int32
	channelNames           []string
	modeNames              []string
...
func dividendlexerLexerInit() {
	staticData := &dividendlexerLexerStaticData
...
// DividendLexerInit initializes any static state used to implement DividendLexer. By default the
// static state used to implement the lexer is lazily initialized during the first call to
// NewDividendLexer(). You can call this function if you wish to initialize the static state ahead
// of time.
func DividendLexerInit() {
	staticData := &dividendlexerLexerStaticData
	staticData.once.Do(dividendlexerLexerInit)
}

// NewDividendLexer produces a new lexer instance for the optional input antlr.CharStream.
func NewDividendLexer(input antlr.CharStream) *DividendLexer {
	DividendLexerInit()
	l := new(DividendLexer)
	...
	l.GrammarFileName = "Dividend.g4"
	// TODO: l.EOF = antlr.TokenEOF

	return l
}

// DividendLexer tokens.
const (
	DividendLexerDIVIDEND = 1
	DividendLexerOWNKEY   = 2
	DividendLexerSPLITKEY = 3
	DividendLexerWS       = 4
)
