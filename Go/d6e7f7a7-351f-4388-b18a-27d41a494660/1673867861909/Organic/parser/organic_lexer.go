...
var organiclexerLexerStaticData struct {
	once                   sync.Once
	serializedATN          []int32
	channelNames           []string
	modeNames              []string
...
func organiclexerLexerInit() {
	staticData := &organiclexerLexerStaticData
...
// OrganicLexerInit initializes any static state used to implement OrganicLexer. By default the
// static state used to implement the lexer is lazily initialized during the first call to
// NewOrganicLexer(). You can call this function if you wish to initialize the static state ahead
// of time.
func OrganicLexerInit() {
	staticData := &organiclexerLexerStaticData
	staticData.once.Do(organiclexerLexerInit)
}

// NewOrganicLexer produces a new lexer instance for the optional input antlr.CharStream.
func NewOrganicLexer(input antlr.CharStream) *OrganicLexer {
	OrganicLexerInit()
	l := new(OrganicLexer)
...
// OrganicLexer tokens.
const (
	OrganicLexerORGANIC  = 1
	OrganicLexerOWNKEY   = 2
	OrganicLexerSPLITKEY = 3
	OrganicLexerWS       = 4
)
