...
var windbearinglexerLexerStaticData struct {
	once                   sync.Once
	serializedATN          []int32
	channelNames           []string
	modeNames              []string
...
func windbearinglexerLexerInit() {
	staticData := &windbearinglexerLexerStaticData
...
// WindBearingLexerInit initializes any static state used to implement WindBearingLexer. By default the
// static state used to implement the lexer is lazily initialized during the first call to
// NewWindBearingLexer(). You can call this function if you wish to initialize the static state ahead
// of time.
func WindBearingLexerInit() {
	staticData := &windbearinglexerLexerStaticData
	staticData.once.Do(windbearinglexerLexerInit)
}

// NewWindBearingLexer produces a new lexer instance for the optional input antlr.CharStream.
func NewWindBearingLexer(input antlr.CharStream) *WindBearingLexer {
	WindBearingLexerInit()
	l := new(WindBearingLexer)
	...
	l.GrammarFileName = "WindBearing.g4"
	// TODO: l.EOF = antlr.TokenEOF

	return l
}

// WindBearingLexer tokens.
const (
	WindBearingLexerWINDBEARING = 1
	WindBearingLexerOWNKEY      = 2
	WindBearingLexerSPLITKEY    = 3
	WindBearingLexerWS          = 4
)
