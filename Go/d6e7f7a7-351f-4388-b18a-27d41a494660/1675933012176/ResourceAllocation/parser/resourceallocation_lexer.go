...
type ResourceAllocationLexer struct {
	*antlr.BaseLexer
	channelNames []string
	modeNames    []string
	// TODO: EOF string
...
var resourceallocationlexerLexerStaticData struct {
	once                   sync.Once
	serializedATN          []int32
	channelNames           []string
	modeNames              []string
...
func resourceallocationlexerLexerInit() {
	staticData := &resourceallocationlexerLexerStaticData
...
// ResourceAllocationLexerInit initializes any static state used to implement ResourceAllocationLexer. By default the
// static state used to implement the lexer is lazily initialized during the first call to
// NewResourceAllocationLexer(). You can call this function if you wish to initialize the static state ahead
// of time.
func ResourceAllocationLexerInit() {
	staticData := &resourceallocationlexerLexerStaticData
	staticData.once.Do(resourceallocationlexerLexerInit)
}

// NewResourceAllocationLexer produces a new lexer instance for the optional input antlr.CharStream.
func NewResourceAllocationLexer(input antlr.CharStream) *ResourceAllocationLexer {
	ResourceAllocationLexerInit()
	l := new(ResourceAllocationLexer)
	...
	l.GrammarFileName = "ResourceAllocation.g4"
	// TODO: l.EOF = antlr.TokenEOF

	return l
}

// ResourceAllocationLexer tokens.
const (
	ResourceAllocationLexerRESOURCEALLOCATION = 1
	ResourceAllocationLexerOWNKEY             = 2
	ResourceAllocationLexerSPLITKEY           = 3
	ResourceAllocationLexerWS                 = 4
)
