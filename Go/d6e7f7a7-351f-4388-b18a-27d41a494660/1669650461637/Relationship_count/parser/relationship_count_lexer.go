...
type Relationship_countLexer struct {
	*antlr.BaseLexer
	channelNames []string
	modeNames    []string
	// TODO: EOF string
...
var relationship_countlexerLexerStaticData struct {
	once                   sync.Once
	serializedATN          []int32
	channelNames           []string
	modeNames              []string
...
func relationship_countlexerLexerInit() {
	staticData := &relationship_countlexerLexerStaticData
...
// Relationship_countLexerInit initializes any static state used to implement Relationship_countLexer. By default the
// static state used to implement the lexer is lazily initialized during the first call to
// NewRelationship_countLexer(). You can call this function if you wish to initialize the static state ahead
// of time.
func Relationship_countLexerInit() {
	staticData := &relationship_countlexerLexerStaticData
	staticData.once.Do(relationship_countlexerLexerInit)
}

// NewRelationship_countLexer produces a new lexer instance for the optional input antlr.CharStream.
func NewRelationship_countLexer(input antlr.CharStream) *Relationship_countLexer {
	Relationship_countLexerInit()
	l := new(Relationship_countLexer)
	...
	l.GrammarFileName = "Relationship_count.g4"
	// TODO: l.EOF = antlr.TokenEOF

	return l
}

// Relationship_countLexer tokens.
const (
	Relationship_countLexerRELATIONSHIP_COUNT = 1
	Relationship_countLexerOWNKEY             = 2
	Relationship_countLexerSPLITKEY           = 3
	Relationship_countLexerWS                 = 4
)
