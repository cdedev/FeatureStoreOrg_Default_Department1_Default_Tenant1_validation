...
var bulkdensitylexerLexerStaticData struct {
	once                   sync.Once
	serializedATN          []int32
	channelNames           []string
	modeNames              []string
...
func bulkdensitylexerLexerInit() {
	staticData := &bulkdensitylexerLexerStaticData
...
// BulkDensityLexerInit initializes any static state used to implement BulkDensityLexer. By default the
// static state used to implement the lexer is lazily initialized during the first call to
// NewBulkDensityLexer(). You can call this function if you wish to initialize the static state ahead
// of time.
func BulkDensityLexerInit() {
	staticData := &bulkdensitylexerLexerStaticData
	staticData.once.Do(bulkdensitylexerLexerInit)
}

// NewBulkDensityLexer produces a new lexer instance for the optional input antlr.CharStream.
func NewBulkDensityLexer(input antlr.CharStream) *BulkDensityLexer {
	BulkDensityLexerInit()
	l := new(BulkDensityLexer)
	...
	l.GrammarFileName = "BulkDensity.g4"
	// TODO: l.EOF = antlr.TokenEOF

	return l
}

// BulkDensityLexer tokens.
const (
	BulkDensityLexerBULKDENSITY = 1
	BulkDensityLexerOWNKEY      = 2
	BulkDensityLexerSPLITKEY    = 3
	BulkDensityLexerWS          = 4
)
