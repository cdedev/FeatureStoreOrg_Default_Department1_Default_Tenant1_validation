...
var fourglexerLexerStaticData struct {
	once                   sync.Once
	serializedATN          []int32
	channelNames           []string
	modeNames              []string
...
func fourglexerLexerInit() {
	staticData := &fourglexerLexerStaticData
...
// FourGLexerInit initializes any static state used to implement FourGLexer. By default the
// static state used to implement the lexer is lazily initialized during the first call to
// NewFourGLexer(). You can call this function if you wish to initialize the static state ahead
// of time.
func FourGLexerInit() {
	staticData := &fourglexerLexerStaticData
	staticData.once.Do(fourglexerLexerInit)
}

// NewFourGLexer produces a new lexer instance for the optional input antlr.CharStream.
func NewFourGLexer(input antlr.CharStream) *FourGLexer {
	FourGLexerInit()
	l := new(FourGLexer)
