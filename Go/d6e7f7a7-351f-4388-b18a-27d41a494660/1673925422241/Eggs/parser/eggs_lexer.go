...
var eggslexerLexerStaticData struct {
	once                   sync.Once
	serializedATN          []int32
	channelNames           []string
	modeNames              []string
...
func eggslexerLexerInit() {
	staticData := &eggslexerLexerStaticData
...
// EggsLexerInit initializes any static state used to implement EggsLexer. By default the
// static state used to implement the lexer is lazily initialized during the first call to
// NewEggsLexer(). You can call this function if you wish to initialize the static state ahead
// of time.
func EggsLexerInit() {
	staticData := &eggslexerLexerStaticData
	staticData.once.Do(eggslexerLexerInit)
}

// NewEggsLexer produces a new lexer instance for the optional input antlr.CharStream.
func NewEggsLexer(input antlr.CharStream) *EggsLexer {
	EggsLexerInit()
	l := new(EggsLexer)
