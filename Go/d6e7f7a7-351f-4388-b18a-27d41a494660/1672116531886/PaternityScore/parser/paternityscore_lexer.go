...
type PaternityScoreLexer struct {
	*antlr.BaseLexer
	channelNames []string
	modeNames    []string
	// TODO: EOF string
...
var paternityscorelexerLexerStaticData struct {
	once                   sync.Once
	serializedATN          []int32
	channelNames           []string
	modeNames              []string
...
func paternityscorelexerLexerInit() {
	staticData := &paternityscorelexerLexerStaticData
...
// PaternityScoreLexerInit initializes any static state used to implement PaternityScoreLexer. By default the
// static state used to implement the lexer is lazily initialized during the first call to
// NewPaternityScoreLexer(). You can call this function if you wish to initialize the static state ahead
// of time.
func PaternityScoreLexerInit() {
	staticData := &paternityscorelexerLexerStaticData
	staticData.once.Do(paternityscorelexerLexerInit)
}

// NewPaternityScoreLexer produces a new lexer instance for the optional input antlr.CharStream.
func NewPaternityScoreLexer(input antlr.CharStream) *PaternityScoreLexer {
	PaternityScoreLexerInit()
	l := new(PaternityScoreLexer)
	...
	l.GrammarFileName = "PaternityScore.g4"
	// TODO: l.EOF = antlr.TokenEOF

	return l
}

// PaternityScoreLexer tokens.
const (
	PaternityScoreLexerPATERNITYSCORE = 1
	PaternityScoreLexerOWNKEY         = 2
	PaternityScoreLexerSPLITKEY       = 3
	PaternityScoreLexerWS             = 4
)
