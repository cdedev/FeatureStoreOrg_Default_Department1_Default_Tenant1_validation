...
var co2emissionslexerLexerStaticData struct {
	once                   sync.Once
	serializedATN          []int32
	channelNames           []string
	modeNames              []string
...
func co2emissionslexerLexerInit() {
	staticData := &co2emissionslexerLexerStaticData
...
// CO2EmissionsLexerInit initializes any static state used to implement CO2EmissionsLexer. By default the
// static state used to implement the lexer is lazily initialized during the first call to
// NewCO2EmissionsLexer(). You can call this function if you wish to initialize the static state ahead
// of time.
func CO2EmissionsLexerInit() {
	staticData := &co2emissionslexerLexerStaticData
	staticData.once.Do(co2emissionslexerLexerInit)
}

// NewCO2EmissionsLexer produces a new lexer instance for the optional input antlr.CharStream.
func NewCO2EmissionsLexer(input antlr.CharStream) *CO2EmissionsLexer {
	CO2EmissionsLexerInit()
	l := new(CO2EmissionsLexer)
	...
	l.GrammarFileName = "CO2Emissions.g4"
	// TODO: l.EOF = antlr.TokenEOF

	return l
}

// CO2EmissionsLexer tokens.
const (
	CO2EmissionsLexerCO2EMISSIONS = 1
	CO2EmissionsLexerOWNKEY       = 2
	CO2EmissionsLexerSPLITKEY     = 3
	CO2EmissionsLexerWS           = 4
)
