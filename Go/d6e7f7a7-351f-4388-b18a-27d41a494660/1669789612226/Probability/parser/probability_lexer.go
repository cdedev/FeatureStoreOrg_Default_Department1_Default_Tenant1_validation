...
var probabilitylexerLexerStaticData struct {
	once                   sync.Once
	serializedATN          []int32
	channelNames           []string
	modeNames              []string
...
func probabilitylexerLexerInit() {
	staticData := &probabilitylexerLexerStaticData
...
// ProbabilityLexerInit initializes any static state used to implement ProbabilityLexer. By default the
// static state used to implement the lexer is lazily initialized during the first call to
// NewProbabilityLexer(). You can call this function if you wish to initialize the static state ahead
// of time.
func ProbabilityLexerInit() {
	staticData := &probabilitylexerLexerStaticData
	staticData.once.Do(probabilitylexerLexerInit)
}

// NewProbabilityLexer produces a new lexer instance for the optional input antlr.CharStream.
func NewProbabilityLexer(input antlr.CharStream) *ProbabilityLexer {
	ProbabilityLexerInit()
	l := new(ProbabilityLexer)
	...
	l.GrammarFileName = "Probability.g4"
	// TODO: l.EOF = antlr.TokenEOF

	return l
}

// ProbabilityLexer tokens.
const (
	ProbabilityLexerPROBABILITY = 1
	ProbabilityLexerOWNKEY      = 2
	ProbabilityLexerSPLITKEY    = 3
	ProbabilityLexerWS          = 4
)
