...
type SulphurdioxideLexer struct {
	*antlr.BaseLexer
	channelNames []string
	modeNames    []string
	// TODO: EOF string
...
var sulphurdioxidelexerLexerStaticData struct {
	once                   sync.Once
	serializedATN          []int32
	channelNames           []string
	modeNames              []string
...
func sulphurdioxidelexerLexerInit() {
	staticData := &sulphurdioxidelexerLexerStaticData
...
// SulphurdioxideLexerInit initializes any static state used to implement SulphurdioxideLexer. By default the
// static state used to implement the lexer is lazily initialized during the first call to
// NewSulphurdioxideLexer(). You can call this function if you wish to initialize the static state ahead
// of time.
func SulphurdioxideLexerInit() {
	staticData := &sulphurdioxidelexerLexerStaticData
	staticData.once.Do(sulphurdioxidelexerLexerInit)
}

// NewSulphurdioxideLexer produces a new lexer instance for the optional input antlr.CharStream.
func NewSulphurdioxideLexer(input antlr.CharStream) *SulphurdioxideLexer {
	SulphurdioxideLexerInit()
	l := new(SulphurdioxideLexer)
	...
	l.GrammarFileName = "Sulphurdioxide.g4"
	// TODO: l.EOF = antlr.TokenEOF

	return l
}

// SulphurdioxideLexer tokens.
const (
	SulphurdioxideLexerSULPHURDIOXIDE = 1
	SulphurdioxideLexerOWNKEY         = 2
	SulphurdioxideLexerSPLITKEY       = 3
	SulphurdioxideLexerWS             = 4
)
