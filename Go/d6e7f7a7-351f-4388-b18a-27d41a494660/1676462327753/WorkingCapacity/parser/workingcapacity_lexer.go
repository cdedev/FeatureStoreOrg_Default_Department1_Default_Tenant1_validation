...
type WorkingCapacityLexer struct {
	*antlr.BaseLexer
	channelNames []string
	modeNames    []string
	// TODO: EOF string
...
var workingcapacitylexerLexerStaticData struct {
	once                   sync.Once
	serializedATN          []int32
	channelNames           []string
	modeNames              []string
...
func workingcapacitylexerLexerInit() {
	staticData := &workingcapacitylexerLexerStaticData
...
// WorkingCapacityLexerInit initializes any static state used to implement WorkingCapacityLexer. By default the
// static state used to implement the lexer is lazily initialized during the first call to
// NewWorkingCapacityLexer(). You can call this function if you wish to initialize the static state ahead
// of time.
func WorkingCapacityLexerInit() {
	staticData := &workingcapacitylexerLexerStaticData
	staticData.once.Do(workingcapacitylexerLexerInit)
}

// NewWorkingCapacityLexer produces a new lexer instance for the optional input antlr.CharStream.
func NewWorkingCapacityLexer(input antlr.CharStream) *WorkingCapacityLexer {
	WorkingCapacityLexerInit()
	l := new(WorkingCapacityLexer)
	...
	l.GrammarFileName = "WorkingCapacity.g4"
	// TODO: l.EOF = antlr.TokenEOF

	return l
}

// WorkingCapacityLexer tokens.
const (
	WorkingCapacityLexerWORKINGCAPACITY = 1
	WorkingCapacityLexerOWNKEY          = 2
	WorkingCapacityLexerSPLITKEY        = 3
	WorkingCapacityLexerWS              = 4
)
