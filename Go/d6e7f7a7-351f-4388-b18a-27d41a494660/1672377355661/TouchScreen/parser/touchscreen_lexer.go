...
var touchscreenlexerLexerStaticData struct {
	once                   sync.Once
	serializedATN          []int32
	channelNames           []string
	modeNames              []string
...
func touchscreenlexerLexerInit() {
	staticData := &touchscreenlexerLexerStaticData
...
// TouchScreenLexerInit initializes any static state used to implement TouchScreenLexer. By default the
// static state used to implement the lexer is lazily initialized during the first call to
// NewTouchScreenLexer(). You can call this function if you wish to initialize the static state ahead
// of time.
func TouchScreenLexerInit() {
	staticData := &touchscreenlexerLexerStaticData
	staticData.once.Do(touchscreenlexerLexerInit)
}

// NewTouchScreenLexer produces a new lexer instance for the optional input antlr.CharStream.
func NewTouchScreenLexer(input antlr.CharStream) *TouchScreenLexer {
	TouchScreenLexerInit()
	l := new(TouchScreenLexer)
	...
	l.GrammarFileName = "TouchScreen.g4"
	// TODO: l.EOF = antlr.TokenEOF

	return l
}

// TouchScreenLexer tokens.
const (
	TouchScreenLexerTOUCHSCREEN = 1
	TouchScreenLexerOWNKEY      = 2
	TouchScreenLexerSPLITKEY    = 3
	TouchScreenLexerWS          = 4
)
