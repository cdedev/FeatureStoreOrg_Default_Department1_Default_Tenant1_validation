...
var dollarvaluelexerLexerStaticData struct {
	once                   sync.Once
	serializedATN          []int32
	channelNames           []string
	modeNames              []string
...
func dollarvaluelexerLexerInit() {
	staticData := &dollarvaluelexerLexerStaticData
...
// DollarValueLexerInit initializes any static state used to implement DollarValueLexer. By default the
// static state used to implement the lexer is lazily initialized during the first call to
// NewDollarValueLexer(). You can call this function if you wish to initialize the static state ahead
// of time.
func DollarValueLexerInit() {
	staticData := &dollarvaluelexerLexerStaticData
	staticData.once.Do(dollarvaluelexerLexerInit)
}

// NewDollarValueLexer produces a new lexer instance for the optional input antlr.CharStream.
func NewDollarValueLexer(input antlr.CharStream) *DollarValueLexer {
	DollarValueLexerInit()
	l := new(DollarValueLexer)
	...
	l.GrammarFileName = "DollarValue.g4"
	// TODO: l.EOF = antlr.TokenEOF

	return l
}

// DollarValueLexer tokens.
const (
	DollarValueLexerDOLLARVALUE = 1
	DollarValueLexerOWNKEY      = 2
	DollarValueLexerSPLITKEY    = 3
	DollarValueLexerWS          = 4
)
