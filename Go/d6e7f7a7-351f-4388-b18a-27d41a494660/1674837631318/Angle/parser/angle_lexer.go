// Code generated from /usr/local/lib/Go/d6e7f7a7-351f-4388-b18a-27d41a494660/1674837631318/Angle.g4 by ANTLR 4.10.1. DO NOT EDIT.
...
var anglelexerLexerStaticData struct {
	once                   sync.Once
	serializedATN          []int32
	channelNames           []string
	modeNames              []string
...
func anglelexerLexerInit() {
	staticData := &anglelexerLexerStaticData
...
// AngleLexerInit initializes any static state used to implement AngleLexer. By default the
// static state used to implement the lexer is lazily initialized during the first call to
// NewAngleLexer(). You can call this function if you wish to initialize the static state ahead
// of time.
func AngleLexerInit() {
	staticData := &anglelexerLexerStaticData
	staticData.once.Do(anglelexerLexerInit)
}

// NewAngleLexer produces a new lexer instance for the optional input antlr.CharStream.
func NewAngleLexer(input antlr.CharStream) *AngleLexer {
	AngleLexerInit()
	l := new(AngleLexer)
