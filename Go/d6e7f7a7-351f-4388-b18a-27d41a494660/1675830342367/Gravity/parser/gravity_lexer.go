...
var gravitylexerLexerStaticData struct {
	once                   sync.Once
	serializedATN          []int32
	channelNames           []string
	modeNames              []string
...
func gravitylexerLexerInit() {
	staticData := &gravitylexerLexerStaticData
...
// GravityLexerInit initializes any static state used to implement GravityLexer. By default the
// static state used to implement the lexer is lazily initialized during the first call to
// NewGravityLexer(). You can call this function if you wish to initialize the static state ahead
// of time.
func GravityLexerInit() {
	staticData := &gravitylexerLexerStaticData
	staticData.once.Do(gravitylexerLexerInit)
}

// NewGravityLexer produces a new lexer instance for the optional input antlr.CharStream.
func NewGravityLexer(input antlr.CharStream) *GravityLexer {
	GravityLexerInit()
	l := new(GravityLexer)
...
// GravityLexer tokens.
const (
	GravityLexerGRAVITY  = 1
	GravityLexerOWNKEY   = 2
	GravityLexerSPLITKEY = 3
	GravityLexerWS       = 4
)
