...
var infectedlexerLexerStaticData struct {
	once                   sync.Once
	serializedATN          []int32
	channelNames           []string
	modeNames              []string
...
func infectedlexerLexerInit() {
	staticData := &infectedlexerLexerStaticData
...
// InfectedLexerInit initializes any static state used to implement InfectedLexer. By default the
// static state used to implement the lexer is lazily initialized during the first call to
// NewInfectedLexer(). You can call this function if you wish to initialize the static state ahead
// of time.
func InfectedLexerInit() {
	staticData := &infectedlexerLexerStaticData
	staticData.once.Do(infectedlexerLexerInit)
}

// NewInfectedLexer produces a new lexer instance for the optional input antlr.CharStream.
func NewInfectedLexer(input antlr.CharStream) *InfectedLexer {
	InfectedLexerInit()
	l := new(InfectedLexer)
	...
	l.GrammarFileName = "Infected.g4"
	// TODO: l.EOF = antlr.TokenEOF

	return l
}

// InfectedLexer tokens.
const (
	InfectedLexerINFECTED = 1
	InfectedLexerOWNKEY   = 2
	InfectedLexerSPLITKEY = 3
	InfectedLexerWS       = 4
)
