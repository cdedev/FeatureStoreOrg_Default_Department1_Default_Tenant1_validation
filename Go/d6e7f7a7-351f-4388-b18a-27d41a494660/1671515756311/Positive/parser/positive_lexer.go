...
var positivelexerLexerStaticData struct {
	once                   sync.Once
	serializedATN          []int32
	channelNames           []string
	modeNames              []string
...
func positivelexerLexerInit() {
	staticData := &positivelexerLexerStaticData
...
// PositiveLexerInit initializes any static state used to implement PositiveLexer. By default the
// static state used to implement the lexer is lazily initialized during the first call to
// NewPositiveLexer(). You can call this function if you wish to initialize the static state ahead
// of time.
func PositiveLexerInit() {
	staticData := &positivelexerLexerStaticData
	staticData.once.Do(positivelexerLexerInit)
}

// NewPositiveLexer produces a new lexer instance for the optional input antlr.CharStream.
func NewPositiveLexer(input antlr.CharStream) *PositiveLexer {
	PositiveLexerInit()
	l := new(PositiveLexer)
	...
	l.GrammarFileName = "Positive.g4"
	// TODO: l.EOF = antlr.TokenEOF

	return l
}

// PositiveLexer tokens.
const (
	PositiveLexerPOSITIVE = 1
	PositiveLexerOWNKEY   = 2
	PositiveLexerSPLITKEY = 3
	PositiveLexerWS       = 4
)
