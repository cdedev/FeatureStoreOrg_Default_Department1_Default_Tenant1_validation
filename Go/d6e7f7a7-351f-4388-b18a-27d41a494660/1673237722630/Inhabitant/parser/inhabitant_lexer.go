...
var inhabitantlexerLexerStaticData struct {
	once                   sync.Once
	serializedATN          []int32
	channelNames           []string
	modeNames              []string
...
func inhabitantlexerLexerInit() {
	staticData := &inhabitantlexerLexerStaticData
...
// InhabitantLexerInit initializes any static state used to implement InhabitantLexer. By default the
// static state used to implement the lexer is lazily initialized during the first call to
// NewInhabitantLexer(). You can call this function if you wish to initialize the static state ahead
// of time.
func InhabitantLexerInit() {
	staticData := &inhabitantlexerLexerStaticData
	staticData.once.Do(inhabitantlexerLexerInit)
}

// NewInhabitantLexer produces a new lexer instance for the optional input antlr.CharStream.
func NewInhabitantLexer(input antlr.CharStream) *InhabitantLexer {
	InhabitantLexerInit()
	l := new(InhabitantLexer)
	...
	l.GrammarFileName = "Inhabitant.g4"
	// TODO: l.EOF = antlr.TokenEOF

	return l
}

// InhabitantLexer tokens.
const (
	InhabitantLexerINHABITANT = 1
	InhabitantLexerOWNKEY     = 2
	InhabitantLexerSPLITKEY   = 3
	InhabitantLexerWS         = 4
)
