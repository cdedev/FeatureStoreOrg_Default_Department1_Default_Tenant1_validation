...
var orderdatelexerLexerStaticData struct {
	once                   sync.Once
	serializedATN          []int32
	channelNames           []string
	modeNames              []string
...
func orderdatelexerLexerInit() {
	staticData := &orderdatelexerLexerStaticData
...
// OrderDateLexerInit initializes any static state used to implement OrderDateLexer. By default the
// static state used to implement the lexer is lazily initialized during the first call to
// NewOrderDateLexer(). You can call this function if you wish to initialize the static state ahead
// of time.
func OrderDateLexerInit() {
	staticData := &orderdatelexerLexerStaticData
	staticData.once.Do(orderdatelexerLexerInit)
}

// NewOrderDateLexer produces a new lexer instance for the optional input antlr.CharStream.
func NewOrderDateLexer(input antlr.CharStream) *OrderDateLexer {
	OrderDateLexerInit()
	l := new(OrderDateLexer)
	...
	l.GrammarFileName = "OrderDate.g4"
	// TODO: l.EOF = antlr.TokenEOF

	return l
}

// OrderDateLexer tokens.
const (
	OrderDateLexerORDERDATE = 1
	OrderDateLexerOWNKEY    = 2
	OrderDateLexerSPLITKEY  = 3
	OrderDateLexerWS        = 4
)
