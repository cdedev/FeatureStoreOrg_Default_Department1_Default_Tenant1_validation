...
var rolllexerLexerStaticData struct {
	once                   sync.Once
	serializedATN          []int32
	channelNames           []string
	modeNames              []string
...
func rolllexerLexerInit() {
	staticData := &rolllexerLexerStaticData
...
// RollLexerInit initializes any static state used to implement RollLexer. By default the
// static state used to implement the lexer is lazily initialized during the first call to
// NewRollLexer(). You can call this function if you wish to initialize the static state ahead
// of time.
func RollLexerInit() {
	staticData := &rolllexerLexerStaticData
	staticData.once.Do(rolllexerLexerInit)
}

// NewRollLexer produces a new lexer instance for the optional input antlr.CharStream.
func NewRollLexer(input antlr.CharStream) *RollLexer {
	RollLexerInit()
	l := new(RollLexer)
