...
var nauseavomitlexerLexerStaticData struct {
	once                   sync.Once
	serializedATN          []int32
	channelNames           []string
	modeNames              []string
...
func nauseavomitlexerLexerInit() {
	staticData := &nauseavomitlexerLexerStaticData
...
// NauseavomitLexerInit initializes any static state used to implement NauseavomitLexer. By default the
// static state used to implement the lexer is lazily initialized during the first call to
// NewNauseavomitLexer(). You can call this function if you wish to initialize the static state ahead
// of time.
func NauseavomitLexerInit() {
	staticData := &nauseavomitlexerLexerStaticData
	staticData.once.Do(nauseavomitlexerLexerInit)
}

// NewNauseavomitLexer produces a new lexer instance for the optional input antlr.CharStream.
func NewNauseavomitLexer(input antlr.CharStream) *NauseavomitLexer {
	NauseavomitLexerInit()
	l := new(NauseavomitLexer)
	...
	l.GrammarFileName = "Nauseavomit.g4"
	// TODO: l.EOF = antlr.TokenEOF

	return l
}

// NauseavomitLexer tokens.
const (
	NauseavomitLexerNAUSEAVOMIT = 1
	NauseavomitLexerOWNKEY      = 2
	NauseavomitLexerSPLITKEY    = 3
	NauseavomitLexerWS          = 4
)
