...
var clonesizelexerLexerStaticData struct {
	once                   sync.Once
	serializedATN          []int32
	channelNames           []string
	modeNames              []string
...
func clonesizelexerLexerInit() {
	staticData := &clonesizelexerLexerStaticData
...
// CloneSizeLexerInit initializes any static state used to implement CloneSizeLexer. By default the
// static state used to implement the lexer is lazily initialized during the first call to
// NewCloneSizeLexer(). You can call this function if you wish to initialize the static state ahead
// of time.
func CloneSizeLexerInit() {
	staticData := &clonesizelexerLexerStaticData
	staticData.once.Do(clonesizelexerLexerInit)
}

// NewCloneSizeLexer produces a new lexer instance for the optional input antlr.CharStream.
func NewCloneSizeLexer(input antlr.CharStream) *CloneSizeLexer {
	CloneSizeLexerInit()
	l := new(CloneSizeLexer)
	...
	l.GrammarFileName = "CloneSize.g4"
	// TODO: l.EOF = antlr.TokenEOF

	return l
}

// CloneSizeLexer tokens.
const (
	CloneSizeLexerCLONESIZE = 1
	CloneSizeLexerOWNKEY    = 2
	CloneSizeLexerSPLITKEY  = 3
	CloneSizeLexerWS        = 4
)
