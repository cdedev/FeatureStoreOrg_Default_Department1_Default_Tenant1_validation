...
var engine_powerlexerLexerStaticData struct {
	once                   sync.Once
	serializedATN          []int32
	channelNames           []string
	modeNames              []string
...
func engine_powerlexerLexerInit() {
	staticData := &engine_powerlexerLexerStaticData
...
// Engine_PowerLexerInit initializes any static state used to implement Engine_PowerLexer. By default the
// static state used to implement the lexer is lazily initialized during the first call to
// NewEngine_PowerLexer(). You can call this function if you wish to initialize the static state ahead
// of time.
func Engine_PowerLexerInit() {
	staticData := &engine_powerlexerLexerStaticData
	staticData.once.Do(engine_powerlexerLexerInit)
}

// NewEngine_PowerLexer produces a new lexer instance for the optional input antlr.CharStream.
func NewEngine_PowerLexer(input antlr.CharStream) *Engine_PowerLexer {
	Engine_PowerLexerInit()
	l := new(Engine_PowerLexer)
	...
	l.GrammarFileName = "Engine_Power.g4"
	// TODO: l.EOF = antlr.TokenEOF

	return l
}

// Engine_PowerLexer tokens.
const (
	Engine_PowerLexerENGINE_POWER = 1
	Engine_PowerLexerOWNKEY       = 2
	Engine_PowerLexerSPLITKEY     = 3
	Engine_PowerLexerWS           = 4
)
