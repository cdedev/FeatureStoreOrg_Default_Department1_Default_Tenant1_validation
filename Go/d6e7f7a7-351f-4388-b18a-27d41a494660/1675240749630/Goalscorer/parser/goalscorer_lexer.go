...
var goalscorerlexerLexerStaticData struct {
	once                   sync.Once
	serializedATN          []int32
	channelNames           []string
	modeNames              []string
...
func goalscorerlexerLexerInit() {
	staticData := &goalscorerlexerLexerStaticData
...
// GoalscorerLexerInit initializes any static state used to implement GoalscorerLexer. By default the
// static state used to implement the lexer is lazily initialized during the first call to
// NewGoalscorerLexer(). You can call this function if you wish to initialize the static state ahead
// of time.
func GoalscorerLexerInit() {
	staticData := &goalscorerlexerLexerStaticData
	staticData.once.Do(goalscorerlexerLexerInit)
}

// NewGoalscorerLexer produces a new lexer instance for the optional input antlr.CharStream.
func NewGoalscorerLexer(input antlr.CharStream) *GoalscorerLexer {
	GoalscorerLexerInit()
	l := new(GoalscorerLexer)
	...
	l.GrammarFileName = "Goalscorer.g4"
	// TODO: l.EOF = antlr.TokenEOF

	return l
}

// GoalscorerLexer tokens.
const (
	GoalscorerLexerGOALSCORER = 1
	GoalscorerLexerOWNKEY     = 2
	GoalscorerLexerSPLITKEY   = 3
	GoalscorerLexerWS         = 4
)
