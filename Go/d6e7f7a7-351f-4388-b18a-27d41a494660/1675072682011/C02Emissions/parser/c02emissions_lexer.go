...
var c02emissionslexerLexerStaticData struct {
	once                   sync.Once
	serializedATN          []int32
	channelNames           []string
	modeNames              []string
...
func c02emissionslexerLexerInit() {
	staticData := &c02emissionslexerLexerStaticData
...
// C02EmissionsLexerInit initializes any static state used to implement C02EmissionsLexer. By default the
// static state used to implement the lexer is lazily initialized during the first call to
// NewC02EmissionsLexer(). You can call this function if you wish to initialize the static state ahead
// of time.
func C02EmissionsLexerInit() {
	staticData := &c02emissionslexerLexerStaticData
	staticData.once.Do(c02emissionslexerLexerInit)
}

// NewC02EmissionsLexer produces a new lexer instance for the optional input antlr.CharStream.
func NewC02EmissionsLexer(input antlr.CharStream) *C02EmissionsLexer {
	C02EmissionsLexerInit()
	l := new(C02EmissionsLexer)
	...
	l.GrammarFileName = "C02Emissions.g4"
	// TODO: l.EOF = antlr.TokenEOF

	return l
}

// C02EmissionsLexer tokens.
const (
	C02EmissionsLexerC02EMISSIONS = 1
	C02EmissionsLexerOWNKEY       = 2
	C02EmissionsLexerSPLITKEY     = 3
	C02EmissionsLexerWS           = 4
)
