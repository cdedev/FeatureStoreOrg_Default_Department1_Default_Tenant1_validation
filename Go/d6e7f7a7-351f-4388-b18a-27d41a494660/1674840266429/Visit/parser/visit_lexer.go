...
var visitlexerLexerStaticData struct {
	once                   sync.Once
	serializedATN          []int32
	channelNames           []string
	modeNames              []string
...
func visitlexerLexerInit() {
	staticData := &visitlexerLexerStaticData
...
// VisitLexerInit initializes any static state used to implement VisitLexer. By default the
// static state used to implement the lexer is lazily initialized during the first call to
// NewVisitLexer(). You can call this function if you wish to initialize the static state ahead
// of time.
func VisitLexerInit() {
	staticData := &visitlexerLexerStaticData
	staticData.once.Do(visitlexerLexerInit)
}

// NewVisitLexer produces a new lexer instance for the optional input antlr.CharStream.
func NewVisitLexer(input antlr.CharStream) *VisitLexer {
	VisitLexerInit()
	l := new(VisitLexer)
