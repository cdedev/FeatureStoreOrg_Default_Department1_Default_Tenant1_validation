...
var visuallexerLexerStaticData struct {
	once                   sync.Once
	serializedATN          []int32
	channelNames           []string
	modeNames              []string
...
func visuallexerLexerInit() {
	staticData := &visuallexerLexerStaticData
	...
	staticData.serializedATN = []int32{
		...
		0, 4, 1, 1, 3, 2, 5, 3, 7, 4, 1, 0, 2, 1, 0, 48, 52, 3, 0, 9, 10, 13, 13,
...
// VisualLexerInit initializes any static state used to implement VisualLexer. By default the
// static state used to implement the lexer is lazily initialized during the first call to
// NewVisualLexer(). You can call this function if you wish to initialize the static state ahead
// of time.
func VisualLexerInit() {
	staticData := &visuallexerLexerStaticData
	staticData.once.Do(visuallexerLexerInit)
}

// NewVisualLexer produces a new lexer instance for the optional input antlr.CharStream.
func NewVisualLexer(input antlr.CharStream) *VisualLexer {
	VisualLexerInit()
	l := new(VisualLexer)
