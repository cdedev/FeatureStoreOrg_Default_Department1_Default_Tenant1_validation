...
var rapelegacylexerLexerStaticData struct {
	once                   sync.Once
	serializedATN          []int32
	channelNames           []string
	modeNames              []string
...
func rapelegacylexerLexerInit() {
	staticData := &rapelegacylexerLexerStaticData
...
// RapeLegacyLexerInit initializes any static state used to implement RapeLegacyLexer. By default the
// static state used to implement the lexer is lazily initialized during the first call to
// NewRapeLegacyLexer(). You can call this function if you wish to initialize the static state ahead
// of time.
func RapeLegacyLexerInit() {
	staticData := &rapelegacylexerLexerStaticData
	staticData.once.Do(rapelegacylexerLexerInit)
}

// NewRapeLegacyLexer produces a new lexer instance for the optional input antlr.CharStream.
func NewRapeLegacyLexer(input antlr.CharStream) *RapeLegacyLexer {
	RapeLegacyLexerInit()
	l := new(RapeLegacyLexer)
	...
	l.GrammarFileName = "RapeLegacy.g4"
	// TODO: l.EOF = antlr.TokenEOF

	return l
}

// RapeLegacyLexer tokens.
const (
	RapeLegacyLexerRAPELEGACY = 1
	RapeLegacyLexerOWNKEY     = 2
	RapeLegacyLexerSPLITKEY   = 3
	RapeLegacyLexerWS         = 4
)
