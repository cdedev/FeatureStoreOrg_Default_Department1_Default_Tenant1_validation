...
type PoliticalContextLexer struct {
	*antlr.BaseLexer
	channelNames []string
	modeNames    []string
	// TODO: EOF string
...
var politicalcontextlexerLexerStaticData struct {
	once                   sync.Once
	serializedATN          []int32
	channelNames           []string
	modeNames              []string
...
func politicalcontextlexerLexerInit() {
	staticData := &politicalcontextlexerLexerStaticData
...
// PoliticalContextLexerInit initializes any static state used to implement PoliticalContextLexer. By default the
// static state used to implement the lexer is lazily initialized during the first call to
// NewPoliticalContextLexer(). You can call this function if you wish to initialize the static state ahead
// of time.
func PoliticalContextLexerInit() {
	staticData := &politicalcontextlexerLexerStaticData
	staticData.once.Do(politicalcontextlexerLexerInit)
}

// NewPoliticalContextLexer produces a new lexer instance for the optional input antlr.CharStream.
func NewPoliticalContextLexer(input antlr.CharStream) *PoliticalContextLexer {
	PoliticalContextLexerInit()
	l := new(PoliticalContextLexer)
	...
	l.GrammarFileName = "PoliticalContext.g4"
	// TODO: l.EOF = antlr.TokenEOF

	return l
}

// PoliticalContextLexer tokens.
const (
	PoliticalContextLexerPOLITICALCONTEXT = 1
	PoliticalContextLexerOWNKEY           = 2
	PoliticalContextLexerSPLITKEY         = 3
	PoliticalContextLexerWS               = 4
)
