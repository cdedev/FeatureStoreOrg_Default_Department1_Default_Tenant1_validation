...
var prodyearlexerLexerStaticData struct {
	once                   sync.Once
	serializedATN          []int32
	channelNames           []string
	modeNames              []string
...
func prodyearlexerLexerInit() {
	staticData := &prodyearlexerLexerStaticData
...
// ProdYearLexerInit initializes any static state used to implement ProdYearLexer. By default the
// static state used to implement the lexer is lazily initialized during the first call to
// NewProdYearLexer(). You can call this function if you wish to initialize the static state ahead
// of time.
func ProdYearLexerInit() {
	staticData := &prodyearlexerLexerStaticData
	staticData.once.Do(prodyearlexerLexerInit)
}

// NewProdYearLexer produces a new lexer instance for the optional input antlr.CharStream.
func NewProdYearLexer(input antlr.CharStream) *ProdYearLexer {
	ProdYearLexerInit()
	l := new(ProdYearLexer)
	...
	l.GrammarFileName = "ProdYear.g4"
	// TODO: l.EOF = antlr.TokenEOF

	return l
}

// ProdYearLexer tokens.
const (
	ProdYearLexerPRODYEAR = 1
	ProdYearLexerOWNKEY   = 2
	ProdYearLexerSPLITKEY = 3
	ProdYearLexerWS       = 4
)
