...
var equationlexerLexerStaticData struct {
	once                   sync.Once
	serializedATN          []int32
	channelNames           []string
	modeNames              []string
...
func equationlexerLexerInit() {
	staticData := &equationlexerLexerStaticData
...
// EquationLexerInit initializes any static state used to implement EquationLexer. By default the
// static state used to implement the lexer is lazily initialized during the first call to
// NewEquationLexer(). You can call this function if you wish to initialize the static state ahead
// of time.
func EquationLexerInit() {
	staticData := &equationlexerLexerStaticData
	staticData.once.Do(equationlexerLexerInit)
}

// NewEquationLexer produces a new lexer instance for the optional input antlr.CharStream.
func NewEquationLexer(input antlr.CharStream) *EquationLexer {
	EquationLexerInit()
	l := new(EquationLexer)
	...
	l.GrammarFileName = "Equation.g4"
	// TODO: l.EOF = antlr.TokenEOF

	return l
}

// EquationLexer tokens.
const (
	EquationLexerEQUATION = 1
	EquationLexerOWNKEY   = 2
	EquationLexerSPLITKEY = 3
	EquationLexerWS       = 4
)
