...
var pitchlexerLexerStaticData struct {
	once                   sync.Once
	serializedATN          []int32
	channelNames           []string
	modeNames              []string
...
func pitchlexerLexerInit() {
	staticData := &pitchlexerLexerStaticData
...
// PitchLexerInit initializes any static state used to implement PitchLexer. By default the
// static state used to implement the lexer is lazily initialized during the first call to
// NewPitchLexer(). You can call this function if you wish to initialize the static state ahead
// of time.
func PitchLexerInit() {
	staticData := &pitchlexerLexerStaticData
	staticData.once.Do(pitchlexerLexerInit)
}

// NewPitchLexer produces a new lexer instance for the optional input antlr.CharStream.
func NewPitchLexer(input antlr.CharStream) *PitchLexer {
	PitchLexerInit()
	l := new(PitchLexer)
