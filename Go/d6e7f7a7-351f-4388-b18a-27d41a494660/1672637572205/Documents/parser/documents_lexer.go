...
var documentslexerLexerStaticData struct {
	once                   sync.Once
	serializedATN          []int32
	channelNames           []string
	modeNames              []string
...
func documentslexerLexerInit() {
	staticData := &documentslexerLexerStaticData
...
// DocumentsLexerInit initializes any static state used to implement DocumentsLexer. By default the
// static state used to implement the lexer is lazily initialized during the first call to
// NewDocumentsLexer(). You can call this function if you wish to initialize the static state ahead
// of time.
func DocumentsLexerInit() {
	staticData := &documentslexerLexerStaticData
	staticData.once.Do(documentslexerLexerInit)
}

// NewDocumentsLexer produces a new lexer instance for the optional input antlr.CharStream.
func NewDocumentsLexer(input antlr.CharStream) *DocumentsLexer {
	DocumentsLexerInit()
	l := new(DocumentsLexer)
	...
	l.GrammarFileName = "Documents.g4"
	// TODO: l.EOF = antlr.TokenEOF

	return l
}

// DocumentsLexer tokens.
const (
	DocumentsLexerDOCUMENTS = 1
	DocumentsLexerOWNKEY    = 2
	DocumentsLexerSPLITKEY  = 3
	DocumentsLexerWS        = 4
)
