...
var netlosslexerLexerStaticData struct {
	once                   sync.Once
	serializedATN          []int32
	channelNames           []string
	modeNames              []string
...
func netlosslexerLexerInit() {
	staticData := &netlosslexerLexerStaticData
...
// NetLossLexerInit initializes any static state used to implement NetLossLexer. By default the
// static state used to implement the lexer is lazily initialized during the first call to
// NewNetLossLexer(). You can call this function if you wish to initialize the static state ahead
// of time.
func NetLossLexerInit() {
	staticData := &netlosslexerLexerStaticData
	staticData.once.Do(netlosslexerLexerInit)
}

// NewNetLossLexer produces a new lexer instance for the optional input antlr.CharStream.
func NewNetLossLexer(input antlr.CharStream) *NetLossLexer {
	NetLossLexerInit()
	l := new(NetLossLexer)
...
// NetLossLexer tokens.
const (
	NetLossLexerNETLOSS  = 1
	NetLossLexerOWNKEY   = 2
	NetLossLexerSPLITKEY = 3
	NetLossLexerWS       = 4
)
