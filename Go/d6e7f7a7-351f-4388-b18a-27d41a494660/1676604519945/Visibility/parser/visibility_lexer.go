...
var visibilitylexerLexerStaticData struct {
	once                   sync.Once
	serializedATN          []int32
	channelNames           []string
	modeNames              []string
...
func visibilitylexerLexerInit() {
	staticData := &visibilitylexerLexerStaticData
...
// VisibilityLexerInit initializes any static state used to implement VisibilityLexer. By default the
// static state used to implement the lexer is lazily initialized during the first call to
// NewVisibilityLexer(). You can call this function if you wish to initialize the static state ahead
// of time.
func VisibilityLexerInit() {
	staticData := &visibilitylexerLexerStaticData
	staticData.once.Do(visibilitylexerLexerInit)
}

// NewVisibilityLexer produces a new lexer instance for the optional input antlr.CharStream.
func NewVisibilityLexer(input antlr.CharStream) *VisibilityLexer {
	VisibilityLexerInit()
	l := new(VisibilityLexer)
	...
	l.GrammarFileName = "Visibility.g4"
	// TODO: l.EOF = antlr.TokenEOF

	return l
}

// VisibilityLexer tokens.
const (
	VisibilityLexerVISIBILITY = 1
	VisibilityLexerOWNKEY     = 2
	VisibilityLexerSPLITKEY   = 3
	VisibilityLexerWS         = 4
)
