...
var hypertensionlexerLexerStaticData struct {
	once                   sync.Once
	serializedATN          []int32
	channelNames           []string
	modeNames              []string
...
func hypertensionlexerLexerInit() {
	staticData := &hypertensionlexerLexerStaticData
...
// HyperTensionLexerInit initializes any static state used to implement HyperTensionLexer. By default the
// static state used to implement the lexer is lazily initialized during the first call to
// NewHyperTensionLexer(). You can call this function if you wish to initialize the static state ahead
// of time.
func HyperTensionLexerInit() {
	staticData := &hypertensionlexerLexerStaticData
	staticData.once.Do(hypertensionlexerLexerInit)
}

// NewHyperTensionLexer produces a new lexer instance for the optional input antlr.CharStream.
func NewHyperTensionLexer(input antlr.CharStream) *HyperTensionLexer {
	HyperTensionLexerInit()
	l := new(HyperTensionLexer)
	...
	l.GrammarFileName = "HyperTension.g4"
	// TODO: l.EOF = antlr.TokenEOF

	return l
}

// HyperTensionLexer tokens.
const (
	HyperTensionLexerHYPERTENSION = 1
	HyperTensionLexerOWNKEY       = 2
	HyperTensionLexerSPLITKEY     = 3
	HyperTensionLexerWS           = 4
)
