...
var populationlexerLexerStaticData struct {
	once                   sync.Once
	serializedATN          []int32
	channelNames           []string
	modeNames              []string
...
func populationlexerLexerInit() {
	staticData := &populationlexerLexerStaticData
...
// PopulationLexerInit initializes any static state used to implement PopulationLexer. By default the
// static state used to implement the lexer is lazily initialized during the first call to
// NewPopulationLexer(). You can call this function if you wish to initialize the static state ahead
// of time.
func PopulationLexerInit() {
	staticData := &populationlexerLexerStaticData
	staticData.once.Do(populationlexerLexerInit)
}

// NewPopulationLexer produces a new lexer instance for the optional input antlr.CharStream.
func NewPopulationLexer(input antlr.CharStream) *PopulationLexer {
	PopulationLexerInit()
	l := new(PopulationLexer)
	...
	l.GrammarFileName = "Population.g4"
	// TODO: l.EOF = antlr.TokenEOF

	return l
}

// PopulationLexer tokens.
const (
	PopulationLexerPOPULATION = 1
	PopulationLexerOWNKEY     = 2
	PopulationLexerSPLITKEY   = 3
	PopulationLexerWS         = 4
)
