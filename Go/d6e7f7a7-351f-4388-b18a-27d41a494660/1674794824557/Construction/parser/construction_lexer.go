...
var constructionlexerLexerStaticData struct {
	once                   sync.Once
	serializedATN          []int32
	channelNames           []string
	modeNames              []string
...
func constructionlexerLexerInit() {
	staticData := &constructionlexerLexerStaticData
...
// ConstructionLexerInit initializes any static state used to implement ConstructionLexer. By default the
// static state used to implement the lexer is lazily initialized during the first call to
// NewConstructionLexer(). You can call this function if you wish to initialize the static state ahead
// of time.
func ConstructionLexerInit() {
	staticData := &constructionlexerLexerStaticData
	staticData.once.Do(constructionlexerLexerInit)
}

// NewConstructionLexer produces a new lexer instance for the optional input antlr.CharStream.
func NewConstructionLexer(input antlr.CharStream) *ConstructionLexer {
	ConstructionLexerInit()
	l := new(ConstructionLexer)
	...
	l.GrammarFileName = "Construction.g4"
	// TODO: l.EOF = antlr.TokenEOF

	return l
}

// ConstructionLexer tokens.
const (
	ConstructionLexerCONSTRUCTION = 1
	ConstructionLexerOWNKEY       = 2
	ConstructionLexerSPLITKEY     = 3
	ConstructionLexerWS           = 4
)
