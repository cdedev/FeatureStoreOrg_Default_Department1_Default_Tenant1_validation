...
var mortgagelexerLexerStaticData struct {
	once                   sync.Once
	serializedATN          []int32
	channelNames           []string
	modeNames              []string
...
func mortgagelexerLexerInit() {
	staticData := &mortgagelexerLexerStaticData
...
// MortgageLexerInit initializes any static state used to implement MortgageLexer. By default the
// static state used to implement the lexer is lazily initialized during the first call to
// NewMortgageLexer(). You can call this function if you wish to initialize the static state ahead
// of time.
func MortgageLexerInit() {
	staticData := &mortgagelexerLexerStaticData
	staticData.once.Do(mortgagelexerLexerInit)
}

// NewMortgageLexer produces a new lexer instance for the optional input antlr.CharStream.
func NewMortgageLexer(input antlr.CharStream) *MortgageLexer {
	MortgageLexerInit()
	l := new(MortgageLexer)
	...
	l.GrammarFileName = "Mortgage.g4"
	// TODO: l.EOF = antlr.TokenEOF

	return l
}

// MortgageLexer tokens.
const (
	MortgageLexerMORTGAGE = 1
	MortgageLexerOWNKEY   = 2
	MortgageLexerSPLITKEY = 3
	MortgageLexerWS       = 4
)
