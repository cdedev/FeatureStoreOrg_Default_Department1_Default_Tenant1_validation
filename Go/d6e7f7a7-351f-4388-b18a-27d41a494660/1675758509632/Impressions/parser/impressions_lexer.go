...
var impressionslexerLexerStaticData struct {
	once                   sync.Once
	serializedATN          []int32
	channelNames           []string
	modeNames              []string
...
func impressionslexerLexerInit() {
	staticData := &impressionslexerLexerStaticData
...
// ImpressionsLexerInit initializes any static state used to implement ImpressionsLexer. By default the
// static state used to implement the lexer is lazily initialized during the first call to
// NewImpressionsLexer(). You can call this function if you wish to initialize the static state ahead
// of time.
func ImpressionsLexerInit() {
	staticData := &impressionslexerLexerStaticData
	staticData.once.Do(impressionslexerLexerInit)
}

// NewImpressionsLexer produces a new lexer instance for the optional input antlr.CharStream.
func NewImpressionsLexer(input antlr.CharStream) *ImpressionsLexer {
	ImpressionsLexerInit()
	l := new(ImpressionsLexer)
	...
	l.GrammarFileName = "Impressions.g4"
	// TODO: l.EOF = antlr.TokenEOF

	return l
}

// ImpressionsLexer tokens.
const (
	ImpressionsLexerIMPRESSIONS = 1
	ImpressionsLexerOWNKEY      = 2
	ImpressionsLexerSPLITKEY    = 3
	ImpressionsLexerWS          = 4
)
