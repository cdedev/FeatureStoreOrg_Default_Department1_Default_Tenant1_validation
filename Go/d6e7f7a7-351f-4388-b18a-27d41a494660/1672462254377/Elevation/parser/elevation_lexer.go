...
var elevationlexerLexerStaticData struct {
	once                   sync.Once
	serializedATN          []int32
	channelNames           []string
	modeNames              []string
...
func elevationlexerLexerInit() {
	staticData := &elevationlexerLexerStaticData
...
// ElevationLexerInit initializes any static state used to implement ElevationLexer. By default the
// static state used to implement the lexer is lazily initialized during the first call to
// NewElevationLexer(). You can call this function if you wish to initialize the static state ahead
// of time.
func ElevationLexerInit() {
	staticData := &elevationlexerLexerStaticData
	staticData.once.Do(elevationlexerLexerInit)
}

// NewElevationLexer produces a new lexer instance for the optional input antlr.CharStream.
func NewElevationLexer(input antlr.CharStream) *ElevationLexer {
	ElevationLexerInit()
	l := new(ElevationLexer)
	...
	l.GrammarFileName = "Elevation.g4"
	// TODO: l.EOF = antlr.TokenEOF

	return l
}

// ElevationLexer tokens.
const (
	ElevationLexerELEVATION = 1
	ElevationLexerOWNKEY    = 2
	ElevationLexerSPLITKEY  = 3
	ElevationLexerWS        = 4
)
