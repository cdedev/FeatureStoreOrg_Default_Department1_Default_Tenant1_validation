...
var predatorlexerLexerStaticData struct {
	once                   sync.Once
	serializedATN          []int32
	channelNames           []string
	modeNames              []string
...
func predatorlexerLexerInit() {
	staticData := &predatorlexerLexerStaticData
...
// PredatorLexerInit initializes any static state used to implement PredatorLexer. By default the
// static state used to implement the lexer is lazily initialized during the first call to
// NewPredatorLexer(). You can call this function if you wish to initialize the static state ahead
// of time.
func PredatorLexerInit() {
	staticData := &predatorlexerLexerStaticData
	staticData.once.Do(predatorlexerLexerInit)
}

// NewPredatorLexer produces a new lexer instance for the optional input antlr.CharStream.
func NewPredatorLexer(input antlr.CharStream) *PredatorLexer {
	PredatorLexerInit()
	l := new(PredatorLexer)
	...
	l.GrammarFileName = "Predator.g4"
	// TODO: l.EOF = antlr.TokenEOF

	return l
}

// PredatorLexer tokens.
const (
	PredatorLexerPREDATOR = 1
	PredatorLexerOWNKEY   = 2
	PredatorLexerSPLITKEY = 3
	PredatorLexerWS       = 4
)
