...
var familysizelexerLexerStaticData struct {
	once                   sync.Once
	serializedATN          []int32
	channelNames           []string
	modeNames              []string
...
func familysizelexerLexerInit() {
	staticData := &familysizelexerLexerStaticData
...
// FamilySizeLexerInit initializes any static state used to implement FamilySizeLexer. By default the
// static state used to implement the lexer is lazily initialized during the first call to
// NewFamilySizeLexer(). You can call this function if you wish to initialize the static state ahead
// of time.
func FamilySizeLexerInit() {
	staticData := &familysizelexerLexerStaticData
	staticData.once.Do(familysizelexerLexerInit)
}

// NewFamilySizeLexer produces a new lexer instance for the optional input antlr.CharStream.
func NewFamilySizeLexer(input antlr.CharStream) *FamilySizeLexer {
	FamilySizeLexerInit()
	l := new(FamilySizeLexer)
	...
	l.GrammarFileName = "FamilySize.g4"
	// TODO: l.EOF = antlr.TokenEOF

	return l
}

// FamilySizeLexer tokens.
const (
	FamilySizeLexerFAMILYSIZE = 1
	FamilySizeLexerOWNKEY     = 2
	FamilySizeLexerSPLITKEY   = 3
	FamilySizeLexerWS         = 4
)
