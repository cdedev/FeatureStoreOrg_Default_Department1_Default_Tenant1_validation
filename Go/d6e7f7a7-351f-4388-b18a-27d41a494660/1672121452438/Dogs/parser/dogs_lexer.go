...
var dogslexerLexerStaticData struct {
	once                   sync.Once
	serializedATN          []int32
	channelNames           []string
	modeNames              []string
...
func dogslexerLexerInit() {
	staticData := &dogslexerLexerStaticData
...
// DogsLexerInit initializes any static state used to implement DogsLexer. By default the
// static state used to implement the lexer is lazily initialized during the first call to
// NewDogsLexer(). You can call this function if you wish to initialize the static state ahead
// of time.
func DogsLexerInit() {
	staticData := &dogslexerLexerStaticData
	staticData.once.Do(dogslexerLexerInit)
}

// NewDogsLexer produces a new lexer instance for the optional input antlr.CharStream.
func NewDogsLexer(input antlr.CharStream) *DogsLexer {
	DogsLexerInit()
	l := new(DogsLexer)
