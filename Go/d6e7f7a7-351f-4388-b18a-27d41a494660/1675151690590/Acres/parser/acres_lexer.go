...
var acreslexerLexerStaticData struct {
	once                   sync.Once
	serializedATN          []int32
	channelNames           []string
	modeNames              []string
...
func acreslexerLexerInit() {
	staticData := &acreslexerLexerStaticData
...
// AcresLexerInit initializes any static state used to implement AcresLexer. By default the
// static state used to implement the lexer is lazily initialized during the first call to
// NewAcresLexer(). You can call this function if you wish to initialize the static state ahead
// of time.
func AcresLexerInit() {
	staticData := &acreslexerLexerStaticData
	staticData.once.Do(acreslexerLexerInit)
}

// NewAcresLexer produces a new lexer instance for the optional input antlr.CharStream.
func NewAcresLexer(input antlr.CharStream) *AcresLexer {
	AcresLexerInit()
	l := new(AcresLexer)
