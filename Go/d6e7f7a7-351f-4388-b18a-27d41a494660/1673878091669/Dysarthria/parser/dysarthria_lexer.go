...
var dysarthrialexerLexerStaticData struct {
	once                   sync.Once
	serializedATN          []int32
	channelNames           []string
	modeNames              []string
...
func dysarthrialexerLexerInit() {
	staticData := &dysarthrialexerLexerStaticData
...
// DysarthriaLexerInit initializes any static state used to implement DysarthriaLexer. By default the
// static state used to implement the lexer is lazily initialized during the first call to
// NewDysarthriaLexer(). You can call this function if you wish to initialize the static state ahead
// of time.
func DysarthriaLexerInit() {
	staticData := &dysarthrialexerLexerStaticData
	staticData.once.Do(dysarthrialexerLexerInit)
}

// NewDysarthriaLexer produces a new lexer instance for the optional input antlr.CharStream.
func NewDysarthriaLexer(input antlr.CharStream) *DysarthriaLexer {
	DysarthriaLexerInit()
	l := new(DysarthriaLexer)
	...
	l.GrammarFileName = "Dysarthria.g4"
	// TODO: l.EOF = antlr.TokenEOF

	return l
}

// DysarthriaLexer tokens.
const (
	DysarthriaLexerDYSARTHRIA = 1
	DysarthriaLexerOWNKEY     = 2
	DysarthriaLexerSPLITKEY   = 3
	DysarthriaLexerWS         = 4
)
