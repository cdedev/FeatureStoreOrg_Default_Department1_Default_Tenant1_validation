...
var elongationlexerLexerStaticData struct {
	once                   sync.Once
	serializedATN          []int32
	channelNames           []string
	modeNames              []string
...
func elongationlexerLexerInit() {
	staticData := &elongationlexerLexerStaticData
...
// ElongationLexerInit initializes any static state used to implement ElongationLexer. By default the
// static state used to implement the lexer is lazily initialized during the first call to
// NewElongationLexer(). You can call this function if you wish to initialize the static state ahead
// of time.
func ElongationLexerInit() {
	staticData := &elongationlexerLexerStaticData
	staticData.once.Do(elongationlexerLexerInit)
}

// NewElongationLexer produces a new lexer instance for the optional input antlr.CharStream.
func NewElongationLexer(input antlr.CharStream) *ElongationLexer {
	ElongationLexerInit()
	l := new(ElongationLexer)
	...
	l.GrammarFileName = "Elongation.g4"
	// TODO: l.EOF = antlr.TokenEOF

	return l
}

// ElongationLexer tokens.
const (
	ElongationLexerELONGATION = 1
	ElongationLexerOWNKEY     = 2
	ElongationLexerSPLITKEY   = 3
	ElongationLexerWS         = 4
)
