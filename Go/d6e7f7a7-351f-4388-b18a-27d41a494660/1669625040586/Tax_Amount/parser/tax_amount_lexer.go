...
var tax_amountlexerLexerStaticData struct {
	once                   sync.Once
	serializedATN          []int32
	channelNames           []string
	modeNames              []string
...
func tax_amountlexerLexerInit() {
	staticData := &tax_amountlexerLexerStaticData
...
// Tax_AmountLexerInit initializes any static state used to implement Tax_AmountLexer. By default the
// static state used to implement the lexer is lazily initialized during the first call to
// NewTax_AmountLexer(). You can call this function if you wish to initialize the static state ahead
// of time.
func Tax_AmountLexerInit() {
	staticData := &tax_amountlexerLexerStaticData
	staticData.once.Do(tax_amountlexerLexerInit)
}

// NewTax_AmountLexer produces a new lexer instance for the optional input antlr.CharStream.
func NewTax_AmountLexer(input antlr.CharStream) *Tax_AmountLexer {
	Tax_AmountLexerInit()
	l := new(Tax_AmountLexer)
	...
	l.GrammarFileName = "Tax_Amount.g4"
	// TODO: l.EOF = antlr.TokenEOF

	return l
}

// Tax_AmountLexer tokens.
const (
	Tax_AmountLexerTAX_AMOUNT = 1
	Tax_AmountLexerOWNKEY     = 2
	Tax_AmountLexerSPLITKEY   = 3
	Tax_AmountLexerWS         = 4
)
