...
var intensitylexerLexerStaticData struct {
	once                   sync.Once
	serializedATN          []int32
	channelNames           []string
	modeNames              []string
...
func intensitylexerLexerInit() {
	staticData := &intensitylexerLexerStaticData
...
// IntensityLexerInit initializes any static state used to implement IntensityLexer. By default the
// static state used to implement the lexer is lazily initialized during the first call to
// NewIntensityLexer(). You can call this function if you wish to initialize the static state ahead
// of time.
func IntensityLexerInit() {
	staticData := &intensitylexerLexerStaticData
	staticData.once.Do(intensitylexerLexerInit)
}

// NewIntensityLexer produces a new lexer instance for the optional input antlr.CharStream.
func NewIntensityLexer(input antlr.CharStream) *IntensityLexer {
	IntensityLexerInit()
	l := new(IntensityLexer)
	...
	l.GrammarFileName = "Intensity.g4"
	// TODO: l.EOF = antlr.TokenEOF

	return l
}

// IntensityLexer tokens.
const (
	IntensityLexerINTENSITY = 1
	IntensityLexerOWNKEY    = 2
	IntensityLexerSPLITKEY  = 3
	IntensityLexerWS        = 4
)
