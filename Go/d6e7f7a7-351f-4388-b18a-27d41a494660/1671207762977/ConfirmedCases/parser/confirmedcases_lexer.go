...
type ConfirmedCasesLexer struct {
	*antlr.BaseLexer
	channelNames []string
	modeNames    []string
	// TODO: EOF string
...
var confirmedcaseslexerLexerStaticData struct {
	once                   sync.Once
	serializedATN          []int32
	channelNames           []string
	modeNames              []string
...
func confirmedcaseslexerLexerInit() {
	staticData := &confirmedcaseslexerLexerStaticData
...
// ConfirmedCasesLexerInit initializes any static state used to implement ConfirmedCasesLexer. By default the
// static state used to implement the lexer is lazily initialized during the first call to
// NewConfirmedCasesLexer(). You can call this function if you wish to initialize the static state ahead
// of time.
func ConfirmedCasesLexerInit() {
	staticData := &confirmedcaseslexerLexerStaticData
	staticData.once.Do(confirmedcaseslexerLexerInit)
}

// NewConfirmedCasesLexer produces a new lexer instance for the optional input antlr.CharStream.
func NewConfirmedCasesLexer(input antlr.CharStream) *ConfirmedCasesLexer {
	ConfirmedCasesLexerInit()
	l := new(ConfirmedCasesLexer)
	...
	l.GrammarFileName = "ConfirmedCases.g4"
	// TODO: l.EOF = antlr.TokenEOF

	return l
}

// ConfirmedCasesLexer tokens.
const (
	ConfirmedCasesLexerCONFIRMEDCASES = 1
	ConfirmedCasesLexerOWNKEY         = 2
	ConfirmedCasesLexerSPLITKEY       = 3
	ConfirmedCasesLexerWS             = 4
)
