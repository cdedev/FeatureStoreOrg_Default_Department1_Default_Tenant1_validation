...
var companylexerLexerStaticData struct {
	once                   sync.Once
	serializedATN          []int32
	channelNames           []string
	modeNames              []string
...
func companylexerLexerInit() {
	staticData := &companylexerLexerStaticData
...
// CompanyLexerInit initializes any static state used to implement CompanyLexer. By default the
// static state used to implement the lexer is lazily initialized during the first call to
// NewCompanyLexer(). You can call this function if you wish to initialize the static state ahead
// of time.
func CompanyLexerInit() {
	staticData := &companylexerLexerStaticData
	staticData.once.Do(companylexerLexerInit)
}

// NewCompanyLexer produces a new lexer instance for the optional input antlr.CharStream.
func NewCompanyLexer(input antlr.CharStream) *CompanyLexer {
	CompanyLexerInit()
	l := new(CompanyLexer)
...
// CompanyLexer tokens.
const (
	CompanyLexerCOMPANY  = 1
	CompanyLexerOWNKEY   = 2
	CompanyLexerSPLITKEY = 3
	CompanyLexerWS       = 4
)
