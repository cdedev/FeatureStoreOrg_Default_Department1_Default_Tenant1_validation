...
type SequenceLengthCountLexer struct {
	*antlr.BaseLexer
	channelNames []string
	modeNames    []string
	// TODO: EOF string
...
var sequencelengthcountlexerLexerStaticData struct {
	once                   sync.Once
	serializedATN          []int32
	channelNames           []string
	modeNames              []string
...
func sequencelengthcountlexerLexerInit() {
	staticData := &sequencelengthcountlexerLexerStaticData
...
// SequenceLengthCountLexerInit initializes any static state used to implement SequenceLengthCountLexer. By default the
// static state used to implement the lexer is lazily initialized during the first call to
// NewSequenceLengthCountLexer(). You can call this function if you wish to initialize the static state ahead
// of time.
func SequenceLengthCountLexerInit() {
	staticData := &sequencelengthcountlexerLexerStaticData
	staticData.once.Do(sequencelengthcountlexerLexerInit)
}

// NewSequenceLengthCountLexer produces a new lexer instance for the optional input antlr.CharStream.
func NewSequenceLengthCountLexer(input antlr.CharStream) *SequenceLengthCountLexer {
	SequenceLengthCountLexerInit()
	l := new(SequenceLengthCountLexer)
	...
	l.GrammarFileName = "SequenceLengthCount.g4"
	// TODO: l.EOF = antlr.TokenEOF

	return l
}

// SequenceLengthCountLexer tokens.
const (
	SequenceLengthCountLexerSEQUENCELENGTHCOUNT = 1
	SequenceLengthCountLexerOWNKEY              = 2
	SequenceLengthCountLexerSPLITKEY            = 3
	SequenceLengthCountLexerWS                  = 4
)
