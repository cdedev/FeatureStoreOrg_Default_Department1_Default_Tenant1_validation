...
var entropylexerLexerStaticData struct {
	once                   sync.Once
	serializedATN          []int32
	channelNames           []string
	modeNames              []string
...
func entropylexerLexerInit() {
	staticData := &entropylexerLexerStaticData
...
// EntropyLexerInit initializes any static state used to implement EntropyLexer. By default the
// static state used to implement the lexer is lazily initialized during the first call to
// NewEntropyLexer(). You can call this function if you wish to initialize the static state ahead
// of time.
func EntropyLexerInit() {
	staticData := &entropylexerLexerStaticData
	staticData.once.Do(entropylexerLexerInit)
}

// NewEntropyLexer produces a new lexer instance for the optional input antlr.CharStream.
func NewEntropyLexer(input antlr.CharStream) *EntropyLexer {
	EntropyLexerInit()
	l := new(EntropyLexer)
...
// EntropyLexer tokens.
const (
	EntropyLexerENTROPY  = 1
	EntropyLexerOWNKEY   = 2
	EntropyLexerSPLITKEY = 3
	EntropyLexerWS       = 4
)
