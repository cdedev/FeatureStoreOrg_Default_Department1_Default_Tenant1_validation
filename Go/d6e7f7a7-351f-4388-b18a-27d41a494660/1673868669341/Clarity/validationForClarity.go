	...
	import (
		...
		"strconv"
		"strings"
		parser "FeatureStoreOrg_Default_Department1_Default_Tenant1_validation/Go/d6e7f7a7-351f-4388-b18a-27d41a494660/1673868669341/Clarity/parser"
...
CLARITY :SPLITKEY  OWNKEY ('I1'|'IF'|'SI1'|'SI2'|'VS1'|'VS2'|'VVS1'|'VVS2') ;
