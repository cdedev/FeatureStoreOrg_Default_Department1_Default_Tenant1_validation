...
var satisfactionlexerLexerStaticData struct {
	once                   sync.Once
	serializedATN          []int32
	channelNames           []string
	modeNames              []string
...
func satisfactionlexerLexerInit() {
	staticData := &satisfactionlexerLexerStaticData
...
// SatisfactionLexerInit initializes any static state used to implement SatisfactionLexer. By default the
// static state used to implement the lexer is lazily initialized during the first call to
// NewSatisfactionLexer(). You can call this function if you wish to initialize the static state ahead
// of time.
func SatisfactionLexerInit() {
	staticData := &satisfactionlexerLexerStaticData
	staticData.once.Do(satisfactionlexerLexerInit)
}

// NewSatisfactionLexer produces a new lexer instance for the optional input antlr.CharStream.
func NewSatisfactionLexer(input antlr.CharStream) *SatisfactionLexer {
	SatisfactionLexerInit()
	l := new(SatisfactionLexer)
	...
	l.GrammarFileName = "Satisfaction.g4"
	// TODO: l.EOF = antlr.TokenEOF

	return l
}

// SatisfactionLexer tokens.
const (
	SatisfactionLexerSATISFACTION = 1
	SatisfactionLexerOWNKEY       = 2
	SatisfactionLexerSPLITKEY     = 3
	SatisfactionLexerWS           = 4
)
