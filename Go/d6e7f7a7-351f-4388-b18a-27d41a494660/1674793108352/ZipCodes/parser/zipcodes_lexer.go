...
var zipcodeslexerLexerStaticData struct {
	once                   sync.Once
	serializedATN          []int32
	channelNames           []string
	modeNames              []string
...
func zipcodeslexerLexerInit() {
	staticData := &zipcodeslexerLexerStaticData
...
// ZipCodesLexerInit initializes any static state used to implement ZipCodesLexer. By default the
// static state used to implement the lexer is lazily initialized during the first call to
// NewZipCodesLexer(). You can call this function if you wish to initialize the static state ahead
// of time.
func ZipCodesLexerInit() {
	staticData := &zipcodeslexerLexerStaticData
	staticData.once.Do(zipcodeslexerLexerInit)
}

// NewZipCodesLexer produces a new lexer instance for the optional input antlr.CharStream.
func NewZipCodesLexer(input antlr.CharStream) *ZipCodesLexer {
	ZipCodesLexerInit()
	l := new(ZipCodesLexer)
	...
	l.GrammarFileName = "ZipCodes.g4"
	// TODO: l.EOF = antlr.TokenEOF

	return l
}

// ZipCodesLexer tokens.
const (
	ZipCodesLexerZIPCODES = 1
	ZipCodesLexerOWNKEY   = 2
	ZipCodesLexerSPLITKEY = 3
	ZipCodesLexerWS       = 4
)
