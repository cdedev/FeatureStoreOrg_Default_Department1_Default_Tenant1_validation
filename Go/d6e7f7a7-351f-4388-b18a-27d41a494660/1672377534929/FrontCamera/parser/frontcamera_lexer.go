...
var frontcameralexerLexerStaticData struct {
	once                   sync.Once
	serializedATN          []int32
	channelNames           []string
	modeNames              []string
...
func frontcameralexerLexerInit() {
	staticData := &frontcameralexerLexerStaticData
...
// FrontCameraLexerInit initializes any static state used to implement FrontCameraLexer. By default the
// static state used to implement the lexer is lazily initialized during the first call to
// NewFrontCameraLexer(). You can call this function if you wish to initialize the static state ahead
// of time.
func FrontCameraLexerInit() {
	staticData := &frontcameralexerLexerStaticData
	staticData.once.Do(frontcameralexerLexerInit)
}

// NewFrontCameraLexer produces a new lexer instance for the optional input antlr.CharStream.
func NewFrontCameraLexer(input antlr.CharStream) *FrontCameraLexer {
	FrontCameraLexerInit()
	l := new(FrontCameraLexer)
	...
	l.GrammarFileName = "FrontCamera.g4"
	// TODO: l.EOF = antlr.TokenEOF

	return l
}

// FrontCameraLexer tokens.
const (
	FrontCameraLexerFRONTCAMERA = 1
	FrontCameraLexerOWNKEY      = 2
	FrontCameraLexerSPLITKEY    = 3
	FrontCameraLexerWS          = 4
)
