...
var bloodoxygenlexerLexerStaticData struct {
	once                   sync.Once
	serializedATN          []int32
	channelNames           []string
	modeNames              []string
...
func bloodoxygenlexerLexerInit() {
	staticData := &bloodoxygenlexerLexerStaticData
...
// BloodOxygenLexerInit initializes any static state used to implement BloodOxygenLexer. By default the
// static state used to implement the lexer is lazily initialized during the first call to
// NewBloodOxygenLexer(). You can call this function if you wish to initialize the static state ahead
// of time.
func BloodOxygenLexerInit() {
	staticData := &bloodoxygenlexerLexerStaticData
	staticData.once.Do(bloodoxygenlexerLexerInit)
}

// NewBloodOxygenLexer produces a new lexer instance for the optional input antlr.CharStream.
func NewBloodOxygenLexer(input antlr.CharStream) *BloodOxygenLexer {
	BloodOxygenLexerInit()
	l := new(BloodOxygenLexer)
	...
	l.GrammarFileName = "BloodOxygen.g4"
	// TODO: l.EOF = antlr.TokenEOF

	return l
}

// BloodOxygenLexer tokens.
const (
	BloodOxygenLexerBLOODOXYGEN = 1
	BloodOxygenLexerOWNKEY      = 2
	BloodOxygenLexerSPLITKEY    = 3
	BloodOxygenLexerWS          = 4
)
