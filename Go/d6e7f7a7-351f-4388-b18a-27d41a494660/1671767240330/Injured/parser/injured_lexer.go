// Code generated from /usr/local/lib/Go/d6e7f7a7-351f-4388-b18a-27d41a494660/1671767240330/Injured.g4 by ANTLR 4.10.1. DO NOT EDIT.
...
var injuredlexerLexerStaticData struct {
	once                   sync.Once
	serializedATN          []int32
	channelNames           []string
	modeNames              []string
...
func injuredlexerLexerInit() {
	staticData := &injuredlexerLexerStaticData
	...
	staticData.serializedATN = []int32{
		...
		0, 4, 1, 1, 3, 2, 5, 3, 7, 4, 1, 0, 2, 1, 0, 48, 51, 3, 0, 9, 10, 13, 13,
...
// InjuredLexerInit initializes any static state used to implement InjuredLexer. By default the
// static state used to implement the lexer is lazily initialized during the first call to
// NewInjuredLexer(). You can call this function if you wish to initialize the static state ahead
// of time.
func InjuredLexerInit() {
	staticData := &injuredlexerLexerStaticData
	staticData.once.Do(injuredlexerLexerInit)
}

// NewInjuredLexer produces a new lexer instance for the optional input antlr.CharStream.
func NewInjuredLexer(input antlr.CharStream) *InjuredLexer {
	InjuredLexerInit()
	l := new(InjuredLexer)
...
// InjuredLexer tokens.
const (
	InjuredLexerINJURED  = 1
	InjuredLexerOWNKEY   = 2
	InjuredLexerSPLITKEY = 3
	InjuredLexerWS       = 4
)
