...
type BloodPressureLexer struct {
	*antlr.BaseLexer
	channelNames []string
	modeNames    []string
	// TODO: EOF string
...
var bloodpressurelexerLexerStaticData struct {
	once                   sync.Once
	serializedATN          []int32
	channelNames           []string
	modeNames              []string
...
func bloodpressurelexerLexerInit() {
	staticData := &bloodpressurelexerLexerStaticData
...
// BloodPressureLexerInit initializes any static state used to implement BloodPressureLexer. By default the
// static state used to implement the lexer is lazily initialized during the first call to
// NewBloodPressureLexer(). You can call this function if you wish to initialize the static state ahead
// of time.
func BloodPressureLexerInit() {
	staticData := &bloodpressurelexerLexerStaticData
	staticData.once.Do(bloodpressurelexerLexerInit)
}

// NewBloodPressureLexer produces a new lexer instance for the optional input antlr.CharStream.
func NewBloodPressureLexer(input antlr.CharStream) *BloodPressureLexer {
	BloodPressureLexerInit()
	l := new(BloodPressureLexer)
	...
	l.GrammarFileName = "BloodPressure.g4"
	// TODO: l.EOF = antlr.TokenEOF

	return l
}

// BloodPressureLexer tokens.
const (
	BloodPressureLexerBLOODPRESSURE = 1
	BloodPressureLexerOWNKEY        = 2
	BloodPressureLexerSPLITKEY      = 3
	BloodPressureLexerWS            = 4
)
