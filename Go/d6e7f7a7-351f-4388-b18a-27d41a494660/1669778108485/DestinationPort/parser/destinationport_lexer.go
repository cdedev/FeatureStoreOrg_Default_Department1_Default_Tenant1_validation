...
type DestinationPortLexer struct {
	*antlr.BaseLexer
	channelNames []string
	modeNames    []string
	// TODO: EOF string
...
var destinationportlexerLexerStaticData struct {
	once                   sync.Once
	serializedATN          []int32
	channelNames           []string
	modeNames              []string
...
func destinationportlexerLexerInit() {
	staticData := &destinationportlexerLexerStaticData
	...
	staticData.serializedATN = []int32{
		...
		0, 4, 1, 1, 3, 2, 5, 3, 7, 4, 1, 0, 2, 2, 0, 48, 57, 65, 90, 3, 0, 9, 10,
...
// DestinationPortLexerInit initializes any static state used to implement DestinationPortLexer. By default the
// static state used to implement the lexer is lazily initialized during the first call to
// NewDestinationPortLexer(). You can call this function if you wish to initialize the static state ahead
// of time.
func DestinationPortLexerInit() {
	staticData := &destinationportlexerLexerStaticData
	staticData.once.Do(destinationportlexerLexerInit)
}

// NewDestinationPortLexer produces a new lexer instance for the optional input antlr.CharStream.
func NewDestinationPortLexer(input antlr.CharStream) *DestinationPortLexer {
	DestinationPortLexerInit()
	l := new(DestinationPortLexer)
	...
	l.GrammarFileName = "DestinationPort.g4"
	// TODO: l.EOF = antlr.TokenEOF

	return l
}

// DestinationPortLexer tokens.
const (
	DestinationPortLexerDESTINATIONPORT = 1
	DestinationPortLexerOWNKEY          = 2
	DestinationPortLexerSPLITKEY        = 3
	DestinationPortLexerWS              = 4
)
