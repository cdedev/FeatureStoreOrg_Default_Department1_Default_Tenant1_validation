...
var bloodgrouplexerLexerStaticData struct {
	once                   sync.Once
	serializedATN          []int32
	channelNames           []string
	modeNames              []string
...
func bloodgrouplexerLexerInit() {
	staticData := &bloodgrouplexerLexerStaticData
...
// BloodGroupLexerInit initializes any static state used to implement BloodGroupLexer. By default the
// static state used to implement the lexer is lazily initialized during the first call to
// NewBloodGroupLexer(). You can call this function if you wish to initialize the static state ahead
// of time.
func BloodGroupLexerInit() {
	staticData := &bloodgrouplexerLexerStaticData
	staticData.once.Do(bloodgrouplexerLexerInit)
}

// NewBloodGroupLexer produces a new lexer instance for the optional input antlr.CharStream.
func NewBloodGroupLexer(input antlr.CharStream) *BloodGroupLexer {
	BloodGroupLexerInit()
	l := new(BloodGroupLexer)
	...
	l.GrammarFileName = "BloodGroup.g4"
	// TODO: l.EOF = antlr.TokenEOF

	return l
}

// BloodGroupLexer tokens.
const (
	BloodGroupLexerBLOODGROUP = 1
	BloodGroupLexerOWNKEY     = 2
	BloodGroupLexerSPLITKEY   = 3
	BloodGroupLexerWS         = 4
)
