...
var medallexerLexerStaticData struct {
	once                   sync.Once
	serializedATN          []int32
	channelNames           []string
	modeNames              []string
...
func medallexerLexerInit() {
	staticData := &medallexerLexerStaticData
...
// MedalLexerInit initializes any static state used to implement MedalLexer. By default the
// static state used to implement the lexer is lazily initialized during the first call to
// NewMedalLexer(). You can call this function if you wish to initialize the static state ahead
// of time.
func MedalLexerInit() {
	staticData := &medallexerLexerStaticData
	staticData.once.Do(medallexerLexerInit)
}

// NewMedalLexer produces a new lexer instance for the optional input antlr.CharStream.
func NewMedalLexer(input antlr.CharStream) *MedalLexer {
	MedalLexerInit()
	l := new(MedalLexer)
