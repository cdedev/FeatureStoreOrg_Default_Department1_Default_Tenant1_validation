...
var chromiumlexerLexerStaticData struct {
	once                   sync.Once
	serializedATN          []int32
	channelNames           []string
	modeNames              []string
...
func chromiumlexerLexerInit() {
	staticData := &chromiumlexerLexerStaticData
...
// ChromiumLexerInit initializes any static state used to implement ChromiumLexer. By default the
// static state used to implement the lexer is lazily initialized during the first call to
// NewChromiumLexer(). You can call this function if you wish to initialize the static state ahead
// of time.
func ChromiumLexerInit() {
	staticData := &chromiumlexerLexerStaticData
	staticData.once.Do(chromiumlexerLexerInit)
}

// NewChromiumLexer produces a new lexer instance for the optional input antlr.CharStream.
func NewChromiumLexer(input antlr.CharStream) *ChromiumLexer {
	ChromiumLexerInit()
	l := new(ChromiumLexer)
	...
	l.GrammarFileName = "Chromium.g4"
	// TODO: l.EOF = antlr.TokenEOF

	return l
}

// ChromiumLexer tokens.
const (
	ChromiumLexerCHROMIUM = 1
	ChromiumLexerOWNKEY   = 2
	ChromiumLexerSPLITKEY = 3
	ChromiumLexerWS       = 4
)
