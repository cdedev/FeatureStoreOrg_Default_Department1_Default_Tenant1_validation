...
var addedsugarslexerLexerStaticData struct {
	once                   sync.Once
	serializedATN          []int32
	channelNames           []string
	modeNames              []string
...
func addedsugarslexerLexerInit() {
	staticData := &addedsugarslexerLexerStaticData
...
// AddedSugarsLexerInit initializes any static state used to implement AddedSugarsLexer. By default the
// static state used to implement the lexer is lazily initialized during the first call to
// NewAddedSugarsLexer(). You can call this function if you wish to initialize the static state ahead
// of time.
func AddedSugarsLexerInit() {
	staticData := &addedsugarslexerLexerStaticData
	staticData.once.Do(addedsugarslexerLexerInit)
}

// NewAddedSugarsLexer produces a new lexer instance for the optional input antlr.CharStream.
func NewAddedSugarsLexer(input antlr.CharStream) *AddedSugarsLexer {
	AddedSugarsLexerInit()
	l := new(AddedSugarsLexer)
	...
	l.GrammarFileName = "AddedSugars.g4"
	// TODO: l.EOF = antlr.TokenEOF

	return l
}

// AddedSugarsLexer tokens.
const (
	AddedSugarsLexerADDEDSUGARS = 1
	AddedSugarsLexerOWNKEY      = 2
	AddedSugarsLexerSPLITKEY    = 3
	AddedSugarsLexerWS          = 4
)
