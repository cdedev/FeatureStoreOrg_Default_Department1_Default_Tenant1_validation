...
type CartoonReferenceLexer struct {
	*antlr.BaseLexer
	channelNames []string
	modeNames    []string
	// TODO: EOF string
...
var cartoonreferencelexerLexerStaticData struct {
	once                   sync.Once
	serializedATN          []int32
	channelNames           []string
	modeNames              []string
...
func cartoonreferencelexerLexerInit() {
	staticData := &cartoonreferencelexerLexerStaticData
...
// CartoonReferenceLexerInit initializes any static state used to implement CartoonReferenceLexer. By default the
// static state used to implement the lexer is lazily initialized during the first call to
// NewCartoonReferenceLexer(). You can call this function if you wish to initialize the static state ahead
// of time.
func CartoonReferenceLexerInit() {
	staticData := &cartoonreferencelexerLexerStaticData
	staticData.once.Do(cartoonreferencelexerLexerInit)
}

// NewCartoonReferenceLexer produces a new lexer instance for the optional input antlr.CharStream.
func NewCartoonReferenceLexer(input antlr.CharStream) *CartoonReferenceLexer {
	CartoonReferenceLexerInit()
	l := new(CartoonReferenceLexer)
	...
	l.GrammarFileName = "CartoonReference.g4"
	// TODO: l.EOF = antlr.TokenEOF

	return l
}

// CartoonReferenceLexer tokens.
const (
	CartoonReferenceLexerCARTOONREFERENCE = 1
	CartoonReferenceLexerOWNKEY           = 2
	CartoonReferenceLexerSPLITKEY         = 3
	CartoonReferenceLexerWS               = 4
)
