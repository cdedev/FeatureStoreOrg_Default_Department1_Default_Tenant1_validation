...
var resistivitylexerLexerStaticData struct {
	once                   sync.Once
	serializedATN          []int32
	channelNames           []string
	modeNames              []string
...
func resistivitylexerLexerInit() {
	staticData := &resistivitylexerLexerStaticData
...
// ResistivityLexerInit initializes any static state used to implement ResistivityLexer. By default the
// static state used to implement the lexer is lazily initialized during the first call to
// NewResistivityLexer(). You can call this function if you wish to initialize the static state ahead
// of time.
func ResistivityLexerInit() {
	staticData := &resistivitylexerLexerStaticData
	staticData.once.Do(resistivitylexerLexerInit)
}

// NewResistivityLexer produces a new lexer instance for the optional input antlr.CharStream.
func NewResistivityLexer(input antlr.CharStream) *ResistivityLexer {
	ResistivityLexerInit()
	l := new(ResistivityLexer)
	...
	l.GrammarFileName = "Resistivity.g4"
	// TODO: l.EOF = antlr.TokenEOF

	return l
}

// ResistivityLexer tokens.
const (
	ResistivityLexerRESISTIVITY = 1
	ResistivityLexerOWNKEY      = 2
	ResistivityLexerSPLITKEY    = 3
	ResistivityLexerWS          = 4
)
