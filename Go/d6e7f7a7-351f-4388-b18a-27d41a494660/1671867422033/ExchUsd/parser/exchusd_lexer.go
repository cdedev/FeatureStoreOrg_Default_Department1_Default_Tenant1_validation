...
var exchusdlexerLexerStaticData struct {
	once                   sync.Once
	serializedATN          []int32
	channelNames           []string
	modeNames              []string
...
func exchusdlexerLexerInit() {
	staticData := &exchusdlexerLexerStaticData
...
// ExchUsdLexerInit initializes any static state used to implement ExchUsdLexer. By default the
// static state used to implement the lexer is lazily initialized during the first call to
// NewExchUsdLexer(). You can call this function if you wish to initialize the static state ahead
// of time.
func ExchUsdLexerInit() {
	staticData := &exchusdlexerLexerStaticData
	staticData.once.Do(exchusdlexerLexerInit)
}

// NewExchUsdLexer produces a new lexer instance for the optional input antlr.CharStream.
func NewExchUsdLexer(input antlr.CharStream) *ExchUsdLexer {
	ExchUsdLexerInit()
	l := new(ExchUsdLexer)
...
// ExchUsdLexer tokens.
const (
	ExchUsdLexerEXCHUSD  = 1
	ExchUsdLexerOWNKEY   = 2
	ExchUsdLexerSPLITKEY = 3
	ExchUsdLexerWS       = 4
)
