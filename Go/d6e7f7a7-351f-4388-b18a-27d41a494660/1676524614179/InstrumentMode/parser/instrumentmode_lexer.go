...
type InstrumentModeLexer struct {
	*antlr.BaseLexer
	channelNames []string
	modeNames    []string
	// TODO: EOF string
...
var instrumentmodelexerLexerStaticData struct {
	once                   sync.Once
	serializedATN          []int32
	channelNames           []string
	modeNames              []string
...
func instrumentmodelexerLexerInit() {
	staticData := &instrumentmodelexerLexerStaticData
...
// InstrumentModeLexerInit initializes any static state used to implement InstrumentModeLexer. By default the
// static state used to implement the lexer is lazily initialized during the first call to
// NewInstrumentModeLexer(). You can call this function if you wish to initialize the static state ahead
// of time.
func InstrumentModeLexerInit() {
	staticData := &instrumentmodelexerLexerStaticData
	staticData.once.Do(instrumentmodelexerLexerInit)
}

// NewInstrumentModeLexer produces a new lexer instance for the optional input antlr.CharStream.
func NewInstrumentModeLexer(input antlr.CharStream) *InstrumentModeLexer {
	InstrumentModeLexerInit()
	l := new(InstrumentModeLexer)
	...
	l.GrammarFileName = "InstrumentMode.g4"
	// TODO: l.EOF = antlr.TokenEOF

	return l
}

// InstrumentModeLexer tokens.
const (
	InstrumentModeLexerINSTRUMENTMODE = 1
	InstrumentModeLexerOWNKEY         = 2
	InstrumentModeLexerSPLITKEY       = 3
	InstrumentModeLexerWS             = 4
)
