...
var pollutionlexerLexerStaticData struct {
	once                   sync.Once
	serializedATN          []int32
	channelNames           []string
	modeNames              []string
...
func pollutionlexerLexerInit() {
	staticData := &pollutionlexerLexerStaticData
...
// PollutionLexerInit initializes any static state used to implement PollutionLexer. By default the
// static state used to implement the lexer is lazily initialized during the first call to
// NewPollutionLexer(). You can call this function if you wish to initialize the static state ahead
// of time.
func PollutionLexerInit() {
	staticData := &pollutionlexerLexerStaticData
	staticData.once.Do(pollutionlexerLexerInit)
}

// NewPollutionLexer produces a new lexer instance for the optional input antlr.CharStream.
func NewPollutionLexer(input antlr.CharStream) *PollutionLexer {
	PollutionLexerInit()
	l := new(PollutionLexer)
	...
	l.GrammarFileName = "Pollution.g4"
	// TODO: l.EOF = antlr.TokenEOF

	return l
}

// PollutionLexer tokens.
const (
	PollutionLexerPOLLUTION = 1
	PollutionLexerOWNKEY    = 2
	PollutionLexerSPLITKEY  = 3
	PollutionLexerWS        = 4
)
