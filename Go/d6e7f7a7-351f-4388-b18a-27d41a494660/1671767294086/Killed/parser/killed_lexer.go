...
var killedlexerLexerStaticData struct {
	once                   sync.Once
	serializedATN          []int32
	channelNames           []string
	modeNames              []string
...
func killedlexerLexerInit() {
	staticData := &killedlexerLexerStaticData
...
// KilledLexerInit initializes any static state used to implement KilledLexer. By default the
// static state used to implement the lexer is lazily initialized during the first call to
// NewKilledLexer(). You can call this function if you wish to initialize the static state ahead
// of time.
func KilledLexerInit() {
	staticData := &killedlexerLexerStaticData
	staticData.once.Do(killedlexerLexerInit)
}

// NewKilledLexer produces a new lexer instance for the optional input antlr.CharStream.
func NewKilledLexer(input antlr.CharStream) *KilledLexer {
	KilledLexerInit()
	l := new(KilledLexer)
