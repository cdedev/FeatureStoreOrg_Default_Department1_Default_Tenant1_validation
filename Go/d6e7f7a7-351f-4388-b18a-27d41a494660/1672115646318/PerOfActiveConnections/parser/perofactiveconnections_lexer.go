...
type PerOfActiveConnectionsLexer struct {
	*antlr.BaseLexer
	channelNames []string
	modeNames    []string
	// TODO: EOF string
...
var perofactiveconnectionslexerLexerStaticData struct {
	once                   sync.Once
	serializedATN          []int32
	channelNames           []string
	modeNames              []string
...
func perofactiveconnectionslexerLexerInit() {
	staticData := &perofactiveconnectionslexerLexerStaticData
...
// PerOfActiveConnectionsLexerInit initializes any static state used to implement PerOfActiveConnectionsLexer. By default the
// static state used to implement the lexer is lazily initialized during the first call to
// NewPerOfActiveConnectionsLexer(). You can call this function if you wish to initialize the static state ahead
// of time.
func PerOfActiveConnectionsLexerInit() {
	staticData := &perofactiveconnectionslexerLexerStaticData
	staticData.once.Do(perofactiveconnectionslexerLexerInit)
}

// NewPerOfActiveConnectionsLexer produces a new lexer instance for the optional input antlr.CharStream.
func NewPerOfActiveConnectionsLexer(input antlr.CharStream) *PerOfActiveConnectionsLexer {
	PerOfActiveConnectionsLexerInit()
	l := new(PerOfActiveConnectionsLexer)
	...
	l.GrammarFileName = "PerOfActiveConnections.g4"
	// TODO: l.EOF = antlr.TokenEOF

	return l
}

// PerOfActiveConnectionsLexer tokens.
const (
	PerOfActiveConnectionsLexerPEROFACTIVECONNECTIONS = 1
	PerOfActiveConnectionsLexerOWNKEY                 = 2
	PerOfActiveConnectionsLexerSPLITKEY               = 3
	PerOfActiveConnectionsLexerWS                     = 4
)
