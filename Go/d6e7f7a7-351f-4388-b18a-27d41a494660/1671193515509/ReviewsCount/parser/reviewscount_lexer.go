...
var reviewscountlexerLexerStaticData struct {
	once                   sync.Once
	serializedATN          []int32
	channelNames           []string
	modeNames              []string
...
func reviewscountlexerLexerInit() {
	staticData := &reviewscountlexerLexerStaticData
...
// ReviewsCountLexerInit initializes any static state used to implement ReviewsCountLexer. By default the
// static state used to implement the lexer is lazily initialized during the first call to
// NewReviewsCountLexer(). You can call this function if you wish to initialize the static state ahead
// of time.
func ReviewsCountLexerInit() {
	staticData := &reviewscountlexerLexerStaticData
	staticData.once.Do(reviewscountlexerLexerInit)
}

// NewReviewsCountLexer produces a new lexer instance for the optional input antlr.CharStream.
func NewReviewsCountLexer(input antlr.CharStream) *ReviewsCountLexer {
	ReviewsCountLexerInit()
	l := new(ReviewsCountLexer)
	...
	l.GrammarFileName = "ReviewsCount.g4"
	// TODO: l.EOF = antlr.TokenEOF

	return l
}

// ReviewsCountLexer tokens.
const (
	ReviewsCountLexerREVIEWSCOUNT = 1
	ReviewsCountLexerOWNKEY       = 2
	ReviewsCountLexerSPLITKEY     = 3
	ReviewsCountLexerWS           = 4
)
