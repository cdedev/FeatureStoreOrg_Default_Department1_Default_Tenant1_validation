...
var oilylexerLexerStaticData struct {
	once                   sync.Once
	serializedATN          []int32
	channelNames           []string
	modeNames              []string
...
func oilylexerLexerInit() {
	staticData := &oilylexerLexerStaticData
...
// OilyLexerInit initializes any static state used to implement OilyLexer. By default the
// static state used to implement the lexer is lazily initialized during the first call to
// NewOilyLexer(). You can call this function if you wish to initialize the static state ahead
// of time.
func OilyLexerInit() {
	staticData := &oilylexerLexerStaticData
	staticData.once.Do(oilylexerLexerInit)
}

// NewOilyLexer produces a new lexer instance for the optional input antlr.CharStream.
func NewOilyLexer(input antlr.CharStream) *OilyLexer {
	OilyLexerInit()
	l := new(OilyLexer)
