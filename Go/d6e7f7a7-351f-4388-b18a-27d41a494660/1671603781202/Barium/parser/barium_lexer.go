...
var bariumlexerLexerStaticData struct {
	once                   sync.Once
	serializedATN          []int32
	channelNames           []string
	modeNames              []string
...
func bariumlexerLexerInit() {
	staticData := &bariumlexerLexerStaticData
...
// BariumLexerInit initializes any static state used to implement BariumLexer. By default the
// static state used to implement the lexer is lazily initialized during the first call to
// NewBariumLexer(). You can call this function if you wish to initialize the static state ahead
// of time.
func BariumLexerInit() {
	staticData := &bariumlexerLexerStaticData
	staticData.once.Do(bariumlexerLexerInit)
}

// NewBariumLexer produces a new lexer instance for the optional input antlr.CharStream.
func NewBariumLexer(input antlr.CharStream) *BariumLexer {
	BariumLexerInit()
	l := new(BariumLexer)
