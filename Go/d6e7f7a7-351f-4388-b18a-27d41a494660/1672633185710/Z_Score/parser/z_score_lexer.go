...
var z_scorelexerLexerStaticData struct {
	once                   sync.Once
	serializedATN          []int32
	channelNames           []string
	modeNames              []string
...
func z_scorelexerLexerInit() {
	staticData := &z_scorelexerLexerStaticData
...
// Z_ScoreLexerInit initializes any static state used to implement Z_ScoreLexer. By default the
// static state used to implement the lexer is lazily initialized during the first call to
// NewZ_ScoreLexer(). You can call this function if you wish to initialize the static state ahead
// of time.
func Z_ScoreLexerInit() {
	staticData := &z_scorelexerLexerStaticData
	staticData.once.Do(z_scorelexerLexerInit)
}

// NewZ_ScoreLexer produces a new lexer instance for the optional input antlr.CharStream.
func NewZ_ScoreLexer(input antlr.CharStream) *Z_ScoreLexer {
	Z_ScoreLexerInit()
	l := new(Z_ScoreLexer)
...
// Z_ScoreLexer tokens.
const (
	Z_ScoreLexerZ_SCORE  = 1
	Z_ScoreLexerOWNKEY   = 2
	Z_ScoreLexerSPLITKEY = 3
	Z_ScoreLexerWS       = 4
)
