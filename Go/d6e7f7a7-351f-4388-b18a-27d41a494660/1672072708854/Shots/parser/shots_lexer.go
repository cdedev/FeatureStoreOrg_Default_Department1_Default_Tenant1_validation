...
var shotslexerLexerStaticData struct {
	once                   sync.Once
	serializedATN          []int32
	channelNames           []string
	modeNames              []string
...
func shotslexerLexerInit() {
	staticData := &shotslexerLexerStaticData
...
// ShotsLexerInit initializes any static state used to implement ShotsLexer. By default the
// static state used to implement the lexer is lazily initialized during the first call to
// NewShotsLexer(). You can call this function if you wish to initialize the static state ahead
// of time.
func ShotsLexerInit() {
	staticData := &shotslexerLexerStaticData
	staticData.once.Do(shotslexerLexerInit)
}

// NewShotsLexer produces a new lexer instance for the optional input antlr.CharStream.
func NewShotsLexer(input antlr.CharStream) *ShotsLexer {
	ShotsLexerInit()
	l := new(ShotsLexer)
