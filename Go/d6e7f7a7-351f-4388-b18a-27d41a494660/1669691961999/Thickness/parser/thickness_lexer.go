...
var thicknesslexerLexerStaticData struct {
	once                   sync.Once
	serializedATN          []int32
	channelNames           []string
	modeNames              []string
...
func thicknesslexerLexerInit() {
	staticData := &thicknesslexerLexerStaticData
...
// ThicknessLexerInit initializes any static state used to implement ThicknessLexer. By default the
// static state used to implement the lexer is lazily initialized during the first call to
// NewThicknessLexer(). You can call this function if you wish to initialize the static state ahead
// of time.
func ThicknessLexerInit() {
	staticData := &thicknesslexerLexerStaticData
	staticData.once.Do(thicknesslexerLexerInit)
}

// NewThicknessLexer produces a new lexer instance for the optional input antlr.CharStream.
func NewThicknessLexer(input antlr.CharStream) *ThicknessLexer {
	ThicknessLexerInit()
	l := new(ThicknessLexer)
	...
	l.GrammarFileName = "Thickness.g4"
	// TODO: l.EOF = antlr.TokenEOF

	return l
}

// ThicknessLexer tokens.
const (
	ThicknessLexerTHICKNESS = 1
	ThicknessLexerOWNKEY    = 2
	ThicknessLexerSPLITKEY  = 3
	ThicknessLexerWS        = 4
)
