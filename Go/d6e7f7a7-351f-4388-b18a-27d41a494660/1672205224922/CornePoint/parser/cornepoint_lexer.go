...
var cornepointlexerLexerStaticData struct {
	once                   sync.Once
	serializedATN          []int32
	channelNames           []string
	modeNames              []string
...
func cornepointlexerLexerInit() {
	staticData := &cornepointlexerLexerStaticData
	...
	staticData.serializedATN = []int32{
		...
		0, 9, 10, 3, 5, 2, 0, 10, 16, 3, 3, 1, 0, 11, 12, 5, 78, 0, 0, 12, 17,
		5, 111, 0, 0, 13, 14, 5, 89, 0, 0, 14, 15, 5, 101, 0, 0, 15, 17, 5, 115,
...
// CornePointLexerInit initializes any static state used to implement CornePointLexer. By default the
// static state used to implement the lexer is lazily initialized during the first call to
// NewCornePointLexer(). You can call this function if you wish to initialize the static state ahead
// of time.
func CornePointLexerInit() {
	staticData := &cornepointlexerLexerStaticData
	staticData.once.Do(cornepointlexerLexerInit)
}

// NewCornePointLexer produces a new lexer instance for the optional input antlr.CharStream.
func NewCornePointLexer(input antlr.CharStream) *CornePointLexer {
	CornePointLexerInit()
	l := new(CornePointLexer)
	...
	l.GrammarFileName = "CornePoint.g4"
	// TODO: l.EOF = antlr.TokenEOF

	return l
}

// CornePointLexer tokens.
const (
	CornePointLexerCORNEPOINT = 1
	CornePointLexerOWNKEY     = 2
	CornePointLexerSPLITKEY   = 3
	CornePointLexerWS         = 4
)
