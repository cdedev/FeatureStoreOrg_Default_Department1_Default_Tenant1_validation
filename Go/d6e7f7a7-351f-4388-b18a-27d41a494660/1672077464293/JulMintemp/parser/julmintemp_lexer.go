...
var julmintemplexerLexerStaticData struct {
	once                   sync.Once
	serializedATN          []int32
	channelNames           []string
	modeNames              []string
...
func julmintemplexerLexerInit() {
	staticData := &julmintemplexerLexerStaticData
...
// JulMintempLexerInit initializes any static state used to implement JulMintempLexer. By default the
// static state used to implement the lexer is lazily initialized during the first call to
// NewJulMintempLexer(). You can call this function if you wish to initialize the static state ahead
// of time.
func JulMintempLexerInit() {
	staticData := &julmintemplexerLexerStaticData
	staticData.once.Do(julmintemplexerLexerInit)
}

// NewJulMintempLexer produces a new lexer instance for the optional input antlr.CharStream.
func NewJulMintempLexer(input antlr.CharStream) *JulMintempLexer {
	JulMintempLexerInit()
	l := new(JulMintempLexer)
	...
	l.GrammarFileName = "JulMintemp.g4"
	// TODO: l.EOF = antlr.TokenEOF

	return l
}

// JulMintempLexer tokens.
const (
	JulMintempLexerJULMINTEMP = 1
	JulMintempLexerOWNKEY     = 2
	JulMintempLexerSPLITKEY   = 3
	JulMintempLexerWS         = 4
)
