...
var marriedlexerLexerStaticData struct {
	once                   sync.Once
	serializedATN          []int32
	channelNames           []string
	modeNames              []string
...
func marriedlexerLexerInit() {
	staticData := &marriedlexerLexerStaticData
...
// MarriedLexerInit initializes any static state used to implement MarriedLexer. By default the
// static state used to implement the lexer is lazily initialized during the first call to
// NewMarriedLexer(). You can call this function if you wish to initialize the static state ahead
// of time.
func MarriedLexerInit() {
	staticData := &marriedlexerLexerStaticData
	staticData.once.Do(marriedlexerLexerInit)
}

// NewMarriedLexer produces a new lexer instance for the optional input antlr.CharStream.
func NewMarriedLexer(input antlr.CharStream) *MarriedLexer {
	MarriedLexerInit()
	l := new(MarriedLexer)
...
// MarriedLexer tokens.
const (
	MarriedLexerMARRIED  = 1
	MarriedLexerOWNKEY   = 2
	MarriedLexerSPLITKEY = 3
	MarriedLexerWS       = 4
)
