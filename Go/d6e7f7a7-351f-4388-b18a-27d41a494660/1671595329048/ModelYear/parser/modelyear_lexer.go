...
var modelyearlexerLexerStaticData struct {
	once                   sync.Once
	serializedATN          []int32
	channelNames           []string
	modeNames              []string
...
func modelyearlexerLexerInit() {
	staticData := &modelyearlexerLexerStaticData
...
// ModelYearLexerInit initializes any static state used to implement ModelYearLexer. By default the
// static state used to implement the lexer is lazily initialized during the first call to
// NewModelYearLexer(). You can call this function if you wish to initialize the static state ahead
// of time.
func ModelYearLexerInit() {
	staticData := &modelyearlexerLexerStaticData
	staticData.once.Do(modelyearlexerLexerInit)
}

// NewModelYearLexer produces a new lexer instance for the optional input antlr.CharStream.
func NewModelYearLexer(input antlr.CharStream) *ModelYearLexer {
	ModelYearLexerInit()
	l := new(ModelYearLexer)
	...
	l.GrammarFileName = "ModelYear.g4"
	// TODO: l.EOF = antlr.TokenEOF

	return l
}

// ModelYearLexer tokens.
const (
	ModelYearLexerFIELD0   = 1
	ModelYearLexerOWNKEY   = 2
	ModelYearLexerSPLITKEY = 3
	ModelYearLexerWS       = 4
)
