...
var ridetimelexerLexerStaticData struct {
	once                   sync.Once
	serializedATN          []int32
	channelNames           []string
	modeNames              []string
...
func ridetimelexerLexerInit() {
	staticData := &ridetimelexerLexerStaticData
...
// RideTimeLexerInit initializes any static state used to implement RideTimeLexer. By default the
// static state used to implement the lexer is lazily initialized during the first call to
// NewRideTimeLexer(). You can call this function if you wish to initialize the static state ahead
// of time.
func RideTimeLexerInit() {
	staticData := &ridetimelexerLexerStaticData
	staticData.once.Do(ridetimelexerLexerInit)
}

// NewRideTimeLexer produces a new lexer instance for the optional input antlr.CharStream.
func NewRideTimeLexer(input antlr.CharStream) *RideTimeLexer {
	RideTimeLexerInit()
	l := new(RideTimeLexer)
	...
	l.GrammarFileName = "RideTime.g4"
	// TODO: l.EOF = antlr.TokenEOF

	return l
}

// RideTimeLexer tokens.
const (
	RideTimeLexerRIDETIME = 1
	RideTimeLexerOWNKEY   = 2
	RideTimeLexerSPLITKEY = 3
	RideTimeLexerWS       = 4
)
