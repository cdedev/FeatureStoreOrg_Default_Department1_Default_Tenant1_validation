...
type IpAddressPresentLexer struct {
	*antlr.BaseLexer
	channelNames []string
	modeNames    []string
	// TODO: EOF string
...
var ipaddresspresentlexerLexerStaticData struct {
	once                   sync.Once
	serializedATN          []int32
	channelNames           []string
	modeNames              []string
...
func ipaddresspresentlexerLexerInit() {
	staticData := &ipaddresspresentlexerLexerStaticData
...
// IpAddressPresentLexerInit initializes any static state used to implement IpAddressPresentLexer. By default the
// static state used to implement the lexer is lazily initialized during the first call to
// NewIpAddressPresentLexer(). You can call this function if you wish to initialize the static state ahead
// of time.
func IpAddressPresentLexerInit() {
	staticData := &ipaddresspresentlexerLexerStaticData
	staticData.once.Do(ipaddresspresentlexerLexerInit)
}

// NewIpAddressPresentLexer produces a new lexer instance for the optional input antlr.CharStream.
func NewIpAddressPresentLexer(input antlr.CharStream) *IpAddressPresentLexer {
	IpAddressPresentLexerInit()
	l := new(IpAddressPresentLexer)
	...
	l.GrammarFileName = "IpAddressPresent.g4"
	// TODO: l.EOF = antlr.TokenEOF

	return l
}

// IpAddressPresentLexer tokens.
const (
	IpAddressPresentLexerIPADDRESSPRESENT = 1
	IpAddressPresentLexerOWNKEY           = 2
	IpAddressPresentLexerSPLITKEY         = 3
	IpAddressPresentLexerWS               = 4
)
