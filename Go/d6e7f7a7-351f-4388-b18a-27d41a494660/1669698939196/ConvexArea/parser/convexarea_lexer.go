...
var convexarealexerLexerStaticData struct {
	once                   sync.Once
	serializedATN          []int32
	channelNames           []string
	modeNames              []string
...
func convexarealexerLexerInit() {
	staticData := &convexarealexerLexerStaticData
...
// ConvexAreaLexerInit initializes any static state used to implement ConvexAreaLexer. By default the
// static state used to implement the lexer is lazily initialized during the first call to
// NewConvexAreaLexer(). You can call this function if you wish to initialize the static state ahead
// of time.
func ConvexAreaLexerInit() {
	staticData := &convexarealexerLexerStaticData
	staticData.once.Do(convexarealexerLexerInit)
}

// NewConvexAreaLexer produces a new lexer instance for the optional input antlr.CharStream.
func NewConvexAreaLexer(input antlr.CharStream) *ConvexAreaLexer {
	ConvexAreaLexerInit()
	l := new(ConvexAreaLexer)
	...
	l.GrammarFileName = "ConvexArea.g4"
	// TODO: l.EOF = antlr.TokenEOF

	return l
}

// ConvexAreaLexer tokens.
const (
	ConvexAreaLexerCONVEXAREA = 1
	ConvexAreaLexerOWNKEY     = 2
	ConvexAreaLexerSPLITKEY   = 3
	ConvexAreaLexerWS         = 4
)
