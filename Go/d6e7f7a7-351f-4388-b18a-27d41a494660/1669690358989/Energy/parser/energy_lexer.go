...
var energylexerLexerStaticData struct {
	once                   sync.Once
	serializedATN          []int32
	channelNames           []string
	modeNames              []string
...
func energylexerLexerInit() {
	staticData := &energylexerLexerStaticData
...
// EnergyLexerInit initializes any static state used to implement EnergyLexer. By default the
// static state used to implement the lexer is lazily initialized during the first call to
// NewEnergyLexer(). You can call this function if you wish to initialize the static state ahead
// of time.
func EnergyLexerInit() {
	staticData := &energylexerLexerStaticData
	staticData.once.Do(energylexerLexerInit)
}

// NewEnergyLexer produces a new lexer instance for the optional input antlr.CharStream.
func NewEnergyLexer(input antlr.CharStream) *EnergyLexer {
	EnergyLexerInit()
	l := new(EnergyLexer)
