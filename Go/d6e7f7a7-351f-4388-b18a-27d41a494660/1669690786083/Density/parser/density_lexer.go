...
var densitylexerLexerStaticData struct {
	once                   sync.Once
	serializedATN          []int32
	channelNames           []string
	modeNames              []string
...
func densitylexerLexerInit() {
	staticData := &densitylexerLexerStaticData
...
// DensityLexerInit initializes any static state used to implement DensityLexer. By default the
// static state used to implement the lexer is lazily initialized during the first call to
// NewDensityLexer(). You can call this function if you wish to initialize the static state ahead
// of time.
func DensityLexerInit() {
	staticData := &densitylexerLexerStaticData
	staticData.once.Do(densitylexerLexerInit)
}

// NewDensityLexer produces a new lexer instance for the optional input antlr.CharStream.
func NewDensityLexer(input antlr.CharStream) *DensityLexer {
	DensityLexerInit()
	l := new(DensityLexer)
...
// DensityLexer tokens.
const (
	DensityLexerDENSITY  = 1
	DensityLexerOWNKEY   = 2
	DensityLexerSPLITKEY = 3
	DensityLexerWS       = 4
)
