...
var curtosislexerLexerStaticData struct {
	once                   sync.Once
	serializedATN          []int32
	channelNames           []string
	modeNames              []string
...
func curtosislexerLexerInit() {
	staticData := &curtosislexerLexerStaticData
...
// CurtosisLexerInit initializes any static state used to implement CurtosisLexer. By default the
// static state used to implement the lexer is lazily initialized during the first call to
// NewCurtosisLexer(). You can call this function if you wish to initialize the static state ahead
// of time.
func CurtosisLexerInit() {
	staticData := &curtosislexerLexerStaticData
	staticData.once.Do(curtosislexerLexerInit)
}

// NewCurtosisLexer produces a new lexer instance for the optional input antlr.CharStream.
func NewCurtosisLexer(input antlr.CharStream) *CurtosisLexer {
	CurtosisLexerInit()
	l := new(CurtosisLexer)
	...
	l.GrammarFileName = "Curtosis.g4"
	// TODO: l.EOF = antlr.TokenEOF

	return l
}

// CurtosisLexer tokens.
const (
	CurtosisLexerCURTOSIS = 1
	CurtosisLexerOWNKEY   = 2
	CurtosisLexerSPLITKEY = 3
	CurtosisLexerWS       = 4
)
