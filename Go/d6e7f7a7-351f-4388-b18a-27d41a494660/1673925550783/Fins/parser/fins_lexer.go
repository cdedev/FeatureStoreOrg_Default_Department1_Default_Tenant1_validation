...
var finslexerLexerStaticData struct {
	once                   sync.Once
	serializedATN          []int32
	channelNames           []string
	modeNames              []string
...
func finslexerLexerInit() {
	staticData := &finslexerLexerStaticData
...
// FinsLexerInit initializes any static state used to implement FinsLexer. By default the
// static state used to implement the lexer is lazily initialized during the first call to
// NewFinsLexer(). You can call this function if you wish to initialize the static state ahead
// of time.
func FinsLexerInit() {
	staticData := &finslexerLexerStaticData
	staticData.once.Do(finslexerLexerInit)
}

// NewFinsLexer produces a new lexer instance for the optional input antlr.CharStream.
func NewFinsLexer(input antlr.CharStream) *FinsLexer {
	FinsLexerInit()
	l := new(FinsLexer)
