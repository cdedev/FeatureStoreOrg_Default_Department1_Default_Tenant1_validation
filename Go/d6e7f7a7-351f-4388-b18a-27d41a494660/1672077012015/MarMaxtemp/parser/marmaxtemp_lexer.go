...
var marmaxtemplexerLexerStaticData struct {
	once                   sync.Once
	serializedATN          []int32
	channelNames           []string
	modeNames              []string
...
func marmaxtemplexerLexerInit() {
	staticData := &marmaxtemplexerLexerStaticData
...
// MarMaxtempLexerInit initializes any static state used to implement MarMaxtempLexer. By default the
// static state used to implement the lexer is lazily initialized during the first call to
// NewMarMaxtempLexer(). You can call this function if you wish to initialize the static state ahead
// of time.
func MarMaxtempLexerInit() {
	staticData := &marmaxtemplexerLexerStaticData
	staticData.once.Do(marmaxtemplexerLexerInit)
}

// NewMarMaxtempLexer produces a new lexer instance for the optional input antlr.CharStream.
func NewMarMaxtempLexer(input antlr.CharStream) *MarMaxtempLexer {
	MarMaxtempLexerInit()
	l := new(MarMaxtempLexer)
	...
	l.GrammarFileName = "MarMaxtemp.g4"
	// TODO: l.EOF = antlr.TokenEOF

	return l
}

// MarMaxtempLexer tokens.
const (
	MarMaxtempLexerMARMAXTEMP = 1
	MarMaxtempLexerOWNKEY     = 2
	MarMaxtempLexerSPLITKEY   = 3
	MarMaxtempLexerWS         = 4
)
