...
var revenuelexerLexerStaticData struct {
	once                   sync.Once
	serializedATN          []int32
	channelNames           []string
	modeNames              []string
...
func revenuelexerLexerInit() {
	staticData := &revenuelexerLexerStaticData
...
// RevenueLexerInit initializes any static state used to implement RevenueLexer. By default the
// static state used to implement the lexer is lazily initialized during the first call to
// NewRevenueLexer(). You can call this function if you wish to initialize the static state ahead
// of time.
func RevenueLexerInit() {
	staticData := &revenuelexerLexerStaticData
	staticData.once.Do(revenuelexerLexerInit)
}

// NewRevenueLexer produces a new lexer instance for the optional input antlr.CharStream.
func NewRevenueLexer(input antlr.CharStream) *RevenueLexer {
	RevenueLexerInit()
	l := new(RevenueLexer)
...
// RevenueLexer tokens.
const (
	RevenueLexerREVENUE  = 1
	RevenueLexerOWNKEY   = 2
	RevenueLexerSPLITKEY = 3
	RevenueLexerWS       = 4
)
