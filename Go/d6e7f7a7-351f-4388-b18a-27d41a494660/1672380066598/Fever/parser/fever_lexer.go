...
var feverlexerLexerStaticData struct {
	once                   sync.Once
	serializedATN          []int32
	channelNames           []string
	modeNames              []string
...
func feverlexerLexerInit() {
	staticData := &feverlexerLexerStaticData
...
// FeverLexerInit initializes any static state used to implement FeverLexer. By default the
// static state used to implement the lexer is lazily initialized during the first call to
// NewFeverLexer(). You can call this function if you wish to initialize the static state ahead
// of time.
func FeverLexerInit() {
	staticData := &feverlexerLexerStaticData
	staticData.once.Do(feverlexerLexerInit)
}

// NewFeverLexer produces a new lexer instance for the optional input antlr.CharStream.
func NewFeverLexer(input antlr.CharStream) *FeverLexer {
	FeverLexerInit()
	l := new(FeverLexer)
