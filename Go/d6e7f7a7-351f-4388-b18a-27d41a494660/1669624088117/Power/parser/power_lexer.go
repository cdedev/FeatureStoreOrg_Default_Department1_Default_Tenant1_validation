// Code generated from /usr/local/lib/Go/d6e7f7a7-351f-4388-b18a-27d41a494660/1669624088117/Power.g4 by ANTLR 4.10.1. DO NOT EDIT.
...
var powerlexerLexerStaticData struct {
	once                   sync.Once
	serializedATN          []int32
	channelNames           []string
	modeNames              []string
...
func powerlexerLexerInit() {
	staticData := &powerlexerLexerStaticData
...
// PowerLexerInit initializes any static state used to implement PowerLexer. By default the
// static state used to implement the lexer is lazily initialized during the first call to
// NewPowerLexer(). You can call this function if you wish to initialize the static state ahead
// of time.
func PowerLexerInit() {
	staticData := &powerlexerLexerStaticData
	staticData.once.Do(powerlexerLexerInit)
}

// NewPowerLexer produces a new lexer instance for the optional input antlr.CharStream.
func NewPowerLexer(input antlr.CharStream) *PowerLexer {
	PowerLexerInit()
	l := new(PowerLexer)
