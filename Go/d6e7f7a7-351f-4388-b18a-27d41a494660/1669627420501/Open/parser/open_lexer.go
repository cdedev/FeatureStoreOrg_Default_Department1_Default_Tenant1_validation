...
var openlexerLexerStaticData struct {
	once                   sync.Once
	serializedATN          []int32
	channelNames           []string
	modeNames              []string
...
func openlexerLexerInit() {
	staticData := &openlexerLexerStaticData
...
// OpenLexerInit initializes any static state used to implement OpenLexer. By default the
// static state used to implement the lexer is lazily initialized during the first call to
// NewOpenLexer(). You can call this function if you wish to initialize the static state ahead
// of time.
func OpenLexerInit() {
	staticData := &openlexerLexerStaticData
	staticData.once.Do(openlexerLexerInit)
}

// NewOpenLexer produces a new lexer instance for the optional input antlr.CharStream.
func NewOpenLexer(input antlr.CharStream) *OpenLexer {
	OpenLexerInit()
	l := new(OpenLexer)
