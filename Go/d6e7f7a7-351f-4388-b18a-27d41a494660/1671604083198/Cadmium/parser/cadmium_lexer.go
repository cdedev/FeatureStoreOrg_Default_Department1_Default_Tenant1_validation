...
var cadmiumlexerLexerStaticData struct {
	once                   sync.Once
	serializedATN          []int32
	channelNames           []string
	modeNames              []string
...
func cadmiumlexerLexerInit() {
	staticData := &cadmiumlexerLexerStaticData
...
// CadmiumLexerInit initializes any static state used to implement CadmiumLexer. By default the
// static state used to implement the lexer is lazily initialized during the first call to
// NewCadmiumLexer(). You can call this function if you wish to initialize the static state ahead
// of time.
func CadmiumLexerInit() {
	staticData := &cadmiumlexerLexerStaticData
	staticData.once.Do(cadmiumlexerLexerInit)
}

// NewCadmiumLexer produces a new lexer instance for the optional input antlr.CharStream.
func NewCadmiumLexer(input antlr.CharStream) *CadmiumLexer {
	CadmiumLexerInit()
	l := new(CadmiumLexer)
...
// CadmiumLexer tokens.
const (
	CadmiumLexerCADMIUM  = 1
	CadmiumLexerOWNKEY   = 2
	CadmiumLexerSPLITKEY = 3
	CadmiumLexerWS       = 4
)
