...
var dropslexerLexerStaticData struct {
	once                   sync.Once
	serializedATN          []int32
	channelNames           []string
	modeNames              []string
...
func dropslexerLexerInit() {
	staticData := &dropslexerLexerStaticData
...
// DropsLexerInit initializes any static state used to implement DropsLexer. By default the
// static state used to implement the lexer is lazily initialized during the first call to
// NewDropsLexer(). You can call this function if you wish to initialize the static state ahead
// of time.
func DropsLexerInit() {
	staticData := &dropslexerLexerStaticData
	staticData.once.Do(dropslexerLexerInit)
}

// NewDropsLexer produces a new lexer instance for the optional input antlr.CharStream.
func NewDropsLexer(input antlr.CharStream) *DropsLexer {
	DropsLexerInit()
	l := new(DropsLexer)
