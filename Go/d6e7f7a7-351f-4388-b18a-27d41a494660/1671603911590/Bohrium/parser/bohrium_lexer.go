...
var bohriumlexerLexerStaticData struct {
	once                   sync.Once
	serializedATN          []int32
	channelNames           []string
	modeNames              []string
...
func bohriumlexerLexerInit() {
	staticData := &bohriumlexerLexerStaticData
...
// BohriumLexerInit initializes any static state used to implement BohriumLexer. By default the
// static state used to implement the lexer is lazily initialized during the first call to
// NewBohriumLexer(). You can call this function if you wish to initialize the static state ahead
// of time.
func BohriumLexerInit() {
	staticData := &bohriumlexerLexerStaticData
	staticData.once.Do(bohriumlexerLexerInit)
}

// NewBohriumLexer produces a new lexer instance for the optional input antlr.CharStream.
func NewBohriumLexer(input antlr.CharStream) *BohriumLexer {
	BohriumLexerInit()
	l := new(BohriumLexer)
...
// BohriumLexer tokens.
const (
	BohriumLexerBOHRIUM  = 1
	BohriumLexerOWNKEY   = 2
	BohriumLexerSPLITKEY = 3
	BohriumLexerWS       = 4
)
