...
type RenewableEnergyLexer struct {
	*antlr.BaseLexer
	channelNames []string
	modeNames    []string
	// TODO: EOF string
...
var renewableenergylexerLexerStaticData struct {
	once                   sync.Once
	serializedATN          []int32
	channelNames           []string
	modeNames              []string
...
func renewableenergylexerLexerInit() {
	staticData := &renewableenergylexerLexerStaticData
...
// RenewableEnergyLexerInit initializes any static state used to implement RenewableEnergyLexer. By default the
// static state used to implement the lexer is lazily initialized during the first call to
// NewRenewableEnergyLexer(). You can call this function if you wish to initialize the static state ahead
// of time.
func RenewableEnergyLexerInit() {
	staticData := &renewableenergylexerLexerStaticData
	staticData.once.Do(renewableenergylexerLexerInit)
}

// NewRenewableEnergyLexer produces a new lexer instance for the optional input antlr.CharStream.
func NewRenewableEnergyLexer(input antlr.CharStream) *RenewableEnergyLexer {
	RenewableEnergyLexerInit()
	l := new(RenewableEnergyLexer)
	...
	l.GrammarFileName = "RenewableEnergy.g4"
	// TODO: l.EOF = antlr.TokenEOF

	return l
}

// RenewableEnergyLexer tokens.
const (
	RenewableEnergyLexerFIELD0   = 1
	RenewableEnergyLexerOWNKEY   = 2
	RenewableEnergyLexerSPLITKEY = 3
	RenewableEnergyLexerWS       = 4
)
