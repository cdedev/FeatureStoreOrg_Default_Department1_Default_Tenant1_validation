...
var rawh2lexerLexerStaticData struct {
	once                   sync.Once
	serializedATN          []int32
	channelNames           []string
	modeNames              []string
...
func rawh2lexerLexerInit() {
	staticData := &rawh2lexerLexerStaticData
...
// RawH2LexerInit initializes any static state used to implement RawH2Lexer. By default the
// static state used to implement the lexer is lazily initialized during the first call to
// NewRawH2Lexer(). You can call this function if you wish to initialize the static state ahead
// of time.
func RawH2LexerInit() {
	staticData := &rawh2lexerLexerStaticData
	staticData.once.Do(rawh2lexerLexerInit)
}

// NewRawH2Lexer produces a new lexer instance for the optional input antlr.CharStream.
func NewRawH2Lexer(input antlr.CharStream) *RawH2Lexer {
	RawH2LexerInit()
	l := new(RawH2Lexer)
