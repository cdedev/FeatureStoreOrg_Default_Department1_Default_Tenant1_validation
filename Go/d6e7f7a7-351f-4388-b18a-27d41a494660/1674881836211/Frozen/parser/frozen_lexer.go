...
var frozenlexerLexerStaticData struct {
	once                   sync.Once
	serializedATN          []int32
	channelNames           []string
	modeNames              []string
...
func frozenlexerLexerInit() {
	staticData := &frozenlexerLexerStaticData
...
// FrozenLexerInit initializes any static state used to implement FrozenLexer. By default the
// static state used to implement the lexer is lazily initialized during the first call to
// NewFrozenLexer(). You can call this function if you wish to initialize the static state ahead
// of time.
func FrozenLexerInit() {
	staticData := &frozenlexerLexerStaticData
	staticData.once.Do(frozenlexerLexerInit)
}

// NewFrozenLexer produces a new lexer instance for the optional input antlr.CharStream.
func NewFrozenLexer(input antlr.CharStream) *FrozenLexer {
	FrozenLexerInit()
	l := new(FrozenLexer)
