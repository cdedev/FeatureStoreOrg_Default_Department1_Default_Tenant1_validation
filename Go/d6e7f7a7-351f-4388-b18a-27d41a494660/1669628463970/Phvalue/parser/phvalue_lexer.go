...
var phvaluelexerLexerStaticData struct {
	once                   sync.Once
	serializedATN          []int32
	channelNames           []string
	modeNames              []string
...
func phvaluelexerLexerInit() {
	staticData := &phvaluelexerLexerStaticData
...
// PhvalueLexerInit initializes any static state used to implement PhvalueLexer. By default the
// static state used to implement the lexer is lazily initialized during the first call to
// NewPhvalueLexer(). You can call this function if you wish to initialize the static state ahead
// of time.
func PhvalueLexerInit() {
	staticData := &phvaluelexerLexerStaticData
	staticData.once.Do(phvaluelexerLexerInit)
}

// NewPhvalueLexer produces a new lexer instance for the optional input antlr.CharStream.
func NewPhvalueLexer(input antlr.CharStream) *PhvalueLexer {
	PhvalueLexerInit()
	l := new(PhvalueLexer)
...
// PhvalueLexer tokens.
const (
	PhvalueLexerPHVALUE  = 1
	PhvalueLexerOWNKEY   = 2
	PhvalueLexerSPLITKEY = 3
	PhvalueLexerWS       = 4
)
