...
var tinnituslexerLexerStaticData struct {
	once                   sync.Once
	serializedATN          []int32
	channelNames           []string
	modeNames              []string
...
func tinnituslexerLexerInit() {
	staticData := &tinnituslexerLexerStaticData
...
// TinnitusLexerInit initializes any static state used to implement TinnitusLexer. By default the
// static state used to implement the lexer is lazily initialized during the first call to
// NewTinnitusLexer(). You can call this function if you wish to initialize the static state ahead
// of time.
func TinnitusLexerInit() {
	staticData := &tinnituslexerLexerStaticData
	staticData.once.Do(tinnituslexerLexerInit)
}

// NewTinnitusLexer produces a new lexer instance for the optional input antlr.CharStream.
func NewTinnitusLexer(input antlr.CharStream) *TinnitusLexer {
	TinnitusLexerInit()
	l := new(TinnitusLexer)
	...
	l.GrammarFileName = "Tinnitus.g4"
	// TODO: l.EOF = antlr.TokenEOF

	return l
}

// TinnitusLexer tokens.
const (
	TinnitusLexerTINNITUS = 1
	TinnitusLexerOWNKEY   = 2
	TinnitusLexerSPLITKEY = 3
	TinnitusLexerWS       = 4
)
