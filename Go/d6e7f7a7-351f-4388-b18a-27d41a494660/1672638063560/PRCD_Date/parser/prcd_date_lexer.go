...
var prcd_datelexerLexerStaticData struct {
	once                   sync.Once
	serializedATN          []int32
	channelNames           []string
	modeNames              []string
...
func prcd_datelexerLexerInit() {
	staticData := &prcd_datelexerLexerStaticData
...
// PRCD_DateLexerInit initializes any static state used to implement PRCD_DateLexer. By default the
// static state used to implement the lexer is lazily initialized during the first call to
// NewPRCD_DateLexer(). You can call this function if you wish to initialize the static state ahead
// of time.
func PRCD_DateLexerInit() {
	staticData := &prcd_datelexerLexerStaticData
	staticData.once.Do(prcd_datelexerLexerInit)
}

// NewPRCD_DateLexer produces a new lexer instance for the optional input antlr.CharStream.
func NewPRCD_DateLexer(input antlr.CharStream) *PRCD_DateLexer {
	PRCD_DateLexerInit()
	l := new(PRCD_DateLexer)
	...
	l.GrammarFileName = "PRCD_Date.g4"
	// TODO: l.EOF = antlr.TokenEOF

	return l
}

// PRCD_DateLexer tokens.
const (
	PRCD_DateLexerPRCD_DATE = 1
	PRCD_DateLexerOWNKEY    = 2
	PRCD_DateLexerSPLITKEY  = 3
	PRCD_DateLexerWS        = 4
)
