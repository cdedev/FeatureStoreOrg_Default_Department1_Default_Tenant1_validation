...
var perimeterlexerLexerStaticData struct {
	once                   sync.Once
	serializedATN          []int32
	channelNames           []string
	modeNames              []string
...
func perimeterlexerLexerInit() {
	staticData := &perimeterlexerLexerStaticData
...
// PerimeterLexerInit initializes any static state used to implement PerimeterLexer. By default the
// static state used to implement the lexer is lazily initialized during the first call to
// NewPerimeterLexer(). You can call this function if you wish to initialize the static state ahead
// of time.
func PerimeterLexerInit() {
	staticData := &perimeterlexerLexerStaticData
	staticData.once.Do(perimeterlexerLexerInit)
}

// NewPerimeterLexer produces a new lexer instance for the optional input antlr.CharStream.
func NewPerimeterLexer(input antlr.CharStream) *PerimeterLexer {
	PerimeterLexerInit()
	l := new(PerimeterLexer)
	...
	l.GrammarFileName = "Perimeter.g4"
	// TODO: l.EOF = antlr.TokenEOF

	return l
}

// PerimeterLexer tokens.
const (
	PerimeterLexerPERIMETER = 1
	PerimeterLexerOWNKEY    = 2
	PerimeterLexerSPLITKEY  = 3
	PerimeterLexerWS        = 4
)
