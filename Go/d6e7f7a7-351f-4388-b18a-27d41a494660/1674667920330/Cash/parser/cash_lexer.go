...
var cashlexerLexerStaticData struct {
	once                   sync.Once
	serializedATN          []int32
	channelNames           []string
	modeNames              []string
...
func cashlexerLexerInit() {
	staticData := &cashlexerLexerStaticData
...
// CashLexerInit initializes any static state used to implement CashLexer. By default the
// static state used to implement the lexer is lazily initialized during the first call to
// NewCashLexer(). You can call this function if you wish to initialize the static state ahead
// of time.
func CashLexerInit() {
	staticData := &cashlexerLexerStaticData
	staticData.once.Do(cashlexerLexerInit)
}

// NewCashLexer produces a new lexer instance for the optional input antlr.CharStream.
func NewCashLexer(input antlr.CharStream) *CashLexer {
	CashLexerInit()
	l := new(CashLexer)
