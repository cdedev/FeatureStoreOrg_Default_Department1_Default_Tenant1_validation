...
var aquaticlexerLexerStaticData struct {
	once                   sync.Once
	serializedATN          []int32
	channelNames           []string
	modeNames              []string
...
func aquaticlexerLexerInit() {
	staticData := &aquaticlexerLexerStaticData
...
// AquaticLexerInit initializes any static state used to implement AquaticLexer. By default the
// static state used to implement the lexer is lazily initialized during the first call to
// NewAquaticLexer(). You can call this function if you wish to initialize the static state ahead
// of time.
func AquaticLexerInit() {
	staticData := &aquaticlexerLexerStaticData
	staticData.once.Do(aquaticlexerLexerInit)
}

// NewAquaticLexer produces a new lexer instance for the optional input antlr.CharStream.
func NewAquaticLexer(input antlr.CharStream) *AquaticLexer {
	AquaticLexerInit()
	l := new(AquaticLexer)
...
// AquaticLexer tokens.
const (
	AquaticLexerAQUATIC  = 1
	AquaticLexerOWNKEY   = 2
	AquaticLexerSPLITKEY = 3
	AquaticLexerWS       = 4
)
