...
var lineslexerLexerStaticData struct {
	once                   sync.Once
	serializedATN          []int32
	channelNames           []string
	modeNames              []string
...
func lineslexerLexerInit() {
	staticData := &lineslexerLexerStaticData
...
// LinesLexerInit initializes any static state used to implement LinesLexer. By default the
// static state used to implement the lexer is lazily initialized during the first call to
// NewLinesLexer(). You can call this function if you wish to initialize the static state ahead
// of time.
func LinesLexerInit() {
	staticData := &lineslexerLexerStaticData
	staticData.once.Do(lineslexerLexerInit)
}

// NewLinesLexer produces a new lexer instance for the optional input antlr.CharStream.
func NewLinesLexer(input antlr.CharStream) *LinesLexer {
	LinesLexerInit()
	l := new(LinesLexer)
