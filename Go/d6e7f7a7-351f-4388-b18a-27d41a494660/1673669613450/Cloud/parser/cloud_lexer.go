...
var cloudlexerLexerStaticData struct {
	once                   sync.Once
	serializedATN          []int32
	channelNames           []string
	modeNames              []string
...
func cloudlexerLexerInit() {
	staticData := &cloudlexerLexerStaticData
...
// CloudLexerInit initializes any static state used to implement CloudLexer. By default the
// static state used to implement the lexer is lazily initialized during the first call to
// NewCloudLexer(). You can call this function if you wish to initialize the static state ahead
// of time.
func CloudLexerInit() {
	staticData := &cloudlexerLexerStaticData
	staticData.once.Do(cloudlexerLexerInit)
}

// NewCloudLexer produces a new lexer instance for the optional input antlr.CharStream.
func NewCloudLexer(input antlr.CharStream) *CloudLexer {
	CloudLexerInit()
	l := new(CloudLexer)
