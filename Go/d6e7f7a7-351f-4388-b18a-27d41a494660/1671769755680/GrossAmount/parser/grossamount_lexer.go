...
var grossamountlexerLexerStaticData struct {
	once                   sync.Once
	serializedATN          []int32
	channelNames           []string
	modeNames              []string
...
func grossamountlexerLexerInit() {
	staticData := &grossamountlexerLexerStaticData
...
// GrossAmountLexerInit initializes any static state used to implement GrossAmountLexer. By default the
// static state used to implement the lexer is lazily initialized during the first call to
// NewGrossAmountLexer(). You can call this function if you wish to initialize the static state ahead
// of time.
func GrossAmountLexerInit() {
	staticData := &grossamountlexerLexerStaticData
	staticData.once.Do(grossamountlexerLexerInit)
}

// NewGrossAmountLexer produces a new lexer instance for the optional input antlr.CharStream.
func NewGrossAmountLexer(input antlr.CharStream) *GrossAmountLexer {
	GrossAmountLexerInit()
	l := new(GrossAmountLexer)
	...
	l.GrammarFileName = "GrossAmount.g4"
	// TODO: l.EOF = antlr.TokenEOF

	return l
}

// GrossAmountLexer tokens.
const (
	GrossAmountLexerGROSSAMOUNT = 1
	GrossAmountLexerOWNKEY      = 2
	GrossAmountLexerSPLITKEY    = 3
	GrossAmountLexerWS          = 4
)
