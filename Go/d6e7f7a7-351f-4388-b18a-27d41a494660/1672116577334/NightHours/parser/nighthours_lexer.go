...
var nighthourslexerLexerStaticData struct {
	once                   sync.Once
	serializedATN          []int32
	channelNames           []string
	modeNames              []string
...
func nighthourslexerLexerInit() {
	staticData := &nighthourslexerLexerStaticData
...
// NightHoursLexerInit initializes any static state used to implement NightHoursLexer. By default the
// static state used to implement the lexer is lazily initialized during the first call to
// NewNightHoursLexer(). You can call this function if you wish to initialize the static state ahead
// of time.
func NightHoursLexerInit() {
	staticData := &nighthourslexerLexerStaticData
	staticData.once.Do(nighthourslexerLexerInit)
}

// NewNightHoursLexer produces a new lexer instance for the optional input antlr.CharStream.
func NewNightHoursLexer(input antlr.CharStream) *NightHoursLexer {
	NightHoursLexerInit()
	l := new(NightHoursLexer)
	...
	l.GrammarFileName = "NightHours.g4"
	// TODO: l.EOF = antlr.TokenEOF

	return l
}

// NightHoursLexer tokens.
const (
	NightHoursLexerNIGHTHOURS = 1
	NightHoursLexerOWNKEY     = 2
	NightHoursLexerSPLITKEY   = 3
	NightHoursLexerWS         = 4
)
