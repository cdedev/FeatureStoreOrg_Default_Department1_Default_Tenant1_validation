...
var averagelexerLexerStaticData struct {
	once                   sync.Once
	serializedATN          []int32
	channelNames           []string
	modeNames              []string
...
func averagelexerLexerInit() {
	staticData := &averagelexerLexerStaticData
...
// AverageLexerInit initializes any static state used to implement AverageLexer. By default the
// static state used to implement the lexer is lazily initialized during the first call to
// NewAverageLexer(). You can call this function if you wish to initialize the static state ahead
// of time.
func AverageLexerInit() {
	staticData := &averagelexerLexerStaticData
	staticData.once.Do(averagelexerLexerInit)
}

// NewAverageLexer produces a new lexer instance for the optional input antlr.CharStream.
func NewAverageLexer(input antlr.CharStream) *AverageLexer {
	AverageLexerInit()
	l := new(AverageLexer)
...
// AverageLexer tokens.
const (
	AverageLexerAVERAGE  = 1
	AverageLexerOWNKEY   = 2
	AverageLexerSPLITKEY = 3
	AverageLexerWS       = 4
)
