...
var acousticnesslexerLexerStaticData struct {
	once                   sync.Once
	serializedATN          []int32
	channelNames           []string
	modeNames              []string
...
func acousticnesslexerLexerInit() {
	staticData := &acousticnesslexerLexerStaticData
...
// AcousticnessLexerInit initializes any static state used to implement AcousticnessLexer. By default the
// static state used to implement the lexer is lazily initialized during the first call to
// NewAcousticnessLexer(). You can call this function if you wish to initialize the static state ahead
// of time.
func AcousticnessLexerInit() {
	staticData := &acousticnesslexerLexerStaticData
	staticData.once.Do(acousticnesslexerLexerInit)
}

// NewAcousticnessLexer produces a new lexer instance for the optional input antlr.CharStream.
func NewAcousticnessLexer(input antlr.CharStream) *AcousticnessLexer {
	AcousticnessLexerInit()
	l := new(AcousticnessLexer)
	...
	l.GrammarFileName = "Acousticness.g4"
	// TODO: l.EOF = antlr.TokenEOF

	return l
}

// AcousticnessLexer tokens.
const (
	AcousticnessLexerACOUSTICNESS = 1
	AcousticnessLexerOWNKEY       = 2
	AcousticnessLexerSPLITKEY     = 3
	AcousticnessLexerWS           = 4
)
