...
var fm1lexerLexerStaticData struct {
	once                   sync.Once
	serializedATN          []int32
	channelNames           []string
	modeNames              []string
...
func fm1lexerLexerInit() {
	staticData := &fm1lexerLexerStaticData
...
// Fm1LexerInit initializes any static state used to implement Fm1Lexer. By default the
// static state used to implement the lexer is lazily initialized during the first call to
// NewFm1Lexer(). You can call this function if you wish to initialize the static state ahead
// of time.
func Fm1LexerInit() {
	staticData := &fm1lexerLexerStaticData
	staticData.once.Do(fm1lexerLexerInit)
}

// NewFm1Lexer produces a new lexer instance for the optional input antlr.CharStream.
func NewFm1Lexer(input antlr.CharStream) *Fm1Lexer {
	Fm1LexerInit()
	l := new(Fm1Lexer)
