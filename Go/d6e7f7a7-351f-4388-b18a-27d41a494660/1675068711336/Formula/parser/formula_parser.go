...
const (
	...
	FormulaParserFORMULA  = 1
	FormulaParserOWNKEY   = 2
	FormulaParserSPLITKEY = 3
	FormulaParserWS       = 4
)

// FormulaParser rules.
const (
	FormulaParserRULE_expression = 0
	FormulaParserRULE_formula    = 1
)
...
func (s *ExpressionContext) Formula() IFormulaContext {
...
func (p *FormulaParser) Expression() (localctx IExpressionContext) {
	...
	p.EnterRule(localctx, 0, FormulaParserRULE_expression)
...
func NewEmptyFormulaContext() *FormulaContext {
	...
	p.BaseParserRuleContext = antlr.NewBaseParserRuleContext(nil, -1)
	p.RuleIndex = FormulaParserRULE_formula
	return p
}
...
func (s *FormulaContext) FORMULA() antlr.TerminalNode {
	return s.GetToken(FormulaParserFORMULA, 0)
}
...
func (p *FormulaParser) Formula() (localctx IFormulaContext) {
	this := p
	_ = this

	localctx = NewFormulaContext(p, p.GetParserRuleContext(), p.GetState())
	p.EnterRule(localctx, 2, FormulaParserRULE_formula)
