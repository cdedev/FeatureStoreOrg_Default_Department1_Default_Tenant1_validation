...
var distancelexerLexerStaticData struct {
	once                   sync.Once
	serializedATN          []int32
	channelNames           []string
	modeNames              []string
...
func distancelexerLexerInit() {
	staticData := &distancelexerLexerStaticData
...
// DistanceLexerInit initializes any static state used to implement DistanceLexer. By default the
// static state used to implement the lexer is lazily initialized during the first call to
// NewDistanceLexer(). You can call this function if you wish to initialize the static state ahead
// of time.
func DistanceLexerInit() {
	staticData := &distancelexerLexerStaticData
	staticData.once.Do(distancelexerLexerInit)
}

// NewDistanceLexer produces a new lexer instance for the optional input antlr.CharStream.
func NewDistanceLexer(input antlr.CharStream) *DistanceLexer {
	DistanceLexerInit()
	l := new(DistanceLexer)
	...
	l.GrammarFileName = "Distance.g4"
	// TODO: l.EOF = antlr.TokenEOF

	return l
}

// DistanceLexer tokens.
const (
	DistanceLexerDISTANCE = 1
	DistanceLexerOWNKEY   = 2
	DistanceLexerSPLITKEY = 3
	DistanceLexerWS       = 4
)
