...
var piglexerLexerStaticData struct {
	once                   sync.Once
	serializedATN          []int32
	channelNames           []string
	modeNames              []string
...
func piglexerLexerInit() {
	staticData := &piglexerLexerStaticData
...
// PigLexerInit initializes any static state used to implement PigLexer. By default the
// static state used to implement the lexer is lazily initialized during the first call to
// NewPigLexer(). You can call this function if you wish to initialize the static state ahead
// of time.
func PigLexerInit() {
	staticData := &piglexerLexerStaticData
	staticData.once.Do(piglexerLexerInit)
}

// NewPigLexer produces a new lexer instance for the optional input antlr.CharStream.
func NewPigLexer(input antlr.CharStream) *PigLexer {
	PigLexerInit()
	l := new(PigLexer)
