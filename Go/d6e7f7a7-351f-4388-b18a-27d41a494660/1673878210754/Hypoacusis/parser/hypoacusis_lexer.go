...
var hypoacusislexerLexerStaticData struct {
	once                   sync.Once
	serializedATN          []int32
	channelNames           []string
	modeNames              []string
...
func hypoacusislexerLexerInit() {
	staticData := &hypoacusislexerLexerStaticData
...
// HypoacusisLexerInit initializes any static state used to implement HypoacusisLexer. By default the
// static state used to implement the lexer is lazily initialized during the first call to
// NewHypoacusisLexer(). You can call this function if you wish to initialize the static state ahead
// of time.
func HypoacusisLexerInit() {
	staticData := &hypoacusislexerLexerStaticData
	staticData.once.Do(hypoacusislexerLexerInit)
}

// NewHypoacusisLexer produces a new lexer instance for the optional input antlr.CharStream.
func NewHypoacusisLexer(input antlr.CharStream) *HypoacusisLexer {
	HypoacusisLexerInit()
	l := new(HypoacusisLexer)
	...
	l.GrammarFileName = "Hypoacusis.g4"
	// TODO: l.EOF = antlr.TokenEOF

	return l
}

// HypoacusisLexer tokens.
const (
	HypoacusisLexerHYPOACUSIS = 1
	HypoacusisLexerOWNKEY     = 2
	HypoacusisLexerSPLITKEY   = 3
	HypoacusisLexerWS         = 4
)
