...
var julmaxtemplexerLexerStaticData struct {
	once                   sync.Once
	serializedATN          []int32
	channelNames           []string
	modeNames              []string
...
func julmaxtemplexerLexerInit() {
	staticData := &julmaxtemplexerLexerStaticData
...
// JulMaxtempLexerInit initializes any static state used to implement JulMaxtempLexer. By default the
// static state used to implement the lexer is lazily initialized during the first call to
// NewJulMaxtempLexer(). You can call this function if you wish to initialize the static state ahead
// of time.
func JulMaxtempLexerInit() {
	staticData := &julmaxtemplexerLexerStaticData
	staticData.once.Do(julmaxtemplexerLexerInit)
}

// NewJulMaxtempLexer produces a new lexer instance for the optional input antlr.CharStream.
func NewJulMaxtempLexer(input antlr.CharStream) *JulMaxtempLexer {
	JulMaxtempLexerInit()
	l := new(JulMaxtempLexer)
	...
	l.GrammarFileName = "JulMaxtemp.g4"
	// TODO: l.EOF = antlr.TokenEOF

	return l
}

// JulMaxtempLexer tokens.
const (
	JulMaxtempLexerJULMAXTEMP = 1
	JulMaxtempLexerOWNKEY     = 2
	JulMaxtempLexerSPLITKEY   = 3
	JulMaxtempLexerWS         = 4
)
