...
var rcoillexerLexerStaticData struct {
	once                   sync.Once
	serializedATN          []int32
	channelNames           []string
	modeNames              []string
...
func rcoillexerLexerInit() {
	staticData := &rcoillexerLexerStaticData
...
// RCoilLexerInit initializes any static state used to implement RCoilLexer. By default the
// static state used to implement the lexer is lazily initialized during the first call to
// NewRCoilLexer(). You can call this function if you wish to initialize the static state ahead
// of time.
func RCoilLexerInit() {
	staticData := &rcoillexerLexerStaticData
	staticData.once.Do(rcoillexerLexerInit)
}

// NewRCoilLexer produces a new lexer instance for the optional input antlr.CharStream.
func NewRCoilLexer(input antlr.CharStream) *RCoilLexer {
	RCoilLexerInit()
	l := new(RCoilLexer)
