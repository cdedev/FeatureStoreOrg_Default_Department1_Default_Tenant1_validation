...
var chlorideslexerLexerStaticData struct {
	once                   sync.Once
	serializedATN          []int32
	channelNames           []string
	modeNames              []string
...
func chlorideslexerLexerInit() {
	staticData := &chlorideslexerLexerStaticData
...
// ChloridesLexerInit initializes any static state used to implement ChloridesLexer. By default the
// static state used to implement the lexer is lazily initialized during the first call to
// NewChloridesLexer(). You can call this function if you wish to initialize the static state ahead
// of time.
func ChloridesLexerInit() {
	staticData := &chlorideslexerLexerStaticData
	staticData.once.Do(chlorideslexerLexerInit)
}

// NewChloridesLexer produces a new lexer instance for the optional input antlr.CharStream.
func NewChloridesLexer(input antlr.CharStream) *ChloridesLexer {
	ChloridesLexerInit()
	l := new(ChloridesLexer)
	...
	l.GrammarFileName = "Chlorides.g4"
	// TODO: l.EOF = antlr.TokenEOF

	return l
}

// ChloridesLexer tokens.
const (
	ChloridesLexerCHLORIDES = 1
	ChloridesLexerOWNKEY    = 2
	ChloridesLexerSPLITKEY  = 3
	ChloridesLexerWS        = 4
)
