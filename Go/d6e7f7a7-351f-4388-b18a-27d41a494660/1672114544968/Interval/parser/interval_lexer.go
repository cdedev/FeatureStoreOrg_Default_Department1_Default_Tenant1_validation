...
var intervallexerLexerStaticData struct {
	once                   sync.Once
	serializedATN          []int32
	channelNames           []string
	modeNames              []string
...
func intervallexerLexerInit() {
	staticData := &intervallexerLexerStaticData
...
// IntervalLexerInit initializes any static state used to implement IntervalLexer. By default the
// static state used to implement the lexer is lazily initialized during the first call to
// NewIntervalLexer(). You can call this function if you wish to initialize the static state ahead
// of time.
func IntervalLexerInit() {
	staticData := &intervallexerLexerStaticData
	staticData.once.Do(intervallexerLexerInit)
}

// NewIntervalLexer produces a new lexer instance for the optional input antlr.CharStream.
func NewIntervalLexer(input antlr.CharStream) *IntervalLexer {
	IntervalLexerInit()
	l := new(IntervalLexer)
	...
	l.GrammarFileName = "Interval.g4"
	// TODO: l.EOF = antlr.TokenEOF

	return l
}

// IntervalLexer tokens.
const (
	IntervalLexerINTERVAL = 1
	IntervalLexerOWNKEY   = 2
	IntervalLexerSPLITKEY = 3
	IntervalLexerWS       = 4
)
