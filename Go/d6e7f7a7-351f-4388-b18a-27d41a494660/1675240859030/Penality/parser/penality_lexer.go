...
var penalitylexerLexerStaticData struct {
	once                   sync.Once
	serializedATN          []int32
	channelNames           []string
	modeNames              []string
...
func penalitylexerLexerInit() {
	staticData := &penalitylexerLexerStaticData
...
// PenalityLexerInit initializes any static state used to implement PenalityLexer. By default the
// static state used to implement the lexer is lazily initialized during the first call to
// NewPenalityLexer(). You can call this function if you wish to initialize the static state ahead
// of time.
func PenalityLexerInit() {
	staticData := &penalitylexerLexerStaticData
	staticData.once.Do(penalitylexerLexerInit)
}

// NewPenalityLexer produces a new lexer instance for the optional input antlr.CharStream.
func NewPenalityLexer(input antlr.CharStream) *PenalityLexer {
	PenalityLexerInit()
	l := new(PenalityLexer)
	...
	l.GrammarFileName = "Penality.g4"
	// TODO: l.EOF = antlr.TokenEOF

	return l
}

// PenalityLexer tokens.
const (
	PenalityLexerPENALITY = 1
	PenalityLexerOWNKEY   = 2
	PenalityLexerSPLITKEY = 3
	PenalityLexerWS       = 4
)
