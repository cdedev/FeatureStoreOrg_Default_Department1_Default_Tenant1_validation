...
var curedlexerLexerStaticData struct {
	once                   sync.Once
	serializedATN          []int32
	channelNames           []string
	modeNames              []string
...
func curedlexerLexerInit() {
	staticData := &curedlexerLexerStaticData
...
// CuredLexerInit initializes any static state used to implement CuredLexer. By default the
// static state used to implement the lexer is lazily initialized during the first call to
// NewCuredLexer(). You can call this function if you wish to initialize the static state ahead
// of time.
func CuredLexerInit() {
	staticData := &curedlexerLexerStaticData
	staticData.once.Do(curedlexerLexerInit)
}

// NewCuredLexer produces a new lexer instance for the optional input antlr.CharStream.
func NewCuredLexer(input antlr.CharStream) *CuredLexer {
	CuredLexerInit()
	l := new(CuredLexer)
