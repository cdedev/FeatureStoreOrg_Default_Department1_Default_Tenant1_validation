...
var routelexerLexerStaticData struct {
	once                   sync.Once
	serializedATN          []int32
	channelNames           []string
	modeNames              []string
...
func routelexerLexerInit() {
	staticData := &routelexerLexerStaticData
...
// RouteLexerInit initializes any static state used to implement RouteLexer. By default the
// static state used to implement the lexer is lazily initialized during the first call to
// NewRouteLexer(). You can call this function if you wish to initialize the static state ahead
// of time.
func RouteLexerInit() {
	staticData := &routelexerLexerStaticData
	staticData.once.Do(routelexerLexerInit)
}

// NewRouteLexer produces a new lexer instance for the optional input antlr.CharStream.
func NewRouteLexer(input antlr.CharStream) *RouteLexer {
	RouteLexerInit()
	l := new(RouteLexer)
