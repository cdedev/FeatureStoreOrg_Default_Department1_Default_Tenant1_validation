...
var sensorylexerLexerStaticData struct {
	once                   sync.Once
	serializedATN          []int32
	channelNames           []string
	modeNames              []string
...
func sensorylexerLexerInit() {
	staticData := &sensorylexerLexerStaticData
...
// SensoryLexerInit initializes any static state used to implement SensoryLexer. By default the
// static state used to implement the lexer is lazily initialized during the first call to
// NewSensoryLexer(). You can call this function if you wish to initialize the static state ahead
// of time.
func SensoryLexerInit() {
	staticData := &sensorylexerLexerStaticData
	staticData.once.Do(sensorylexerLexerInit)
}

// NewSensoryLexer produces a new lexer instance for the optional input antlr.CharStream.
func NewSensoryLexer(input antlr.CharStream) *SensoryLexer {
	SensoryLexerInit()
	l := new(SensoryLexer)
...
// SensoryLexer tokens.
const (
	SensoryLexerSENSORY  = 1
	SensoryLexerOWNKEY   = 2
	SensoryLexerSPLITKEY = 3
	SensoryLexerWS       = 4
)
