...
var shapefactorlexerLexerStaticData struct {
	once                   sync.Once
	serializedATN          []int32
	channelNames           []string
	modeNames              []string
...
func shapefactorlexerLexerInit() {
	staticData := &shapefactorlexerLexerStaticData
...
// ShapeFactorLexerInit initializes any static state used to implement ShapeFactorLexer. By default the
// static state used to implement the lexer is lazily initialized during the first call to
// NewShapeFactorLexer(). You can call this function if you wish to initialize the static state ahead
// of time.
func ShapeFactorLexerInit() {
	staticData := &shapefactorlexerLexerStaticData
	staticData.once.Do(shapefactorlexerLexerInit)
}

// NewShapeFactorLexer produces a new lexer instance for the optional input antlr.CharStream.
func NewShapeFactorLexer(input antlr.CharStream) *ShapeFactorLexer {
	ShapeFactorLexerInit()
	l := new(ShapeFactorLexer)
	...
	l.GrammarFileName = "ShapeFactor.g4"
	// TODO: l.EOF = antlr.TokenEOF

	return l
}

// ShapeFactorLexer tokens.
const (
	ShapeFactorLexerSHAPEFACTOR = 1
	ShapeFactorLexerOWNKEY      = 2
	ShapeFactorLexerSPLITKEY    = 3
	ShapeFactorLexerWS          = 4
)
