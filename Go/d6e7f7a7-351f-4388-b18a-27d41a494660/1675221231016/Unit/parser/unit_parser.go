...
var unitParserStaticData struct {
	once                   sync.Once
	serializedATN          []int32
	literalNames           []string
...
func unitParserInit() {
	staticData := &unitParserStaticData
...
func UnitParserInit() {
	staticData := &unitParserStaticData
	staticData.once.Do(unitParserInit)
}
...
const (
	...
	UnitParserUNIT     = 1
	UnitParserOWNKEY   = 2
	UnitParserSPLITKEY = 3
	UnitParserWS       = 4
)

// UnitParser rules.
const (
	UnitParserRULE_expression = 0
	UnitParserRULE_unit       = 1
)
...
func NewEmptyExpressionContext() *ExpressionContext {
	...
	p.RuleIndex = UnitParserRULE_expression
	return p
}
...
func (s *ExpressionContext) EnterRule(listener antlr.ParseTreeListener) {
	if listenerT, ok := listener.(UnitListener); ok {
...
func (p *UnitParser) Expression() (localctx IExpressionContext) {
	this := p
	_ = this

	localctx = NewExpressionContext(p, p.GetParserRuleContext(), p.GetState())
	p.EnterRule(localctx, 0, UnitParserRULE_expression)
...
func (s *UnitContext) UNIT() antlr.TerminalNode {
	return s.GetToken(UnitParserUNIT, 0)
}
...
func (p *UnitParser) Unit() (localctx IUnitContext) {
	...
	p.EnterRule(localctx, 2, UnitParserRULE_unit)
