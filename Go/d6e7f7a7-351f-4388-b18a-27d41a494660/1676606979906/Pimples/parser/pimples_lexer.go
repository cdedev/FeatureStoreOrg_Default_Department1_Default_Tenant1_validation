...
var pimpleslexerLexerStaticData struct {
	once                   sync.Once
	serializedATN          []int32
	channelNames           []string
	modeNames              []string
...
func pimpleslexerLexerInit() {
	staticData := &pimpleslexerLexerStaticData
...
// PimplesLexerInit initializes any static state used to implement PimplesLexer. By default the
// static state used to implement the lexer is lazily initialized during the first call to
// NewPimplesLexer(). You can call this function if you wish to initialize the static state ahead
// of time.
func PimplesLexerInit() {
	staticData := &pimpleslexerLexerStaticData
	staticData.once.Do(pimpleslexerLexerInit)
}

// NewPimplesLexer produces a new lexer instance for the optional input antlr.CharStream.
func NewPimplesLexer(input antlr.CharStream) *PimplesLexer {
	PimplesLexerInit()
	l := new(PimplesLexer)
...
// PimplesLexer tokens.
const (
	PimplesLexerPIMPLES  = 1
	PimplesLexerOWNKEY   = 2
	PimplesLexerSPLITKEY = 3
	PimplesLexerWS       = 4
)
