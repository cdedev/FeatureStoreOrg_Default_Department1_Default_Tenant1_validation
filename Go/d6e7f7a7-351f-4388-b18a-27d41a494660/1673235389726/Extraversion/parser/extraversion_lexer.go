...
var extraversionlexerLexerStaticData struct {
	once                   sync.Once
	serializedATN          []int32
	channelNames           []string
	modeNames              []string
...
func extraversionlexerLexerInit() {
	staticData := &extraversionlexerLexerStaticData
...
// ExtraversionLexerInit initializes any static state used to implement ExtraversionLexer. By default the
// static state used to implement the lexer is lazily initialized during the first call to
// NewExtraversionLexer(). You can call this function if you wish to initialize the static state ahead
// of time.
func ExtraversionLexerInit() {
	staticData := &extraversionlexerLexerStaticData
	staticData.once.Do(extraversionlexerLexerInit)
}

// NewExtraversionLexer produces a new lexer instance for the optional input antlr.CharStream.
func NewExtraversionLexer(input antlr.CharStream) *ExtraversionLexer {
	ExtraversionLexerInit()
	l := new(ExtraversionLexer)
	...
	l.GrammarFileName = "Extraversion.g4"
	// TODO: l.EOF = antlr.TokenEOF

	return l
}

// ExtraversionLexer tokens.
const (
	ExtraversionLexerEXTRAVERSION = 1
	ExtraversionLexerOWNKEY       = 2
	ExtraversionLexerSPLITKEY     = 3
	ExtraversionLexerWS           = 4
)
