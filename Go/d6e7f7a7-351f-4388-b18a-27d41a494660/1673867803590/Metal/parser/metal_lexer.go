...
var metallexerLexerStaticData struct {
	once                   sync.Once
	serializedATN          []int32
	channelNames           []string
	modeNames              []string
...
func metallexerLexerInit() {
	staticData := &metallexerLexerStaticData
...
// MetalLexerInit initializes any static state used to implement MetalLexer. By default the
// static state used to implement the lexer is lazily initialized during the first call to
// NewMetalLexer(). You can call this function if you wish to initialize the static state ahead
// of time.
func MetalLexerInit() {
	staticData := &metallexerLexerStaticData
	staticData.once.Do(metallexerLexerInit)
}

// NewMetalLexer produces a new lexer instance for the optional input antlr.CharStream.
func NewMetalLexer(input antlr.CharStream) *MetalLexer {
	MetalLexerInit()
	l := new(MetalLexer)
