...
var concavitylexerLexerStaticData struct {
	once                   sync.Once
	serializedATN          []int32
	channelNames           []string
	modeNames              []string
...
func concavitylexerLexerInit() {
	staticData := &concavitylexerLexerStaticData
...
// ConcavityLexerInit initializes any static state used to implement ConcavityLexer. By default the
// static state used to implement the lexer is lazily initialized during the first call to
// NewConcavityLexer(). You can call this function if you wish to initialize the static state ahead
// of time.
func ConcavityLexerInit() {
	staticData := &concavitylexerLexerStaticData
	staticData.once.Do(concavitylexerLexerInit)
}

// NewConcavityLexer produces a new lexer instance for the optional input antlr.CharStream.
func NewConcavityLexer(input antlr.CharStream) *ConcavityLexer {
	ConcavityLexerInit()
	l := new(ConcavityLexer)
	...
	l.GrammarFileName = "Concavity.g4"
	// TODO: l.EOF = antlr.TokenEOF

	return l
}

// ConcavityLexer tokens.
const (
	ConcavityLexerCONCAVITY = 1
	ConcavityLexerOWNKEY    = 2
	ConcavityLexerSPLITKEY  = 3
	ConcavityLexerWS        = 4
)
