...
var novmintemplexerLexerStaticData struct {
	once                   sync.Once
	serializedATN          []int32
	channelNames           []string
	modeNames              []string
...
func novmintemplexerLexerInit() {
	staticData := &novmintemplexerLexerStaticData
...
// NovMintempLexerInit initializes any static state used to implement NovMintempLexer. By default the
// static state used to implement the lexer is lazily initialized during the first call to
// NewNovMintempLexer(). You can call this function if you wish to initialize the static state ahead
// of time.
func NovMintempLexerInit() {
	staticData := &novmintemplexerLexerStaticData
	staticData.once.Do(novmintemplexerLexerInit)
}

// NewNovMintempLexer produces a new lexer instance for the optional input antlr.CharStream.
func NewNovMintempLexer(input antlr.CharStream) *NovMintempLexer {
	NovMintempLexerInit()
	l := new(NovMintempLexer)
	...
	l.GrammarFileName = "NovMintemp.g4"
	// TODO: l.EOF = antlr.TokenEOF

	return l
}

// NovMintempLexer tokens.
const (
	NovMintempLexerNOVMINTEMP = 1
	NovMintempLexerOWNKEY     = 2
	NovMintempLexerSPLITKEY   = 3
	NovMintempLexerWS         = 4
)
