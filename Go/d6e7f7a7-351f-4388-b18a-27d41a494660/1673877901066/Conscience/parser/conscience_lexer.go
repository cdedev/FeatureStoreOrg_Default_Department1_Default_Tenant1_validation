...
var consciencelexerLexerStaticData struct {
	once                   sync.Once
	serializedATN          []int32
	channelNames           []string
	modeNames              []string
...
func consciencelexerLexerInit() {
	staticData := &consciencelexerLexerStaticData
...
// ConscienceLexerInit initializes any static state used to implement ConscienceLexer. By default the
// static state used to implement the lexer is lazily initialized during the first call to
// NewConscienceLexer(). You can call this function if you wish to initialize the static state ahead
// of time.
func ConscienceLexerInit() {
	staticData := &consciencelexerLexerStaticData
	staticData.once.Do(consciencelexerLexerInit)
}

// NewConscienceLexer produces a new lexer instance for the optional input antlr.CharStream.
func NewConscienceLexer(input antlr.CharStream) *ConscienceLexer {
	ConscienceLexerInit()
	l := new(ConscienceLexer)
	...
	l.GrammarFileName = "Conscience.g4"
	// TODO: l.EOF = antlr.TokenEOF

	return l
}

// ConscienceLexer tokens.
const (
	ConscienceLexerCONSCIENCE = 1
	ConscienceLexerOWNKEY     = 2
	ConscienceLexerSPLITKEY   = 3
	ConscienceLexerWS         = 4
)
