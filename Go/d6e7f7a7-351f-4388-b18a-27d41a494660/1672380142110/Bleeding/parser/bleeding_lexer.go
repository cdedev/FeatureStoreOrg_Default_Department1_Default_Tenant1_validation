...
var bleedinglexerLexerStaticData struct {
	once                   sync.Once
	serializedATN          []int32
	channelNames           []string
	modeNames              []string
...
func bleedinglexerLexerInit() {
	staticData := &bleedinglexerLexerStaticData
...
// BleedingLexerInit initializes any static state used to implement BleedingLexer. By default the
// static state used to implement the lexer is lazily initialized during the first call to
// NewBleedingLexer(). You can call this function if you wish to initialize the static state ahead
// of time.
func BleedingLexerInit() {
	staticData := &bleedinglexerLexerStaticData
	staticData.once.Do(bleedinglexerLexerInit)
}

// NewBleedingLexer produces a new lexer instance for the optional input antlr.CharStream.
func NewBleedingLexer(input antlr.CharStream) *BleedingLexer {
	BleedingLexerInit()
	l := new(BleedingLexer)
	...
	l.GrammarFileName = "Bleeding.g4"
	// TODO: l.EOF = antlr.TokenEOF

	return l
}

// BleedingLexer tokens.
const (
	BleedingLexerBLEEDING = 1
	BleedingLexerOWNKEY   = 2
	BleedingLexerSPLITKEY = 3
	BleedingLexerWS       = 4
)
