...
var patientslexerLexerStaticData struct {
	once                   sync.Once
	serializedATN          []int32
	channelNames           []string
	modeNames              []string
...
func patientslexerLexerInit() {
	staticData := &patientslexerLexerStaticData
...
// PatientsLexerInit initializes any static state used to implement PatientsLexer. By default the
// static state used to implement the lexer is lazily initialized during the first call to
// NewPatientsLexer(). You can call this function if you wish to initialize the static state ahead
// of time.
func PatientsLexerInit() {
	staticData := &patientslexerLexerStaticData
	staticData.once.Do(patientslexerLexerInit)
}

// NewPatientsLexer produces a new lexer instance for the optional input antlr.CharStream.
func NewPatientsLexer(input antlr.CharStream) *PatientsLexer {
	PatientsLexerInit()
	l := new(PatientsLexer)
	...
	l.GrammarFileName = "Patients.g4"
	// TODO: l.EOF = antlr.TokenEOF

	return l
}

// PatientsLexer tokens.
const (
	PatientsLexerPATIENTS = 1
	PatientsLexerOWNKEY   = 2
	PatientsLexerSPLITKEY = 3
	PatientsLexerWS       = 4
)
