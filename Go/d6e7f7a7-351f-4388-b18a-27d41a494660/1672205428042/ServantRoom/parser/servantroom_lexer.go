...
var servantroomlexerLexerStaticData struct {
	once                   sync.Once
	serializedATN          []int32
	channelNames           []string
	modeNames              []string
...
func servantroomlexerLexerInit() {
	staticData := &servantroomlexerLexerStaticData
...
// ServantRoomLexerInit initializes any static state used to implement ServantRoomLexer. By default the
// static state used to implement the lexer is lazily initialized during the first call to
// NewServantRoomLexer(). You can call this function if you wish to initialize the static state ahead
// of time.
func ServantRoomLexerInit() {
	staticData := &servantroomlexerLexerStaticData
	staticData.once.Do(servantroomlexerLexerInit)
}

// NewServantRoomLexer produces a new lexer instance for the optional input antlr.CharStream.
func NewServantRoomLexer(input antlr.CharStream) *ServantRoomLexer {
	ServantRoomLexerInit()
	l := new(ServantRoomLexer)
	...
	l.GrammarFileName = "ServantRoom.g4"
	// TODO: l.EOF = antlr.TokenEOF

	return l
}

// ServantRoomLexer tokens.
const (
	ServantRoomLexerSERVANTROOM = 1
	ServantRoomLexerOWNKEY      = 2
	ServantRoomLexerSPLITKEY    = 3
	ServantRoomLexerWS          = 4
)
