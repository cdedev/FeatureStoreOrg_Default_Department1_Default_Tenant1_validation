...
var meditationlexerLexerStaticData struct {
	once                   sync.Once
	serializedATN          []int32
	channelNames           []string
	modeNames              []string
...
func meditationlexerLexerInit() {
	staticData := &meditationlexerLexerStaticData
...
// MeditationLexerInit initializes any static state used to implement MeditationLexer. By default the
// static state used to implement the lexer is lazily initialized during the first call to
// NewMeditationLexer(). You can call this function if you wish to initialize the static state ahead
// of time.
func MeditationLexerInit() {
	staticData := &meditationlexerLexerStaticData
	staticData.once.Do(meditationlexerLexerInit)
}

// NewMeditationLexer produces a new lexer instance for the optional input antlr.CharStream.
func NewMeditationLexer(input antlr.CharStream) *MeditationLexer {
	MeditationLexerInit()
	l := new(MeditationLexer)
	...
	l.GrammarFileName = "Meditation.g4"
	// TODO: l.EOF = antlr.TokenEOF

	return l
}

// MeditationLexer tokens.
const (
	MeditationLexerMEDITATION = 1
	MeditationLexerOWNKEY     = 2
	MeditationLexerSPLITKEY   = 3
	MeditationLexerWS         = 4
)
