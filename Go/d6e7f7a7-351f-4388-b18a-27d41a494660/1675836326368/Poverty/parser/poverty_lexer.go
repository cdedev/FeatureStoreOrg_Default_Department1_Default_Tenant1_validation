...
var povertylexerLexerStaticData struct {
	once                   sync.Once
	serializedATN          []int32
	channelNames           []string
	modeNames              []string
...
func povertylexerLexerInit() {
	staticData := &povertylexerLexerStaticData
...
// PovertyLexerInit initializes any static state used to implement PovertyLexer. By default the
// static state used to implement the lexer is lazily initialized during the first call to
// NewPovertyLexer(). You can call this function if you wish to initialize the static state ahead
// of time.
func PovertyLexerInit() {
	staticData := &povertylexerLexerStaticData
	staticData.once.Do(povertylexerLexerInit)
}

// NewPovertyLexer produces a new lexer instance for the optional input antlr.CharStream.
func NewPovertyLexer(input antlr.CharStream) *PovertyLexer {
	PovertyLexerInit()
	l := new(PovertyLexer)
...
// PovertyLexer tokens.
const (
	PovertyLexerPOVERTY  = 1
	PovertyLexerOWNKEY   = 2
	PovertyLexerSPLITKEY = 3
	PovertyLexerWS       = 4
)
