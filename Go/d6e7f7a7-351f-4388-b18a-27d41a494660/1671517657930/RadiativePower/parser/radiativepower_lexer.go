...
type RadiativePowerLexer struct {
	*antlr.BaseLexer
	channelNames []string
	modeNames    []string
	// TODO: EOF string
...
var radiativepowerlexerLexerStaticData struct {
	once                   sync.Once
	serializedATN          []int32
	channelNames           []string
	modeNames              []string
...
func radiativepowerlexerLexerInit() {
	staticData := &radiativepowerlexerLexerStaticData
...
// RadiativePowerLexerInit initializes any static state used to implement RadiativePowerLexer. By default the
// static state used to implement the lexer is lazily initialized during the first call to
// NewRadiativePowerLexer(). You can call this function if you wish to initialize the static state ahead
// of time.
func RadiativePowerLexerInit() {
	staticData := &radiativepowerlexerLexerStaticData
	staticData.once.Do(radiativepowerlexerLexerInit)
}

// NewRadiativePowerLexer produces a new lexer instance for the optional input antlr.CharStream.
func NewRadiativePowerLexer(input antlr.CharStream) *RadiativePowerLexer {
	RadiativePowerLexerInit()
	l := new(RadiativePowerLexer)
	...
	l.GrammarFileName = "RadiativePower.g4"
	// TODO: l.EOF = antlr.TokenEOF

	return l
}

// RadiativePowerLexer tokens.
const (
	RadiativePowerLexerRADIATIVEPOWER = 1
	RadiativePowerLexerOWNKEY         = 2
	RadiativePowerLexerSPLITKEY       = 3
	RadiativePowerLexerWS             = 4
)
