...
var occasionlexerLexerStaticData struct {
	once                   sync.Once
	serializedATN          []int32
	channelNames           []string
	modeNames              []string
...
func occasionlexerLexerInit() {
	staticData := &occasionlexerLexerStaticData
	...
	staticData.serializedATN = []int32{
		...
		0, 4, 1, 1, 3, 2, 5, 3, 7, 4, 1, 0, 2, 1, 0, 49, 51, 3, 0, 9, 10, 13, 13,
...
// OccasionLexerInit initializes any static state used to implement OccasionLexer. By default the
// static state used to implement the lexer is lazily initialized during the first call to
// NewOccasionLexer(). You can call this function if you wish to initialize the static state ahead
// of time.
func OccasionLexerInit() {
	staticData := &occasionlexerLexerStaticData
	staticData.once.Do(occasionlexerLexerInit)
}

// NewOccasionLexer produces a new lexer instance for the optional input antlr.CharStream.
func NewOccasionLexer(input antlr.CharStream) *OccasionLexer {
	OccasionLexerInit()
	l := new(OccasionLexer)
	...
	l.GrammarFileName = "Occasion.g4"
	// TODO: l.EOF = antlr.TokenEOF

	return l
}

// OccasionLexer tokens.
const (
	OccasionLexerOCCASION = 1
	OccasionLexerOWNKEY   = 2
	OccasionLexerSPLITKEY = 3
	OccasionLexerWS       = 4
)
