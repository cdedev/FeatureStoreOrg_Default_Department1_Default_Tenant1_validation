...
var compactnesslexerLexerStaticData struct {
	once                   sync.Once
	serializedATN          []int32
	channelNames           []string
	modeNames              []string
...
func compactnesslexerLexerInit() {
	staticData := &compactnesslexerLexerStaticData
...
// CompactnessLexerInit initializes any static state used to implement CompactnessLexer. By default the
// static state used to implement the lexer is lazily initialized during the first call to
// NewCompactnessLexer(). You can call this function if you wish to initialize the static state ahead
// of time.
func CompactnessLexerInit() {
	staticData := &compactnesslexerLexerStaticData
	staticData.once.Do(compactnesslexerLexerInit)
}

// NewCompactnessLexer produces a new lexer instance for the optional input antlr.CharStream.
func NewCompactnessLexer(input antlr.CharStream) *CompactnessLexer {
	CompactnessLexerInit()
	l := new(CompactnessLexer)
	...
	l.GrammarFileName = "Compactness.g4"
	// TODO: l.EOF = antlr.TokenEOF

	return l
}

// CompactnessLexer tokens.
const (
	CompactnessLexerCOMPACTNESS = 1
	CompactnessLexerOWNKEY      = 2
	CompactnessLexerSPLITKEY    = 3
	CompactnessLexerWS          = 4
)
