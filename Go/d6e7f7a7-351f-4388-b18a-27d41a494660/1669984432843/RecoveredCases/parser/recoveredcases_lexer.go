...
type RecoveredCasesLexer struct {
	*antlr.BaseLexer
	channelNames []string
	modeNames    []string
	// TODO: EOF string
...
var recoveredcaseslexerLexerStaticData struct {
	once                   sync.Once
	serializedATN          []int32
	channelNames           []string
	modeNames              []string
...
func recoveredcaseslexerLexerInit() {
	staticData := &recoveredcaseslexerLexerStaticData
...
// RecoveredCasesLexerInit initializes any static state used to implement RecoveredCasesLexer. By default the
// static state used to implement the lexer is lazily initialized during the first call to
// NewRecoveredCasesLexer(). You can call this function if you wish to initialize the static state ahead
// of time.
func RecoveredCasesLexerInit() {
	staticData := &recoveredcaseslexerLexerStaticData
	staticData.once.Do(recoveredcaseslexerLexerInit)
}

// NewRecoveredCasesLexer produces a new lexer instance for the optional input antlr.CharStream.
func NewRecoveredCasesLexer(input antlr.CharStream) *RecoveredCasesLexer {
	RecoveredCasesLexerInit()
	l := new(RecoveredCasesLexer)
	...
	l.GrammarFileName = "RecoveredCases.g4"
	// TODO: l.EOF = antlr.TokenEOF

	return l
}

// RecoveredCasesLexer tokens.
const (
	RecoveredCasesLexerRECOVEREDCASES = 1
	RecoveredCasesLexerOWNKEY         = 2
	RecoveredCasesLexerSPLITKEY       = 3
	RecoveredCasesLexerWS             = 4
)
