...
var toothedlexerLexerStaticData struct {
	once                   sync.Once
	serializedATN          []int32
	channelNames           []string
	modeNames              []string
...
func toothedlexerLexerInit() {
	staticData := &toothedlexerLexerStaticData
...
// ToothedLexerInit initializes any static state used to implement ToothedLexer. By default the
// static state used to implement the lexer is lazily initialized during the first call to
// NewToothedLexer(). You can call this function if you wish to initialize the static state ahead
// of time.
func ToothedLexerInit() {
	staticData := &toothedlexerLexerStaticData
	staticData.once.Do(toothedlexerLexerInit)
}

// NewToothedLexer produces a new lexer instance for the optional input antlr.CharStream.
func NewToothedLexer(input antlr.CharStream) *ToothedLexer {
	ToothedLexerInit()
	l := new(ToothedLexer)
...
// ToothedLexer tokens.
const (
	ToothedLexerTOOTHED  = 1
	ToothedLexerOWNKEY   = 2
	ToothedLexerSPLITKEY = 3
	ToothedLexerWS       = 4
)
