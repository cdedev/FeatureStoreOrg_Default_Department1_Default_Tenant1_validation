// Code generated from /usr/local/lib/Go/d6e7f7a7-351f-4388-b18a-27d41a494660/1672289637305/Steps.g4 by ANTLR 4.10.1. DO NOT EDIT.
...
var stepslexerLexerStaticData struct {
	once                   sync.Once
	serializedATN          []int32
	channelNames           []string
	modeNames              []string
...
func stepslexerLexerInit() {
	staticData := &stepslexerLexerStaticData
...
// StepsLexerInit initializes any static state used to implement StepsLexer. By default the
// static state used to implement the lexer is lazily initialized during the first call to
// NewStepsLexer(). You can call this function if you wish to initialize the static state ahead
// of time.
func StepsLexerInit() {
	staticData := &stepslexerLexerStaticData
	staticData.once.Do(stepslexerLexerInit)
}

// NewStepsLexer produces a new lexer instance for the optional input antlr.CharStream.
