// Code generated from /usr/local/lib/Go/d6e7f7a7-351f-4388-b18a-27d41a494660/1674577813505/Calls.g4 by ANTLR 4.10.1. DO NOT EDIT.
...
var callslexerLexerStaticData struct {
	once                   sync.Once
	serializedATN          []int32
	channelNames           []string
	modeNames              []string
...
func callslexerLexerInit() {
	staticData := &callslexerLexerStaticData
...
// CallsLexerInit initializes any static state used to implement CallsLexer. By default the
// static state used to implement the lexer is lazily initialized during the first call to
// NewCallsLexer(). You can call this function if you wish to initialize the static state ahead
// of time.
func CallsLexerInit() {
	staticData := &callslexerLexerStaticData
	staticData.once.Do(callslexerLexerInit)
}

// NewCallsLexer produces a new lexer instance for the optional input antlr.CharStream.
func NewCallsLexer(input antlr.CharStream) *CallsLexer {
	CallsLexerInit()
	l := new(CallsLexer)
