...
var barometerlexerLexerStaticData struct {
	once                   sync.Once
	serializedATN          []int32
	channelNames           []string
	modeNames              []string
...
func barometerlexerLexerInit() {
	staticData := &barometerlexerLexerStaticData
...
// BarometerLexerInit initializes any static state used to implement BarometerLexer. By default the
// static state used to implement the lexer is lazily initialized during the first call to
// NewBarometerLexer(). You can call this function if you wish to initialize the static state ahead
// of time.
func BarometerLexerInit() {
	staticData := &barometerlexerLexerStaticData
	staticData.once.Do(barometerlexerLexerInit)
}

// NewBarometerLexer produces a new lexer instance for the optional input antlr.CharStream.
func NewBarometerLexer(input antlr.CharStream) *BarometerLexer {
	BarometerLexerInit()
	l := new(BarometerLexer)
	...
	l.GrammarFileName = "Barometer.g4"
	// TODO: l.EOF = antlr.TokenEOF

	return l
}

// BarometerLexer tokens.
const (
	BarometerLexerBAROMETER = 1
	BarometerLexerOWNKEY    = 2
	BarometerLexerSPLITKEY  = 3
	BarometerLexerWS        = 4
)
