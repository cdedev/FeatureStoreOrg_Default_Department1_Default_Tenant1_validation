...
var monetarylexerLexerStaticData struct {
	once                   sync.Once
	serializedATN          []int32
	channelNames           []string
	modeNames              []string
...
func monetarylexerLexerInit() {
	staticData := &monetarylexerLexerStaticData
...
// MonetaryLexerInit initializes any static state used to implement MonetaryLexer. By default the
// static state used to implement the lexer is lazily initialized during the first call to
// NewMonetaryLexer(). You can call this function if you wish to initialize the static state ahead
// of time.
func MonetaryLexerInit() {
	staticData := &monetarylexerLexerStaticData
	staticData.once.Do(monetarylexerLexerInit)
}

// NewMonetaryLexer produces a new lexer instance for the optional input antlr.CharStream.
func NewMonetaryLexer(input antlr.CharStream) *MonetaryLexer {
	MonetaryLexerInit()
	l := new(MonetaryLexer)
	...
	l.GrammarFileName = "Monetary.g4"
	// TODO: l.EOF = antlr.TokenEOF

	return l
}

// MonetaryLexer tokens.
const (
	MonetaryLexerMONETARY = 1
	MonetaryLexerOWNKEY   = 2
	MonetaryLexerSPLITKEY = 3
	MonetaryLexerWS       = 4
)
