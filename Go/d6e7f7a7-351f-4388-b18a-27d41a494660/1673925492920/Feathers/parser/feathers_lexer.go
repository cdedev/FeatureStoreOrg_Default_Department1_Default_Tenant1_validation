...
var featherslexerLexerStaticData struct {
	once                   sync.Once
	serializedATN          []int32
	channelNames           []string
	modeNames              []string
...
func featherslexerLexerInit() {
	staticData := &featherslexerLexerStaticData
...
// FeathersLexerInit initializes any static state used to implement FeathersLexer. By default the
// static state used to implement the lexer is lazily initialized during the first call to
// NewFeathersLexer(). You can call this function if you wish to initialize the static state ahead
// of time.
func FeathersLexerInit() {
	staticData := &featherslexerLexerStaticData
	staticData.once.Do(featherslexerLexerInit)
}

// NewFeathersLexer produces a new lexer instance for the optional input antlr.CharStream.
func NewFeathersLexer(input antlr.CharStream) *FeathersLexer {
	FeathersLexerInit()
	l := new(FeathersLexer)
	...
	l.GrammarFileName = "Feathers.g4"
	// TODO: l.EOF = antlr.TokenEOF

	return l
}

// FeathersLexer tokens.
const (
	FeathersLexerFEATHERS = 1
	FeathersLexerOWNKEY   = 2
	FeathersLexerSPLITKEY = 3
	FeathersLexerWS       = 4
)
