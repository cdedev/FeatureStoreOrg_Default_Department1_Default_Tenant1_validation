...
var sexualthemeslexerLexerStaticData struct {
	once                   sync.Once
	serializedATN          []int32
	channelNames           []string
	modeNames              []string
...
func sexualthemeslexerLexerInit() {
	staticData := &sexualthemeslexerLexerStaticData
...
// SexualThemesLexerInit initializes any static state used to implement SexualThemesLexer. By default the
// static state used to implement the lexer is lazily initialized during the first call to
// NewSexualThemesLexer(). You can call this function if you wish to initialize the static state ahead
// of time.
func SexualThemesLexerInit() {
	staticData := &sexualthemeslexerLexerStaticData
	staticData.once.Do(sexualthemeslexerLexerInit)
}

// NewSexualThemesLexer produces a new lexer instance for the optional input antlr.CharStream.
func NewSexualThemesLexer(input antlr.CharStream) *SexualThemesLexer {
	SexualThemesLexerInit()
	l := new(SexualThemesLexer)
	...
	l.GrammarFileName = "SexualThemes.g4"
	// TODO: l.EOF = antlr.TokenEOF

	return l
}

// SexualThemesLexer tokens.
const (
	SexualThemesLexerSEXUALTHEMES = 1
	SexualThemesLexerOWNKEY       = 2
	SexualThemesLexerSPLITKEY     = 3
	SexualThemesLexerWS           = 4
)
