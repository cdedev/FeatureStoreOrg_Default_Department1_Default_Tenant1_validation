...
var basepricelexerLexerStaticData struct {
	once                   sync.Once
	serializedATN          []int32
	channelNames           []string
	modeNames              []string
...
func basepricelexerLexerInit() {
	staticData := &basepricelexerLexerStaticData
...
// BasePriceLexerInit initializes any static state used to implement BasePriceLexer. By default the
// static state used to implement the lexer is lazily initialized during the first call to
// NewBasePriceLexer(). You can call this function if you wish to initialize the static state ahead
// of time.
func BasePriceLexerInit() {
	staticData := &basepricelexerLexerStaticData
	staticData.once.Do(basepricelexerLexerInit)
}

// NewBasePriceLexer produces a new lexer instance for the optional input antlr.CharStream.
func NewBasePriceLexer(input antlr.CharStream) *BasePriceLexer {
	BasePriceLexerInit()
	l := new(BasePriceLexer)
	...
	l.GrammarFileName = "BasePrice.g4"
	// TODO: l.EOF = antlr.TokenEOF

	return l
}

// BasePriceLexer tokens.
const (
	BasePriceLexerBASEPRICE = 1
	BasePriceLexerOWNKEY    = 2
	BasePriceLexerSPLITKEY  = 3
	BasePriceLexerWS        = 4
)
