...
var maymaxtemplexerLexerStaticData struct {
	once                   sync.Once
	serializedATN          []int32
	channelNames           []string
	modeNames              []string
...
func maymaxtemplexerLexerInit() {
	staticData := &maymaxtemplexerLexerStaticData
...
// MayMaxtempLexerInit initializes any static state used to implement MayMaxtempLexer. By default the
// static state used to implement the lexer is lazily initialized during the first call to
// NewMayMaxtempLexer(). You can call this function if you wish to initialize the static state ahead
// of time.
func MayMaxtempLexerInit() {
	staticData := &maymaxtemplexerLexerStaticData
	staticData.once.Do(maymaxtemplexerLexerInit)
}

// NewMayMaxtempLexer produces a new lexer instance for the optional input antlr.CharStream.
func NewMayMaxtempLexer(input antlr.CharStream) *MayMaxtempLexer {
	MayMaxtempLexerInit()
	l := new(MayMaxtempLexer)
	...
	l.GrammarFileName = "MayMaxtemp.g4"
	// TODO: l.EOF = antlr.TokenEOF

	return l
}

// MayMaxtempLexer tokens.
const (
	MayMaxtempLexerMAYMAXTEMP = 1
	MayMaxtempLexerOWNKEY     = 2
	MayMaxtempLexerSPLITKEY   = 3
	MayMaxtempLexerWS         = 4
)
