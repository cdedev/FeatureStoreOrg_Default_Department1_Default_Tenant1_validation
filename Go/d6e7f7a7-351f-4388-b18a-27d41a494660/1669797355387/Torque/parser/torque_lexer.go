...
var torquelexerLexerStaticData struct {
	once                   sync.Once
	serializedATN          []int32
	channelNames           []string
	modeNames              []string
...
func torquelexerLexerInit() {
	staticData := &torquelexerLexerStaticData
...
// TorqueLexerInit initializes any static state used to implement TorqueLexer. By default the
// static state used to implement the lexer is lazily initialized during the first call to
// NewTorqueLexer(). You can call this function if you wish to initialize the static state ahead
// of time.
func TorqueLexerInit() {
	staticData := &torquelexerLexerStaticData
	staticData.once.Do(torquelexerLexerInit)
}

// NewTorqueLexer produces a new lexer instance for the optional input antlr.CharStream.
func NewTorqueLexer(input antlr.CharStream) *TorqueLexer {
	TorqueLexerInit()
	l := new(TorqueLexer)
