...
var junmaxtemplexerLexerStaticData struct {
	once                   sync.Once
	serializedATN          []int32
	channelNames           []string
	modeNames              []string
...
func junmaxtemplexerLexerInit() {
	staticData := &junmaxtemplexerLexerStaticData
...
// JunMaxtempLexerInit initializes any static state used to implement JunMaxtempLexer. By default the
// static state used to implement the lexer is lazily initialized during the first call to
// NewJunMaxtempLexer(). You can call this function if you wish to initialize the static state ahead
// of time.
func JunMaxtempLexerInit() {
	staticData := &junmaxtemplexerLexerStaticData
	staticData.once.Do(junmaxtemplexerLexerInit)
}

// NewJunMaxtempLexer produces a new lexer instance for the optional input antlr.CharStream.
func NewJunMaxtempLexer(input antlr.CharStream) *JunMaxtempLexer {
	JunMaxtempLexerInit()
	l := new(JunMaxtempLexer)
	...
	l.GrammarFileName = "JunMaxtemp.g4"
	// TODO: l.EOF = antlr.TokenEOF

	return l
}

// JunMaxtempLexer tokens.
const (
	JunMaxtempLexerJUNMAXTEMP = 1
	JunMaxtempLexerOWNKEY     = 2
	JunMaxtempLexerSPLITKEY   = 3
	JunMaxtempLexerWS         = 4
)
