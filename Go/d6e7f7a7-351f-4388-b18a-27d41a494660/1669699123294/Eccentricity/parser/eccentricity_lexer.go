...
var eccentricitylexerLexerStaticData struct {
	once                   sync.Once
	serializedATN          []int32
	channelNames           []string
	modeNames              []string
...
func eccentricitylexerLexerInit() {
	staticData := &eccentricitylexerLexerStaticData
...
// EccentricityLexerInit initializes any static state used to implement EccentricityLexer. By default the
// static state used to implement the lexer is lazily initialized during the first call to
// NewEccentricityLexer(). You can call this function if you wish to initialize the static state ahead
// of time.
func EccentricityLexerInit() {
	staticData := &eccentricitylexerLexerStaticData
	staticData.once.Do(eccentricitylexerLexerInit)
}

// NewEccentricityLexer produces a new lexer instance for the optional input antlr.CharStream.
func NewEccentricityLexer(input antlr.CharStream) *EccentricityLexer {
	EccentricityLexerInit()
	l := new(EccentricityLexer)
	...
	l.GrammarFileName = "Eccentricity.g4"
	// TODO: l.EOF = antlr.TokenEOF

	return l
}

// EccentricityLexer tokens.
const (
	EccentricityLexerECCENTRICITY = 1
	EccentricityLexerOWNKEY       = 2
	EccentricityLexerSPLITKEY     = 3
	EccentricityLexerWS           = 4
)
