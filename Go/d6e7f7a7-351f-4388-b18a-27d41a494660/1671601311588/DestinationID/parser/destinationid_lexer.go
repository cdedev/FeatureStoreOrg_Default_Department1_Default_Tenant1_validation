...
type DestinationIDLexer struct {
	*antlr.BaseLexer
	channelNames []string
	modeNames    []string
	// TODO: EOF string
...
var destinationidlexerLexerStaticData struct {
	once                   sync.Once
	serializedATN          []int32
	channelNames           []string
	modeNames              []string
...
func destinationidlexerLexerInit() {
	staticData := &destinationidlexerLexerStaticData
...
// DestinationIDLexerInit initializes any static state used to implement DestinationIDLexer. By default the
// static state used to implement the lexer is lazily initialized during the first call to
// NewDestinationIDLexer(). You can call this function if you wish to initialize the static state ahead
// of time.
func DestinationIDLexerInit() {
	staticData := &destinationidlexerLexerStaticData
	staticData.once.Do(destinationidlexerLexerInit)
}

// NewDestinationIDLexer produces a new lexer instance for the optional input antlr.CharStream.
func NewDestinationIDLexer(input antlr.CharStream) *DestinationIDLexer {
	DestinationIDLexerInit()
	l := new(DestinationIDLexer)
	...
	l.GrammarFileName = "DestinationID.g4"
	// TODO: l.EOF = antlr.TokenEOF

	return l
}

// DestinationIDLexer tokens.
const (
	DestinationIDLexerDESTINATIONID = 1
	DestinationIDLexerOWNKEY        = 2
	DestinationIDLexerSPLITKEY      = 3
	DestinationIDLexerWS            = 4
)
