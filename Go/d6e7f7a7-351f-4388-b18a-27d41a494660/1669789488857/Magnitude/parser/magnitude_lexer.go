...
var magnitudelexerLexerStaticData struct {
	once                   sync.Once
	serializedATN          []int32
	channelNames           []string
	modeNames              []string
...
func magnitudelexerLexerInit() {
	staticData := &magnitudelexerLexerStaticData
...
// MagnitudeLexerInit initializes any static state used to implement MagnitudeLexer. By default the
// static state used to implement the lexer is lazily initialized during the first call to
// NewMagnitudeLexer(). You can call this function if you wish to initialize the static state ahead
// of time.
func MagnitudeLexerInit() {
	staticData := &magnitudelexerLexerStaticData
	staticData.once.Do(magnitudelexerLexerInit)
}

// NewMagnitudeLexer produces a new lexer instance for the optional input antlr.CharStream.
func NewMagnitudeLexer(input antlr.CharStream) *MagnitudeLexer {
	MagnitudeLexerInit()
	l := new(MagnitudeLexer)
	...
	l.GrammarFileName = "Magnitude.g4"
	// TODO: l.EOF = antlr.TokenEOF

	return l
}

// MagnitudeLexer tokens.
const (
	MagnitudeLexerMAGNITUDE = 1
	MagnitudeLexerOWNKEY    = 2
	MagnitudeLexerSPLITKEY  = 3
	MagnitudeLexerWS        = 4
)
