...
var tiltlexerLexerStaticData struct {
	once                   sync.Once
	serializedATN          []int32
	channelNames           []string
	modeNames              []string
...
func tiltlexerLexerInit() {
	staticData := &tiltlexerLexerStaticData
...
// TiltLexerInit initializes any static state used to implement TiltLexer. By default the
// static state used to implement the lexer is lazily initialized during the first call to
// NewTiltLexer(). You can call this function if you wish to initialize the static state ahead
// of time.
func TiltLexerInit() {
	staticData := &tiltlexerLexerStaticData
	staticData.once.Do(tiltlexerLexerInit)
}

// NewTiltLexer produces a new lexer instance for the optional input antlr.CharStream.
func NewTiltLexer(input antlr.CharStream) *TiltLexer {
	TiltLexerInit()
	l := new(TiltLexer)
