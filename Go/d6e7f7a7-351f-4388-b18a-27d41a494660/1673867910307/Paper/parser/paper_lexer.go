...
var paperlexerLexerStaticData struct {
	once                   sync.Once
	serializedATN          []int32
	channelNames           []string
	modeNames              []string
...
func paperlexerLexerInit() {
	staticData := &paperlexerLexerStaticData
...
// PaperLexerInit initializes any static state used to implement PaperLexer. By default the
// static state used to implement the lexer is lazily initialized during the first call to
// NewPaperLexer(). You can call this function if you wish to initialize the static state ahead
// of time.
func PaperLexerInit() {
	staticData := &paperlexerLexerStaticData
	staticData.once.Do(paperlexerLexerInit)
}

// NewPaperLexer produces a new lexer instance for the optional input antlr.CharStream.
func NewPaperLexer(input antlr.CharStream) *PaperLexer {
	PaperLexerInit()
	l := new(PaperLexer)
