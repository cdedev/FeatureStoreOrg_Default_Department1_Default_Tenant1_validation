...
var snoring_ratelexerLexerStaticData struct {
	once                   sync.Once
	serializedATN          []int32
	channelNames           []string
	modeNames              []string
...
func snoring_ratelexerLexerInit() {
	staticData := &snoring_ratelexerLexerStaticData
...
// Snoring_rateLexerInit initializes any static state used to implement Snoring_rateLexer. By default the
// static state used to implement the lexer is lazily initialized during the first call to
// NewSnoring_rateLexer(). You can call this function if you wish to initialize the static state ahead
// of time.
func Snoring_rateLexerInit() {
	staticData := &snoring_ratelexerLexerStaticData
	staticData.once.Do(snoring_ratelexerLexerInit)
}

// NewSnoring_rateLexer produces a new lexer instance for the optional input antlr.CharStream.
func NewSnoring_rateLexer(input antlr.CharStream) *Snoring_rateLexer {
	Snoring_rateLexerInit()
	l := new(Snoring_rateLexer)
	...
	l.GrammarFileName = "Snoring_rate.g4"
	// TODO: l.EOF = antlr.TokenEOF

	return l
}

// Snoring_rateLexer tokens.
const (
	Snoring_rateLexerSNORING_RATE = 1
	Snoring_rateLexerOWNKEY       = 2
	Snoring_rateLexerSPLITKEY     = 3
	Snoring_rateLexerWS           = 4
)
