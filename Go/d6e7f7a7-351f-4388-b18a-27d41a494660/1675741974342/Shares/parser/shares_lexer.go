...
var shareslexerLexerStaticData struct {
	once                   sync.Once
	serializedATN          []int32
	channelNames           []string
	modeNames              []string
...
func shareslexerLexerInit() {
	staticData := &shareslexerLexerStaticData
...
// SharesLexerInit initializes any static state used to implement SharesLexer. By default the
// static state used to implement the lexer is lazily initialized during the first call to
// NewSharesLexer(). You can call this function if you wish to initialize the static state ahead
// of time.
func SharesLexerInit() {
	staticData := &shareslexerLexerStaticData
	staticData.once.Do(shareslexerLexerInit)
}

// NewSharesLexer produces a new lexer instance for the optional input antlr.CharStream.
func NewSharesLexer(input antlr.CharStream) *SharesLexer {
	SharesLexerInit()
	l := new(SharesLexer)
