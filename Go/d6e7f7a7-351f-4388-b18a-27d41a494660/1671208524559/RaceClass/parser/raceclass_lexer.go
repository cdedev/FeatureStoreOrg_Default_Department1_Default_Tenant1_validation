...
var raceclasslexerLexerStaticData struct {
	once                   sync.Once
	serializedATN          []int32
	channelNames           []string
	modeNames              []string
...
func raceclasslexerLexerInit() {
	staticData := &raceclasslexerLexerStaticData
...
// RaceClassLexerInit initializes any static state used to implement RaceClassLexer. By default the
// static state used to implement the lexer is lazily initialized during the first call to
// NewRaceClassLexer(). You can call this function if you wish to initialize the static state ahead
// of time.
func RaceClassLexerInit() {
	staticData := &raceclasslexerLexerStaticData
	staticData.once.Do(raceclasslexerLexerInit)
}

// NewRaceClassLexer produces a new lexer instance for the optional input antlr.CharStream.
func NewRaceClassLexer(input antlr.CharStream) *RaceClassLexer {
	RaceClassLexerInit()
	l := new(RaceClassLexer)
	...
	l.GrammarFileName = "RaceClass.g4"
	// TODO: l.EOF = antlr.TokenEOF

	return l
}

// RaceClassLexer tokens.
const (
	RaceClassLexerRACECLASS = 1
	RaceClassLexerOWNKEY    = 2
	RaceClassLexerSPLITKEY  = 3
	RaceClassLexerWS        = 4
)
