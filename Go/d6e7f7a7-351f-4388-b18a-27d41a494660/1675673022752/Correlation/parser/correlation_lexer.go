...
var correlationlexerLexerStaticData struct {
	once                   sync.Once
	serializedATN          []int32
	channelNames           []string
	modeNames              []string
...
func correlationlexerLexerInit() {
	staticData := &correlationlexerLexerStaticData
...
// CorrelationLexerInit initializes any static state used to implement CorrelationLexer. By default the
// static state used to implement the lexer is lazily initialized during the first call to
// NewCorrelationLexer(). You can call this function if you wish to initialize the static state ahead
// of time.
func CorrelationLexerInit() {
	staticData := &correlationlexerLexerStaticData
	staticData.once.Do(correlationlexerLexerInit)
}

// NewCorrelationLexer produces a new lexer instance for the optional input antlr.CharStream.
func NewCorrelationLexer(input antlr.CharStream) *CorrelationLexer {
	CorrelationLexerInit()
	l := new(CorrelationLexer)
	...
	l.GrammarFileName = "Correlation.g4"
	// TODO: l.EOF = antlr.TokenEOF

	return l
}

// CorrelationLexer tokens.
const (
	CorrelationLexerCORRELATION = 1
	CorrelationLexerOWNKEY      = 2
	CorrelationLexerSPLITKEY    = 3
	CorrelationLexerWS          = 4
)
