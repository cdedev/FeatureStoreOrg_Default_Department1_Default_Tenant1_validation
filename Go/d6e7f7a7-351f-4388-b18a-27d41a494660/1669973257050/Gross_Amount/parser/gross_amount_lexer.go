...
var gross_amountlexerLexerStaticData struct {
	once                   sync.Once
	serializedATN          []int32
	channelNames           []string
	modeNames              []string
...
func gross_amountlexerLexerInit() {
	staticData := &gross_amountlexerLexerStaticData
...
// Gross_AmountLexerInit initializes any static state used to implement Gross_AmountLexer. By default the
// static state used to implement the lexer is lazily initialized during the first call to
// NewGross_AmountLexer(). You can call this function if you wish to initialize the static state ahead
// of time.
func Gross_AmountLexerInit() {
	staticData := &gross_amountlexerLexerStaticData
	staticData.once.Do(gross_amountlexerLexerInit)
}

// NewGross_AmountLexer produces a new lexer instance for the optional input antlr.CharStream.
func NewGross_AmountLexer(input antlr.CharStream) *Gross_AmountLexer {
	Gross_AmountLexerInit()
	l := new(Gross_AmountLexer)
	...
	l.GrammarFileName = "Gross_Amount.g4"
	// TODO: l.EOF = antlr.TokenEOF

	return l
}

// Gross_AmountLexer tokens.
const (
	Gross_AmountLexerGROSS_AMOUNT = 1
	Gross_AmountLexerOWNKEY       = 2
	Gross_AmountLexerSPLITKEY     = 3
	Gross_AmountLexerWS           = 4
)
