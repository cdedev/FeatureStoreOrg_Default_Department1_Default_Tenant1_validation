...
type FuelConsumptionLexer struct {
	*antlr.BaseLexer
	channelNames []string
	modeNames    []string
	// TODO: EOF string
...
var fuelconsumptionlexerLexerStaticData struct {
	once                   sync.Once
	serializedATN          []int32
	channelNames           []string
	modeNames              []string
...
func fuelconsumptionlexerLexerInit() {
	staticData := &fuelconsumptionlexerLexerStaticData
...
// FuelConsumptionLexerInit initializes any static state used to implement FuelConsumptionLexer. By default the
// static state used to implement the lexer is lazily initialized during the first call to
// NewFuelConsumptionLexer(). You can call this function if you wish to initialize the static state ahead
// of time.
func FuelConsumptionLexerInit() {
	staticData := &fuelconsumptionlexerLexerStaticData
	staticData.once.Do(fuelconsumptionlexerLexerInit)
}

// NewFuelConsumptionLexer produces a new lexer instance for the optional input antlr.CharStream.
func NewFuelConsumptionLexer(input antlr.CharStream) *FuelConsumptionLexer {
	FuelConsumptionLexerInit()
	l := new(FuelConsumptionLexer)
	...
	l.GrammarFileName = "FuelConsumption.g4"
	// TODO: l.EOF = antlr.TokenEOF

	return l
}

// FuelConsumptionLexer tokens.
const (
	FuelConsumptionLexerFUELCONSUMPTION = 1
	FuelConsumptionLexerOWNKEY          = 2
	FuelConsumptionLexerSPLITKEY        = 3
	FuelConsumptionLexerWS              = 4
)
