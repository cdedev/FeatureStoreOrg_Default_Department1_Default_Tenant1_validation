...
var berylliumlexerLexerStaticData struct {
	once                   sync.Once
	serializedATN          []int32
	channelNames           []string
	modeNames              []string
...
func berylliumlexerLexerInit() {
	staticData := &berylliumlexerLexerStaticData
...
// BerylliumLexerInit initializes any static state used to implement BerylliumLexer. By default the
// static state used to implement the lexer is lazily initialized during the first call to
// NewBerylliumLexer(). You can call this function if you wish to initialize the static state ahead
// of time.
func BerylliumLexerInit() {
	staticData := &berylliumlexerLexerStaticData
	staticData.once.Do(berylliumlexerLexerInit)
}

// NewBerylliumLexer produces a new lexer instance for the optional input antlr.CharStream.
func NewBerylliumLexer(input antlr.CharStream) *BerylliumLexer {
	BerylliumLexerInit()
	l := new(BerylliumLexer)
	...
	l.GrammarFileName = "Beryllium.g4"
	// TODO: l.EOF = antlr.TokenEOF

	return l
}

// BerylliumLexer tokens.
const (
	BerylliumLexerBERYLLIUM = 1
	BerylliumLexerOWNKEY    = 2
	BerylliumLexerSPLITKEY  = 3
	BerylliumLexerWS        = 4
)
