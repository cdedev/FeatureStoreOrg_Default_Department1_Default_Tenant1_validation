...
var pageslexerLexerStaticData struct {
	once                   sync.Once
	serializedATN          []int32
	channelNames           []string
	modeNames              []string
...
func pageslexerLexerInit() {
	staticData := &pageslexerLexerStaticData
...
// PagesLexerInit initializes any static state used to implement PagesLexer. By default the
// static state used to implement the lexer is lazily initialized during the first call to
// NewPagesLexer(). You can call this function if you wish to initialize the static state ahead
// of time.
func PagesLexerInit() {
	staticData := &pageslexerLexerStaticData
	staticData.once.Do(pageslexerLexerInit)
}

// NewPagesLexer produces a new lexer instance for the optional input antlr.CharStream.
func NewPagesLexer(input antlr.CharStream) *PagesLexer {
	PagesLexerInit()
	l := new(PagesLexer)
