...
var speedlexerLexerStaticData struct {
	once                   sync.Once
	serializedATN          []int32
	channelNames           []string
	modeNames              []string
...
func speedlexerLexerInit() {
	staticData := &speedlexerLexerStaticData
...
// SpeedLexerInit initializes any static state used to implement SpeedLexer. By default the
// static state used to implement the lexer is lazily initialized during the first call to
// NewSpeedLexer(). You can call this function if you wish to initialize the static state ahead
// of time.
func SpeedLexerInit() {
	staticData := &speedlexerLexerStaticData
	staticData.once.Do(speedlexerLexerInit)
}

// NewSpeedLexer produces a new lexer instance for the optional input antlr.CharStream.
func NewSpeedLexer(input antlr.CharStream) *SpeedLexer {
	SpeedLexerInit()
	l := new(SpeedLexer)
