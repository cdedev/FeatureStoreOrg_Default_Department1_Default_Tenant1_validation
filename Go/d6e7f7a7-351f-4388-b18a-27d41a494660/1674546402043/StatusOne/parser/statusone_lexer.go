...
var statusonelexerLexerStaticData struct {
	once                   sync.Once
	serializedATN          []int32
	channelNames           []string
	modeNames              []string
...
func statusonelexerLexerInit() {
	staticData := &statusonelexerLexerStaticData
...
// StatusOneLexerInit initializes any static state used to implement StatusOneLexer. By default the
// static state used to implement the lexer is lazily initialized during the first call to
// NewStatusOneLexer(). You can call this function if you wish to initialize the static state ahead
// of time.
func StatusOneLexerInit() {
	staticData := &statusonelexerLexerStaticData
	staticData.once.Do(statusonelexerLexerInit)
}

// NewStatusOneLexer produces a new lexer instance for the optional input antlr.CharStream.
func NewStatusOneLexer(input antlr.CharStream) *StatusOneLexer {
	StatusOneLexerInit()
	l := new(StatusOneLexer)
	...
	l.GrammarFileName = "StatusOne.g4"
	// TODO: l.EOF = antlr.TokenEOF

	return l
}

// StatusOneLexer tokens.
const (
	StatusOneLexerSTATUSONE = 1
	StatusOneLexerOWNKEY    = 2
	StatusOneLexerSPLITKEY  = 3
	StatusOneLexerWS        = 4
)
