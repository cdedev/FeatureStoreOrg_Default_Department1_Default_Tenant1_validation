...
var carbonlexerLexerStaticData struct {
	once                   sync.Once
	serializedATN          []int32
	channelNames           []string
	modeNames              []string
...
func carbonlexerLexerInit() {
	staticData := &carbonlexerLexerStaticData
...
// CarbonLexerInit initializes any static state used to implement CarbonLexer. By default the
// static state used to implement the lexer is lazily initialized during the first call to
// NewCarbonLexer(). You can call this function if you wish to initialize the static state ahead
// of time.
func CarbonLexerInit() {
	staticData := &carbonlexerLexerStaticData
	staticData.once.Do(carbonlexerLexerInit)
}

// NewCarbonLexer produces a new lexer instance for the optional input antlr.CharStream.
func NewCarbonLexer(input antlr.CharStream) *CarbonLexer {
	CarbonLexerInit()
	l := new(CarbonLexer)
