...
var weightlexerLexerStaticData struct {
	once                   sync.Once
	serializedATN          []int32
	channelNames           []string
	modeNames              []string
...
func weightlexerLexerInit() {
	staticData := &weightlexerLexerStaticData
...
// WeightLexerInit initializes any static state used to implement WeightLexer. By default the
// static state used to implement the lexer is lazily initialized during the first call to
// NewWeightLexer(). You can call this function if you wish to initialize the static state ahead
// of time.
func WeightLexerInit() {
	staticData := &weightlexerLexerStaticData
	staticData.once.Do(weightlexerLexerInit)
}

// NewWeightLexer produces a new lexer instance for the optional input antlr.CharStream.
func NewWeightLexer(input antlr.CharStream) *WeightLexer {
	WeightLexerInit()
	l := new(WeightLexer)
