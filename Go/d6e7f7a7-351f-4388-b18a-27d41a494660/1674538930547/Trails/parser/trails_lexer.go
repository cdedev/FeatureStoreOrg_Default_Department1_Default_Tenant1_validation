...
var trailslexerLexerStaticData struct {
	once                   sync.Once
	serializedATN          []int32
	channelNames           []string
	modeNames              []string
...
func trailslexerLexerInit() {
	staticData := &trailslexerLexerStaticData
...
// TrailsLexerInit initializes any static state used to implement TrailsLexer. By default the
// static state used to implement the lexer is lazily initialized during the first call to
// NewTrailsLexer(). You can call this function if you wish to initialize the static state ahead
// of time.
func TrailsLexerInit() {
	staticData := &trailslexerLexerStaticData
	staticData.once.Do(trailslexerLexerInit)
}

// NewTrailsLexer produces a new lexer instance for the optional input antlr.CharStream.
func NewTrailsLexer(input antlr.CharStream) *TrailsLexer {
	TrailsLexerInit()
	l := new(TrailsLexer)
