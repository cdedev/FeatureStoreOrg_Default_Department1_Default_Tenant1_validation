...
type RevisedAmountLexer struct {
	*antlr.BaseLexer
	channelNames []string
	modeNames    []string
	// TODO: EOF string
...
var revisedamountlexerLexerStaticData struct {
	once                   sync.Once
	serializedATN          []int32
	channelNames           []string
	modeNames              []string
...
func revisedamountlexerLexerInit() {
	staticData := &revisedamountlexerLexerStaticData
...
// RevisedAmountLexerInit initializes any static state used to implement RevisedAmountLexer. By default the
// static state used to implement the lexer is lazily initialized during the first call to
// NewRevisedAmountLexer(). You can call this function if you wish to initialize the static state ahead
// of time.
func RevisedAmountLexerInit() {
	staticData := &revisedamountlexerLexerStaticData
	staticData.once.Do(revisedamountlexerLexerInit)
}

// NewRevisedAmountLexer produces a new lexer instance for the optional input antlr.CharStream.
func NewRevisedAmountLexer(input antlr.CharStream) *RevisedAmountLexer {
	RevisedAmountLexerInit()
	l := new(RevisedAmountLexer)
	...
	l.GrammarFileName = "RevisedAmount.g4"
	// TODO: l.EOF = antlr.TokenEOF

	return l
}

// RevisedAmountLexer tokens.
const (
	RevisedAmountLexerREVISEDAMOUNT = 1
	RevisedAmountLexerOWNKEY        = 2
	RevisedAmountLexerSPLITKEY      = 3
	RevisedAmountLexerWS            = 4
)
