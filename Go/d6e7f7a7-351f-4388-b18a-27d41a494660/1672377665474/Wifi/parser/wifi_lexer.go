...
var wifilexerLexerStaticData struct {
	once                   sync.Once
	serializedATN          []int32
	channelNames           []string
	modeNames              []string
...
func wifilexerLexerInit() {
	staticData := &wifilexerLexerStaticData
...
// WifiLexerInit initializes any static state used to implement WifiLexer. By default the
// static state used to implement the lexer is lazily initialized during the first call to
// NewWifiLexer(). You can call this function if you wish to initialize the static state ahead
// of time.
func WifiLexerInit() {
	staticData := &wifilexerLexerStaticData
	staticData.once.Do(wifilexerLexerInit)
}

// NewWifiLexer produces a new lexer instance for the optional input antlr.CharStream.
func NewWifiLexer(input antlr.CharStream) *WifiLexer {
	WifiLexerInit()
	l := new(WifiLexer)
