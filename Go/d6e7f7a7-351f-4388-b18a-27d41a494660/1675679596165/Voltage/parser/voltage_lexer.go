...
var voltagelexerLexerStaticData struct {
	once                   sync.Once
	serializedATN          []int32
	channelNames           []string
	modeNames              []string
...
func voltagelexerLexerInit() {
	staticData := &voltagelexerLexerStaticData
...
// VoltageLexerInit initializes any static state used to implement VoltageLexer. By default the
// static state used to implement the lexer is lazily initialized during the first call to
// NewVoltageLexer(). You can call this function if you wish to initialize the static state ahead
// of time.
func VoltageLexerInit() {
	staticData := &voltagelexerLexerStaticData
	staticData.once.Do(voltagelexerLexerInit)
}

// NewVoltageLexer produces a new lexer instance for the optional input antlr.CharStream.
func NewVoltageLexer(input antlr.CharStream) *VoltageLexer {
	VoltageLexerInit()
	l := new(VoltageLexer)
...
// VoltageLexer tokens.
const (
	VoltageLexerVOLTAGE  = 1
	VoltageLexerOWNKEY   = 2
	VoltageLexerSPLITKEY = 3
	VoltageLexerWS       = 4
)
