...
var baselinelexerLexerStaticData struct {
	once                   sync.Once
	serializedATN          []int32
	channelNames           []string
	modeNames              []string
...
func baselinelexerLexerInit() {
	staticData := &baselinelexerLexerStaticData
...
// BaselineLexerInit initializes any static state used to implement BaselineLexer. By default the
// static state used to implement the lexer is lazily initialized during the first call to
// NewBaselineLexer(). You can call this function if you wish to initialize the static state ahead
// of time.
func BaselineLexerInit() {
	staticData := &baselinelexerLexerStaticData
	staticData.once.Do(baselinelexerLexerInit)
}

// NewBaselineLexer produces a new lexer instance for the optional input antlr.CharStream.
func NewBaselineLexer(input antlr.CharStream) *BaselineLexer {
	BaselineLexerInit()
	l := new(BaselineLexer)
	...
	l.GrammarFileName = "Baseline.g4"
	// TODO: l.EOF = antlr.TokenEOF

	return l
}

// BaselineLexer tokens.
const (
	BaselineLexerBASELINE = 1
	BaselineLexerOWNKEY   = 2
	BaselineLexerSPLITKEY = 3
	BaselineLexerWS       = 4
)
