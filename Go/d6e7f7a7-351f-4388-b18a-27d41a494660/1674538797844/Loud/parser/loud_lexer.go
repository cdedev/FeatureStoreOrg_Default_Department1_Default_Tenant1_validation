...
var loudlexerLexerStaticData struct {
	once                   sync.Once
	serializedATN          []int32
	channelNames           []string
	modeNames              []string
...
func loudlexerLexerInit() {
	staticData := &loudlexerLexerStaticData
...
// LoudLexerInit initializes any static state used to implement LoudLexer. By default the
// static state used to implement the lexer is lazily initialized during the first call to
// NewLoudLexer(). You can call this function if you wish to initialize the static state ahead
// of time.
func LoudLexerInit() {
	staticData := &loudlexerLexerStaticData
	staticData.once.Do(loudlexerLexerInit)
}

// NewLoudLexer produces a new lexer instance for the optional input antlr.CharStream.
func NewLoudLexer(input antlr.CharStream) *LoudLexer {
	LoudLexerInit()
	l := new(LoudLexer)
