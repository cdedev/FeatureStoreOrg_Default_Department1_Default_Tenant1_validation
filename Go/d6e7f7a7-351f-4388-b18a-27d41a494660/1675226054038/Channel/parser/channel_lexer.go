...
var channellexerLexerStaticData struct {
	once                   sync.Once
	serializedATN          []int32
	channelNames           []string
	modeNames              []string
...
func channellexerLexerInit() {
	staticData := &channellexerLexerStaticData
...
// ChannelLexerInit initializes any static state used to implement ChannelLexer. By default the
// static state used to implement the lexer is lazily initialized during the first call to
// NewChannelLexer(). You can call this function if you wish to initialize the static state ahead
// of time.
func ChannelLexerInit() {
	staticData := &channellexerLexerStaticData
	staticData.once.Do(channellexerLexerInit)
}

// NewChannelLexer produces a new lexer instance for the optional input antlr.CharStream.
func NewChannelLexer(input antlr.CharStream) *ChannelLexer {
	ChannelLexerInit()
	l := new(ChannelLexer)
...
// ChannelLexer tokens.
const (
	ChannelLexerCHANNEL  = 1
	ChannelLexerOWNKEY   = 2
	ChannelLexerSPLITKEY = 3
	ChannelLexerWS       = 4
)
