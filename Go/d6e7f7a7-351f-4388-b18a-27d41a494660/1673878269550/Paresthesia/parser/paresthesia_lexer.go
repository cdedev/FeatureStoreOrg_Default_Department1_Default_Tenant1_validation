...
var paresthesialexerLexerStaticData struct {
	once                   sync.Once
	serializedATN          []int32
	channelNames           []string
	modeNames              []string
...
func paresthesialexerLexerInit() {
	staticData := &paresthesialexerLexerStaticData
...
// ParesthesiaLexerInit initializes any static state used to implement ParesthesiaLexer. By default the
// static state used to implement the lexer is lazily initialized during the first call to
// NewParesthesiaLexer(). You can call this function if you wish to initialize the static state ahead
// of time.
func ParesthesiaLexerInit() {
	staticData := &paresthesialexerLexerStaticData
	staticData.once.Do(paresthesialexerLexerInit)
}

// NewParesthesiaLexer produces a new lexer instance for the optional input antlr.CharStream.
func NewParesthesiaLexer(input antlr.CharStream) *ParesthesiaLexer {
	ParesthesiaLexerInit()
	l := new(ParesthesiaLexer)
	...
	l.GrammarFileName = "Paresthesia.g4"
	// TODO: l.EOF = antlr.TokenEOF

	return l
}

// ParesthesiaLexer tokens.
const (
	ParesthesiaLexerPARESTHESIA = 1
	ParesthesiaLexerOWNKEY      = 2
	ParesthesiaLexerSPLITKEY    = 3
	ParesthesiaLexerWS          = 4
)
