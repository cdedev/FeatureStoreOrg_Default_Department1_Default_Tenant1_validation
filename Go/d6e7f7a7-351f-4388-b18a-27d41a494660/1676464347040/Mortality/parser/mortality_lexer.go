...
var mortalitylexerLexerStaticData struct {
	once                   sync.Once
	serializedATN          []int32
	channelNames           []string
	modeNames              []string
...
func mortalitylexerLexerInit() {
	staticData := &mortalitylexerLexerStaticData
	...
	staticData.serializedATN = []int32{
		...
		0, 4, 1, 1, 3, 2, 5, 3, 7, 4, 1, 0, 2, 2, 0, 48, 57, 69, 89, 3, 0, 9, 10,
...
// MortalityLexerInit initializes any static state used to implement MortalityLexer. By default the
// static state used to implement the lexer is lazily initialized during the first call to
// NewMortalityLexer(). You can call this function if you wish to initialize the static state ahead
// of time.
func MortalityLexerInit() {
	staticData := &mortalitylexerLexerStaticData
	staticData.once.Do(mortalitylexerLexerInit)
}

// NewMortalityLexer produces a new lexer instance for the optional input antlr.CharStream.
func NewMortalityLexer(input antlr.CharStream) *MortalityLexer {
	MortalityLexerInit()
	l := new(MortalityLexer)
	...
	l.GrammarFileName = "Mortality.g4"
	// TODO: l.EOF = antlr.TokenEOF

	return l
}

// MortalityLexer tokens.
const (
	MortalityLexerMORTALITY = 1
	MortalityLexerOWNKEY    = 2
	MortalityLexerSPLITKEY  = 3
	MortalityLexerWS        = 4
)
