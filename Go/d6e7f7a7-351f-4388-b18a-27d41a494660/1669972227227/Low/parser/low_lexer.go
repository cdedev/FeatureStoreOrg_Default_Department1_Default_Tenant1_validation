...
var lowlexerLexerStaticData struct {
	once                   sync.Once
	serializedATN          []int32
	channelNames           []string
	modeNames              []string
...
func lowlexerLexerInit() {
	staticData := &lowlexerLexerStaticData
...
// LowLexerInit initializes any static state used to implement LowLexer. By default the
// static state used to implement the lexer is lazily initialized during the first call to
// NewLowLexer(). You can call this function if you wish to initialize the static state ahead
// of time.
func LowLexerInit() {
	staticData := &lowlexerLexerStaticData
	staticData.once.Do(lowlexerLexerInit)
}

// NewLowLexer produces a new lexer instance for the optional input antlr.CharStream.
func NewLowLexer(input antlr.CharStream) *LowLexer {
	LowLexerInit()
	l := new(LowLexer)
