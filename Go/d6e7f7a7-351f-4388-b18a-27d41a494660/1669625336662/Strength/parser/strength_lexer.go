...
var strengthlexerLexerStaticData struct {
	once                   sync.Once
	serializedATN          []int32
	channelNames           []string
	modeNames              []string
...
func strengthlexerLexerInit() {
	staticData := &strengthlexerLexerStaticData
...
// StrengthLexerInit initializes any static state used to implement StrengthLexer. By default the
// static state used to implement the lexer is lazily initialized during the first call to
// NewStrengthLexer(). You can call this function if you wish to initialize the static state ahead
// of time.
func StrengthLexerInit() {
	staticData := &strengthlexerLexerStaticData
	staticData.once.Do(strengthlexerLexerInit)
}

// NewStrengthLexer produces a new lexer instance for the optional input antlr.CharStream.
func NewStrengthLexer(input antlr.CharStream) *StrengthLexer {
	StrengthLexerInit()
	l := new(StrengthLexer)
	...
	l.GrammarFileName = "Strength.g4"
	// TODO: l.EOF = antlr.TokenEOF

	return l
}

// StrengthLexer tokens.
const (
	StrengthLexerSTRENGTH = 1
	StrengthLexerOWNKEY   = 2
	StrengthLexerSPLITKEY = 3
	StrengthLexerWS       = 4
)
