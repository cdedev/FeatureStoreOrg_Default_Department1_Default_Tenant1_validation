...
var loanlexerLexerStaticData struct {
	once                   sync.Once
	serializedATN          []int32
	channelNames           []string
	modeNames              []string
...
func loanlexerLexerInit() {
	staticData := &loanlexerLexerStaticData
...
// LoanLexerInit initializes any static state used to implement LoanLexer. By default the
// static state used to implement the lexer is lazily initialized during the first call to
// NewLoanLexer(). You can call this function if you wish to initialize the static state ahead
// of time.
func LoanLexerInit() {
	staticData := &loanlexerLexerStaticData
	staticData.once.Do(loanlexerLexerInit)
}

// NewLoanLexer produces a new lexer instance for the optional input antlr.CharStream.
func NewLoanLexer(input antlr.CharStream) *LoanLexer {
	LoanLexerInit()
	l := new(LoanLexer)
