...
var charismalexerLexerStaticData struct {
	once                   sync.Once
	serializedATN          []int32
	channelNames           []string
	modeNames              []string
...
func charismalexerLexerInit() {
	staticData := &charismalexerLexerStaticData
...
// CharismaLexerInit initializes any static state used to implement CharismaLexer. By default the
// static state used to implement the lexer is lazily initialized during the first call to
// NewCharismaLexer(). You can call this function if you wish to initialize the static state ahead
// of time.
func CharismaLexerInit() {
	staticData := &charismalexerLexerStaticData
	staticData.once.Do(charismalexerLexerInit)
}

// NewCharismaLexer produces a new lexer instance for the optional input antlr.CharStream.
func NewCharismaLexer(input antlr.CharStream) *CharismaLexer {
	CharismaLexerInit()
	l := new(CharismaLexer)
	...
	l.GrammarFileName = "Charisma.g4"
	// TODO: l.EOF = antlr.TokenEOF

	return l
}

// CharismaLexer tokens.
const (
	CharismaLexerCHARISMA = 1
	CharismaLexerOWNKEY   = 2
	CharismaLexerSPLITKEY = 3
	CharismaLexerWS       = 4
)
