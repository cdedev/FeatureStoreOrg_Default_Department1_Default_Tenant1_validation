...
var totalairtimelexerLexerStaticData struct {
	once                   sync.Once
	serializedATN          []int32
	channelNames           []string
	modeNames              []string
...
func totalairtimelexerLexerInit() {
	staticData := &totalairtimelexerLexerStaticData
...
// TotalAirTimeLexerInit initializes any static state used to implement TotalAirTimeLexer. By default the
// static state used to implement the lexer is lazily initialized during the first call to
// NewTotalAirTimeLexer(). You can call this function if you wish to initialize the static state ahead
// of time.
func TotalAirTimeLexerInit() {
	staticData := &totalairtimelexerLexerStaticData
	staticData.once.Do(totalairtimelexerLexerInit)
}

// NewTotalAirTimeLexer produces a new lexer instance for the optional input antlr.CharStream.
func NewTotalAirTimeLexer(input antlr.CharStream) *TotalAirTimeLexer {
	TotalAirTimeLexerInit()
	l := new(TotalAirTimeLexer)
	...
	l.GrammarFileName = "TotalAirTime.g4"
	// TODO: l.EOF = antlr.TokenEOF

	return l
}

// TotalAirTimeLexer tokens.
const (
	TotalAirTimeLexerTOTALAIRTIME = 1
	TotalAirTimeLexerOWNKEY       = 2
	TotalAirTimeLexerSPLITKEY     = 3
	TotalAirTimeLexerWS           = 4
)
