...
type LeatherInteriorLexer struct {
	*antlr.BaseLexer
	channelNames []string
	modeNames    []string
	// TODO: EOF string
...
var leatherinteriorlexerLexerStaticData struct {
	once                   sync.Once
	serializedATN          []int32
	channelNames           []string
	modeNames              []string
...
func leatherinteriorlexerLexerInit() {
	staticData := &leatherinteriorlexerLexerStaticData
...
// LeatherInteriorLexerInit initializes any static state used to implement LeatherInteriorLexer. By default the
// static state used to implement the lexer is lazily initialized during the first call to
// NewLeatherInteriorLexer(). You can call this function if you wish to initialize the static state ahead
// of time.
func LeatherInteriorLexerInit() {
	staticData := &leatherinteriorlexerLexerStaticData
	staticData.once.Do(leatherinteriorlexerLexerInit)
}

// NewLeatherInteriorLexer produces a new lexer instance for the optional input antlr.CharStream.
func NewLeatherInteriorLexer(input antlr.CharStream) *LeatherInteriorLexer {
	LeatherInteriorLexerInit()
	l := new(LeatherInteriorLexer)
	...
	l.GrammarFileName = "LeatherInterior.g4"
	// TODO: l.EOF = antlr.TokenEOF

	return l
}

// LeatherInteriorLexer tokens.
const (
	LeatherInteriorLexerLEATHERINTERIOR = 1
	LeatherInteriorLexerOWNKEY          = 2
	LeatherInteriorLexerSPLITKEY        = 3
	LeatherInteriorLexerWS              = 4
)
