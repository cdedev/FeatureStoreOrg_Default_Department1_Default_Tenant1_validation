...
var averagespeedlexerLexerStaticData struct {
	once                   sync.Once
	serializedATN          []int32
	channelNames           []string
	modeNames              []string
...
func averagespeedlexerLexerInit() {
	staticData := &averagespeedlexerLexerStaticData
...
// AverageSpeedLexerInit initializes any static state used to implement AverageSpeedLexer. By default the
// static state used to implement the lexer is lazily initialized during the first call to
// NewAverageSpeedLexer(). You can call this function if you wish to initialize the static state ahead
// of time.
func AverageSpeedLexerInit() {
	staticData := &averagespeedlexerLexerStaticData
	staticData.once.Do(averagespeedlexerLexerInit)
}

// NewAverageSpeedLexer produces a new lexer instance for the optional input antlr.CharStream.
func NewAverageSpeedLexer(input antlr.CharStream) *AverageSpeedLexer {
	AverageSpeedLexerInit()
	l := new(AverageSpeedLexer)
	...
	l.GrammarFileName = "AverageSpeed.g4"
	// TODO: l.EOF = antlr.TokenEOF

	return l
}

// AverageSpeedLexer tokens.
const (
	AverageSpeedLexerAVERAGESPEED = 1
	AverageSpeedLexerOWNKEY       = 2
	AverageSpeedLexerSPLITKEY     = 3
	AverageSpeedLexerWS           = 4
)
