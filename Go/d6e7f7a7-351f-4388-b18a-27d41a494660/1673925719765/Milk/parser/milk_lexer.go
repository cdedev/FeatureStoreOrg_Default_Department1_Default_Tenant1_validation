...
var milklexerLexerStaticData struct {
	once                   sync.Once
	serializedATN          []int32
	channelNames           []string
	modeNames              []string
...
func milklexerLexerInit() {
	staticData := &milklexerLexerStaticData
...
// MilkLexerInit initializes any static state used to implement MilkLexer. By default the
// static state used to implement the lexer is lazily initialized during the first call to
// NewMilkLexer(). You can call this function if you wish to initialize the static state ahead
// of time.
func MilkLexerInit() {
	staticData := &milklexerLexerStaticData
	staticData.once.Do(milklexerLexerInit)
}

// NewMilkLexer produces a new lexer instance for the optional input antlr.CharStream.
func NewMilkLexer(input antlr.CharStream) *MilkLexer {
	MilkLexerInit()
	l := new(MilkLexer)
