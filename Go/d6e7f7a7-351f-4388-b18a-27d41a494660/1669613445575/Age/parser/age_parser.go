...
// AgeParser rules.
const (
	AgeParserRULE_expression = 0
	AgeParserRULE_field0     = 1
)
...
func NewEmptyExpressionContext() *ExpressionContext {
	...
	p.RuleIndex = AgeParserRULE_expression
	return p
}
...
func (s *ExpressionContext) EOF() antlr.TerminalNode {
	return s.GetToken(AgeParserEOF, 0)
}
...
func (p *AgeParser) Expression() (localctx IExpressionContext) {
	this := p
	_ = this

	localctx = NewExpressionContext(p, p.GetParserRuleContext(), p.GetState())
	p.EnterRule(localctx, 0, AgeParserRULE_expression)
...
func NewEmptyField0Context() *Field0Context {
	...
	p.BaseParserRuleContext = antlr.NewBaseParserRuleContext(nil, -1)
	p.RuleIndex = AgeParserRULE_field0
	return p
}
...
func (s *Field0Context) FIELD0() antlr.TerminalNode {
	return s.GetToken(AgeParserFIELD0, 0)
}
...
func (p *AgeParser) Field0() (localctx IField0Context) {
	this := p
	_ = this

	localctx = NewField0Context(p, p.GetParserRuleContext(), p.GetState())
	p.EnterRule(localctx, 2, AgeParserRULE_field0)
