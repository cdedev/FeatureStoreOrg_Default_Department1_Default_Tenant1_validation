...
var combinationlexerLexerStaticData struct {
	once                   sync.Once
	serializedATN          []int32
	channelNames           []string
	modeNames              []string
...
func combinationlexerLexerInit() {
	staticData := &combinationlexerLexerStaticData
...
// CombinationLexerInit initializes any static state used to implement CombinationLexer. By default the
// static state used to implement the lexer is lazily initialized during the first call to
// NewCombinationLexer(). You can call this function if you wish to initialize the static state ahead
// of time.
func CombinationLexerInit() {
	staticData := &combinationlexerLexerStaticData
	staticData.once.Do(combinationlexerLexerInit)
}

// NewCombinationLexer produces a new lexer instance for the optional input antlr.CharStream.
func NewCombinationLexer(input antlr.CharStream) *CombinationLexer {
	CombinationLexerInit()
	l := new(CombinationLexer)
	...
	l.GrammarFileName = "Combination.g4"
	// TODO: l.EOF = antlr.TokenEOF

	return l
}

// CombinationLexer tokens.
const (
	CombinationLexerCOMBINATION = 1
	CombinationLexerOWNKEY      = 2
	CombinationLexerSPLITKEY    = 3
	CombinationLexerWS          = 4
)
