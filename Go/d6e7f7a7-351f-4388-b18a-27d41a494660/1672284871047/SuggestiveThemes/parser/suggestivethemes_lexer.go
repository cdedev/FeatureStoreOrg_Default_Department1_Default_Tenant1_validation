...
type SuggestiveThemesLexer struct {
	*antlr.BaseLexer
	channelNames []string
	modeNames    []string
	// TODO: EOF string
...
var suggestivethemeslexerLexerStaticData struct {
	once                   sync.Once
	serializedATN          []int32
	channelNames           []string
	modeNames              []string
...
func suggestivethemeslexerLexerInit() {
	staticData := &suggestivethemeslexerLexerStaticData
...
// SuggestiveThemesLexerInit initializes any static state used to implement SuggestiveThemesLexer. By default the
// static state used to implement the lexer is lazily initialized during the first call to
// NewSuggestiveThemesLexer(). You can call this function if you wish to initialize the static state ahead
// of time.
func SuggestiveThemesLexerInit() {
	staticData := &suggestivethemeslexerLexerStaticData
	staticData.once.Do(suggestivethemeslexerLexerInit)
}

// NewSuggestiveThemesLexer produces a new lexer instance for the optional input antlr.CharStream.
func NewSuggestiveThemesLexer(input antlr.CharStream) *SuggestiveThemesLexer {
	SuggestiveThemesLexerInit()
	l := new(SuggestiveThemesLexer)
	...
	l.GrammarFileName = "SuggestiveThemes.g4"
	// TODO: l.EOF = antlr.TokenEOF

	return l
}

// SuggestiveThemesLexer tokens.
const (
	SuggestiveThemesLexerSUGGESTIVETHEMES = 1
	SuggestiveThemesLexerOWNKEY           = 2
	SuggestiveThemesLexerSPLITKEY         = 3
	SuggestiveThemesLexerWS               = 4
)
