...
var periodlexerLexerStaticData struct {
	once                   sync.Once
	serializedATN          []int32
	channelNames           []string
	modeNames              []string
...
func periodlexerLexerInit() {
	staticData := &periodlexerLexerStaticData
...
// PeriodLexerInit initializes any static state used to implement PeriodLexer. By default the
// static state used to implement the lexer is lazily initialized during the first call to
// NewPeriodLexer(). You can call this function if you wish to initialize the static state ahead
// of time.
func PeriodLexerInit() {
	staticData := &periodlexerLexerStaticData
	staticData.once.Do(periodlexerLexerInit)
}

// NewPeriodLexer produces a new lexer instance for the optional input antlr.CharStream.
func NewPeriodLexer(input antlr.CharStream) *PeriodLexer {
	PeriodLexerInit()
	l := new(PeriodLexer)
