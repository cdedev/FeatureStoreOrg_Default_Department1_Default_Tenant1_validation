...
var squarefeetlexerLexerStaticData struct {
	once                   sync.Once
	serializedATN          []int32
	channelNames           []string
	modeNames              []string
...
func squarefeetlexerLexerInit() {
	staticData := &squarefeetlexerLexerStaticData
...
// SquareFeetLexerInit initializes any static state used to implement SquareFeetLexer. By default the
// static state used to implement the lexer is lazily initialized during the first call to
// NewSquareFeetLexer(). You can call this function if you wish to initialize the static state ahead
// of time.
func SquareFeetLexerInit() {
	staticData := &squarefeetlexerLexerStaticData
	staticData.once.Do(squarefeetlexerLexerInit)
}

// NewSquareFeetLexer produces a new lexer instance for the optional input antlr.CharStream.
func NewSquareFeetLexer(input antlr.CharStream) *SquareFeetLexer {
	SquareFeetLexerInit()
	l := new(SquareFeetLexer)
	...
	l.GrammarFileName = "SquareFeet.g4"
	// TODO: l.EOF = antlr.TokenEOF

	return l
}

// SquareFeetLexer tokens.
const (
	SquareFeetLexerSQUAREFEET = 1
	SquareFeetLexerOWNKEY     = 2
	SquareFeetLexerSPLITKEY   = 3
	SquareFeetLexerWS         = 4
)
