...
var kilometerlexerLexerStaticData struct {
	once                   sync.Once
	serializedATN          []int32
	channelNames           []string
	modeNames              []string
...
func kilometerlexerLexerInit() {
	staticData := &kilometerlexerLexerStaticData
...
// KilometerLexerInit initializes any static state used to implement KilometerLexer. By default the
// static state used to implement the lexer is lazily initialized during the first call to
// NewKilometerLexer(). You can call this function if you wish to initialize the static state ahead
// of time.
func KilometerLexerInit() {
	staticData := &kilometerlexerLexerStaticData
	staticData.once.Do(kilometerlexerLexerInit)
}

// NewKilometerLexer produces a new lexer instance for the optional input antlr.CharStream.
func NewKilometerLexer(input antlr.CharStream) *KilometerLexer {
	KilometerLexerInit()
	l := new(KilometerLexer)
	...
	l.GrammarFileName = "Kilometer.g4"
	// TODO: l.EOF = antlr.TokenEOF

	return l
}

// KilometerLexer tokens.
const (
	KilometerLexerKILOMETER = 1
	KilometerLexerOWNKEY    = 2
	KilometerLexerSPLITKEY  = 3
	KilometerLexerWS        = 4
)
