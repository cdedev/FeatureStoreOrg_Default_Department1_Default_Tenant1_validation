...
var decmintemplexerLexerStaticData struct {
	once                   sync.Once
	serializedATN          []int32
	channelNames           []string
	modeNames              []string
...
func decmintemplexerLexerInit() {
	staticData := &decmintemplexerLexerStaticData
...
// DecMintempLexerInit initializes any static state used to implement DecMintempLexer. By default the
// static state used to implement the lexer is lazily initialized during the first call to
// NewDecMintempLexer(). You can call this function if you wish to initialize the static state ahead
// of time.
func DecMintempLexerInit() {
	staticData := &decmintemplexerLexerStaticData
	staticData.once.Do(decmintemplexerLexerInit)
}

// NewDecMintempLexer produces a new lexer instance for the optional input antlr.CharStream.
func NewDecMintempLexer(input antlr.CharStream) *DecMintempLexer {
	DecMintempLexerInit()
	l := new(DecMintempLexer)
	...
	l.GrammarFileName = "DecMintemp.g4"
	// TODO: l.EOF = antlr.TokenEOF

	return l
}

// DecMintempLexer tokens.
const (
	DecMintempLexerDECMINTEMP = 1
	DecMintempLexerOWNKEY     = 2
	DecMintempLexerSPLITKEY   = 3
	DecMintempLexerWS         = 4
)
