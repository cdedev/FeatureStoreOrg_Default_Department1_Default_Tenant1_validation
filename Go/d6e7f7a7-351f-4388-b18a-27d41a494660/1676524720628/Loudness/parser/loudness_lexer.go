...
var loudnesslexerLexerStaticData struct {
	once                   sync.Once
	serializedATN          []int32
	channelNames           []string
	modeNames              []string
...
func loudnesslexerLexerInit() {
	staticData := &loudnesslexerLexerStaticData
...
// LoudnessLexerInit initializes any static state used to implement LoudnessLexer. By default the
// static state used to implement the lexer is lazily initialized during the first call to
// NewLoudnessLexer(). You can call this function if you wish to initialize the static state ahead
// of time.
func LoudnessLexerInit() {
	staticData := &loudnesslexerLexerStaticData
	staticData.once.Do(loudnesslexerLexerInit)
}

// NewLoudnessLexer produces a new lexer instance for the optional input antlr.CharStream.
func NewLoudnessLexer(input antlr.CharStream) *LoudnessLexer {
	LoudnessLexerInit()
	l := new(LoudnessLexer)
	...
	l.GrammarFileName = "Loudness.g4"
	// TODO: l.EOF = antlr.TokenEOF

	return l
}

// LoudnessLexer tokens.
const (
	LoudnessLexerLOUDNESS = 1
	LoudnessLexerOWNKEY   = 2
	LoudnessLexerSPLITKEY = 3
	LoudnessLexerWS       = 4
)
