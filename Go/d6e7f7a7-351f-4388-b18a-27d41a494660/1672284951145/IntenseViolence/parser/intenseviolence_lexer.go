...
type IntenseViolenceLexer struct {
	*antlr.BaseLexer
	channelNames []string
	modeNames    []string
	// TODO: EOF string
...
var intenseviolencelexerLexerStaticData struct {
	once                   sync.Once
	serializedATN          []int32
	channelNames           []string
	modeNames              []string
...
func intenseviolencelexerLexerInit() {
	staticData := &intenseviolencelexerLexerStaticData
...
// IntenseViolenceLexerInit initializes any static state used to implement IntenseViolenceLexer. By default the
// static state used to implement the lexer is lazily initialized during the first call to
// NewIntenseViolenceLexer(). You can call this function if you wish to initialize the static state ahead
// of time.
func IntenseViolenceLexerInit() {
	staticData := &intenseviolencelexerLexerStaticData
	staticData.once.Do(intenseviolencelexerLexerInit)
}

// NewIntenseViolenceLexer produces a new lexer instance for the optional input antlr.CharStream.
func NewIntenseViolenceLexer(input antlr.CharStream) *IntenseViolenceLexer {
	IntenseViolenceLexerInit()
	l := new(IntenseViolenceLexer)
	...
	l.GrammarFileName = "IntenseViolence.g4"
	// TODO: l.EOF = antlr.TokenEOF

	return l
}

// IntenseViolenceLexer tokens.
const (
	IntenseViolenceLexerINTENSEVIOLENCE = 1
	IntenseViolenceLexerOWNKEY          = 2
	IntenseViolenceLexerSPLITKEY        = 3
	IntenseViolenceLexerWS              = 4
)
