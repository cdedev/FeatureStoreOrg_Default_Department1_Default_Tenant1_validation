...
var plasticlexerLexerStaticData struct {
	once                   sync.Once
	serializedATN          []int32
	channelNames           []string
	modeNames              []string
...
func plasticlexerLexerInit() {
	staticData := &plasticlexerLexerStaticData
...
// PlasticLexerInit initializes any static state used to implement PlasticLexer. By default the
// static state used to implement the lexer is lazily initialized during the first call to
// NewPlasticLexer(). You can call this function if you wish to initialize the static state ahead
// of time.
func PlasticLexerInit() {
	staticData := &plasticlexerLexerStaticData
	staticData.once.Do(plasticlexerLexerInit)
}

// NewPlasticLexer produces a new lexer instance for the optional input antlr.CharStream.
func NewPlasticLexer(input antlr.CharStream) *PlasticLexer {
	PlasticLexerInit()
	l := new(PlasticLexer)
...
// PlasticLexer tokens.
const (
	PlasticLexerPLASTIC  = 1
	PlasticLexerOWNKEY   = 2
	PlasticLexerSPLITKEY = 3
	PlasticLexerWS       = 4
)
