...
var ordertotallexerLexerStaticData struct {
	once                   sync.Once
	serializedATN          []int32
	channelNames           []string
	modeNames              []string
...
func ordertotallexerLexerInit() {
	staticData := &ordertotallexerLexerStaticData
...
// OrderTotalLexerInit initializes any static state used to implement OrderTotalLexer. By default the
// static state used to implement the lexer is lazily initialized during the first call to
// NewOrderTotalLexer(). You can call this function if you wish to initialize the static state ahead
// of time.
func OrderTotalLexerInit() {
	staticData := &ordertotallexerLexerStaticData
	staticData.once.Do(ordertotallexerLexerInit)
}

// NewOrderTotalLexer produces a new lexer instance for the optional input antlr.CharStream.
func NewOrderTotalLexer(input antlr.CharStream) *OrderTotalLexer {
	OrderTotalLexerInit()
	l := new(OrderTotalLexer)
	...
	l.GrammarFileName = "OrderTotal.g4"
	// TODO: l.EOF = antlr.TokenEOF

	return l
}

// OrderTotalLexer tokens.
const (
	OrderTotalLexerORDERTOTAL = 1
	OrderTotalLexerOWNKEY     = 2
	OrderTotalLexerSPLITKEY   = 3
	OrderTotalLexerWS         = 4
)
