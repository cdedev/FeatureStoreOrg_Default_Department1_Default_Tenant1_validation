...
// TransactionLexerInit initializes any static state used to implement TransactionLexer. By default the
// static state used to implement the lexer is lazily initialized during the first call to
// NewTransactionLexer(). You can call this function if you wish to initialize the static state ahead
// of time.
func TransactionLexerInit() {
	staticData := &transactionlexerLexerStaticData
	staticData.once.Do(transactionlexerLexerInit)
}
...
const (
	TransactionLexerTRANSACTION = 1
	TransactionLexerOWNKEY      = 2
	TransactionLexerSPLITKEY    = 3
	TransactionLexerWS          = 4
)
