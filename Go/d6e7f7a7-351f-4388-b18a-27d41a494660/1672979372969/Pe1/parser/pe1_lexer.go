...
var pe1lexerLexerStaticData struct {
	once                   sync.Once
	serializedATN          []int32
	channelNames           []string
	modeNames              []string
...
func pe1lexerLexerInit() {
	staticData := &pe1lexerLexerStaticData
...
// Pe1LexerInit initializes any static state used to implement Pe1Lexer. By default the
// static state used to implement the lexer is lazily initialized during the first call to
// NewPe1Lexer(). You can call this function if you wish to initialize the static state ahead
// of time.
func Pe1LexerInit() {
	staticData := &pe1lexerLexerStaticData
	staticData.once.Do(pe1lexerLexerInit)
}

// NewPe1Lexer produces a new lexer instance for the optional input antlr.CharStream.
func NewPe1Lexer(input antlr.CharStream) *Pe1Lexer {
	Pe1LexerInit()
	l := new(Pe1Lexer)
