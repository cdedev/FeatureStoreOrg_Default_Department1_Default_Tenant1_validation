...
var marketpricelexerLexerStaticData struct {
	once                   sync.Once
	serializedATN          []int32
	channelNames           []string
	modeNames              []string
...
func marketpricelexerLexerInit() {
	staticData := &marketpricelexerLexerStaticData
...
// MarketPriceLexerInit initializes any static state used to implement MarketPriceLexer. By default the
// static state used to implement the lexer is lazily initialized during the first call to
// NewMarketPriceLexer(). You can call this function if you wish to initialize the static state ahead
// of time.
func MarketPriceLexerInit() {
	staticData := &marketpricelexerLexerStaticData
	staticData.once.Do(marketpricelexerLexerInit)
}

// NewMarketPriceLexer produces a new lexer instance for the optional input antlr.CharStream.
func NewMarketPriceLexer(input antlr.CharStream) *MarketPriceLexer {
	MarketPriceLexerInit()
	l := new(MarketPriceLexer)
	...
	l.GrammarFileName = "MarketPrice.g4"
	// TODO: l.EOF = antlr.TokenEOF

	return l
}

// MarketPriceLexer tokens.
const (
	MarketPriceLexerMARKETPRICE = 1
	MarketPriceLexerOWNKEY      = 2
	MarketPriceLexerSPLITKEY    = 3
	MarketPriceLexerWS          = 4
)
