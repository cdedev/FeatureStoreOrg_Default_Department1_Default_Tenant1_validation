...
var airbagslexerLexerStaticData struct {
	once                   sync.Once
	serializedATN          []int32
	channelNames           []string
	modeNames              []string
...
func airbagslexerLexerInit() {
	staticData := &airbagslexerLexerStaticData
...
// AirbagsLexerInit initializes any static state used to implement AirbagsLexer. By default the
// static state used to implement the lexer is lazily initialized during the first call to
// NewAirbagsLexer(). You can call this function if you wish to initialize the static state ahead
// of time.
func AirbagsLexerInit() {
	staticData := &airbagslexerLexerStaticData
	staticData.once.Do(airbagslexerLexerInit)
}

// NewAirbagsLexer produces a new lexer instance for the optional input antlr.CharStream.
func NewAirbagsLexer(input antlr.CharStream) *AirbagsLexer {
	AirbagsLexerInit()
	l := new(AirbagsLexer)
...
// AirbagsLexer tokens.
const (
	AirbagsLexerAIRBAGS  = 1
	AirbagsLexerOWNKEY   = 2
	AirbagsLexerSPLITKEY = 3
	AirbagsLexerWS       = 4
)
