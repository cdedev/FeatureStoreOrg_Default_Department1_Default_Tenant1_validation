// Code generated from /usr/local/lib/Go/d6e7f7a7-351f-4388-b18a-27d41a494660/1671863528488/Fat.g4 by ANTLR 4.10.1. DO NOT EDIT.
...
var fatlexerLexerStaticData struct {
	once                   sync.Once
	serializedATN          []int32
	channelNames           []string
	modeNames              []string
...
func fatlexerLexerInit() {
	staticData := &fatlexerLexerStaticData
...
// FatLexerInit initializes any static state used to implement FatLexer. By default the
// static state used to implement the lexer is lazily initialized during the first call to
// NewFatLexer(). You can call this function if you wish to initialize the static state ahead
// of time.
func FatLexerInit() {
	staticData := &fatlexerLexerStaticData
	staticData.once.Do(fatlexerLexerInit)
}

// NewFatLexer produces a new lexer instance for the optional input antlr.CharStream.
func NewFatLexer(input antlr.CharStream) *FatLexer {
	FatLexerInit()
	l := new(FatLexer)
