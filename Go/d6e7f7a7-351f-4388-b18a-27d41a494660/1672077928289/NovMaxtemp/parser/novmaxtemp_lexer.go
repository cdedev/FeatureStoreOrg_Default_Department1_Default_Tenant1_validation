...
var novmaxtemplexerLexerStaticData struct {
	once                   sync.Once
	serializedATN          []int32
	channelNames           []string
	modeNames              []string
...
func novmaxtemplexerLexerInit() {
	staticData := &novmaxtemplexerLexerStaticData
...
// NovMaxtempLexerInit initializes any static state used to implement NovMaxtempLexer. By default the
// static state used to implement the lexer is lazily initialized during the first call to
// NewNovMaxtempLexer(). You can call this function if you wish to initialize the static state ahead
// of time.
func NovMaxtempLexerInit() {
	staticData := &novmaxtemplexerLexerStaticData
	staticData.once.Do(novmaxtemplexerLexerInit)
}

// NewNovMaxtempLexer produces a new lexer instance for the optional input antlr.CharStream.
func NewNovMaxtempLexer(input antlr.CharStream) *NovMaxtempLexer {
	NovMaxtempLexerInit()
	l := new(NovMaxtempLexer)
	...
	l.GrammarFileName = "NovMaxtemp.g4"
	// TODO: l.EOF = antlr.TokenEOF

	return l
}

// NovMaxtempLexer tokens.
const (
	NovMaxtempLexerNOVMAXTEMP = 1
	NovMaxtempLexerOWNKEY     = 2
	NovMaxtempLexerSPLITKEY   = 3
	NovMaxtempLexerWS         = 4
)
