...
var rpricelexerLexerStaticData struct {
	once                   sync.Once
	serializedATN          []int32
	channelNames           []string
	modeNames              []string
...
func rpricelexerLexerInit() {
	staticData := &rpricelexerLexerStaticData
...
// RPriceLexerInit initializes any static state used to implement RPriceLexer. By default the
// static state used to implement the lexer is lazily initialized during the first call to
// NewRPriceLexer(). You can call this function if you wish to initialize the static state ahead
// of time.
func RPriceLexerInit() {
	staticData := &rpricelexerLexerStaticData
	staticData.once.Do(rpricelexerLexerInit)
}

// NewRPriceLexer produces a new lexer instance for the optional input antlr.CharStream.
func NewRPriceLexer(input antlr.CharStream) *RPriceLexer {
	RPriceLexerInit()
	l := new(RPriceLexer)
