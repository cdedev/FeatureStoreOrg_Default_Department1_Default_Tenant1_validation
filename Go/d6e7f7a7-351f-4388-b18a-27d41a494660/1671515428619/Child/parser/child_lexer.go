...
var childlexerLexerStaticData struct {
	once                   sync.Once
	serializedATN          []int32
	channelNames           []string
	modeNames              []string
...
func childlexerLexerInit() {
	staticData := &childlexerLexerStaticData
...
// ChildLexerInit initializes any static state used to implement ChildLexer. By default the
// static state used to implement the lexer is lazily initialized during the first call to
// NewChildLexer(). You can call this function if you wish to initialize the static state ahead
// of time.
func ChildLexerInit() {
	staticData := &childlexerLexerStaticData
	staticData.once.Do(childlexerLexerInit)
}

// NewChildLexer produces a new lexer instance for the optional input antlr.CharStream.
func NewChildLexer(input antlr.CharStream) *ChildLexer {
	ChildLexerInit()
	l := new(ChildLexer)
