...
var debitscorelexerLexerStaticData struct {
	once                   sync.Once
	serializedATN          []int32
	channelNames           []string
	modeNames              []string
...
func debitscorelexerLexerInit() {
	staticData := &debitscorelexerLexerStaticData
...
// DebitscoreLexerInit initializes any static state used to implement DebitscoreLexer. By default the
// static state used to implement the lexer is lazily initialized during the first call to
// NewDebitscoreLexer(). You can call this function if you wish to initialize the static state ahead
// of time.
func DebitscoreLexerInit() {
	staticData := &debitscorelexerLexerStaticData
	staticData.once.Do(debitscorelexerLexerInit)
}

// NewDebitscoreLexer produces a new lexer instance for the optional input antlr.CharStream.
func NewDebitscoreLexer(input antlr.CharStream) *DebitscoreLexer {
	DebitscoreLexerInit()
	l := new(DebitscoreLexer)
	...
	l.GrammarFileName = "Debitscore.g4"
	// TODO: l.EOF = antlr.TokenEOF

	return l
}

// DebitscoreLexer tokens.
const (
	DebitscoreLexerDEBITSCORE = 1
	DebitscoreLexerOWNKEY     = 2
	DebitscoreLexerSPLITKEY   = 3
	DebitscoreLexerWS         = 4
)
