...
var biomasslexerLexerStaticData struct {
	once                   sync.Once
	serializedATN          []int32
	channelNames           []string
	modeNames              []string
...
func biomasslexerLexerInit() {
	staticData := &biomasslexerLexerStaticData
...
// BiomassLexerInit initializes any static state used to implement BiomassLexer. By default the
// static state used to implement the lexer is lazily initialized during the first call to
// NewBiomassLexer(). You can call this function if you wish to initialize the static state ahead
// of time.
func BiomassLexerInit() {
	staticData := &biomasslexerLexerStaticData
	staticData.once.Do(biomasslexerLexerInit)
}

// NewBiomassLexer produces a new lexer instance for the optional input antlr.CharStream.
func NewBiomassLexer(input antlr.CharStream) *BiomassLexer {
	BiomassLexerInit()
	l := new(BiomassLexer)
...
// BiomassLexer tokens.
const (
	BiomassLexerBIOMASS  = 1
	BiomassLexerOWNKEY   = 2
	BiomassLexerSPLITKEY = 3
	BiomassLexerWS       = 4
)
