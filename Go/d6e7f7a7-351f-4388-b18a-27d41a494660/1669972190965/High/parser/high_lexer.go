...
var highlexerLexerStaticData struct {
	once                   sync.Once
	serializedATN          []int32
	channelNames           []string
	modeNames              []string
...
func highlexerLexerInit() {
	staticData := &highlexerLexerStaticData
...
// HighLexerInit initializes any static state used to implement HighLexer. By default the
// static state used to implement the lexer is lazily initialized during the first call to
// NewHighLexer(). You can call this function if you wish to initialize the static state ahead
// of time.
func HighLexerInit() {
	staticData := &highlexerLexerStaticData
	staticData.once.Do(highlexerLexerInit)
}

// NewHighLexer produces a new lexer instance for the optional input antlr.CharStream.
func NewHighLexer(input antlr.CharStream) *HighLexer {
	HighLexerInit()
	l := new(HighLexer)
