...
var febmaxtemplexerLexerStaticData struct {
	once                   sync.Once
	serializedATN          []int32
	channelNames           []string
	modeNames              []string
...
func febmaxtemplexerLexerInit() {
	staticData := &febmaxtemplexerLexerStaticData
...
// FebMaxtempLexerInit initializes any static state used to implement FebMaxtempLexer. By default the
// static state used to implement the lexer is lazily initialized during the first call to
// NewFebMaxtempLexer(). You can call this function if you wish to initialize the static state ahead
// of time.
func FebMaxtempLexerInit() {
	staticData := &febmaxtemplexerLexerStaticData
	staticData.once.Do(febmaxtemplexerLexerInit)
}

// NewFebMaxtempLexer produces a new lexer instance for the optional input antlr.CharStream.
func NewFebMaxtempLexer(input antlr.CharStream) *FebMaxtempLexer {
	FebMaxtempLexerInit()
	l := new(FebMaxtempLexer)
	...
	l.GrammarFileName = "FebMaxtemp.g4"
	// TODO: l.EOF = antlr.TokenEOF

	return l
}

// FebMaxtempLexer tokens.
const (
	FebMaxtempLexerFEBMAXTEMP = 1
	FebMaxtempLexerOWNKEY     = 2
	FebMaxtempLexerSPLITKEY   = 3
	FebMaxtempLexerWS         = 4
)
