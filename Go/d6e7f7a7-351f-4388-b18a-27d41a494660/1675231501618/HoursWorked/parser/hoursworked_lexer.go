...
var hoursworkedlexerLexerStaticData struct {
	once                   sync.Once
	serializedATN          []int32
	channelNames           []string
	modeNames              []string
...
func hoursworkedlexerLexerInit() {
	staticData := &hoursworkedlexerLexerStaticData
...
// HoursWorkedLexerInit initializes any static state used to implement HoursWorkedLexer. By default the
// static state used to implement the lexer is lazily initialized during the first call to
// NewHoursWorkedLexer(). You can call this function if you wish to initialize the static state ahead
// of time.
func HoursWorkedLexerInit() {
	staticData := &hoursworkedlexerLexerStaticData
	staticData.once.Do(hoursworkedlexerLexerInit)
}

// NewHoursWorkedLexer produces a new lexer instance for the optional input antlr.CharStream.
func NewHoursWorkedLexer(input antlr.CharStream) *HoursWorkedLexer {
	HoursWorkedLexerInit()
	l := new(HoursWorkedLexer)
	...
	l.GrammarFileName = "HoursWorked.g4"
	// TODO: l.EOF = antlr.TokenEOF

	return l
}

// HoursWorkedLexer tokens.
const (
	HoursWorkedLexerHOURSWORKED = 1
	HoursWorkedLexerOWNKEY      = 2
	HoursWorkedLexerSPLITKEY    = 3
	HoursWorkedLexerWS          = 4
)
