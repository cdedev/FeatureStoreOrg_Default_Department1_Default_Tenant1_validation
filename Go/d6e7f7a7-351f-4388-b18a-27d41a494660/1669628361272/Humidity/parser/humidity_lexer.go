...
var humiditylexerLexerStaticData struct {
	once                   sync.Once
	serializedATN          []int32
	channelNames           []string
	modeNames              []string
...
func humiditylexerLexerInit() {
	staticData := &humiditylexerLexerStaticData
...
// HumidityLexerInit initializes any static state used to implement HumidityLexer. By default the
// static state used to implement the lexer is lazily initialized during the first call to
// NewHumidityLexer(). You can call this function if you wish to initialize the static state ahead
// of time.
func HumidityLexerInit() {
	staticData := &humiditylexerLexerStaticData
	staticData.once.Do(humiditylexerLexerInit)
}

// NewHumidityLexer produces a new lexer instance for the optional input antlr.CharStream.
func NewHumidityLexer(input antlr.CharStream) *HumidityLexer {
	HumidityLexerInit()
	l := new(HumidityLexer)
	...
	l.GrammarFileName = "Humidity.g4"
	// TODO: l.EOF = antlr.TokenEOF

	return l
}

// HumidityLexer tokens.
const (
	HumidityLexerHUMIDITY = 1
	HumidityLexerOWNKEY   = 2
	HumidityLexerSPLITKEY = 3
	HumidityLexerWS       = 4
)
