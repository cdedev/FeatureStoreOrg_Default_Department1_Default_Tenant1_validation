...
type RespirationRateLexer struct {
	*antlr.BaseLexer
	channelNames []string
	modeNames    []string
	// TODO: EOF string
...
var respirationratelexerLexerStaticData struct {
	once                   sync.Once
	serializedATN          []int32
	channelNames           []string
	modeNames              []string
...
func respirationratelexerLexerInit() {
	staticData := &respirationratelexerLexerStaticData
...
// RespirationRateLexerInit initializes any static state used to implement RespirationRateLexer. By default the
// static state used to implement the lexer is lazily initialized during the first call to
// NewRespirationRateLexer(). You can call this function if you wish to initialize the static state ahead
// of time.
func RespirationRateLexerInit() {
	staticData := &respirationratelexerLexerStaticData
	staticData.once.Do(respirationratelexerLexerInit)
}

// NewRespirationRateLexer produces a new lexer instance for the optional input antlr.CharStream.
func NewRespirationRateLexer(input antlr.CharStream) *RespirationRateLexer {
	RespirationRateLexerInit()
	l := new(RespirationRateLexer)
	...
	l.GrammarFileName = "RespirationRate.g4"
	// TODO: l.EOF = antlr.TokenEOF

	return l
}

// RespirationRateLexer tokens.
const (
	RespirationRateLexerRESPIRATIONRATE = 1
	RespirationRateLexerOWNKEY          = 2
	RespirationRateLexerSPLITKEY        = 3
	RespirationRateLexerWS              = 4
)
