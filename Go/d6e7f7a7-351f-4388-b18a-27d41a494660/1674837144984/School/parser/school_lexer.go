...
var schoollexerLexerStaticData struct {
	once                   sync.Once
	serializedATN          []int32
	channelNames           []string
	modeNames              []string
...
func schoollexerLexerInit() {
	staticData := &schoollexerLexerStaticData
...
// SchoolLexerInit initializes any static state used to implement SchoolLexer. By default the
// static state used to implement the lexer is lazily initialized during the first call to
// NewSchoolLexer(). You can call this function if you wish to initialize the static state ahead
// of time.
func SchoolLexerInit() {
	staticData := &schoollexerLexerStaticData
	staticData.once.Do(schoollexerLexerInit)
}

// NewSchoolLexer produces a new lexer instance for the optional input antlr.CharStream.
func NewSchoolLexer(input antlr.CharStream) *SchoolLexer {
	SchoolLexerInit()
	l := new(SchoolLexer)
