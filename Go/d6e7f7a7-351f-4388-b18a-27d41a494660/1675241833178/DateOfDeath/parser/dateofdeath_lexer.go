...
var dateofdeathlexerLexerStaticData struct {
	once                   sync.Once
	serializedATN          []int32
	channelNames           []string
	modeNames              []string
...
func dateofdeathlexerLexerInit() {
	staticData := &dateofdeathlexerLexerStaticData
	...
	staticData.serializedATN = []int32{
		...
		0, 4, 1, 1, 3, 2, 5, 3, 7, 4, 1, 0, 2, 1, 0, 47, 57, 3, 0, 9, 10, 13, 13,
...
// DateOfDeathLexerInit initializes any static state used to implement DateOfDeathLexer. By default the
// static state used to implement the lexer is lazily initialized during the first call to
// NewDateOfDeathLexer(). You can call this function if you wish to initialize the static state ahead
// of time.
func DateOfDeathLexerInit() {
	staticData := &dateofdeathlexerLexerStaticData
	staticData.once.Do(dateofdeathlexerLexerInit)
}

// NewDateOfDeathLexer produces a new lexer instance for the optional input antlr.CharStream.
func NewDateOfDeathLexer(input antlr.CharStream) *DateOfDeathLexer {
	DateOfDeathLexerInit()
	l := new(DateOfDeathLexer)
	...
	l.GrammarFileName = "DateOfDeath.g4"
	// TODO: l.EOF = antlr.TokenEOF

	return l
}

// DateOfDeathLexer tokens.
const (
	DateOfDeathLexerDATEOFDEATH = 1
	DateOfDeathLexerOWNKEY      = 2
	DateOfDeathLexerSPLITKEY    = 3
	DateOfDeathLexerWS          = 4
)
