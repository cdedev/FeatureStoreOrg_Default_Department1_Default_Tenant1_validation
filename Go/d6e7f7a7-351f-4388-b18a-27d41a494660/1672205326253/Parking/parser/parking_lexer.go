...
var parkinglexerLexerStaticData struct {
	once                   sync.Once
	serializedATN          []int32
	channelNames           []string
	modeNames              []string
...
func parkinglexerLexerInit() {
	staticData := &parkinglexerLexerStaticData
	...
	staticData.serializedATN = []int32{
		...
		0, 4, 1, 1, 3, 2, 5, 3, 7, 4, 1, 0, 2, 1, 0, 48, 50, 3, 0, 9, 10, 13, 13,
...
// ParkingLexerInit initializes any static state used to implement ParkingLexer. By default the
// static state used to implement the lexer is lazily initialized during the first call to
// NewParkingLexer(). You can call this function if you wish to initialize the static state ahead
// of time.
func ParkingLexerInit() {
	staticData := &parkinglexerLexerStaticData
	staticData.once.Do(parkinglexerLexerInit)
}

// NewParkingLexer produces a new lexer instance for the optional input antlr.CharStream.
func NewParkingLexer(input antlr.CharStream) *ParkingLexer {
	ParkingLexerInit()
	l := new(ParkingLexer)
...
// ParkingLexer tokens.
const (
	ParkingLexerPARKING  = 1
	ParkingLexerOWNKEY   = 2
	ParkingLexerSPLITKEY = 3
	ParkingLexerWS       = 4
)
