...
var intmemorylexerLexerStaticData struct {
	once                   sync.Once
	serializedATN          []int32
	channelNames           []string
	modeNames              []string
...
func intmemorylexerLexerInit() {
	staticData := &intmemorylexerLexerStaticData
...
// IntMemoryLexerInit initializes any static state used to implement IntMemoryLexer. By default the
// static state used to implement the lexer is lazily initialized during the first call to
// NewIntMemoryLexer(). You can call this function if you wish to initialize the static state ahead
// of time.
func IntMemoryLexerInit() {
	staticData := &intmemorylexerLexerStaticData
	staticData.once.Do(intmemorylexerLexerInit)
}

// NewIntMemoryLexer produces a new lexer instance for the optional input antlr.CharStream.
func NewIntMemoryLexer(input antlr.CharStream) *IntMemoryLexer {
	IntMemoryLexerInit()
	l := new(IntMemoryLexer)
	...
	l.GrammarFileName = "IntMemory.g4"
	// TODO: l.EOF = antlr.TokenEOF

	return l
}

// IntMemoryLexer tokens.
const (
	IntMemoryLexerINTMEMORY = 1
	IntMemoryLexerOWNKEY    = 2
	IntMemoryLexerSPLITKEY  = 3
	IntMemoryLexerWS        = 4
)
