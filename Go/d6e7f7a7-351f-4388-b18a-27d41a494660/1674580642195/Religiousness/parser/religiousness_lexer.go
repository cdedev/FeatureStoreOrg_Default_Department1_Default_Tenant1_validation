...
type ReligiousnessLexer struct {
	*antlr.BaseLexer
	channelNames []string
	modeNames    []string
	// TODO: EOF string
...
var religiousnesslexerLexerStaticData struct {
	once                   sync.Once
	serializedATN          []int32
	channelNames           []string
	modeNames              []string
...
func religiousnesslexerLexerInit() {
	staticData := &religiousnesslexerLexerStaticData
...
// ReligiousnessLexerInit initializes any static state used to implement ReligiousnessLexer. By default the
// static state used to implement the lexer is lazily initialized during the first call to
// NewReligiousnessLexer(). You can call this function if you wish to initialize the static state ahead
// of time.
func ReligiousnessLexerInit() {
	staticData := &religiousnesslexerLexerStaticData
	staticData.once.Do(religiousnesslexerLexerInit)
}

// NewReligiousnessLexer produces a new lexer instance for the optional input antlr.CharStream.
func NewReligiousnessLexer(input antlr.CharStream) *ReligiousnessLexer {
	ReligiousnessLexerInit()
	l := new(ReligiousnessLexer)
	...
	l.GrammarFileName = "Religiousness.g4"
	// TODO: l.EOF = antlr.TokenEOF

	return l
}

// ReligiousnessLexer tokens.
const (
	ReligiousnessLexerRELIGIOUSNESS = 1
	ReligiousnessLexerOWNKEY        = 2
	ReligiousnessLexerSPLITKEY      = 3
	ReligiousnessLexerWS            = 4
)
