...
var failurelexerLexerStaticData struct {
	once                   sync.Once
	serializedATN          []int32
	channelNames           []string
	modeNames              []string
...
func failurelexerLexerInit() {
	staticData := &failurelexerLexerStaticData
...
// FailureLexerInit initializes any static state used to implement FailureLexer. By default the
// static state used to implement the lexer is lazily initialized during the first call to
// NewFailureLexer(). You can call this function if you wish to initialize the static state ahead
// of time.
func FailureLexerInit() {
	staticData := &failurelexerLexerStaticData
	staticData.once.Do(failurelexerLexerInit)
}

// NewFailureLexer produces a new lexer instance for the optional input antlr.CharStream.
func NewFailureLexer(input antlr.CharStream) *FailureLexer {
	FailureLexerInit()
	l := new(FailureLexer)
...
// FailureLexer tokens.
const (
	FailureLexerFAILURE  = 1
	FailureLexerOWNKEY   = 2
	FailureLexerSPLITKEY = 3
	FailureLexerWS       = 4
)
