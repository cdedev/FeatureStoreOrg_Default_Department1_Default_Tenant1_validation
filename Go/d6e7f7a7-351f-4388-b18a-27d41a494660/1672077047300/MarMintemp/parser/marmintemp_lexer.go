...
var marmintemplexerLexerStaticData struct {
	once                   sync.Once
	serializedATN          []int32
	channelNames           []string
	modeNames              []string
...
func marmintemplexerLexerInit() {
	staticData := &marmintemplexerLexerStaticData
...
// MarMintempLexerInit initializes any static state used to implement MarMintempLexer. By default the
// static state used to implement the lexer is lazily initialized during the first call to
// NewMarMintempLexer(). You can call this function if you wish to initialize the static state ahead
// of time.
func MarMintempLexerInit() {
	staticData := &marmintemplexerLexerStaticData
	staticData.once.Do(marmintemplexerLexerInit)
}

// NewMarMintempLexer produces a new lexer instance for the optional input antlr.CharStream.
func NewMarMintempLexer(input antlr.CharStream) *MarMintempLexer {
	MarMintempLexerInit()
	l := new(MarMintempLexer)
	...
	l.GrammarFileName = "MarMintemp.g4"
	// TODO: l.EOF = antlr.TokenEOF

	return l
}

// MarMintempLexer tokens.
const (
	MarMintempLexerMARMINTEMP = 1
	MarMintempLexerOWNKEY     = 2
	MarMintempLexerSPLITKEY   = 3
	MarMintempLexerWS         = 4
)
