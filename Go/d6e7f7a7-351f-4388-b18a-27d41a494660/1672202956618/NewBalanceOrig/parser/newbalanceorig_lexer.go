...
type NewBalanceOrigLexer struct {
	*antlr.BaseLexer
	channelNames []string
	modeNames    []string
	// TODO: EOF string
...
var newbalanceoriglexerLexerStaticData struct {
	once                   sync.Once
	serializedATN          []int32
	channelNames           []string
	modeNames              []string
...
func newbalanceoriglexerLexerInit() {
	staticData := &newbalanceoriglexerLexerStaticData
...
// NewBalanceOrigLexerInit initializes any static state used to implement NewBalanceOrigLexer. By default the
// static state used to implement the lexer is lazily initialized during the first call to
// NewNewBalanceOrigLexer(). You can call this function if you wish to initialize the static state ahead
// of time.
func NewBalanceOrigLexerInit() {
	staticData := &newbalanceoriglexerLexerStaticData
	staticData.once.Do(newbalanceoriglexerLexerInit)
}

// NewNewBalanceOrigLexer produces a new lexer instance for the optional input antlr.CharStream.
func NewNewBalanceOrigLexer(input antlr.CharStream) *NewBalanceOrigLexer {
	NewBalanceOrigLexerInit()
	l := new(NewBalanceOrigLexer)
	...
	l.GrammarFileName = "NewBalanceOrig.g4"
	// TODO: l.EOF = antlr.TokenEOF

	return l
}

// NewBalanceOrigLexer tokens.
const (
	NewBalanceOrigLexerNEWBALANCEORIG = 1
	NewBalanceOrigLexerOWNKEY         = 2
	NewBalanceOrigLexerSPLITKEY       = 3
	NewBalanceOrigLexerWS             = 4
)
