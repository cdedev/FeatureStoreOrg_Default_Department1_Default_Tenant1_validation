...
var electorslexerLexerStaticData struct {
	once                   sync.Once
	serializedATN          []int32
	channelNames           []string
	modeNames              []string
...
func electorslexerLexerInit() {
	staticData := &electorslexerLexerStaticData
...
// ElectorsLexerInit initializes any static state used to implement ElectorsLexer. By default the
// static state used to implement the lexer is lazily initialized during the first call to
// NewElectorsLexer(). You can call this function if you wish to initialize the static state ahead
// of time.
func ElectorsLexerInit() {
	staticData := &electorslexerLexerStaticData
	staticData.once.Do(electorslexerLexerInit)
}

// NewElectorsLexer produces a new lexer instance for the optional input antlr.CharStream.
func NewElectorsLexer(input antlr.CharStream) *ElectorsLexer {
	ElectorsLexerInit()
	l := new(ElectorsLexer)
	...
	l.GrammarFileName = "Electors.g4"
	// TODO: l.EOF = antlr.TokenEOF

	return l
}

// ElectorsLexer tokens.
const (
	ElectorsLexerELECTORS = 1
	ElectorsLexerOWNKEY   = 2
	ElectorsLexerSPLITKEY = 3
	ElectorsLexerWS       = 4
)
