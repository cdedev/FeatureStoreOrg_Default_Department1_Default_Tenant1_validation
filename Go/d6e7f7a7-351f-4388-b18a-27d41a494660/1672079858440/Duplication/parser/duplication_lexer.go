...
var duplicationlexerLexerStaticData struct {
	once                   sync.Once
	serializedATN          []int32
	channelNames           []string
	modeNames              []string
...
func duplicationlexerLexerInit() {
	staticData := &duplicationlexerLexerStaticData
...
// DuplicationLexerInit initializes any static state used to implement DuplicationLexer. By default the
// static state used to implement the lexer is lazily initialized during the first call to
// NewDuplicationLexer(). You can call this function if you wish to initialize the static state ahead
// of time.
func DuplicationLexerInit() {
	staticData := &duplicationlexerLexerStaticData
	staticData.once.Do(duplicationlexerLexerInit)
}

// NewDuplicationLexer produces a new lexer instance for the optional input antlr.CharStream.
func NewDuplicationLexer(input antlr.CharStream) *DuplicationLexer {
	DuplicationLexerInit()
	l := new(DuplicationLexer)
	...
	l.GrammarFileName = "Duplication.g4"
	// TODO: l.EOF = antlr.TokenEOF

	return l
}

// DuplicationLexer tokens.
const (
	DuplicationLexerDUPLICATION = 1
	DuplicationLexerOWNKEY      = 2
	DuplicationLexerSPLITKEY    = 3
	DuplicationLexerWS          = 4
)
