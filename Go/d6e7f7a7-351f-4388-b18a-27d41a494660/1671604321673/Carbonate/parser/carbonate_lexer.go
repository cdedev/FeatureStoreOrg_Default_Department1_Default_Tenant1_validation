...
var carbonatelexerLexerStaticData struct {
	once                   sync.Once
	serializedATN          []int32
	channelNames           []string
	modeNames              []string
...
func carbonatelexerLexerInit() {
	staticData := &carbonatelexerLexerStaticData
...
// CarbonateLexerInit initializes any static state used to implement CarbonateLexer. By default the
// static state used to implement the lexer is lazily initialized during the first call to
// NewCarbonateLexer(). You can call this function if you wish to initialize the static state ahead
// of time.
func CarbonateLexerInit() {
	staticData := &carbonatelexerLexerStaticData
	staticData.once.Do(carbonatelexerLexerInit)
}

// NewCarbonateLexer produces a new lexer instance for the optional input antlr.CharStream.
func NewCarbonateLexer(input antlr.CharStream) *CarbonateLexer {
	CarbonateLexerInit()
	l := new(CarbonateLexer)
	...
	l.GrammarFileName = "Carbonate.g4"
	// TODO: l.EOF = antlr.TokenEOF

	return l
}

// CarbonateLexer tokens.
const (
	CarbonateLexerCARBONATE = 1
	CarbonateLexerOWNKEY    = 2
	CarbonateLexerSPLITKEY  = 3
	CarbonateLexerWS        = 4
)
