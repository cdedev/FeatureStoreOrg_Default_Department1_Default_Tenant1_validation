...
var caratlexerLexerStaticData struct {
	once                   sync.Once
	serializedATN          []int32
	channelNames           []string
	modeNames              []string
...
func caratlexerLexerInit() {
	staticData := &caratlexerLexerStaticData
...
// CaratLexerInit initializes any static state used to implement CaratLexer. By default the
// static state used to implement the lexer is lazily initialized during the first call to
// NewCaratLexer(). You can call this function if you wish to initialize the static state ahead
// of time.
func CaratLexerInit() {
	staticData := &caratlexerLexerStaticData
	staticData.once.Do(caratlexerLexerInit)
}

// NewCaratLexer produces a new lexer instance for the optional input antlr.CharStream.
func NewCaratLexer(input antlr.CharStream) *CaratLexer {
	CaratLexerInit()
	l := new(CaratLexer)
