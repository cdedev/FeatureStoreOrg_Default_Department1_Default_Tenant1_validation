...
type Sleeping_hoursLexer struct {
	*antlr.BaseLexer
	channelNames []string
	modeNames    []string
	// TODO: EOF string
...
var sleeping_hourslexerLexerStaticData struct {
	once                   sync.Once
	serializedATN          []int32
	channelNames           []string
	modeNames              []string
...
func sleeping_hourslexerLexerInit() {
	staticData := &sleeping_hourslexerLexerStaticData
...
// Sleeping_hoursLexerInit initializes any static state used to implement Sleeping_hoursLexer. By default the
// static state used to implement the lexer is lazily initialized during the first call to
// NewSleeping_hoursLexer(). You can call this function if you wish to initialize the static state ahead
// of time.
func Sleeping_hoursLexerInit() {
	staticData := &sleeping_hourslexerLexerStaticData
	staticData.once.Do(sleeping_hourslexerLexerInit)
}

// NewSleeping_hoursLexer produces a new lexer instance for the optional input antlr.CharStream.
func NewSleeping_hoursLexer(input antlr.CharStream) *Sleeping_hoursLexer {
	Sleeping_hoursLexerInit()
	l := new(Sleeping_hoursLexer)
	...
	l.GrammarFileName = "Sleeping_hours.g4"
	// TODO: l.EOF = antlr.TokenEOF

	return l
}

// Sleeping_hoursLexer tokens.
const (
	Sleeping_hoursLexerSLEEPING_HOURS = 1
	Sleeping_hoursLexerOWNKEY         = 2
	Sleeping_hoursLexerSPLITKEY       = 3
	Sleeping_hoursLexerWS             = 4
)
