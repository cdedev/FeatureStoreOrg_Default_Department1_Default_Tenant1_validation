...
var argonlexerLexerStaticData struct {
	once                   sync.Once
	serializedATN          []int32
	channelNames           []string
	modeNames              []string
...
func argonlexerLexerInit() {
	staticData := &argonlexerLexerStaticData
...
// ArgonLexerInit initializes any static state used to implement ArgonLexer. By default the
// static state used to implement the lexer is lazily initialized during the first call to
// NewArgonLexer(). You can call this function if you wish to initialize the static state ahead
// of time.
func ArgonLexerInit() {
	staticData := &argonlexerLexerStaticData
	staticData.once.Do(argonlexerLexerInit)
}

// NewArgonLexer produces a new lexer instance for the optional input antlr.CharStream.
func NewArgonLexer(input antlr.CharStream) *ArgonLexer {
	ArgonLexerInit()
	l := new(ArgonLexer)
