...
var expenditureslexerLexerStaticData struct {
	once                   sync.Once
	serializedATN          []int32
	channelNames           []string
	modeNames              []string
...
func expenditureslexerLexerInit() {
	staticData := &expenditureslexerLexerStaticData
...
// ExpendituresLexerInit initializes any static state used to implement ExpendituresLexer. By default the
// static state used to implement the lexer is lazily initialized during the first call to
// NewExpendituresLexer(). You can call this function if you wish to initialize the static state ahead
// of time.
func ExpendituresLexerInit() {
	staticData := &expenditureslexerLexerStaticData
	staticData.once.Do(expenditureslexerLexerInit)
}

// NewExpendituresLexer produces a new lexer instance for the optional input antlr.CharStream.
func NewExpendituresLexer(input antlr.CharStream) *ExpendituresLexer {
	ExpendituresLexerInit()
	l := new(ExpendituresLexer)
	...
	l.GrammarFileName = "Expenditures.g4"
	// TODO: l.EOF = antlr.TokenEOF

	return l
}

// ExpendituresLexer tokens.
const (
	ExpendituresLexerEXPENDITURES = 1
	ExpendituresLexerOWNKEY       = 2
	ExpendituresLexerSPLITKEY     = 3
	ExpendituresLexerWS           = 4
)
