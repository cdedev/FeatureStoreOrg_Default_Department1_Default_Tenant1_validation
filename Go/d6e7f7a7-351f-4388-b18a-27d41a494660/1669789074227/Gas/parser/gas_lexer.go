...
var gaslexerLexerStaticData struct {
	once                   sync.Once
	serializedATN          []int32
	channelNames           []string
	modeNames              []string
...
func gaslexerLexerInit() {
	staticData := &gaslexerLexerStaticData
...
// GasLexerInit initializes any static state used to implement GasLexer. By default the
// static state used to implement the lexer is lazily initialized during the first call to
// NewGasLexer(). You can call this function if you wish to initialize the static state ahead
// of time.
func GasLexerInit() {
	staticData := &gaslexerLexerStaticData
	staticData.once.Do(gaslexerLexerInit)
}

// NewGasLexer produces a new lexer instance for the optional input antlr.CharStream.
func NewGasLexer(input antlr.CharStream) *GasLexer {
	GasLexerInit()
	l := new(GasLexer)
