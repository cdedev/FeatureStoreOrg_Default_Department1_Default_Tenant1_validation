...
var shipdatelexerLexerStaticData struct {
	once                   sync.Once
	serializedATN          []int32
	channelNames           []string
	modeNames              []string
...
func shipdatelexerLexerInit() {
	staticData := &shipdatelexerLexerStaticData
...
// ShipDateLexerInit initializes any static state used to implement ShipDateLexer. By default the
// static state used to implement the lexer is lazily initialized during the first call to
// NewShipDateLexer(). You can call this function if you wish to initialize the static state ahead
// of time.
func ShipDateLexerInit() {
	staticData := &shipdatelexerLexerStaticData
	staticData.once.Do(shipdatelexerLexerInit)
}

// NewShipDateLexer produces a new lexer instance for the optional input antlr.CharStream.
func NewShipDateLexer(input antlr.CharStream) *ShipDateLexer {
	ShipDateLexerInit()
	l := new(ShipDateLexer)
	...
	l.GrammarFileName = "ShipDate.g4"
	// TODO: l.EOF = antlr.TokenEOF

	return l
}

// ShipDateLexer tokens.
const (
	ShipDateLexerSHIPDATE = 1
	ShipDateLexerOWNKEY   = 2
	ShipDateLexerSPLITKEY = 3
	ShipDateLexerWS       = 4
)
