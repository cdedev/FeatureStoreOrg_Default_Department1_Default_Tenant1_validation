...
var wisdomlexerLexerStaticData struct {
	once                   sync.Once
	serializedATN          []int32
	channelNames           []string
	modeNames              []string
...
func wisdomlexerLexerInit() {
	staticData := &wisdomlexerLexerStaticData
...
// WisdomLexerInit initializes any static state used to implement WisdomLexer. By default the
// static state used to implement the lexer is lazily initialized during the first call to
// NewWisdomLexer(). You can call this function if you wish to initialize the static state ahead
// of time.
func WisdomLexerInit() {
	staticData := &wisdomlexerLexerStaticData
	staticData.once.Do(wisdomlexerLexerInit)
}

// NewWisdomLexer produces a new lexer instance for the optional input antlr.CharStream.
func NewWisdomLexer(input antlr.CharStream) *WisdomLexer {
	WisdomLexerInit()
	l := new(WisdomLexer)
