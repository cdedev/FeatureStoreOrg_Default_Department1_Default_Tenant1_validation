...
var memberslexerLexerStaticData struct {
	once                   sync.Once
	serializedATN          []int32
	channelNames           []string
	modeNames              []string
...
func memberslexerLexerInit() {
	staticData := &memberslexerLexerStaticData
...
// MembersLexerInit initializes any static state used to implement MembersLexer. By default the
// static state used to implement the lexer is lazily initialized during the first call to
// NewMembersLexer(). You can call this function if you wish to initialize the static state ahead
// of time.
func MembersLexerInit() {
	staticData := &memberslexerLexerStaticData
	staticData.once.Do(memberslexerLexerInit)
}

// NewMembersLexer produces a new lexer instance for the optional input antlr.CharStream.
func NewMembersLexer(input antlr.CharStream) *MembersLexer {
	MembersLexerInit()
	l := new(MembersLexer)
...
// MembersLexer tokens.
const (
	MembersLexerMEMBERS  = 1
	MembersLexerOWNKEY   = 2
	MembersLexerSPLITKEY = 3
	MembersLexerWS       = 4
)
