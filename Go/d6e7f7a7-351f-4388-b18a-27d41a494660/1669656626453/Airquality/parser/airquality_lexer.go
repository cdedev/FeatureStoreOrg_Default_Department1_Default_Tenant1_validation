...
var airqualitylexerLexerStaticData struct {
	once                   sync.Once
	serializedATN          []int32
	channelNames           []string
	modeNames              []string
...
func airqualitylexerLexerInit() {
	staticData := &airqualitylexerLexerStaticData
...
// AirqualityLexerInit initializes any static state used to implement AirqualityLexer. By default the
// static state used to implement the lexer is lazily initialized during the first call to
// NewAirqualityLexer(). You can call this function if you wish to initialize the static state ahead
// of time.
func AirqualityLexerInit() {
	staticData := &airqualitylexerLexerStaticData
	staticData.once.Do(airqualitylexerLexerInit)
}

// NewAirqualityLexer produces a new lexer instance for the optional input antlr.CharStream.
func NewAirqualityLexer(input antlr.CharStream) *AirqualityLexer {
	AirqualityLexerInit()
	l := new(AirqualityLexer)
	...
	l.GrammarFileName = "Airquality.g4"
	// TODO: l.EOF = antlr.TokenEOF

	return l
}

// AirqualityLexer tokens.
const (
	AirqualityLexerAIRQUALITY = 1
	AirqualityLexerOWNKEY     = 2
	AirqualityLexerSPLITKEY   = 3
	AirqualityLexerWS         = 4
)
