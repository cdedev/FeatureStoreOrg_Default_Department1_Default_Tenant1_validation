...
var buyingpowerlexerLexerStaticData struct {
	once                   sync.Once
	serializedATN          []int32
	channelNames           []string
	modeNames              []string
...
func buyingpowerlexerLexerInit() {
	staticData := &buyingpowerlexerLexerStaticData
...
// BuyingPowerLexerInit initializes any static state used to implement BuyingPowerLexer. By default the
// static state used to implement the lexer is lazily initialized during the first call to
// NewBuyingPowerLexer(). You can call this function if you wish to initialize the static state ahead
// of time.
func BuyingPowerLexerInit() {
	staticData := &buyingpowerlexerLexerStaticData
	staticData.once.Do(buyingpowerlexerLexerInit)
}

// NewBuyingPowerLexer produces a new lexer instance for the optional input antlr.CharStream.
func NewBuyingPowerLexer(input antlr.CharStream) *BuyingPowerLexer {
	BuyingPowerLexerInit()
	l := new(BuyingPowerLexer)
	...
	l.GrammarFileName = "BuyingPower.g4"
	// TODO: l.EOF = antlr.TokenEOF

	return l
}

// BuyingPowerLexer tokens.
const (
	BuyingPowerLexerBUYINGPOWER = 1
	BuyingPowerLexerOWNKEY      = 2
	BuyingPowerLexerSPLITKEY    = 3
	BuyingPowerLexerWS          = 4
)
