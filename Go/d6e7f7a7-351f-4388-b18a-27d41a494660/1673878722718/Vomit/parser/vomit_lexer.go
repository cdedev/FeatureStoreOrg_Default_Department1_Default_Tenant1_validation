...
var vomitlexerLexerStaticData struct {
	once                   sync.Once
	serializedATN          []int32
	channelNames           []string
	modeNames              []string
...
func vomitlexerLexerInit() {
	staticData := &vomitlexerLexerStaticData
...
// VomitLexerInit initializes any static state used to implement VomitLexer. By default the
// static state used to implement the lexer is lazily initialized during the first call to
// NewVomitLexer(). You can call this function if you wish to initialize the static state ahead
// of time.
func VomitLexerInit() {
	staticData := &vomitlexerLexerStaticData
	staticData.once.Do(vomitlexerLexerInit)
}

// NewVomitLexer produces a new lexer instance for the optional input antlr.CharStream.
func NewVomitLexer(input antlr.CharStream) *VomitLexer {
	VomitLexerInit()
	l := new(VomitLexer)
