...
var safetylexerLexerStaticData struct {
	once                   sync.Once
	serializedATN          []int32
	channelNames           []string
	modeNames              []string
...
func safetylexerLexerInit() {
	staticData := &safetylexerLexerStaticData
...
// SafetyLexerInit initializes any static state used to implement SafetyLexer. By default the
// static state used to implement the lexer is lazily initialized during the first call to
// NewSafetyLexer(). You can call this function if you wish to initialize the static state ahead
// of time.
func SafetyLexerInit() {
	staticData := &safetylexerLexerStaticData
	staticData.once.Do(safetylexerLexerInit)
}

// NewSafetyLexer produces a new lexer instance for the optional input antlr.CharStream.
func NewSafetyLexer(input antlr.CharStream) *SafetyLexer {
	SafetyLexerInit()
	l := new(SafetyLexer)
