...
var deltalexerLexerStaticData struct {
	once                   sync.Once
	serializedATN          []int32
	channelNames           []string
	modeNames              []string
...
func deltalexerLexerInit() {
	staticData := &deltalexerLexerStaticData
...
// DeltaLexerInit initializes any static state used to implement DeltaLexer. By default the
// static state used to implement the lexer is lazily initialized during the first call to
// NewDeltaLexer(). You can call this function if you wish to initialize the static state ahead
// of time.
func DeltaLexerInit() {
	staticData := &deltalexerLexerStaticData
	staticData.once.Do(deltalexerLexerInit)
}

// NewDeltaLexer produces a new lexer instance for the optional input antlr.CharStream.
func NewDeltaLexer(input antlr.CharStream) *DeltaLexer {
	DeltaLexerInit()
	l := new(DeltaLexer)
