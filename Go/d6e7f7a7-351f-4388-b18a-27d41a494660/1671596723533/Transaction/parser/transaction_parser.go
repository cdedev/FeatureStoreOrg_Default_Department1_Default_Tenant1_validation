...
func transactionParserInit() {
	...
	staticData.symbolicNames = []string{
		"", "TRANSACTION", "OWNKEY", "SPLITKEY", "WS",
	}
...
const (
	...
	TransactionParserTRANSACTION = 1
	TransactionParserOWNKEY      = 2
	TransactionParserSPLITKEY    = 3
	TransactionParserWS          = 4
)

// TransactionParser rules.
const (
	TransactionParserRULE_expression  = 0
	TransactionParserRULE_transaction = 1
)
...
func NewEmptyExpressionContext() *ExpressionContext {
	...
	p.RuleIndex = TransactionParserRULE_expression
	return p
}
...
func (s *ExpressionContext) Transaction() ITransactionContext {
	var t antlr.RuleContext
	for _, ctx := range s.GetChildren() {
		if _, ok := ctx.(ITransactionContext); ok {
...
func (s *ExpressionContext) EOF() antlr.TerminalNode {
	return s.GetToken(TransactionParserEOF, 0)
}
...
func (p *TransactionParser) Expression() (localctx IExpressionContext) {
	this := p
	_ = this

	localctx = NewExpressionContext(p, p.GetParserRuleContext(), p.GetState())
	p.EnterRule(localctx, 0, TransactionParserRULE_expression)
...
func (s *TransactionContext) TRANSACTION() antlr.TerminalNode {
	return s.GetToken(TransactionParserTRANSACTION, 0)
}
...
func (p *TransactionParser) Transaction() (localctx ITransactionContext) {
	...
	p.EnterRule(localctx, 2, TransactionParserRULE_transaction)
	...
	{
		p.SetState(7)
		p.Match(TransactionParserTRANSACTION)
	}
