...
var liquidlexerLexerStaticData struct {
	once                   sync.Once
	serializedATN          []int32
	channelNames           []string
	modeNames              []string
...
func liquidlexerLexerInit() {
	staticData := &liquidlexerLexerStaticData
...
// LiquidLexerInit initializes any static state used to implement LiquidLexer. By default the
// static state used to implement the lexer is lazily initialized during the first call to
// NewLiquidLexer(). You can call this function if you wish to initialize the static state ahead
// of time.
func LiquidLexerInit() {
	staticData := &liquidlexerLexerStaticData
	staticData.once.Do(liquidlexerLexerInit)
}

// NewLiquidLexer produces a new lexer instance for the optional input antlr.CharStream.
func NewLiquidLexer(input antlr.CharStream) *LiquidLexer {
	LiquidLexerInit()
	l := new(LiquidLexer)
