...
type RotationalSpeedLexer struct {
	*antlr.BaseLexer
	channelNames []string
	modeNames    []string
	// TODO: EOF string
...
var rotationalspeedlexerLexerStaticData struct {
	once                   sync.Once
	serializedATN          []int32
	channelNames           []string
	modeNames              []string
...
func rotationalspeedlexerLexerInit() {
	staticData := &rotationalspeedlexerLexerStaticData
...
// RotationalSpeedLexerInit initializes any static state used to implement RotationalSpeedLexer. By default the
// static state used to implement the lexer is lazily initialized during the first call to
// NewRotationalSpeedLexer(). You can call this function if you wish to initialize the static state ahead
// of time.
func RotationalSpeedLexerInit() {
	staticData := &rotationalspeedlexerLexerStaticData
	staticData.once.Do(rotationalspeedlexerLexerInit)
}

// NewRotationalSpeedLexer produces a new lexer instance for the optional input antlr.CharStream.
func NewRotationalSpeedLexer(input antlr.CharStream) *RotationalSpeedLexer {
	RotationalSpeedLexerInit()
	l := new(RotationalSpeedLexer)
	...
	l.GrammarFileName = "RotationalSpeed.g4"
	// TODO: l.EOF = antlr.TokenEOF

	return l
}

// RotationalSpeedLexer tokens.
const (
	RotationalSpeedLexerROTATIONALSPEED = 1
	RotationalSpeedLexerOWNKEY          = 2
	RotationalSpeedLexerSPLITKEY        = 3
	RotationalSpeedLexerWS              = 4
)
