...
var augmintemplexerLexerStaticData struct {
	once                   sync.Once
	serializedATN          []int32
	channelNames           []string
	modeNames              []string
...
func augmintemplexerLexerInit() {
	staticData := &augmintemplexerLexerStaticData
...
// AugMintempLexerInit initializes any static state used to implement AugMintempLexer. By default the
// static state used to implement the lexer is lazily initialized during the first call to
// NewAugMintempLexer(). You can call this function if you wish to initialize the static state ahead
// of time.
func AugMintempLexerInit() {
	staticData := &augmintemplexerLexerStaticData
	staticData.once.Do(augmintemplexerLexerInit)
}

// NewAugMintempLexer produces a new lexer instance for the optional input antlr.CharStream.
func NewAugMintempLexer(input antlr.CharStream) *AugMintempLexer {
	AugMintempLexerInit()
	l := new(AugMintempLexer)
	...
	l.GrammarFileName = "AugMintemp.g4"
	// TODO: l.EOF = antlr.TokenEOF

	return l
}

// AugMintempLexer tokens.
const (
	AugMintempLexerAUGMINTEMP = 1
	AugMintempLexerOWNKEY     = 2
	AugMintempLexerSPLITKEY   = 3
	AugMintempLexerWS         = 4
)
