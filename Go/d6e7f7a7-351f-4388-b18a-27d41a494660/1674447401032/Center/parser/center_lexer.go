...
var centerlexerLexerStaticData struct {
	once                   sync.Once
	serializedATN          []int32
	channelNames           []string
	modeNames              []string
...
func centerlexerLexerInit() {
	staticData := &centerlexerLexerStaticData
...
// CenterLexerInit initializes any static state used to implement CenterLexer. By default the
// static state used to implement the lexer is lazily initialized during the first call to
// NewCenterLexer(). You can call this function if you wish to initialize the static state ahead
// of time.
func CenterLexerInit() {
	staticData := &centerlexerLexerStaticData
	staticData.once.Do(centerlexerLexerInit)
}

// NewCenterLexer produces a new lexer instance for the optional input antlr.CharStream.
func NewCenterLexer(input antlr.CharStream) *CenterLexer {
	CenterLexerInit()
	l := new(CenterLexer)
