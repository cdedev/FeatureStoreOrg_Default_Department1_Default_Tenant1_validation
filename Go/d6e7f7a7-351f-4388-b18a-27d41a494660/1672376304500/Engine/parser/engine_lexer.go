...
var enginelexerLexerStaticData struct {
	once                   sync.Once
	serializedATN          []int32
	channelNames           []string
	modeNames              []string
...
func enginelexerLexerInit() {
	staticData := &enginelexerLexerStaticData
...
// EngineLexerInit initializes any static state used to implement EngineLexer. By default the
// static state used to implement the lexer is lazily initialized during the first call to
// NewEngineLexer(). You can call this function if you wish to initialize the static state ahead
// of time.
func EngineLexerInit() {
	staticData := &enginelexerLexerStaticData
	staticData.once.Do(enginelexerLexerInit)
}
