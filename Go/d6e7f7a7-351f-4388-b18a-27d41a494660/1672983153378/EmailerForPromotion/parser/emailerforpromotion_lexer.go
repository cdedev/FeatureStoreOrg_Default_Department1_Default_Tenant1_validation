...
type EmailerForPromotionLexer struct {
	*antlr.BaseLexer
	channelNames []string
	modeNames    []string
	// TODO: EOF string
...
var emailerforpromotionlexerLexerStaticData struct {
	once                   sync.Once
	serializedATN          []int32
	channelNames           []string
	modeNames              []string
...
func emailerforpromotionlexerLexerInit() {
	staticData := &emailerforpromotionlexerLexerStaticData
	...
	staticData.serializedATN = []int32{
		...
		0, 4, 1, 1, 3, 2, 5, 3, 7, 4, 1, 0, 2, 1, 0, 48, 49, 3, 0, 9, 10, 13, 13,
...
// EmailerForPromotionLexerInit initializes any static state used to implement EmailerForPromotionLexer. By default the
// static state used to implement the lexer is lazily initialized during the first call to
// NewEmailerForPromotionLexer(). You can call this function if you wish to initialize the static state ahead
// of time.
func EmailerForPromotionLexerInit() {
	staticData := &emailerforpromotionlexerLexerStaticData
	staticData.once.Do(emailerforpromotionlexerLexerInit)
}

// NewEmailerForPromotionLexer produces a new lexer instance for the optional input antlr.CharStream.
func NewEmailerForPromotionLexer(input antlr.CharStream) *EmailerForPromotionLexer {
	EmailerForPromotionLexerInit()
	l := new(EmailerForPromotionLexer)
	...
	l.GrammarFileName = "EmailerForPromotion.g4"
	// TODO: l.EOF = antlr.TokenEOF

	return l
}

// EmailerForPromotionLexer tokens.
const (
	EmailerForPromotionLexerEMAILERFORPROMOTION = 1
	EmailerForPromotionLexerOWNKEY              = 2
	EmailerForPromotionLexerSPLITKEY            = 3
	EmailerForPromotionLexerWS                  = 4
)
