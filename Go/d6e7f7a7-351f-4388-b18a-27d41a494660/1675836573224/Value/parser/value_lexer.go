...
var valuelexerLexerStaticData struct {
	once                   sync.Once
	serializedATN          []int32
	channelNames           []string
	modeNames              []string
...
func valuelexerLexerInit() {
	staticData := &valuelexerLexerStaticData
...
// ValueLexerInit initializes any static state used to implement ValueLexer. By default the
// static state used to implement the lexer is lazily initialized during the first call to
// NewValueLexer(). You can call this function if you wish to initialize the static state ahead
// of time.
func ValueLexerInit() {
	staticData := &valuelexerLexerStaticData
	staticData.once.Do(valuelexerLexerInit)
}

// NewValueLexer produces a new lexer instance for the optional input antlr.CharStream.
func NewValueLexer(input antlr.CharStream) *ValueLexer {
	ValueLexerInit()
	l := new(ValueLexer)
