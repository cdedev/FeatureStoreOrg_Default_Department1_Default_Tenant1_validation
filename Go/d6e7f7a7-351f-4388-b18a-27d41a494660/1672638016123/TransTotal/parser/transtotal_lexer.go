...
var transtotallexerLexerStaticData struct {
	once                   sync.Once
	serializedATN          []int32
	channelNames           []string
	modeNames              []string
...
func transtotallexerLexerInit() {
	staticData := &transtotallexerLexerStaticData
...
// TransTotalLexerInit initializes any static state used to implement TransTotalLexer. By default the
// static state used to implement the lexer is lazily initialized during the first call to
// NewTransTotalLexer(). You can call this function if you wish to initialize the static state ahead
// of time.
func TransTotalLexerInit() {
	staticData := &transtotallexerLexerStaticData
	staticData.once.Do(transtotallexerLexerInit)
}

// NewTransTotalLexer produces a new lexer instance for the optional input antlr.CharStream.
func NewTransTotalLexer(input antlr.CharStream) *TransTotalLexer {
	TransTotalLexerInit()
	l := new(TransTotalLexer)
	...
	l.GrammarFileName = "TransTotal.g4"
	// TODO: l.EOF = antlr.TokenEOF

	return l
}

// TransTotalLexer tokens.
const (
	TransTotalLexerTRANSTOTAL = 1
	TransTotalLexerOWNKEY     = 2
	TransTotalLexerSPLITKEY   = 3
	TransTotalLexerWS         = 4
)
