...
var normallexerLexerStaticData struct {
	once                   sync.Once
	serializedATN          []int32
	channelNames           []string
	modeNames              []string
...
func normallexerLexerInit() {
	staticData := &normallexerLexerStaticData
...
// NormalLexerInit initializes any static state used to implement NormalLexer. By default the
// static state used to implement the lexer is lazily initialized during the first call to
// NewNormalLexer(). You can call this function if you wish to initialize the static state ahead
// of time.
func NormalLexerInit() {
	staticData := &normallexerLexerStaticData
	staticData.once.Do(normallexerLexerInit)
}

// NewNormalLexer produces a new lexer instance for the optional input antlr.CharStream.
func NewNormalLexer(input antlr.CharStream) *NormalLexer {
	NormalLexerInit()
	l := new(NormalLexer)
