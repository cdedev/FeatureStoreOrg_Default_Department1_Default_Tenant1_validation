...
var octmaxtemplexerLexerStaticData struct {
	once                   sync.Once
	serializedATN          []int32
	channelNames           []string
	modeNames              []string
...
func octmaxtemplexerLexerInit() {
	staticData := &octmaxtemplexerLexerStaticData
...
// OctMaxtempLexerInit initializes any static state used to implement OctMaxtempLexer. By default the
// static state used to implement the lexer is lazily initialized during the first call to
// NewOctMaxtempLexer(). You can call this function if you wish to initialize the static state ahead
// of time.
func OctMaxtempLexerInit() {
	staticData := &octmaxtemplexerLexerStaticData
	staticData.once.Do(octmaxtemplexerLexerInit)
}

// NewOctMaxtempLexer produces a new lexer instance for the optional input antlr.CharStream.
func NewOctMaxtempLexer(input antlr.CharStream) *OctMaxtempLexer {
	OctMaxtempLexerInit()
	l := new(OctMaxtempLexer)
	...
	l.GrammarFileName = "OctMaxtemp.g4"
	// TODO: l.EOF = antlr.TokenEOF

	return l
}

// OctMaxtempLexer tokens.
const (
	OctMaxtempLexerOCTMAXTEMP = 1
	OctMaxtempLexerOWNKEY     = 2
	OctMaxtempLexerSPLITKEY   = 3
	OctMaxtempLexerWS         = 4
)
