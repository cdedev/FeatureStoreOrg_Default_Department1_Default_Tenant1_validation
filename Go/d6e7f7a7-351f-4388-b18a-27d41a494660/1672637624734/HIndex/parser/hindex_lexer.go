...
var hindexlexerLexerStaticData struct {
	once                   sync.Once
	serializedATN          []int32
	channelNames           []string
	modeNames              []string
...
func hindexlexerLexerInit() {
	staticData := &hindexlexerLexerStaticData
...
// HIndexLexerInit initializes any static state used to implement HIndexLexer. By default the
// static state used to implement the lexer is lazily initialized during the first call to
// NewHIndexLexer(). You can call this function if you wish to initialize the static state ahead
// of time.
func HIndexLexerInit() {
	staticData := &hindexlexerLexerStaticData
	staticData.once.Do(hindexlexerLexerInit)
}

// NewHIndexLexer produces a new lexer instance for the optional input antlr.CharStream.
func NewHIndexLexer(input antlr.CharStream) *HIndexLexer {
	HIndexLexerInit()
	l := new(HIndexLexer)
