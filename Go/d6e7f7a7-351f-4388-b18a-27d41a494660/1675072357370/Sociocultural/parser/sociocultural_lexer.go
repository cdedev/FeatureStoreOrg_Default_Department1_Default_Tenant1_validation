...
type SocioculturalLexer struct {
	*antlr.BaseLexer
	channelNames []string
	modeNames    []string
	// TODO: EOF string
...
var socioculturallexerLexerStaticData struct {
	once                   sync.Once
	serializedATN          []int32
	channelNames           []string
	modeNames              []string
...
func socioculturallexerLexerInit() {
	staticData := &socioculturallexerLexerStaticData
...
// SocioculturalLexerInit initializes any static state used to implement SocioculturalLexer. By default the
// static state used to implement the lexer is lazily initialized during the first call to
// NewSocioculturalLexer(). You can call this function if you wish to initialize the static state ahead
// of time.
func SocioculturalLexerInit() {
	staticData := &socioculturallexerLexerStaticData
	staticData.once.Do(socioculturallexerLexerInit)
}

// NewSocioculturalLexer produces a new lexer instance for the optional input antlr.CharStream.
func NewSocioculturalLexer(input antlr.CharStream) *SocioculturalLexer {
	SocioculturalLexerInit()
	l := new(SocioculturalLexer)
	...
	l.GrammarFileName = "Sociocultural.g4"
	// TODO: l.EOF = antlr.TokenEOF

	return l
}

// SocioculturalLexer tokens.
const (
	SocioculturalLexerSOCIOCULTURAL = 1
	SocioculturalLexerOWNKEY        = 2
	SocioculturalLexerSPLITKEY      = 3
	SocioculturalLexerWS            = 4
)
