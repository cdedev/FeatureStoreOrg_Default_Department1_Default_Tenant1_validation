...
var phonophobialexerLexerStaticData struct {
	once                   sync.Once
	serializedATN          []int32
	channelNames           []string
	modeNames              []string
...
func phonophobialexerLexerInit() {
	staticData := &phonophobialexerLexerStaticData
...
// PhonophobiaLexerInit initializes any static state used to implement PhonophobiaLexer. By default the
// static state used to implement the lexer is lazily initialized during the first call to
// NewPhonophobiaLexer(). You can call this function if you wish to initialize the static state ahead
// of time.
func PhonophobiaLexerInit() {
	staticData := &phonophobialexerLexerStaticData
	staticData.once.Do(phonophobialexerLexerInit)
}

// NewPhonophobiaLexer produces a new lexer instance for the optional input antlr.CharStream.
func NewPhonophobiaLexer(input antlr.CharStream) *PhonophobiaLexer {
	PhonophobiaLexerInit()
	l := new(PhonophobiaLexer)
	...
	l.GrammarFileName = "Phonophobia.g4"
	// TODO: l.EOF = antlr.TokenEOF

	return l
}

// PhonophobiaLexer tokens.
const (
	PhonophobiaLexerPHONOPHOBIA = 1
	PhonophobiaLexerOWNKEY      = 2
	PhonophobiaLexerSPLITKEY    = 3
	PhonophobiaLexerWS          = 4
)
