...
var aluminiumlexerLexerStaticData struct {
	once                   sync.Once
	serializedATN          []int32
	channelNames           []string
	modeNames              []string
...
func aluminiumlexerLexerInit() {
	staticData := &aluminiumlexerLexerStaticData
...
// AluminiumLexerInit initializes any static state used to implement AluminiumLexer. By default the
// static state used to implement the lexer is lazily initialized during the first call to
// NewAluminiumLexer(). You can call this function if you wish to initialize the static state ahead
// of time.
func AluminiumLexerInit() {
	staticData := &aluminiumlexerLexerStaticData
	staticData.once.Do(aluminiumlexerLexerInit)
}

// NewAluminiumLexer produces a new lexer instance for the optional input antlr.CharStream.
func NewAluminiumLexer(input antlr.CharStream) *AluminiumLexer {
	AluminiumLexerInit()
	l := new(AluminiumLexer)
	...
	l.GrammarFileName = "Aluminium.g4"
	// TODO: l.EOF = antlr.TokenEOF

	return l
}

// AluminiumLexer tokens.
const (
	AluminiumLexerALUMINIUM = 1
	AluminiumLexerOWNKEY    = 2
	AluminiumLexerSPLITKEY  = 3
	AluminiumLexerWS        = 4
)
