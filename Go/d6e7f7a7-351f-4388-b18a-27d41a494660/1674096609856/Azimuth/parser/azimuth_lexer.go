...
var azimuthlexerLexerStaticData struct {
	once                   sync.Once
	serializedATN          []int32
	channelNames           []string
	modeNames              []string
...
func azimuthlexerLexerInit() {
	staticData := &azimuthlexerLexerStaticData
...
// AzimuthLexerInit initializes any static state used to implement AzimuthLexer. By default the
// static state used to implement the lexer is lazily initialized during the first call to
// NewAzimuthLexer(). You can call this function if you wish to initialize the static state ahead
// of time.
func AzimuthLexerInit() {
	staticData := &azimuthlexerLexerStaticData
	staticData.once.Do(azimuthlexerLexerInit)
}

// NewAzimuthLexer produces a new lexer instance for the optional input antlr.CharStream.
func NewAzimuthLexer(input antlr.CharStream) *AzimuthLexer {
	AzimuthLexerInit()
	l := new(AzimuthLexer)
...
// AzimuthLexer tokens.
const (
	AzimuthLexerAZIMUTH  = 1
	AzimuthLexerOWNKEY   = 2
	AzimuthLexerSPLITKEY = 3
	AzimuthLexerWS       = 4
)
