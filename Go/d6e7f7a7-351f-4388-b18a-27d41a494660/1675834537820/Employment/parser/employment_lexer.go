...
var employmentlexerLexerStaticData struct {
	once                   sync.Once
	serializedATN          []int32
	channelNames           []string
	modeNames              []string
...
func employmentlexerLexerInit() {
	staticData := &employmentlexerLexerStaticData
...
// EmploymentLexerInit initializes any static state used to implement EmploymentLexer. By default the
// static state used to implement the lexer is lazily initialized during the first call to
// NewEmploymentLexer(). You can call this function if you wish to initialize the static state ahead
// of time.
func EmploymentLexerInit() {
	staticData := &employmentlexerLexerStaticData
	staticData.once.Do(employmentlexerLexerInit)
}

// NewEmploymentLexer produces a new lexer instance for the optional input antlr.CharStream.
func NewEmploymentLexer(input antlr.CharStream) *EmploymentLexer {
	EmploymentLexerInit()
	l := new(EmploymentLexer)
	...
	l.GrammarFileName = "Employment.g4"
	// TODO: l.EOF = antlr.TokenEOF

	return l
}

// EmploymentLexer tokens.
const (
	EmploymentLexerEMPLOYMENT = 1
	EmploymentLexerOWNKEY     = 2
	EmploymentLexerSPLITKEY   = 3
	EmploymentLexerWS         = 4
)
