...
type CarbondioxideLexer struct {
	*antlr.BaseLexer
	channelNames []string
	modeNames    []string
	// TODO: EOF string
...
var carbondioxidelexerLexerStaticData struct {
	once                   sync.Once
	serializedATN          []int32
	channelNames           []string
	modeNames              []string
...
func carbondioxidelexerLexerInit() {
	staticData := &carbondioxidelexerLexerStaticData
...
// CarbondioxideLexerInit initializes any static state used to implement CarbondioxideLexer. By default the
// static state used to implement the lexer is lazily initialized during the first call to
// NewCarbondioxideLexer(). You can call this function if you wish to initialize the static state ahead
// of time.
func CarbondioxideLexerInit() {
	staticData := &carbondioxidelexerLexerStaticData
	staticData.once.Do(carbondioxidelexerLexerInit)
}

// NewCarbondioxideLexer produces a new lexer instance for the optional input antlr.CharStream.
func NewCarbondioxideLexer(input antlr.CharStream) *CarbondioxideLexer {
	CarbondioxideLexerInit()
	l := new(CarbondioxideLexer)
	...
	l.GrammarFileName = "Carbondioxide.g4"
	// TODO: l.EOF = antlr.TokenEOF

	return l
}

// CarbondioxideLexer tokens.
const (
	CarbondioxideLexerCARBONDIOXIDE = 1
	CarbondioxideLexerOWNKEY        = 2
	CarbondioxideLexerSPLITKEY      = 3
	CarbondioxideLexerWS            = 4
)
