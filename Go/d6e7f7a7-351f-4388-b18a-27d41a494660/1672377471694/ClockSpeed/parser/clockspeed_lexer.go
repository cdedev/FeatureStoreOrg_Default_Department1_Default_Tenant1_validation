...
var clockspeedlexerLexerStaticData struct {
	once                   sync.Once
	serializedATN          []int32
	channelNames           []string
	modeNames              []string
...
func clockspeedlexerLexerInit() {
	staticData := &clockspeedlexerLexerStaticData
...
// ClockSpeedLexerInit initializes any static state used to implement ClockSpeedLexer. By default the
// static state used to implement the lexer is lazily initialized during the first call to
// NewClockSpeedLexer(). You can call this function if you wish to initialize the static state ahead
// of time.
func ClockSpeedLexerInit() {
	staticData := &clockspeedlexerLexerStaticData
	staticData.once.Do(clockspeedlexerLexerInit)
}

// NewClockSpeedLexer produces a new lexer instance for the optional input antlr.CharStream.
func NewClockSpeedLexer(input antlr.CharStream) *ClockSpeedLexer {
	ClockSpeedLexerInit()
	l := new(ClockSpeedLexer)
	...
	l.GrammarFileName = "ClockSpeed.g4"
	// TODO: l.EOF = antlr.TokenEOF

	return l
}

// ClockSpeedLexer tokens.
const (
	ClockSpeedLexerCLOCKSPEED = 1
	ClockSpeedLexerOWNKEY     = 2
	ClockSpeedLexerSPLITKEY   = 3
	ClockSpeedLexerWS         = 4
)
