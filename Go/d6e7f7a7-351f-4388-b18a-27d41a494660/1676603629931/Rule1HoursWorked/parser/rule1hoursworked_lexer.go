...
type Rule1HoursWorkedLexer struct {
	*antlr.BaseLexer
	channelNames []string
	modeNames    []string
	// TODO: EOF string
...
var rule1hoursworkedlexerLexerStaticData struct {
	once                   sync.Once
	serializedATN          []int32
	channelNames           []string
	modeNames              []string
...
func rule1hoursworkedlexerLexerInit() {
	staticData := &rule1hoursworkedlexerLexerStaticData
...
// Rule1HoursWorkedLexerInit initializes any static state used to implement Rule1HoursWorkedLexer. By default the
// static state used to implement the lexer is lazily initialized during the first call to
// NewRule1HoursWorkedLexer(). You can call this function if you wish to initialize the static state ahead
// of time.
func Rule1HoursWorkedLexerInit() {
	staticData := &rule1hoursworkedlexerLexerStaticData
	staticData.once.Do(rule1hoursworkedlexerLexerInit)
}

// NewRule1HoursWorkedLexer produces a new lexer instance for the optional input antlr.CharStream.
func NewRule1HoursWorkedLexer(input antlr.CharStream) *Rule1HoursWorkedLexer {
	Rule1HoursWorkedLexerInit()
	l := new(Rule1HoursWorkedLexer)
	...
	l.GrammarFileName = "Rule1HoursWorked.g4"
	// TODO: l.EOF = antlr.TokenEOF

	return l
}

// Rule1HoursWorkedLexer tokens.
const (
	Rule1HoursWorkedLexerHOURSWORKED = 1
	Rule1HoursWorkedLexerOWNKEY      = 2
	Rule1HoursWorkedLexerSPLITKEY    = 3
	Rule1HoursWorkedLexerWS          = 4
)
