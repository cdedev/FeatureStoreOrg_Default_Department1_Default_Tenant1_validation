...
var majoraxislexerLexerStaticData struct {
	once                   sync.Once
	serializedATN          []int32
	channelNames           []string
	modeNames              []string
...
func majoraxislexerLexerInit() {
	staticData := &majoraxislexerLexerStaticData
...
// MajoraxisLexerInit initializes any static state used to implement MajoraxisLexer. By default the
// static state used to implement the lexer is lazily initialized during the first call to
// NewMajoraxisLexer(). You can call this function if you wish to initialize the static state ahead
// of time.
func MajoraxisLexerInit() {
	staticData := &majoraxislexerLexerStaticData
	staticData.once.Do(majoraxislexerLexerInit)
}

// NewMajoraxisLexer produces a new lexer instance for the optional input antlr.CharStream.
func NewMajoraxisLexer(input antlr.CharStream) *MajoraxisLexer {
	MajoraxisLexerInit()
	l := new(MajoraxisLexer)
	...
	l.GrammarFileName = "Majoraxis.g4"
	// TODO: l.EOF = antlr.TokenEOF

	return l
}

// MajoraxisLexer tokens.
const (
	MajoraxisLexerMAJORAXIS = 1
	MajoraxisLexerOWNKEY    = 2
	MajoraxisLexerSPLITKEY  = 3
	MajoraxisLexerWS        = 4
)
