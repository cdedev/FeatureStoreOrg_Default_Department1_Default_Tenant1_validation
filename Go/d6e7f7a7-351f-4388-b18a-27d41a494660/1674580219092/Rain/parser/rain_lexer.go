...
var rainlexerLexerStaticData struct {
	once                   sync.Once
	serializedATN          []int32
	channelNames           []string
	modeNames              []string
...
func rainlexerLexerInit() {
	staticData := &rainlexerLexerStaticData
...
// RainLexerInit initializes any static state used to implement RainLexer. By default the
// static state used to implement the lexer is lazily initialized during the first call to
// NewRainLexer(). You can call this function if you wish to initialize the static state ahead
// of time.
func RainLexerInit() {
	staticData := &rainlexerLexerStaticData
	staticData.once.Do(rainlexerLexerInit)
}

// NewRainLexer produces a new lexer instance for the optional input antlr.CharStream.
func NewRainLexer(input antlr.CharStream) *RainLexer {
	RainLexerInit()
	l := new(RainLexer)
