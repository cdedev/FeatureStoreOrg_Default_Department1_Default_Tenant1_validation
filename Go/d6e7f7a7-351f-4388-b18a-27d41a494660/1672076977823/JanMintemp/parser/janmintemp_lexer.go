...
var janmintemplexerLexerStaticData struct {
	once                   sync.Once
	serializedATN          []int32
	channelNames           []string
	modeNames              []string
...
func janmintemplexerLexerInit() {
	staticData := &janmintemplexerLexerStaticData
...
// JanMintempLexerInit initializes any static state used to implement JanMintempLexer. By default the
// static state used to implement the lexer is lazily initialized during the first call to
// NewJanMintempLexer(). You can call this function if you wish to initialize the static state ahead
// of time.
func JanMintempLexerInit() {
	staticData := &janmintemplexerLexerStaticData
	staticData.once.Do(janmintemplexerLexerInit)
}

// NewJanMintempLexer produces a new lexer instance for the optional input antlr.CharStream.
func NewJanMintempLexer(input antlr.CharStream) *JanMintempLexer {
	JanMintempLexerInit()
	l := new(JanMintempLexer)
	...
	l.GrammarFileName = "JanMintemp.g4"
	// TODO: l.EOF = antlr.TokenEOF

	return l
}

// JanMintempLexer tokens.
const (
	JanMintempLexerJANMINTEMP = 1
	JanMintempLexerOWNKEY     = 2
	JanMintempLexerSPLITKEY   = 3
	JanMintempLexerWS         = 4
)
