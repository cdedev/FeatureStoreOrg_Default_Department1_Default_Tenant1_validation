...
var mobilitylexerLexerStaticData struct {
	once                   sync.Once
	serializedATN          []int32
	channelNames           []string
	modeNames              []string
...
func mobilitylexerLexerInit() {
	staticData := &mobilitylexerLexerStaticData
...
// MobilityLexerInit initializes any static state used to implement MobilityLexer. By default the
// static state used to implement the lexer is lazily initialized during the first call to
// NewMobilityLexer(). You can call this function if you wish to initialize the static state ahead
// of time.
func MobilityLexerInit() {
	staticData := &mobilitylexerLexerStaticData
	staticData.once.Do(mobilitylexerLexerInit)
}

// NewMobilityLexer produces a new lexer instance for the optional input antlr.CharStream.
func NewMobilityLexer(input antlr.CharStream) *MobilityLexer {
	MobilityLexerInit()
	l := new(MobilityLexer)
	...
	l.GrammarFileName = "Mobility.g4"
	// TODO: l.EOF = antlr.TokenEOF

	return l
}

// MobilityLexer tokens.
const (
	MobilityLexerMOBILITY = 1
	MobilityLexerOWNKEY   = 2
	MobilityLexerSPLITKEY = 3
	MobilityLexerWS       = 4
)
