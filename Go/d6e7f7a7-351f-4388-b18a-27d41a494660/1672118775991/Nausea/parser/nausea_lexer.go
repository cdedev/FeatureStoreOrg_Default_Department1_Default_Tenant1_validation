...
var nausealexerLexerStaticData struct {
	once                   sync.Once
	serializedATN          []int32
	channelNames           []string
	modeNames              []string
...
func nausealexerLexerInit() {
	staticData := &nausealexerLexerStaticData
...
// NauseaLexerInit initializes any static state used to implement NauseaLexer. By default the
// static state used to implement the lexer is lazily initialized during the first call to
// NewNauseaLexer(). You can call this function if you wish to initialize the static state ahead
// of time.
func NauseaLexerInit() {
	staticData := &nausealexerLexerStaticData
	staticData.once.Do(nausealexerLexerInit)
}

// NewNauseaLexer produces a new lexer instance for the optional input antlr.CharStream.
func NewNauseaLexer(input antlr.CharStream) *NauseaLexer {
	NauseaLexerInit()
	l := new(NauseaLexer)
