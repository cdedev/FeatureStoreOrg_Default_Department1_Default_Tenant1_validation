...
var cholesterollexerLexerStaticData struct {
	once                   sync.Once
	serializedATN          []int32
	channelNames           []string
	modeNames              []string
...
func cholesterollexerLexerInit() {
	staticData := &cholesterollexerLexerStaticData
...
// CholesterolLexerInit initializes any static state used to implement CholesterolLexer. By default the
// static state used to implement the lexer is lazily initialized during the first call to
// NewCholesterolLexer(). You can call this function if you wish to initialize the static state ahead
// of time.
func CholesterolLexerInit() {
	staticData := &cholesterollexerLexerStaticData
	staticData.once.Do(cholesterollexerLexerInit)
}

// NewCholesterolLexer produces a new lexer instance for the optional input antlr.CharStream.
func NewCholesterolLexer(input antlr.CharStream) *CholesterolLexer {
	CholesterolLexerInit()
	l := new(CholesterolLexer)
	...
	l.GrammarFileName = "Cholesterol.g4"
	// TODO: l.EOF = antlr.TokenEOF

	return l
}

// CholesterolLexer tokens.
const (
	CholesterolLexerCHOLESTEROL = 1
	CholesterolLexerOWNKEY      = 2
	CholesterolLexerSPLITKEY    = 3
	CholesterolLexerWS          = 4
)
