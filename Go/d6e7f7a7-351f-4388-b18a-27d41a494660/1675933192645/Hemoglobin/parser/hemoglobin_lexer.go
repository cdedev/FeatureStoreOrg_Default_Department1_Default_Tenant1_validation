...
var hemoglobinlexerLexerStaticData struct {
	once                   sync.Once
	serializedATN          []int32
	channelNames           []string
	modeNames              []string
...
func hemoglobinlexerLexerInit() {
	staticData := &hemoglobinlexerLexerStaticData
...
// HemoglobinLexerInit initializes any static state used to implement HemoglobinLexer. By default the
// static state used to implement the lexer is lazily initialized during the first call to
// NewHemoglobinLexer(). You can call this function if you wish to initialize the static state ahead
// of time.
func HemoglobinLexerInit() {
	staticData := &hemoglobinlexerLexerStaticData
	staticData.once.Do(hemoglobinlexerLexerInit)
}

// NewHemoglobinLexer produces a new lexer instance for the optional input antlr.CharStream.
func NewHemoglobinLexer(input antlr.CharStream) *HemoglobinLexer {
	HemoglobinLexerInit()
	l := new(HemoglobinLexer)
	...
	l.GrammarFileName = "Hemoglobin.g4"
	// TODO: l.EOF = antlr.TokenEOF

	return l
}

// HemoglobinLexer tokens.
const (
	HemoglobinLexerHEMOGLOBIN = 1
	HemoglobinLexerOWNKEY     = 2
	HemoglobinLexerSPLITKEY   = 3
	HemoglobinLexerWS         = 4
)
