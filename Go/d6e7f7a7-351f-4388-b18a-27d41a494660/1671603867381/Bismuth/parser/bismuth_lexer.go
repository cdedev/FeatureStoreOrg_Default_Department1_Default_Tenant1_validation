...
var bismuthlexerLexerStaticData struct {
	once                   sync.Once
	serializedATN          []int32
	channelNames           []string
	modeNames              []string
...
func bismuthlexerLexerInit() {
	staticData := &bismuthlexerLexerStaticData
...
// BismuthLexerInit initializes any static state used to implement BismuthLexer. By default the
// static state used to implement the lexer is lazily initialized during the first call to
// NewBismuthLexer(). You can call this function if you wish to initialize the static state ahead
// of time.
func BismuthLexerInit() {
	staticData := &bismuthlexerLexerStaticData
	staticData.once.Do(bismuthlexerLexerInit)
}

// NewBismuthLexer produces a new lexer instance for the optional input antlr.CharStream.
func NewBismuthLexer(input antlr.CharStream) *BismuthLexer {
	BismuthLexerInit()
	l := new(BismuthLexer)
...
// BismuthLexer tokens.
const (
	BismuthLexerBISMUTH  = 1
	BismuthLexerOWNKEY   = 2
	BismuthLexerSPLITKEY = 3
	BismuthLexerWS       = 4
)
