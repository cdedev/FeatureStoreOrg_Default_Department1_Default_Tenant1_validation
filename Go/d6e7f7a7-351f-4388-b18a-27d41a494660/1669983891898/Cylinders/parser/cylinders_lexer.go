...
var cylinderslexerLexerStaticData struct {
	once                   sync.Once
	serializedATN          []int32
	channelNames           []string
	modeNames              []string
...
func cylinderslexerLexerInit() {
	staticData := &cylinderslexerLexerStaticData
...
// CylindersLexerInit initializes any static state used to implement CylindersLexer. By default the
// static state used to implement the lexer is lazily initialized during the first call to
// NewCylindersLexer(). You can call this function if you wish to initialize the static state ahead
// of time.
func CylindersLexerInit() {
	staticData := &cylinderslexerLexerStaticData
	staticData.once.Do(cylinderslexerLexerInit)
}

// NewCylindersLexer produces a new lexer instance for the optional input antlr.CharStream.
func NewCylindersLexer(input antlr.CharStream) *CylindersLexer {
	CylindersLexerInit()
	l := new(CylindersLexer)
	...
	l.GrammarFileName = "Cylinders.g4"
	// TODO: l.EOF = antlr.TokenEOF

	return l
}

// CylindersLexer tokens.
const (
	CylindersLexerCYLINDERS = 1
	CylindersLexerOWNKEY    = 2
	CylindersLexerSPLITKEY  = 3
	CylindersLexerWS        = 4
)
