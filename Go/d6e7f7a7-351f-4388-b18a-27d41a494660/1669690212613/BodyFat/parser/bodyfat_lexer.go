...
var bodyfatlexerLexerStaticData struct {
	once                   sync.Once
	serializedATN          []int32
	channelNames           []string
	modeNames              []string
...
func bodyfatlexerLexerInit() {
	staticData := &bodyfatlexerLexerStaticData
...
// BodyFatLexerInit initializes any static state used to implement BodyFatLexer. By default the
// static state used to implement the lexer is lazily initialized during the first call to
// NewBodyFatLexer(). You can call this function if you wish to initialize the static state ahead
// of time.
func BodyFatLexerInit() {
	staticData := &bodyfatlexerLexerStaticData
	staticData.once.Do(bodyfatlexerLexerInit)
}

// NewBodyFatLexer produces a new lexer instance for the optional input antlr.CharStream.
func NewBodyFatLexer(input antlr.CharStream) *BodyFatLexer {
	BodyFatLexerInit()
	l := new(BodyFatLexer)
...
// BodyFatLexer tokens.
const (
	BodyFatLexerBODYFAT  = 1
	BodyFatLexerOWNKEY   = 2
	BodyFatLexerSPLITKEY = 3
	BodyFatLexerWS       = 4
)
