...
var junmintemplexerLexerStaticData struct {
	once                   sync.Once
	serializedATN          []int32
	channelNames           []string
	modeNames              []string
...
func junmintemplexerLexerInit() {
	staticData := &junmintemplexerLexerStaticData
...
// JunMintempLexerInit initializes any static state used to implement JunMintempLexer. By default the
// static state used to implement the lexer is lazily initialized during the first call to
// NewJunMintempLexer(). You can call this function if you wish to initialize the static state ahead
// of time.
func JunMintempLexerInit() {
	staticData := &junmintemplexerLexerStaticData
	staticData.once.Do(junmintemplexerLexerInit)
}

// NewJunMintempLexer produces a new lexer instance for the optional input antlr.CharStream.
func NewJunMintempLexer(input antlr.CharStream) *JunMintempLexer {
	JunMintempLexerInit()
	l := new(JunMintempLexer)
	...
	l.GrammarFileName = "JunMintemp.g4"
	// TODO: l.EOF = antlr.TokenEOF

	return l
}

// JunMintempLexer tokens.
const (
	JunMintempLexerJUNMINTEMP = 1
	JunMintempLexerOWNKEY     = 2
	JunMintempLexerSPLITKEY   = 3
	JunMintempLexerWS         = 4
)
