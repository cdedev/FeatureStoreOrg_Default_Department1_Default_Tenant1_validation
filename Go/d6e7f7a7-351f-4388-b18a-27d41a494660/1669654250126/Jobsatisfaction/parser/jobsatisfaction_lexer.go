...
type JobsatisfactionLexer struct {
	*antlr.BaseLexer
	channelNames []string
	modeNames    []string
	// TODO: EOF string
...
var jobsatisfactionlexerLexerStaticData struct {
	once                   sync.Once
	serializedATN          []int32
	channelNames           []string
	modeNames              []string
...
func jobsatisfactionlexerLexerInit() {
	staticData := &jobsatisfactionlexerLexerStaticData
...
// JobsatisfactionLexerInit initializes any static state used to implement JobsatisfactionLexer. By default the
// static state used to implement the lexer is lazily initialized during the first call to
// NewJobsatisfactionLexer(). You can call this function if you wish to initialize the static state ahead
// of time.
func JobsatisfactionLexerInit() {
	staticData := &jobsatisfactionlexerLexerStaticData
	staticData.once.Do(jobsatisfactionlexerLexerInit)
}

// NewJobsatisfactionLexer produces a new lexer instance for the optional input antlr.CharStream.
func NewJobsatisfactionLexer(input antlr.CharStream) *JobsatisfactionLexer {
	JobsatisfactionLexerInit()
	l := new(JobsatisfactionLexer)
	...
	l.GrammarFileName = "Jobsatisfaction.g4"
	// TODO: l.EOF = antlr.TokenEOF

	return l
}

// JobsatisfactionLexer tokens.
const (
	JobsatisfactionLexerJOBSATISFACTION = 1
	JobsatisfactionLexerOWNKEY          = 2
	JobsatisfactionLexerSPLITKEY        = 3
	JobsatisfactionLexerWS              = 4
)
