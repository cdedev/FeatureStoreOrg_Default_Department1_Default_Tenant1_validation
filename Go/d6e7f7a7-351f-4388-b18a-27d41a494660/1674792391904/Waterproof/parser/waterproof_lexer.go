...
var waterprooflexerLexerStaticData struct {
	once                   sync.Once
	serializedATN          []int32
	channelNames           []string
	modeNames              []string
...
func waterprooflexerLexerInit() {
	staticData := &waterprooflexerLexerStaticData
...
// WaterproofLexerInit initializes any static state used to implement WaterproofLexer. By default the
// static state used to implement the lexer is lazily initialized during the first call to
// NewWaterproofLexer(). You can call this function if you wish to initialize the static state ahead
// of time.
func WaterproofLexerInit() {
	staticData := &waterprooflexerLexerStaticData
	staticData.once.Do(waterprooflexerLexerInit)
}

// NewWaterproofLexer produces a new lexer instance for the optional input antlr.CharStream.
func NewWaterproofLexer(input antlr.CharStream) *WaterproofLexer {
	WaterproofLexerInit()
	l := new(WaterproofLexer)
	...
	l.GrammarFileName = "Waterproof.g4"
	// TODO: l.EOF = antlr.TokenEOF

	return l
}

// WaterproofLexer tokens.
const (
	WaterproofLexerWATERPROOF = 1
	WaterproofLexerOWNKEY     = 2
	WaterproofLexerSPLITKEY   = 3
	WaterproofLexerWS         = 4
)
