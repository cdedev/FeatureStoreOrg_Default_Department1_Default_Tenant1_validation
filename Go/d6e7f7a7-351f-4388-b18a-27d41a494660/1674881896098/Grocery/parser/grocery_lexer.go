...
var grocerylexerLexerStaticData struct {
	once                   sync.Once
	serializedATN          []int32
	channelNames           []string
	modeNames              []string
...
func grocerylexerLexerInit() {
	staticData := &grocerylexerLexerStaticData
...
// GroceryLexerInit initializes any static state used to implement GroceryLexer. By default the
// static state used to implement the lexer is lazily initialized during the first call to
// NewGroceryLexer(). You can call this function if you wish to initialize the static state ahead
// of time.
func GroceryLexerInit() {
	staticData := &grocerylexerLexerStaticData
	staticData.once.Do(grocerylexerLexerInit)
}

// NewGroceryLexer produces a new lexer instance for the optional input antlr.CharStream.
func NewGroceryLexer(input antlr.CharStream) *GroceryLexer {
	GroceryLexerInit()
	l := new(GroceryLexer)
...
// GroceryLexer tokens.
const (
	GroceryLexerGROCERY  = 1
	GroceryLexerOWNKEY   = 2
	GroceryLexerSPLITKEY = 3
	GroceryLexerWS       = 4
)
