...
var dateofbirthlexerLexerStaticData struct {
	once                   sync.Once
	serializedATN          []int32
	channelNames           []string
	modeNames              []string
...
func dateofbirthlexerLexerInit() {
	staticData := &dateofbirthlexerLexerStaticData
...
// DateOfBirthLexerInit initializes any static state used to implement DateOfBirthLexer. By default the
// static state used to implement the lexer is lazily initialized during the first call to
// NewDateOfBirthLexer(). You can call this function if you wish to initialize the static state ahead
// of time.
func DateOfBirthLexerInit() {
	staticData := &dateofbirthlexerLexerStaticData
	staticData.once.Do(dateofbirthlexerLexerInit)
}

// NewDateOfBirthLexer produces a new lexer instance for the optional input antlr.CharStream.
func NewDateOfBirthLexer(input antlr.CharStream) *DateOfBirthLexer {
	DateOfBirthLexerInit()
	l := new(DateOfBirthLexer)
	...
	l.GrammarFileName = "DateOfBirth.g4"
	// TODO: l.EOF = antlr.TokenEOF

	return l
}

// DateOfBirthLexer tokens.
const (
	DateOfBirthLexerDATEOFBIRTH = 1
	DateOfBirthLexerOWNKEY      = 2
	DateOfBirthLexerSPLITKEY    = 3
	DateOfBirthLexerWS          = 4
)
