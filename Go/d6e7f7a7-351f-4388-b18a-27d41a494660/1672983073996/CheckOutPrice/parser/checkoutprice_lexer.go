...
type CheckOutPriceLexer struct {
	*antlr.BaseLexer
	channelNames []string
	modeNames    []string
	// TODO: EOF string
...
var checkoutpricelexerLexerStaticData struct {
	once                   sync.Once
	serializedATN          []int32
	channelNames           []string
	modeNames              []string
...
func checkoutpricelexerLexerInit() {
	staticData := &checkoutpricelexerLexerStaticData
...
// CheckOutPriceLexerInit initializes any static state used to implement CheckOutPriceLexer. By default the
// static state used to implement the lexer is lazily initialized during the first call to
// NewCheckOutPriceLexer(). You can call this function if you wish to initialize the static state ahead
// of time.
func CheckOutPriceLexerInit() {
	staticData := &checkoutpricelexerLexerStaticData
	staticData.once.Do(checkoutpricelexerLexerInit)
}

// NewCheckOutPriceLexer produces a new lexer instance for the optional input antlr.CharStream.
func NewCheckOutPriceLexer(input antlr.CharStream) *CheckOutPriceLexer {
	CheckOutPriceLexerInit()
	l := new(CheckOutPriceLexer)
	...
	l.GrammarFileName = "CheckOutPrice.g4"
	// TODO: l.EOF = antlr.TokenEOF

	return l
}

// CheckOutPriceLexer tokens.
const (
	CheckOutPriceLexerCHECKOUTPRICE = 1
	CheckOutPriceLexerOWNKEY        = 2
	CheckOutPriceLexerSPLITKEY      = 3
	CheckOutPriceLexerWS            = 4
)
