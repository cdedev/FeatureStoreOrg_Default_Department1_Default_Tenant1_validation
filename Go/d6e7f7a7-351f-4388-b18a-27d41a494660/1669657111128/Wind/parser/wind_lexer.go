...
var windlexerLexerStaticData struct {
	once                   sync.Once
	serializedATN          []int32
	channelNames           []string
	modeNames              []string
...
func windlexerLexerInit() {
	staticData := &windlexerLexerStaticData
...
// WindLexerInit initializes any static state used to implement WindLexer. By default the
// static state used to implement the lexer is lazily initialized during the first call to
// NewWindLexer(). You can call this function if you wish to initialize the static state ahead
// of time.
func WindLexerInit() {
	staticData := &windlexerLexerStaticData
	staticData.once.Do(windlexerLexerInit)
}

// NewWindLexer produces a new lexer instance for the optional input antlr.CharStream.
func NewWindLexer(input antlr.CharStream) *WindLexer {
	WindLexerInit()
	l := new(WindLexer)
