...
var saleslexerLexerStaticData struct {
	once                   sync.Once
	serializedATN          []int32
	channelNames           []string
	modeNames              []string
...
func saleslexerLexerInit() {
	staticData := &saleslexerLexerStaticData
...
// SalesLexerInit initializes any static state used to implement SalesLexer. By default the
// static state used to implement the lexer is lazily initialized during the first call to
// NewSalesLexer(). You can call this function if you wish to initialize the static state ahead
// of time.
func SalesLexerInit() {
	staticData := &saleslexerLexerStaticData
	staticData.once.Do(saleslexerLexerInit)
}

// NewSalesLexer produces a new lexer instance for the optional input antlr.CharStream.
func NewSalesLexer(input antlr.CharStream) *SalesLexer {
	SalesLexerInit()
	l := new(SalesLexer)
