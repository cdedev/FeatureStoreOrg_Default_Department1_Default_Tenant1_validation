...
var kurtosislexerLexerStaticData struct {
	once                   sync.Once
	serializedATN          []int32
	channelNames           []string
	modeNames              []string
...
func kurtosislexerLexerInit() {
	staticData := &kurtosislexerLexerStaticData
...
// KurtosisLexerInit initializes any static state used to implement KurtosisLexer. By default the
// static state used to implement the lexer is lazily initialized during the first call to
// NewKurtosisLexer(). You can call this function if you wish to initialize the static state ahead
// of time.
func KurtosisLexerInit() {
	staticData := &kurtosislexerLexerStaticData
	staticData.once.Do(kurtosislexerLexerInit)
}

// NewKurtosisLexer produces a new lexer instance for the optional input antlr.CharStream.
func NewKurtosisLexer(input antlr.CharStream) *KurtosisLexer {
	KurtosisLexerInit()
	l := new(KurtosisLexer)
	...
	l.GrammarFileName = "Kurtosis.g4"
	// TODO: l.EOF = antlr.TokenEOF

	return l
}

// KurtosisLexer tokens.
const (
	KurtosisLexerKURTOSIS = 1
	KurtosisLexerOWNKEY   = 2
	KurtosisLexerSPLITKEY = 3
	KurtosisLexerWS       = 4
)
