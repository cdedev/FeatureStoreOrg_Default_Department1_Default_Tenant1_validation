...
var quarantinelexerLexerStaticData struct {
	once                   sync.Once
	serializedATN          []int32
	channelNames           []string
	modeNames              []string
...
func quarantinelexerLexerInit() {
	staticData := &quarantinelexerLexerStaticData
...
// QuarantineLexerInit initializes any static state used to implement QuarantineLexer. By default the
// static state used to implement the lexer is lazily initialized during the first call to
// NewQuarantineLexer(). You can call this function if you wish to initialize the static state ahead
// of time.
func QuarantineLexerInit() {
	staticData := &quarantinelexerLexerStaticData
	staticData.once.Do(quarantinelexerLexerInit)
}

// NewQuarantineLexer produces a new lexer instance for the optional input antlr.CharStream.
func NewQuarantineLexer(input antlr.CharStream) *QuarantineLexer {
	QuarantineLexerInit()
	l := new(QuarantineLexer)
	...
	l.GrammarFileName = "Quarantine.g4"
	// TODO: l.EOF = antlr.TokenEOF

	return l
}

// QuarantineLexer tokens.
const (
	QuarantineLexerQUARANTINE = 1
	QuarantineLexerOWNKEY     = 2
	QuarantineLexerSPLITKEY   = 3
	QuarantineLexerWS         = 4
)
