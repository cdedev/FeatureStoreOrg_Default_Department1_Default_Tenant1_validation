...
var phosphorouslexerLexerStaticData struct {
	once                   sync.Once
	serializedATN          []int32
	channelNames           []string
	modeNames              []string
...
func phosphorouslexerLexerInit() {
	staticData := &phosphorouslexerLexerStaticData
...
// PhosphorousLexerInit initializes any static state used to implement PhosphorousLexer. By default the
// static state used to implement the lexer is lazily initialized during the first call to
// NewPhosphorousLexer(). You can call this function if you wish to initialize the static state ahead
// of time.
func PhosphorousLexerInit() {
	staticData := &phosphorouslexerLexerStaticData
	staticData.once.Do(phosphorouslexerLexerInit)
}

// NewPhosphorousLexer produces a new lexer instance for the optional input antlr.CharStream.
func NewPhosphorousLexer(input antlr.CharStream) *PhosphorousLexer {
	PhosphorousLexerInit()
	l := new(PhosphorousLexer)
	...
	l.GrammarFileName = "Phosphorous.g4"
	// TODO: l.EOF = antlr.TokenEOF

	return l
}

// PhosphorousLexer tokens.
const (
	PhosphorousLexerPHOSPHOROUS = 1
	PhosphorousLexerOWNKEY      = 2
	PhosphorousLexerSPLITKEY    = 3
	PhosphorousLexerWS          = 4
)
