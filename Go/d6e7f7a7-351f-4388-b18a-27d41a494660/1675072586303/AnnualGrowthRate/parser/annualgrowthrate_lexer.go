...
type AnnualGrowthRateLexer struct {
	*antlr.BaseLexer
	channelNames []string
	modeNames    []string
	// TODO: EOF string
...
var annualgrowthratelexerLexerStaticData struct {
	once                   sync.Once
	serializedATN          []int32
	channelNames           []string
	modeNames              []string
...
func annualgrowthratelexerLexerInit() {
	staticData := &annualgrowthratelexerLexerStaticData
...
// AnnualGrowthRateLexerInit initializes any static state used to implement AnnualGrowthRateLexer. By default the
// static state used to implement the lexer is lazily initialized during the first call to
// NewAnnualGrowthRateLexer(). You can call this function if you wish to initialize the static state ahead
// of time.
func AnnualGrowthRateLexerInit() {
	staticData := &annualgrowthratelexerLexerStaticData
	staticData.once.Do(annualgrowthratelexerLexerInit)
}

// NewAnnualGrowthRateLexer produces a new lexer instance for the optional input antlr.CharStream.
func NewAnnualGrowthRateLexer(input antlr.CharStream) *AnnualGrowthRateLexer {
	AnnualGrowthRateLexerInit()
	l := new(AnnualGrowthRateLexer)
	...
	l.GrammarFileName = "AnnualGrowthRate.g4"
	// TODO: l.EOF = antlr.TokenEOF

	return l
}

// AnnualGrowthRateLexer tokens.
const (
	AnnualGrowthRateLexerANNUALGROWTHRATE = 1
	AnnualGrowthRateLexerOWNKEY           = 2
	AnnualGrowthRateLexerSPLITKEY         = 3
	AnnualGrowthRateLexerWS               = 4
)
