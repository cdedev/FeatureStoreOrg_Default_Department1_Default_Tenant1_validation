...
const (
	...
	PatternParserPATTERN  = 1
	PatternParserOWNKEY   = 2
	PatternParserSPLITKEY = 3
	PatternParserWS       = 4
)

// PatternParser rules.
const (
	PatternParserRULE_expression = 0
	PatternParserRULE_pattern    = 1
)
...
func (p *PatternParser) Expression() (localctx IExpressionContext) {
	...
	p.EnterRule(localctx, 0, PatternParserRULE_expression)
...
func NewEmptyPatternContext() *PatternContext {
	...
	p.BaseParserRuleContext = antlr.NewBaseParserRuleContext(nil, -1)
	p.RuleIndex = PatternParserRULE_pattern
	return p
}
...
func (s *PatternContext) PATTERN() antlr.TerminalNode {
	return s.GetToken(PatternParserPATTERN, 0)
}
...
func (p *PatternParser) Pattern() (localctx IPatternContext) {
	this := p
	_ = this

	localctx = NewPatternContext(p, p.GetParserRuleContext(), p.GetState())
	p.EnterRule(localctx, 2, PatternParserRULE_pattern)
