...
var variancelexerLexerStaticData struct {
	once                   sync.Once
	serializedATN          []int32
	channelNames           []string
	modeNames              []string
...
func variancelexerLexerInit() {
	staticData := &variancelexerLexerStaticData
...
// VarianceLexerInit initializes any static state used to implement VarianceLexer. By default the
// static state used to implement the lexer is lazily initialized during the first call to
// NewVarianceLexer(). You can call this function if you wish to initialize the static state ahead
// of time.
func VarianceLexerInit() {
	staticData := &variancelexerLexerStaticData
	staticData.once.Do(variancelexerLexerInit)
}

// NewVarianceLexer produces a new lexer instance for the optional input antlr.CharStream.
func NewVarianceLexer(input antlr.CharStream) *VarianceLexer {
	VarianceLexerInit()
	l := new(VarianceLexer)
	...
	l.GrammarFileName = "Variance.g4"
	// TODO: l.EOF = antlr.TokenEOF

	return l
}

// VarianceLexer tokens.
const (
	VarianceLexerVARIANCE = 1
	VarianceLexerOWNKEY   = 2
	VarianceLexerSPLITKEY = 3
	VarianceLexerWS       = 4
)
