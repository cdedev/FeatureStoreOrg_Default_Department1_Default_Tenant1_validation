...
var janmaxtemplexerLexerStaticData struct {
	once                   sync.Once
	serializedATN          []int32
	channelNames           []string
	modeNames              []string
...
func janmaxtemplexerLexerInit() {
	staticData := &janmaxtemplexerLexerStaticData
...
// JanMaxtempLexerInit initializes any static state used to implement JanMaxtempLexer. By default the
// static state used to implement the lexer is lazily initialized during the first call to
// NewJanMaxtempLexer(). You can call this function if you wish to initialize the static state ahead
// of time.
func JanMaxtempLexerInit() {
	staticData := &janmaxtemplexerLexerStaticData
	staticData.once.Do(janmaxtemplexerLexerInit)
}

// NewJanMaxtempLexer produces a new lexer instance for the optional input antlr.CharStream.
func NewJanMaxtempLexer(input antlr.CharStream) *JanMaxtempLexer {
	JanMaxtempLexerInit()
	l := new(JanMaxtempLexer)
	...
	l.GrammarFileName = "JanMaxtemp.g4"
	// TODO: l.EOF = antlr.TokenEOF

	return l
}

// JanMaxtempLexer tokens.
const (
	JanMaxtempLexerJANMAXTEMP = 1
	JanMaxtempLexerOWNKEY     = 2
	JanMaxtempLexerSPLITKEY   = 3
	JanMaxtempLexerWS         = 4
)
