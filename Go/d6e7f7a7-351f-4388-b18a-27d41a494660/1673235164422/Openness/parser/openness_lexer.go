...
var opennesslexerLexerStaticData struct {
	once                   sync.Once
	serializedATN          []int32
	channelNames           []string
	modeNames              []string
...
func opennesslexerLexerInit() {
	staticData := &opennesslexerLexerStaticData
...
// OpennessLexerInit initializes any static state used to implement OpennessLexer. By default the
// static state used to implement the lexer is lazily initialized during the first call to
// NewOpennessLexer(). You can call this function if you wish to initialize the static state ahead
// of time.
func OpennessLexerInit() {
	staticData := &opennesslexerLexerStaticData
	staticData.once.Do(opennesslexerLexerInit)
}

// NewOpennessLexer produces a new lexer instance for the optional input antlr.CharStream.
func NewOpennessLexer(input antlr.CharStream) *OpennessLexer {
	OpennessLexerInit()
	l := new(OpennessLexer)
	...
	l.GrammarFileName = "Openness.g4"
	// TODO: l.EOF = antlr.TokenEOF

	return l
}

// OpennessLexer tokens.
const (
	OpennessLexerOPENNESS = 1
	OpennessLexerOWNKEY   = 2
	OpennessLexerSPLITKEY = 3
	OpennessLexerWS       = 4
)
