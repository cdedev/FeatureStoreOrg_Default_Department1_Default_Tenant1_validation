...
var followinglexerLexerStaticData struct {
	once                   sync.Once
	serializedATN          []int32
	channelNames           []string
	modeNames              []string
...
func followinglexerLexerInit() {
	staticData := &followinglexerLexerStaticData
...
// FollowingLexerInit initializes any static state used to implement FollowingLexer. By default the
// static state used to implement the lexer is lazily initialized during the first call to
// NewFollowingLexer(). You can call this function if you wish to initialize the static state ahead
// of time.
func FollowingLexerInit() {
	staticData := &followinglexerLexerStaticData
	staticData.once.Do(followinglexerLexerInit)
}

// NewFollowingLexer produces a new lexer instance for the optional input antlr.CharStream.
func NewFollowingLexer(input antlr.CharStream) *FollowingLexer {
	FollowingLexerInit()
	l := new(FollowingLexer)
	...
	l.GrammarFileName = "Following.g4"
	// TODO: l.EOF = antlr.TokenEOF

	return l
}

// FollowingLexer tokens.
const (
	FollowingLexerFOLLOWING = 1
	FollowingLexerOWNKEY    = 2
	FollowingLexerSPLITKEY  = 3
	FollowingLexerWS        = 4
)
