...
type AbsoulteMagnitudeLexer struct {
	*antlr.BaseLexer
	channelNames []string
	modeNames    []string
	// TODO: EOF string
...
var absoultemagnitudelexerLexerStaticData struct {
	once                   sync.Once
	serializedATN          []int32
	channelNames           []string
	modeNames              []string
...
func absoultemagnitudelexerLexerInit() {
	staticData := &absoultemagnitudelexerLexerStaticData
...
// AbsoulteMagnitudeLexerInit initializes any static state used to implement AbsoulteMagnitudeLexer. By default the
// static state used to implement the lexer is lazily initialized during the first call to
// NewAbsoulteMagnitudeLexer(). You can call this function if you wish to initialize the static state ahead
// of time.
func AbsoulteMagnitudeLexerInit() {
	staticData := &absoultemagnitudelexerLexerStaticData
	staticData.once.Do(absoultemagnitudelexerLexerInit)
}

// NewAbsoulteMagnitudeLexer produces a new lexer instance for the optional input antlr.CharStream.
func NewAbsoulteMagnitudeLexer(input antlr.CharStream) *AbsoulteMagnitudeLexer {
	AbsoulteMagnitudeLexerInit()
	l := new(AbsoulteMagnitudeLexer)
	...
	l.GrammarFileName = "AbsoulteMagnitude.g4"
	// TODO: l.EOF = antlr.TokenEOF

	return l
}

// AbsoulteMagnitudeLexer tokens.
const (
	AbsoulteMagnitudeLexerABSOULTEMAGNITUDE = 1
	AbsoulteMagnitudeLexerOWNKEY            = 2
	AbsoulteMagnitudeLexerSPLITKEY          = 3
	AbsoulteMagnitudeLexerWS                = 4
)
