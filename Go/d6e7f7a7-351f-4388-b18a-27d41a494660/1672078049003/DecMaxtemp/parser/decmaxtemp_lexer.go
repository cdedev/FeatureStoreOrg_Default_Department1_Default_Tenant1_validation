...
var decmaxtemplexerLexerStaticData struct {
	once                   sync.Once
	serializedATN          []int32
	channelNames           []string
	modeNames              []string
...
func decmaxtemplexerLexerInit() {
	staticData := &decmaxtemplexerLexerStaticData
...
// DecMaxtempLexerInit initializes any static state used to implement DecMaxtempLexer. By default the
// static state used to implement the lexer is lazily initialized during the first call to
// NewDecMaxtempLexer(). You can call this function if you wish to initialize the static state ahead
// of time.
func DecMaxtempLexerInit() {
	staticData := &decmaxtemplexerLexerStaticData
	staticData.once.Do(decmaxtemplexerLexerInit)
}

// NewDecMaxtempLexer produces a new lexer instance for the optional input antlr.CharStream.
func NewDecMaxtempLexer(input antlr.CharStream) *DecMaxtempLexer {
	DecMaxtempLexerInit()
	l := new(DecMaxtempLexer)
	...
	l.GrammarFileName = "DecMaxtemp.g4"
	// TODO: l.EOF = antlr.TokenEOF

	return l
}

// DecMaxtempLexer tokens.
const (
	DecMaxtempLexerDECMAXTEMP = 1
	DecMaxtempLexerOWNKEY     = 2
	DecMaxtempLexerSPLITKEY   = 3
	DecMaxtempLexerWS         = 4
)
