...
var poojaroomlexerLexerStaticData struct {
	once                   sync.Once
	serializedATN          []int32
	channelNames           []string
	modeNames              []string
...
func poojaroomlexerLexerInit() {
	staticData := &poojaroomlexerLexerStaticData
...
// PoojaRoomLexerInit initializes any static state used to implement PoojaRoomLexer. By default the
// static state used to implement the lexer is lazily initialized during the first call to
// NewPoojaRoomLexer(). You can call this function if you wish to initialize the static state ahead
// of time.
func PoojaRoomLexerInit() {
	staticData := &poojaroomlexerLexerStaticData
	staticData.once.Do(poojaroomlexerLexerInit)
}

// NewPoojaRoomLexer produces a new lexer instance for the optional input antlr.CharStream.
func NewPoojaRoomLexer(input antlr.CharStream) *PoojaRoomLexer {
	PoojaRoomLexerInit()
	l := new(PoojaRoomLexer)
	...
	l.GrammarFileName = "PoojaRoom.g4"
	// TODO: l.EOF = antlr.TokenEOF

	return l
}

// PoojaRoomLexer tokens.
const (
	PoojaRoomLexerPOOJAROOM = 1
	PoojaRoomLexerOWNKEY    = 2
	PoojaRoomLexerSPLITKEY  = 3
	PoojaRoomLexerWS        = 4
)
