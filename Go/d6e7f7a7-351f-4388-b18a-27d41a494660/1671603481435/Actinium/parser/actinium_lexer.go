...
var actiniumlexerLexerStaticData struct {
	once                   sync.Once
	serializedATN          []int32
	channelNames           []string
	modeNames              []string
...
func actiniumlexerLexerInit() {
	staticData := &actiniumlexerLexerStaticData
...
// ActiniumLexerInit initializes any static state used to implement ActiniumLexer. By default the
// static state used to implement the lexer is lazily initialized during the first call to
// NewActiniumLexer(). You can call this function if you wish to initialize the static state ahead
// of time.
func ActiniumLexerInit() {
	staticData := &actiniumlexerLexerStaticData
	staticData.once.Do(actiniumlexerLexerInit)
}

// NewActiniumLexer produces a new lexer instance for the optional input antlr.CharStream.
func NewActiniumLexer(input antlr.CharStream) *ActiniumLexer {
	ActiniumLexerInit()
	l := new(ActiniumLexer)
	...
	l.GrammarFileName = "Actinium.g4"
	// TODO: l.EOF = antlr.TokenEOF

	return l
}

// ActiniumLexer tokens.
const (
	ActiniumLexerACTINIUM = 1
	ActiniumLexerOWNKEY   = 2
	ActiniumLexerSPLITKEY = 3
	ActiniumLexerWS       = 4
)
