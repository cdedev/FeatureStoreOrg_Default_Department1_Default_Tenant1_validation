...
var brightnesslexerLexerStaticData struct {
	once                   sync.Once
	serializedATN          []int32
	channelNames           []string
	modeNames              []string
...
func brightnesslexerLexerInit() {
	staticData := &brightnesslexerLexerStaticData
...
// BrightnessLexerInit initializes any static state used to implement BrightnessLexer. By default the
// static state used to implement the lexer is lazily initialized during the first call to
// NewBrightnessLexer(). You can call this function if you wish to initialize the static state ahead
// of time.
func BrightnessLexerInit() {
	staticData := &brightnesslexerLexerStaticData
	staticData.once.Do(brightnesslexerLexerInit)
}

// NewBrightnessLexer produces a new lexer instance for the optional input antlr.CharStream.
func NewBrightnessLexer(input antlr.CharStream) *BrightnessLexer {
	BrightnessLexerInit()
	l := new(BrightnessLexer)
	...
	l.GrammarFileName = "Brightness.g4"
	// TODO: l.EOF = antlr.TokenEOF

	return l
}

// BrightnessLexer tokens.
const (
	BrightnessLexerBRIGHTNESS = 1
	BrightnessLexerOWNKEY     = 2
	BrightnessLexerSPLITKEY   = 3
	BrightnessLexerWS         = 4
)
