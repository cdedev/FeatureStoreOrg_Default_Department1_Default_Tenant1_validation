...
type MaleLifeExpectancyLexer struct {
	*antlr.BaseLexer
	channelNames []string
	modeNames    []string
	// TODO: EOF string
...
var malelifeexpectancylexerLexerStaticData struct {
	once                   sync.Once
	serializedATN          []int32
	channelNames           []string
	modeNames              []string
...
func malelifeexpectancylexerLexerInit() {
	staticData := &malelifeexpectancylexerLexerStaticData
...
// MaleLifeExpectancyLexerInit initializes any static state used to implement MaleLifeExpectancyLexer. By default the
// static state used to implement the lexer is lazily initialized during the first call to
// NewMaleLifeExpectancyLexer(). You can call this function if you wish to initialize the static state ahead
// of time.
func MaleLifeExpectancyLexerInit() {
	staticData := &malelifeexpectancylexerLexerStaticData
	staticData.once.Do(malelifeexpectancylexerLexerInit)
}

// NewMaleLifeExpectancyLexer produces a new lexer instance for the optional input antlr.CharStream.
func NewMaleLifeExpectancyLexer(input antlr.CharStream) *MaleLifeExpectancyLexer {
	MaleLifeExpectancyLexerInit()
	l := new(MaleLifeExpectancyLexer)
	...
	l.GrammarFileName = "MaleLifeExpectancy.g4"
	// TODO: l.EOF = antlr.TokenEOF

	return l
}

// MaleLifeExpectancyLexer tokens.
const (
	MaleLifeExpectancyLexerMALELIFEEXPECTANCY = 1
	MaleLifeExpectancyLexerOWNKEY             = 2
	MaleLifeExpectancyLexerSPLITKEY           = 3
	MaleLifeExpectancyLexerWS                 = 4
)
