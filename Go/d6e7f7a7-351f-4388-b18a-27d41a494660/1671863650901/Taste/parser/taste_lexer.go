...
var tastelexerLexerStaticData struct {
	once                   sync.Once
	serializedATN          []int32
	channelNames           []string
	modeNames              []string
...
func tastelexerLexerInit() {
	staticData := &tastelexerLexerStaticData
...
// TasteLexerInit initializes any static state used to implement TasteLexer. By default the
// static state used to implement the lexer is lazily initialized during the first call to
// NewTasteLexer(). You can call this function if you wish to initialize the static state ahead
// of time.
func TasteLexerInit() {
	staticData := &tastelexerLexerStaticData
	staticData.once.Do(tastelexerLexerInit)
}

// NewTasteLexer produces a new lexer instance for the optional input antlr.CharStream.
func NewTasteLexer(input antlr.CharStream) *TasteLexer {
	TasteLexerInit()
	l := new(TasteLexer)
