...
var catslexerLexerStaticData struct {
	once                   sync.Once
	serializedATN          []int32
	channelNames           []string
	modeNames              []string
...
func catslexerLexerInit() {
	staticData := &catslexerLexerStaticData
...
// CatsLexerInit initializes any static state used to implement CatsLexer. By default the
// static state used to implement the lexer is lazily initialized during the first call to
// NewCatsLexer(). You can call this function if you wish to initialize the static state ahead
// of time.
func CatsLexerInit() {
	staticData := &catslexerLexerStaticData
	staticData.once.Do(catslexerLexerInit)
}

// NewCatsLexer produces a new lexer instance for the optional input antlr.CharStream.
func NewCatsLexer(input antlr.CharStream) *CatsLexer {
	CatsLexerInit()
	l := new(CatsLexer)
