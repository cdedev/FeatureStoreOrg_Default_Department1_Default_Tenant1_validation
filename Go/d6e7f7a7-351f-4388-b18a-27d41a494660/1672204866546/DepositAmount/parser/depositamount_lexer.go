...
type DepositAmountLexer struct {
	*antlr.BaseLexer
	channelNames []string
	modeNames    []string
	// TODO: EOF string
...
var depositamountlexerLexerStaticData struct {
	once                   sync.Once
	serializedATN          []int32
	channelNames           []string
	modeNames              []string
...
func depositamountlexerLexerInit() {
	staticData := &depositamountlexerLexerStaticData
...
// DepositAmountLexerInit initializes any static state used to implement DepositAmountLexer. By default the
// static state used to implement the lexer is lazily initialized during the first call to
// NewDepositAmountLexer(). You can call this function if you wish to initialize the static state ahead
// of time.
func DepositAmountLexerInit() {
	staticData := &depositamountlexerLexerStaticData
	staticData.once.Do(depositamountlexerLexerInit)
}

// NewDepositAmountLexer produces a new lexer instance for the optional input antlr.CharStream.
func NewDepositAmountLexer(input antlr.CharStream) *DepositAmountLexer {
	DepositAmountLexerInit()
	l := new(DepositAmountLexer)
	...
	l.GrammarFileName = "DepositAmount.g4"
	// TODO: l.EOF = antlr.TokenEOF

	return l
}

// DepositAmountLexer tokens.
const (
	DepositAmountLexerDEPOSITAMOUNT = 1
	DepositAmountLexerOWNKEY        = 2
	DepositAmountLexerSPLITKEY      = 3
	DepositAmountLexerWS            = 4
)
