...
var typelexerLexerStaticData struct {
	once                   sync.Once
	serializedATN          []int32
	channelNames           []string
	modeNames              []string
...
func typelexerLexerInit() {
	staticData := &typelexerLexerStaticData
	...
	staticData.serializedATN = []int32{
		...
		12, 5, 67, 0, 0, 12, 13, 5, 114, 0, 0, 13, 14, 5, 101, 0, 0, 14, 15, 5,
		100, 0, 0, 15, 16, 5, 105, 0, 0, 16, 22, 5, 116, 0, 0, 17, 18, 5, 67, 0,
		0, 18, 19, 5, 97, 0, 0, 19, 20, 5, 115, 0, 0, 20, 22, 5, 104, 0, 0, 21,
		11, 1, 0, 0, 0, 21, 17, 1, 0, 0, 0, 22, 2, 1, 0, 0, 0, 23, 24, 5, 36, 0,
...
// TypeLexerInit initializes any static state used to implement TypeLexer. By default the
// static state used to implement the lexer is lazily initialized during the first call to
// NewTypeLexer(). You can call this function if you wish to initialize the static state ahead
// of time.
func TypeLexerInit() {
	staticData := &typelexerLexerStaticData
	staticData.once.Do(typelexerLexerInit)
}

// NewTypeLexer produces a new lexer instance for the optional input antlr.CharStream.
func NewTypeLexer(input antlr.CharStream) *TypeLexer {
	TypeLexerInit()
	l := new(TypeLexer)
