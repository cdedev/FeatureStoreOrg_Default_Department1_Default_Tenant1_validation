...
var augmaxtemplexerLexerStaticData struct {
	once                   sync.Once
	serializedATN          []int32
	channelNames           []string
	modeNames              []string
...
func augmaxtemplexerLexerInit() {
	staticData := &augmaxtemplexerLexerStaticData
...
// AugMaxtempLexerInit initializes any static state used to implement AugMaxtempLexer. By default the
// static state used to implement the lexer is lazily initialized during the first call to
// NewAugMaxtempLexer(). You can call this function if you wish to initialize the static state ahead
// of time.
func AugMaxtempLexerInit() {
	staticData := &augmaxtemplexerLexerStaticData
	staticData.once.Do(augmaxtemplexerLexerInit)
}

// NewAugMaxtempLexer produces a new lexer instance for the optional input antlr.CharStream.
func NewAugMaxtempLexer(input antlr.CharStream) *AugMaxtempLexer {
	AugMaxtempLexerInit()
	l := new(AugMaxtempLexer)
	...
	l.GrammarFileName = "AugMaxtemp.g4"
	// TODO: l.EOF = antlr.TokenEOF

	return l
}

// AugMaxtempLexer tokens.
const (
	AugMaxtempLexerAUGMAXTEMP = 1
	AugMaxtempLexerOWNKEY     = 2
	AugMaxtempLexerSPLITKEY   = 3
	AugMaxtempLexerWS         = 4
)
