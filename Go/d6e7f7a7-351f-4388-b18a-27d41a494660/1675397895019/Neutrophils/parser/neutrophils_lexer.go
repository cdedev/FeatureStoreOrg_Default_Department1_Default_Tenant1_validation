...
var neutrophilslexerLexerStaticData struct {
	once                   sync.Once
	serializedATN          []int32
	channelNames           []string
	modeNames              []string
...
func neutrophilslexerLexerInit() {
	staticData := &neutrophilslexerLexerStaticData
...
// NeutrophilsLexerInit initializes any static state used to implement NeutrophilsLexer. By default the
// static state used to implement the lexer is lazily initialized during the first call to
// NewNeutrophilsLexer(). You can call this function if you wish to initialize the static state ahead
// of time.
func NeutrophilsLexerInit() {
	staticData := &neutrophilslexerLexerStaticData
	staticData.once.Do(neutrophilslexerLexerInit)
}

// NewNeutrophilsLexer produces a new lexer instance for the optional input antlr.CharStream.
func NewNeutrophilsLexer(input antlr.CharStream) *NeutrophilsLexer {
	NeutrophilsLexerInit()
	l := new(NeutrophilsLexer)
	...
	l.GrammarFileName = "Neutrophils.g4"
	// TODO: l.EOF = antlr.TokenEOF

	return l
}

// NeutrophilsLexer tokens.
const (
	NeutrophilsLexerNEUTROPHILS = 1
	NeutrophilsLexerOWNKEY      = 2
	NeutrophilsLexerSPLITKEY    = 3
	NeutrophilsLexerWS          = 4
)
