...
var pmlexerLexerStaticData struct {
	once                   sync.Once
	serializedATN          []int32
	channelNames           []string
	modeNames              []string
...
func pmlexerLexerInit() {
	staticData := &pmlexerLexerStaticData
...
// PMLexerInit initializes any static state used to implement PMLexer. By default the
// static state used to implement the lexer is lazily initialized during the first call to
// NewPMLexer(). You can call this function if you wish to initialize the static state ahead
// of time.
func PMLexerInit() {
	staticData := &pmlexerLexerStaticData
	staticData.once.Do(pmlexerLexerInit)
}

// NewPMLexer produces a new lexer instance for the optional input antlr.CharStream.
func NewPMLexer(input antlr.CharStream) *PMLexer {
	PMLexerInit()
	l := new(PMLexer)
