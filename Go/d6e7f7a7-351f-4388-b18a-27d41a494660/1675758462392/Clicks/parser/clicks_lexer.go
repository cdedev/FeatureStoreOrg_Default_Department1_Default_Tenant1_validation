...
var clickslexerLexerStaticData struct {
	once                   sync.Once
	serializedATN          []int32
	channelNames           []string
	modeNames              []string
...
func clickslexerLexerInit() {
	staticData := &clickslexerLexerStaticData
...
// ClicksLexerInit initializes any static state used to implement ClicksLexer. By default the
// static state used to implement the lexer is lazily initialized during the first call to
// NewClicksLexer(). You can call this function if you wish to initialize the static state ahead
// of time.
func ClicksLexerInit() {
	staticData := &clickslexerLexerStaticData
	staticData.once.Do(clickslexerLexerInit)
}

// NewClicksLexer produces a new lexer instance for the optional input antlr.CharStream.
func NewClicksLexer(input antlr.CharStream) *ClicksLexer {
	ClicksLexerInit()
	l := new(ClicksLexer)
