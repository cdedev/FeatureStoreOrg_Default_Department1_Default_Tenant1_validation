...
var cesiumlexerLexerStaticData struct {
	once                   sync.Once
	serializedATN          []int32
	channelNames           []string
	modeNames              []string
...
func cesiumlexerLexerInit() {
	staticData := &cesiumlexerLexerStaticData
...
// CesiumLexerInit initializes any static state used to implement CesiumLexer. By default the
// static state used to implement the lexer is lazily initialized during the first call to
// NewCesiumLexer(). You can call this function if you wish to initialize the static state ahead
// of time.
func CesiumLexerInit() {
	staticData := &cesiumlexerLexerStaticData
	staticData.once.Do(cesiumlexerLexerInit)
}

// NewCesiumLexer produces a new lexer instance for the optional input antlr.CharStream.
func NewCesiumLexer(input antlr.CharStream) *CesiumLexer {
	CesiumLexerInit()
	l := new(CesiumLexer)
