...
var voteslexerLexerStaticData struct {
	once                   sync.Once
	serializedATN          []int32
	channelNames           []string
	modeNames              []string
...
func voteslexerLexerInit() {
	staticData := &voteslexerLexerStaticData
...
// VotesLexerInit initializes any static state used to implement VotesLexer. By default the
// static state used to implement the lexer is lazily initialized during the first call to
// NewVotesLexer(). You can call this function if you wish to initialize the static state ahead
// of time.
func VotesLexerInit() {
	staticData := &voteslexerLexerStaticData
	staticData.once.Do(voteslexerLexerInit)
}

// NewVotesLexer produces a new lexer instance for the optional input antlr.CharStream.
func NewVotesLexer(input antlr.CharStream) *VotesLexer {
	VotesLexerInit()
	l := new(VotesLexer)
