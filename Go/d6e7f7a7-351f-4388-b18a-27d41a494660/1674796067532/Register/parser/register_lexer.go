...
var registerlexerLexerStaticData struct {
	once                   sync.Once
	serializedATN          []int32
	channelNames           []string
	modeNames              []string
...
func registerlexerLexerInit() {
	staticData := &registerlexerLexerStaticData
...
// RegisterLexerInit initializes any static state used to implement RegisterLexer. By default the
// static state used to implement the lexer is lazily initialized during the first call to
// NewRegisterLexer(). You can call this function if you wish to initialize the static state ahead
// of time.
func RegisterLexerInit() {
	staticData := &registerlexerLexerStaticData
	staticData.once.Do(registerlexerLexerInit)
}

// NewRegisterLexer produces a new lexer instance for the optional input antlr.CharStream.
func NewRegisterLexer(input antlr.CharStream) *RegisterLexer {
	RegisterLexerInit()
	l := new(RegisterLexer)
	...
	l.GrammarFileName = "Register.g4"
	// TODO: l.EOF = antlr.TokenEOF

	return l
}

// RegisterLexer tokens.
const (
	RegisterLexerREGISTER = 1
	RegisterLexerOWNKEY   = 2
	RegisterLexerSPLITKEY = 3
	RegisterLexerWS       = 4
)
