...
var hairlexerLexerStaticData struct {
	once                   sync.Once
	serializedATN          []int32
	channelNames           []string
	modeNames              []string
...
func hairlexerLexerInit() {
	staticData := &hairlexerLexerStaticData
...
// HairLexerInit initializes any static state used to implement HairLexer. By default the
// static state used to implement the lexer is lazily initialized during the first call to
// NewHairLexer(). You can call this function if you wish to initialize the static state ahead
// of time.
func HairLexerInit() {
	staticData := &hairlexerLexerStaticData
	staticData.once.Do(hairlexerLexerInit)
}

// NewHairLexer produces a new lexer instance for the optional input antlr.CharStream.
func NewHairLexer(input antlr.CharStream) *HairLexer {
	HairLexerInit()
	l := new(HairLexer)
