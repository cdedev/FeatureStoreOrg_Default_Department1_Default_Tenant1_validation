...
var salesoutletlexerLexerStaticData struct {
	once                   sync.Once
	serializedATN          []int32
	channelNames           []string
	modeNames              []string
...
func salesoutletlexerLexerInit() {
	staticData := &salesoutletlexerLexerStaticData
	...
	staticData.serializedATN = []int32{
		...
		0, 4, 1, 1, 3, 2, 5, 3, 7, 4, 1, 0, 2, 1, 0, 51, 56, 3, 0, 9, 10, 13, 13,
...
// SalesOutletLexerInit initializes any static state used to implement SalesOutletLexer. By default the
// static state used to implement the lexer is lazily initialized during the first call to
// NewSalesOutletLexer(). You can call this function if you wish to initialize the static state ahead
// of time.
func SalesOutletLexerInit() {
	staticData := &salesoutletlexerLexerStaticData
	staticData.once.Do(salesoutletlexerLexerInit)
}

// NewSalesOutletLexer produces a new lexer instance for the optional input antlr.CharStream.
func NewSalesOutletLexer(input antlr.CharStream) *SalesOutletLexer {
	SalesOutletLexerInit()
	l := new(SalesOutletLexer)
	...
	l.GrammarFileName = "SalesOutlet.g4"
	// TODO: l.EOF = antlr.TokenEOF

	return l
}

// SalesOutletLexer tokens.
const (
	SalesOutletLexerSALESOUTLET = 1
	SalesOutletLexerOWNKEY      = 2
	SalesOutletLexerSPLITKEY    = 3
	SalesOutletLexerWS          = 4
)
