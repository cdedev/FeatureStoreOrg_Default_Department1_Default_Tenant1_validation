...
var quantitylexerLexerStaticData struct {
	once                   sync.Once
	serializedATN          []int32
	channelNames           []string
	modeNames              []string
...
func quantitylexerLexerInit() {
	staticData := &quantitylexerLexerStaticData
...
// QuantityLexerInit initializes any static state used to implement QuantityLexer. By default the
// static state used to implement the lexer is lazily initialized during the first call to
// NewQuantityLexer(). You can call this function if you wish to initialize the static state ahead
// of time.
func QuantityLexerInit() {
	staticData := &quantitylexerLexerStaticData
	staticData.once.Do(quantitylexerLexerInit)
}

// NewQuantityLexer produces a new lexer instance for the optional input antlr.CharStream.
func NewQuantityLexer(input antlr.CharStream) *QuantityLexer {
	QuantityLexerInit()
	l := new(QuantityLexer)
	...
	l.GrammarFileName = "Quantity.g4"
	// TODO: l.EOF = antlr.TokenEOF

	return l
}

// QuantityLexer tokens.
const (
	QuantityLexerQUANTITY = 1
	QuantityLexerOWNKEY   = 2
	QuantityLexerSPLITKEY = 3
	QuantityLexerWS       = 4
)
