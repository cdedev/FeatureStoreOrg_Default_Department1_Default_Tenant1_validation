...
var volumelexerLexerStaticData struct {
	once                   sync.Once
	serializedATN          []int32
	channelNames           []string
	modeNames              []string
...
func volumelexerLexerInit() {
	staticData := &volumelexerLexerStaticData
...
// VolumeLexerInit initializes any static state used to implement VolumeLexer. By default the
// static state used to implement the lexer is lazily initialized during the first call to
// NewVolumeLexer(). You can call this function if you wish to initialize the static state ahead
// of time.
func VolumeLexerInit() {
	staticData := &volumelexerLexerStaticData
	staticData.once.Do(volumelexerLexerInit)
}

// NewVolumeLexer produces a new lexer instance for the optional input antlr.CharStream.
func NewVolumeLexer(input antlr.CharStream) *VolumeLexer {
	VolumeLexerInit()
	l := new(VolumeLexer)
