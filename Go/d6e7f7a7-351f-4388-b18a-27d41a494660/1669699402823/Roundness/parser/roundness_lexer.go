...
var roundnesslexerLexerStaticData struct {
	once                   sync.Once
	serializedATN          []int32
	channelNames           []string
	modeNames              []string
...
func roundnesslexerLexerInit() {
	staticData := &roundnesslexerLexerStaticData
...
// RoundnessLexerInit initializes any static state used to implement RoundnessLexer. By default the
// static state used to implement the lexer is lazily initialized during the first call to
// NewRoundnessLexer(). You can call this function if you wish to initialize the static state ahead
// of time.
func RoundnessLexerInit() {
	staticData := &roundnesslexerLexerStaticData
	staticData.once.Do(roundnesslexerLexerInit)
}

// NewRoundnessLexer produces a new lexer instance for the optional input antlr.CharStream.
func NewRoundnessLexer(input antlr.CharStream) *RoundnessLexer {
	RoundnessLexerInit()
	l := new(RoundnessLexer)
	...
	l.GrammarFileName = "Roundness.g4"
	// TODO: l.EOF = antlr.TokenEOF

	return l
}

// RoundnessLexer tokens.
const (
	RoundnessLexerROUNDNESS = 1
	RoundnessLexerOWNKEY    = 2
	RoundnessLexerSPLITKEY  = 3
	RoundnessLexerWS        = 4
)
