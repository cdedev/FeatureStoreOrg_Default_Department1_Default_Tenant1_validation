...
var epochlexerLexerStaticData struct {
	once                   sync.Once
	serializedATN          []int32
	channelNames           []string
	modeNames              []string
...
func epochlexerLexerInit() {
	staticData := &epochlexerLexerStaticData
...
// EpochLexerInit initializes any static state used to implement EpochLexer. By default the
// static state used to implement the lexer is lazily initialized during the first call to
// NewEpochLexer(). You can call this function if you wish to initialize the static state ahead
// of time.
func EpochLexerInit() {
	staticData := &epochlexerLexerStaticData
	staticData.once.Do(epochlexerLexerInit)
}

// NewEpochLexer produces a new lexer instance for the optional input antlr.CharStream.
func NewEpochLexer(input antlr.CharStream) *EpochLexer {
	EpochLexerInit()
	l := new(EpochLexer)
