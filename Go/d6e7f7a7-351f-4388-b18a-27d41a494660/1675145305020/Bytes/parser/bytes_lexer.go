...
var byteslexerLexerStaticData struct {
	once                   sync.Once
	serializedATN          []int32
	channelNames           []string
	modeNames              []string
...
func byteslexerLexerInit() {
	staticData := &byteslexerLexerStaticData
...
// BytesLexerInit initializes any static state used to implement BytesLexer. By default the
// static state used to implement the lexer is lazily initialized during the first call to
// NewBytesLexer(). You can call this function if you wish to initialize the static state ahead
// of time.
func BytesLexerInit() {
	staticData := &byteslexerLexerStaticData
	staticData.once.Do(byteslexerLexerInit)
}

// NewBytesLexer produces a new lexer instance for the optional input antlr.CharStream.
func NewBytesLexer(input antlr.CharStream) *BytesLexer {
	BytesLexerInit()
	l := new(BytesLexer)
