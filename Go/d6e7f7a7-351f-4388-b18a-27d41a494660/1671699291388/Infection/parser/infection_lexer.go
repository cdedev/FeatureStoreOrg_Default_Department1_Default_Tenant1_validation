...
var infectionlexerLexerStaticData struct {
	once                   sync.Once
	serializedATN          []int32
	channelNames           []string
	modeNames              []string
...
func infectionlexerLexerInit() {
	staticData := &infectionlexerLexerStaticData
...
// InfectionLexerInit initializes any static state used to implement InfectionLexer. By default the
// static state used to implement the lexer is lazily initialized during the first call to
// NewInfectionLexer(). You can call this function if you wish to initialize the static state ahead
// of time.
func InfectionLexerInit() {
	staticData := &infectionlexerLexerStaticData
	staticData.once.Do(infectionlexerLexerInit)
}

// NewInfectionLexer produces a new lexer instance for the optional input antlr.CharStream.
func NewInfectionLexer(input antlr.CharStream) *InfectionLexer {
	InfectionLexerInit()
	l := new(InfectionLexer)
	...
	l.GrammarFileName = "Infection.g4"
	// TODO: l.EOF = antlr.TokenEOF

	return l
}

// InfectionLexer tokens.
const (
	InfectionLexerINFECTION = 1
	InfectionLexerOWNKEY    = 2
	InfectionLexerSPLITKEY  = 3
	InfectionLexerWS        = 4
)
