...
var zipcodelexerLexerStaticData struct {
	once                   sync.Once
	serializedATN          []int32
	channelNames           []string
	modeNames              []string
...
func zipcodelexerLexerInit() {
	staticData := &zipcodelexerLexerStaticData
...
// ZipCodeLexerInit initializes any static state used to implement ZipCodeLexer. By default the
// static state used to implement the lexer is lazily initialized during the first call to
// NewZipCodeLexer(). You can call this function if you wish to initialize the static state ahead
// of time.
func ZipCodeLexerInit() {
	staticData := &zipcodelexerLexerStaticData
	staticData.once.Do(zipcodelexerLexerInit)
}

// NewZipCodeLexer produces a new lexer instance for the optional input antlr.CharStream.
func NewZipCodeLexer(input antlr.CharStream) *ZipCodeLexer {
	ZipCodeLexerInit()
	l := new(ZipCodeLexer)
...
// ZipCodeLexer tokens.
const (
	ZipCodeLexerZIPCODE  = 1
	ZipCodeLexerOWNKEY   = 2
	ZipCodeLexerSPLITKEY = 3
	ZipCodeLexerWS       = 4
)
