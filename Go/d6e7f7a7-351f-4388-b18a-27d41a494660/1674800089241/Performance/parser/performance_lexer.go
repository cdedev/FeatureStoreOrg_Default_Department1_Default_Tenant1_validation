...
var performancelexerLexerStaticData struct {
	once                   sync.Once
	serializedATN          []int32
	channelNames           []string
	modeNames              []string
...
func performancelexerLexerInit() {
	staticData := &performancelexerLexerStaticData
...
// PerformanceLexerInit initializes any static state used to implement PerformanceLexer. By default the
// static state used to implement the lexer is lazily initialized during the first call to
// NewPerformanceLexer(). You can call this function if you wish to initialize the static state ahead
// of time.
func PerformanceLexerInit() {
	staticData := &performancelexerLexerStaticData
	staticData.once.Do(performancelexerLexerInit)
}

// NewPerformanceLexer produces a new lexer instance for the optional input antlr.CharStream.
func NewPerformanceLexer(input antlr.CharStream) *PerformanceLexer {
	PerformanceLexerInit()
	l := new(PerformanceLexer)
	...
	l.GrammarFileName = "Performance.g4"
	// TODO: l.EOF = antlr.TokenEOF

	return l
}

// PerformanceLexer tokens.
const (
	PerformanceLexerPERFORMANCE = 1
	PerformanceLexerOWNKEY      = 2
	PerformanceLexerSPLITKEY    = 3
	PerformanceLexerWS          = 4
)
