...
var studyroomlexerLexerStaticData struct {
	once                   sync.Once
	serializedATN          []int32
	channelNames           []string
	modeNames              []string
...
func studyroomlexerLexerInit() {
	staticData := &studyroomlexerLexerStaticData
...
// StudyRoomLexerInit initializes any static state used to implement StudyRoomLexer. By default the
// static state used to implement the lexer is lazily initialized during the first call to
// NewStudyRoomLexer(). You can call this function if you wish to initialize the static state ahead
// of time.
func StudyRoomLexerInit() {
	staticData := &studyroomlexerLexerStaticData
	staticData.once.Do(studyroomlexerLexerInit)
}

// NewStudyRoomLexer produces a new lexer instance for the optional input antlr.CharStream.
func NewStudyRoomLexer(input antlr.CharStream) *StudyRoomLexer {
	StudyRoomLexerInit()
	l := new(StudyRoomLexer)
	...
	l.GrammarFileName = "StudyRoom.g4"
	// TODO: l.EOF = antlr.TokenEOF

	return l
}

// StudyRoomLexer tokens.
const (
	StudyRoomLexerSTUDYROOM = 1
	StudyRoomLexerOWNKEY    = 2
	StudyRoomLexerSPLITKEY  = 3
	StudyRoomLexerWS        = 4
)
