...
var aprmintemplexerLexerStaticData struct {
	once                   sync.Once
	serializedATN          []int32
	channelNames           []string
	modeNames              []string
...
func aprmintemplexerLexerInit() {
	staticData := &aprmintemplexerLexerStaticData
...
// AprMintempLexerInit initializes any static state used to implement AprMintempLexer. By default the
// static state used to implement the lexer is lazily initialized during the first call to
// NewAprMintempLexer(). You can call this function if you wish to initialize the static state ahead
// of time.
func AprMintempLexerInit() {
	staticData := &aprmintemplexerLexerStaticData
	staticData.once.Do(aprmintemplexerLexerInit)
}

// NewAprMintempLexer produces a new lexer instance for the optional input antlr.CharStream.
func NewAprMintempLexer(input antlr.CharStream) *AprMintempLexer {
	AprMintempLexerInit()
	l := new(AprMintempLexer)
	...
	l.GrammarFileName = "AprMintemp.g4"
	// TODO: l.EOF = antlr.TokenEOF

	return l
}

// AprMintempLexer tokens.
const (
	AprMintempLexerAPRMINTEMP = 1
	AprMintempLexerOWNKEY     = 2
	AprMintempLexerSPLITKEY   = 3
	AprMintempLexerWS         = 4
)
