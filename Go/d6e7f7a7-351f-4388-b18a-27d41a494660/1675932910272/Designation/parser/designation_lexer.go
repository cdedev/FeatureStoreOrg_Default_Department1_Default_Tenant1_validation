...
var designationlexerLexerStaticData struct {
	once                   sync.Once
	serializedATN          []int32
	channelNames           []string
	modeNames              []string
...
func designationlexerLexerInit() {
	staticData := &designationlexerLexerStaticData
...
// DesignationLexerInit initializes any static state used to implement DesignationLexer. By default the
// static state used to implement the lexer is lazily initialized during the first call to
// NewDesignationLexer(). You can call this function if you wish to initialize the static state ahead
// of time.
func DesignationLexerInit() {
	staticData := &designationlexerLexerStaticData
	staticData.once.Do(designationlexerLexerInit)
}

// NewDesignationLexer produces a new lexer instance for the optional input antlr.CharStream.
func NewDesignationLexer(input antlr.CharStream) *DesignationLexer {
	DesignationLexerInit()
	l := new(DesignationLexer)
	...
	l.GrammarFileName = "Designation.g4"
	// TODO: l.EOF = antlr.TokenEOF

	return l
}

// DesignationLexer tokens.
const (
	DesignationLexerDESIGNATION = 1
	DesignationLexerOWNKEY      = 2
	DesignationLexerSPLITKEY    = 3
	DesignationLexerWS          = 4
)
