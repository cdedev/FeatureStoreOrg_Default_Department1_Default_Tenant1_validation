...
var dualsimlexerLexerStaticData struct {
	once                   sync.Once
	serializedATN          []int32
	channelNames           []string
	modeNames              []string
...
func dualsimlexerLexerInit() {
	staticData := &dualsimlexerLexerStaticData
...
// DualSimLexerInit initializes any static state used to implement DualSimLexer. By default the
// static state used to implement the lexer is lazily initialized during the first call to
// NewDualSimLexer(). You can call this function if you wish to initialize the static state ahead
// of time.
func DualSimLexerInit() {
	staticData := &dualsimlexerLexerStaticData
	staticData.once.Do(dualsimlexerLexerInit)
}

// NewDualSimLexer produces a new lexer instance for the optional input antlr.CharStream.
func NewDualSimLexer(input antlr.CharStream) *DualSimLexer {
	DualSimLexerInit()
	l := new(DualSimLexer)
...
// DualSimLexer tokens.
const (
	DualSimLexerDUALSIM  = 1
	DualSimLexerOWNKEY   = 2
	DualSimLexerSPLITKEY = 3
	DualSimLexerWS       = 4
)
