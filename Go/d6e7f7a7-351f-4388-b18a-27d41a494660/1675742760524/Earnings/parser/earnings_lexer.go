...
var earningslexerLexerStaticData struct {
	once                   sync.Once
	serializedATN          []int32
	channelNames           []string
	modeNames              []string
...
func earningslexerLexerInit() {
	staticData := &earningslexerLexerStaticData
...
// EarningsLexerInit initializes any static state used to implement EarningsLexer. By default the
// static state used to implement the lexer is lazily initialized during the first call to
// NewEarningsLexer(). You can call this function if you wish to initialize the static state ahead
// of time.
func EarningsLexerInit() {
	staticData := &earningslexerLexerStaticData
	staticData.once.Do(earningslexerLexerInit)
}

// NewEarningsLexer produces a new lexer instance for the optional input antlr.CharStream.
func NewEarningsLexer(input antlr.CharStream) *EarningsLexer {
	EarningsLexerInit()
	l := new(EarningsLexer)
	...
	l.GrammarFileName = "Earnings.g4"
	// TODO: l.EOF = antlr.TokenEOF

	return l
}

// EarningsLexer tokens.
const (
	EarningsLexerEARNINGS = 1
	EarningsLexerOWNKEY   = 2
	EarningsLexerSPLITKEY = 3
	EarningsLexerWS       = 4
)
