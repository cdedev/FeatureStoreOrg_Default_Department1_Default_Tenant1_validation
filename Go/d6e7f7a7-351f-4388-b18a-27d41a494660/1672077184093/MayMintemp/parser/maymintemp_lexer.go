...
var maymintemplexerLexerStaticData struct {
	once                   sync.Once
	serializedATN          []int32
	channelNames           []string
	modeNames              []string
...
func maymintemplexerLexerInit() {
	staticData := &maymintemplexerLexerStaticData
...
// MayMintempLexerInit initializes any static state used to implement MayMintempLexer. By default the
// static state used to implement the lexer is lazily initialized during the first call to
// NewMayMintempLexer(). You can call this function if you wish to initialize the static state ahead
// of time.
func MayMintempLexerInit() {
	staticData := &maymintemplexerLexerStaticData
	staticData.once.Do(maymintemplexerLexerInit)
}

// NewMayMintempLexer produces a new lexer instance for the optional input antlr.CharStream.
func NewMayMintempLexer(input antlr.CharStream) *MayMintempLexer {
	MayMintempLexerInit()
	l := new(MayMintempLexer)
	...
	l.GrammarFileName = "MayMintemp.g4"
	// TODO: l.EOF = antlr.TokenEOF

	return l
}

// MayMintempLexer tokens.
const (
	MayMintempLexerMAYMINTEMP = 1
	MayMintempLexerOWNKEY     = 2
	MayMintempLexerSPLITKEY   = 3
	MayMintempLexerWS         = 4
)
