...
var evermarriedlexerLexerStaticData struct {
	once                   sync.Once
	serializedATN          []int32
	channelNames           []string
	modeNames              []string
...
func evermarriedlexerLexerInit() {
	staticData := &evermarriedlexerLexerStaticData
...
// EverMarriedLexerInit initializes any static state used to implement EverMarriedLexer. By default the
// static state used to implement the lexer is lazily initialized during the first call to
// NewEverMarriedLexer(). You can call this function if you wish to initialize the static state ahead
// of time.
func EverMarriedLexerInit() {
	staticData := &evermarriedlexerLexerStaticData
	staticData.once.Do(evermarriedlexerLexerInit)
}

// NewEverMarriedLexer produces a new lexer instance for the optional input antlr.CharStream.
func NewEverMarriedLexer(input antlr.CharStream) *EverMarriedLexer {
	EverMarriedLexerInit()
	l := new(EverMarriedLexer)
	...
	l.GrammarFileName = "EverMarried.g4"
	// TODO: l.EOF = antlr.TokenEOF

	return l
}

// EverMarriedLexer tokens.
const (
	EverMarriedLexerEVERMARRIED = 1
	EverMarriedLexerOWNKEY      = 2
	EverMarriedLexerSPLITKEY    = 3
	EverMarriedLexerWS          = 4
)
