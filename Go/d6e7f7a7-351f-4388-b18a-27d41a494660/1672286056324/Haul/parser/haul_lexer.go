...
var haullexerLexerStaticData struct {
	once                   sync.Once
	serializedATN          []int32
	channelNames           []string
	modeNames              []string
...
func haullexerLexerInit() {
	staticData := &haullexerLexerStaticData
...
// HaulLexerInit initializes any static state used to implement HaulLexer. By default the
// static state used to implement the lexer is lazily initialized during the first call to
// NewHaulLexer(). You can call this function if you wish to initialize the static state ahead
// of time.
func HaulLexerInit() {
	staticData := &haullexerLexerStaticData
	staticData.once.Do(haullexerLexerInit)
}

// NewHaulLexer produces a new lexer instance for the optional input antlr.CharStream.
func NewHaulLexer(input antlr.CharStream) *HaulLexer {
	HaulLexerInit()
	l := new(HaulLexer)
