...
var followerslexerLexerStaticData struct {
	once                   sync.Once
	serializedATN          []int32
	channelNames           []string
	modeNames              []string
...
func followerslexerLexerInit() {
	staticData := &followerslexerLexerStaticData
...
// FollowersLexerInit initializes any static state used to implement FollowersLexer. By default the
// static state used to implement the lexer is lazily initialized during the first call to
// NewFollowersLexer(). You can call this function if you wish to initialize the static state ahead
// of time.
func FollowersLexerInit() {
	staticData := &followerslexerLexerStaticData
	staticData.once.Do(followerslexerLexerInit)
}

// NewFollowersLexer produces a new lexer instance for the optional input antlr.CharStream.
func NewFollowersLexer(input antlr.CharStream) *FollowersLexer {
	FollowersLexerInit()
	l := new(FollowersLexer)
	...
	l.GrammarFileName = "Followers.g4"
	// TODO: l.EOF = antlr.TokenEOF

	return l
}

// FollowersLexer tokens.
const (
	FollowersLexerFOLLOWERS = 1
	FollowersLexerOWNKEY    = 2
	FollowersLexerSPLITKEY  = 3
	FollowersLexerWS        = 4
)
