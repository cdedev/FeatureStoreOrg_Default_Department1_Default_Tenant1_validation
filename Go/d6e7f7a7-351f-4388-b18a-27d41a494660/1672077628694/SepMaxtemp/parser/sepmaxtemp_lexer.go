...
var sepmaxtemplexerLexerStaticData struct {
	once                   sync.Once
	serializedATN          []int32
	channelNames           []string
	modeNames              []string
...
func sepmaxtemplexerLexerInit() {
	staticData := &sepmaxtemplexerLexerStaticData
...
// SepMaxtempLexerInit initializes any static state used to implement SepMaxtempLexer. By default the
// static state used to implement the lexer is lazily initialized during the first call to
// NewSepMaxtempLexer(). You can call this function if you wish to initialize the static state ahead
// of time.
func SepMaxtempLexerInit() {
	staticData := &sepmaxtemplexerLexerStaticData
	staticData.once.Do(sepmaxtemplexerLexerInit)
}

// NewSepMaxtempLexer produces a new lexer instance for the optional input antlr.CharStream.
func NewSepMaxtempLexer(input antlr.CharStream) *SepMaxtempLexer {
	SepMaxtempLexerInit()
	l := new(SepMaxtempLexer)
	...
	l.GrammarFileName = "SepMaxtemp.g4"
	// TODO: l.EOF = antlr.TokenEOF

	return l
}

// SepMaxtempLexer tokens.
const (
	SepMaxtempLexerSEPMAXTEMP = 1
	SepMaxtempLexerOWNKEY     = 2
	SepMaxtempLexerSPLITKEY   = 3
	SepMaxtempLexerWS         = 4
)
