...
var vibrationlexerLexerStaticData struct {
	once                   sync.Once
	serializedATN          []int32
	channelNames           []string
	modeNames              []string
...
func vibrationlexerLexerInit() {
	staticData := &vibrationlexerLexerStaticData
...
// VibrationLexerInit initializes any static state used to implement VibrationLexer. By default the
// static state used to implement the lexer is lazily initialized during the first call to
// NewVibrationLexer(). You can call this function if you wish to initialize the static state ahead
// of time.
func VibrationLexerInit() {
	staticData := &vibrationlexerLexerStaticData
	staticData.once.Do(vibrationlexerLexerInit)
}

// NewVibrationLexer produces a new lexer instance for the optional input antlr.CharStream.
func NewVibrationLexer(input antlr.CharStream) *VibrationLexer {
	VibrationLexerInit()
	l := new(VibrationLexer)
	...
	l.GrammarFileName = "Vibration.g4"
	// TODO: l.EOF = antlr.TokenEOF

	return l
}

// VibrationLexer tokens.
const (
	VibrationLexerVIBRATION = 1
	VibrationLexerOWNKEY    = 2
	VibrationLexerSPLITKEY  = 3
	VibrationLexerWS        = 4
)
