...
type Eonal_stabilityLexer struct {
	*antlr.BaseLexer
	channelNames []string
	modeNames    []string
	// TODO: EOF string
...
var eonal_stabilitylexerLexerStaticData struct {
	once                   sync.Once
	serializedATN          []int32
	channelNames           []string
	modeNames              []string
...
func eonal_stabilitylexerLexerInit() {
	staticData := &eonal_stabilitylexerLexerStaticData
...
// Eonal_stabilityLexerInit initializes any static state used to implement Eonal_stabilityLexer. By default the
// static state used to implement the lexer is lazily initialized during the first call to
// NewEonal_stabilityLexer(). You can call this function if you wish to initialize the static state ahead
// of time.
func Eonal_stabilityLexerInit() {
	staticData := &eonal_stabilitylexerLexerStaticData
	staticData.once.Do(eonal_stabilitylexerLexerInit)
}

// NewEonal_stabilityLexer produces a new lexer instance for the optional input antlr.CharStream.
func NewEonal_stabilityLexer(input antlr.CharStream) *Eonal_stabilityLexer {
	Eonal_stabilityLexerInit()
	l := new(Eonal_stabilityLexer)
	...
	l.GrammarFileName = "Eonal_stability.g4"
	// TODO: l.EOF = antlr.TokenEOF

	return l
}

// Eonal_stabilityLexer tokens.
const (
	Eonal_stabilityLexerEONAL_STABILITY = 1
	Eonal_stabilityLexerOWNKEY          = 2
	Eonal_stabilityLexerSPLITKEY        = 3
	Eonal_stabilityLexerWS              = 4
)
