...
var wordslexerLexerStaticData struct {
	once                   sync.Once
	serializedATN          []int32
	channelNames           []string
	modeNames              []string
...
func wordslexerLexerInit() {
	staticData := &wordslexerLexerStaticData
...
// WordsLexerInit initializes any static state used to implement WordsLexer. By default the
// static state used to implement the lexer is lazily initialized during the first call to
// NewWordsLexer(). You can call this function if you wish to initialize the static state ahead
// of time.
func WordsLexerInit() {
	staticData := &wordslexerLexerStaticData
	staticData.once.Do(wordslexerLexerInit)
}

// NewWordsLexer produces a new lexer instance for the optional input antlr.CharStream.
func NewWordsLexer(input antlr.CharStream) *WordsLexer {
	WordsLexerInit()
	l := new(WordsLexer)
