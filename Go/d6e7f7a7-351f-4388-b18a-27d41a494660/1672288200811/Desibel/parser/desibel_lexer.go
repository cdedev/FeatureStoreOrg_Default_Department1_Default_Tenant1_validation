...
var desibellexerLexerStaticData struct {
	once                   sync.Once
	serializedATN          []int32
	channelNames           []string
	modeNames              []string
...
func desibellexerLexerInit() {
	staticData := &desibellexerLexerStaticData
...
// DesibelLexerInit initializes any static state used to implement DesibelLexer. By default the
// static state used to implement the lexer is lazily initialized during the first call to
// NewDesibelLexer(). You can call this function if you wish to initialize the static state ahead
// of time.
func DesibelLexerInit() {
	staticData := &desibellexerLexerStaticData
	staticData.once.Do(desibellexerLexerInit)
}

// NewDesibelLexer produces a new lexer instance for the optional input antlr.CharStream.
func NewDesibelLexer(input antlr.CharStream) *DesibelLexer {
	DesibelLexerInit()
	l := new(DesibelLexer)
...
// DesibelLexer tokens.
const (
	DesibelLexerDESIBEL  = 1
	DesibelLexerOWNKEY   = 2
	DesibelLexerSPLITKEY = 3
	DesibelLexerWS       = 4
)
