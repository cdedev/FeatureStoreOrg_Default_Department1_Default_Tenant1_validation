...
type SmokingStatusLexer struct {
	*antlr.BaseLexer
	channelNames []string
	modeNames    []string
	// TODO: EOF string
...
var smokingstatuslexerLexerStaticData struct {
	once                   sync.Once
	serializedATN          []int32
	channelNames           []string
	modeNames              []string
...
func smokingstatuslexerLexerInit() {
	staticData := &smokingstatuslexerLexerStaticData
...
// SmokingStatusLexerInit initializes any static state used to implement SmokingStatusLexer. By default the
// static state used to implement the lexer is lazily initialized during the first call to
// NewSmokingStatusLexer(). You can call this function if you wish to initialize the static state ahead
// of time.
func SmokingStatusLexerInit() {
	staticData := &smokingstatuslexerLexerStaticData
	staticData.once.Do(smokingstatuslexerLexerInit)
}

// NewSmokingStatusLexer produces a new lexer instance for the optional input antlr.CharStream.
func NewSmokingStatusLexer(input antlr.CharStream) *SmokingStatusLexer {
	SmokingStatusLexerInit()
	l := new(SmokingStatusLexer)
	...
	l.GrammarFileName = "SmokingStatus.g4"
	// TODO: l.EOF = antlr.TokenEOF

	return l
}

// SmokingStatusLexer tokens.
const (
	SmokingStatusLexerSMOKINGSTATUS = 1
	SmokingStatusLexerOWNKEY        = 2
	SmokingStatusLexerSPLITKEY      = 3
	SmokingStatusLexerWS            = 4
)
