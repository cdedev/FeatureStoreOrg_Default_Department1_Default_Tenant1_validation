...
var capacitylexerLexerStaticData struct {
	once                   sync.Once
	serializedATN          []int32
	channelNames           []string
	modeNames              []string
...
func capacitylexerLexerInit() {
	staticData := &capacitylexerLexerStaticData
...
// CapacityLexerInit initializes any static state used to implement CapacityLexer. By default the
// static state used to implement the lexer is lazily initialized during the first call to
// NewCapacityLexer(). You can call this function if you wish to initialize the static state ahead
// of time.
func CapacityLexerInit() {
	staticData := &capacitylexerLexerStaticData
	staticData.once.Do(capacitylexerLexerInit)
}

// NewCapacityLexer produces a new lexer instance for the optional input antlr.CharStream.
func NewCapacityLexer(input antlr.CharStream) *CapacityLexer {
	CapacityLexerInit()
	l := new(CapacityLexer)
	...
	l.GrammarFileName = "Capacity.g4"
	// TODO: l.EOF = antlr.TokenEOF

	return l
}

// CapacityLexer tokens.
const (
	CapacityLexerCAPACITY = 1
	CapacityLexerOWNKEY   = 2
	CapacityLexerSPLITKEY = 3
	CapacityLexerWS       = 4
)
