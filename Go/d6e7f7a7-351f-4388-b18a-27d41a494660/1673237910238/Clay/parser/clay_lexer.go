...
var claylexerLexerStaticData struct {
	once                   sync.Once
	serializedATN          []int32
	channelNames           []string
	modeNames              []string
...
func claylexerLexerInit() {
	staticData := &claylexerLexerStaticData
...
// ClayLexerInit initializes any static state used to implement ClayLexer. By default the
// static state used to implement the lexer is lazily initialized during the first call to
// NewClayLexer(). You can call this function if you wish to initialize the static state ahead
// of time.
func ClayLexerInit() {
	staticData := &claylexerLexerStaticData
	staticData.once.Do(claylexerLexerInit)
}

// NewClayLexer produces a new lexer instance for the optional input antlr.CharStream.
func NewClayLexer(input antlr.CharStream) *ClayLexer {
	ClayLexerInit()
	l := new(ClayLexer)
