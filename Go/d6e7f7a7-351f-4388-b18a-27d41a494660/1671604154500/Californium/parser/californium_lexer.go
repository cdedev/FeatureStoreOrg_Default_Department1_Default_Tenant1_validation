...
var californiumlexerLexerStaticData struct {
	once                   sync.Once
	serializedATN          []int32
	channelNames           []string
	modeNames              []string
...
func californiumlexerLexerInit() {
	staticData := &californiumlexerLexerStaticData
...
// CaliforniumLexerInit initializes any static state used to implement CaliforniumLexer. By default the
// static state used to implement the lexer is lazily initialized during the first call to
// NewCaliforniumLexer(). You can call this function if you wish to initialize the static state ahead
// of time.
func CaliforniumLexerInit() {
	staticData := &californiumlexerLexerStaticData
	staticData.once.Do(californiumlexerLexerInit)
}

// NewCaliforniumLexer produces a new lexer instance for the optional input antlr.CharStream.
func NewCaliforniumLexer(input antlr.CharStream) *CaliforniumLexer {
	CaliforniumLexerInit()
	l := new(CaliforniumLexer)
	...
	l.GrammarFileName = "Californium.g4"
	// TODO: l.EOF = antlr.TokenEOF

	return l
}

// CaliforniumLexer tokens.
const (
	CaliforniumLexerCALIFORNIUM = 1
	CaliforniumLexerOWNKEY      = 2
	CaliforniumLexerSPLITKEY    = 3
	CaliforniumLexerWS          = 4
)
