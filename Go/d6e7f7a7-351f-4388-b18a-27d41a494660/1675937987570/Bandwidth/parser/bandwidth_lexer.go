...
var bandwidthlexerLexerStaticData struct {
	once                   sync.Once
	serializedATN          []int32
	channelNames           []string
	modeNames              []string
...
func bandwidthlexerLexerInit() {
	staticData := &bandwidthlexerLexerStaticData
...
// BandwidthLexerInit initializes any static state used to implement BandwidthLexer. By default the
// static state used to implement the lexer is lazily initialized during the first call to
// NewBandwidthLexer(). You can call this function if you wish to initialize the static state ahead
// of time.
func BandwidthLexerInit() {
	staticData := &bandwidthlexerLexerStaticData
	staticData.once.Do(bandwidthlexerLexerInit)
}

// NewBandwidthLexer produces a new lexer instance for the optional input antlr.CharStream.
func NewBandwidthLexer(input antlr.CharStream) *BandwidthLexer {
	BandwidthLexerInit()
	l := new(BandwidthLexer)
	...
	l.GrammarFileName = "Bandwidth.g4"
	// TODO: l.EOF = antlr.TokenEOF

	return l
}

// BandwidthLexer tokens.
const (
	BandwidthLexerBANDWIDTH = 1
	BandwidthLexerOWNKEY    = 2
	BandwidthLexerSPLITKEY  = 3
	BandwidthLexerWS        = 4
)
