...
var marginlexerLexerStaticData struct {
	once                   sync.Once
	serializedATN          []int32
	channelNames           []string
	modeNames              []string
...
func marginlexerLexerInit() {
	staticData := &marginlexerLexerStaticData
...
// MarginLexerInit initializes any static state used to implement MarginLexer. By default the
// static state used to implement the lexer is lazily initialized during the first call to
// NewMarginLexer(). You can call this function if you wish to initialize the static state ahead
// of time.
func MarginLexerInit() {
	staticData := &marginlexerLexerStaticData
	staticData.once.Do(marginlexerLexerInit)
}

// NewMarginLexer produces a new lexer instance for the optional input antlr.CharStream.
func NewMarginLexer(input antlr.CharStream) *MarginLexer {
	MarginLexerInit()
	l := new(MarginLexer)
