...
var gainlexerLexerStaticData struct {
	once                   sync.Once
	serializedATN          []int32
	channelNames           []string
	modeNames              []string
...
func gainlexerLexerInit() {
	staticData := &gainlexerLexerStaticData
...
// GainLexerInit initializes any static state used to implement GainLexer. By default the
// static state used to implement the lexer is lazily initialized during the first call to
// NewGainLexer(). You can call this function if you wish to initialize the static state ahead
// of time.
func GainLexerInit() {
	staticData := &gainlexerLexerStaticData
	staticData.once.Do(gainlexerLexerInit)
}

// NewGainLexer produces a new lexer instance for the optional input antlr.CharStream.
func NewGainLexer(input antlr.CharStream) *GainLexer {
	GainLexerInit()
	l := new(GainLexer)
