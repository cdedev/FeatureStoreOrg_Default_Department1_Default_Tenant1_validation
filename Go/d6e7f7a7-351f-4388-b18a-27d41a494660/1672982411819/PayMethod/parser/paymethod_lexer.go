...
var paymethodlexerLexerStaticData struct {
	once                   sync.Once
	serializedATN          []int32
	channelNames           []string
	modeNames              []string
...
func paymethodlexerLexerInit() {
	staticData := &paymethodlexerLexerStaticData
...
// PayMethodLexerInit initializes any static state used to implement PayMethodLexer. By default the
// static state used to implement the lexer is lazily initialized during the first call to
// NewPayMethodLexer(). You can call this function if you wish to initialize the static state ahead
// of time.
func PayMethodLexerInit() {
	staticData := &paymethodlexerLexerStaticData
	staticData.once.Do(paymethodlexerLexerInit)
}

// NewPayMethodLexer produces a new lexer instance for the optional input antlr.CharStream.
func NewPayMethodLexer(input antlr.CharStream) *PayMethodLexer {
	PayMethodLexerInit()
	l := new(PayMethodLexer)
	...
	l.GrammarFileName = "PayMethod.g4"
	// TODO: l.EOF = antlr.TokenEOF

	return l
}

// PayMethodLexer tokens.
const (
	PayMethodLexerPAYMETHOD = 1
	PayMethodLexerOWNKEY    = 2
	PayMethodLexerSPLITKEY  = 3
	PayMethodLexerWS        = 4
)
