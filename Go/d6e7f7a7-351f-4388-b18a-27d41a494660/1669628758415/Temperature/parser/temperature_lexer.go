...
var temperaturelexerLexerStaticData struct {
	once                   sync.Once
	serializedATN          []int32
	channelNames           []string
	modeNames              []string
...
func temperaturelexerLexerInit() {
	staticData := &temperaturelexerLexerStaticData
...
// TemperatureLexerInit initializes any static state used to implement TemperatureLexer. By default the
// static state used to implement the lexer is lazily initialized during the first call to
// NewTemperatureLexer(). You can call this function if you wish to initialize the static state ahead
// of time.
func TemperatureLexerInit() {
	staticData := &temperaturelexerLexerStaticData
	staticData.once.Do(temperaturelexerLexerInit)
}

// NewTemperatureLexer produces a new lexer instance for the optional input antlr.CharStream.
func NewTemperatureLexer(input antlr.CharStream) *TemperatureLexer {
	TemperatureLexerInit()
	l := new(TemperatureLexer)
	...
	l.GrammarFileName = "Temperature.g4"
	// TODO: l.EOF = antlr.TokenEOF

	return l
}

// TemperatureLexer tokens.
const (
	TemperatureLexerTEMPERATURE = 1
	TemperatureLexerOWNKEY      = 2
	TemperatureLexerSPLITKEY    = 3
	TemperatureLexerWS          = 4
)
