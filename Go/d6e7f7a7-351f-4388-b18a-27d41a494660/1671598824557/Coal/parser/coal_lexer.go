...
var coallexerLexerStaticData struct {
	once                   sync.Once
	serializedATN          []int32
	channelNames           []string
	modeNames              []string
...
func coallexerLexerInit() {
	staticData := &coallexerLexerStaticData
...
// CoalLexerInit initializes any static state used to implement CoalLexer. By default the
// static state used to implement the lexer is lazily initialized during the first call to
// NewCoalLexer(). You can call this function if you wish to initialize the static state ahead
// of time.
func CoalLexerInit() {
	staticData := &coallexerLexerStaticData
	staticData.once.Do(coallexerLexerInit)
}

// NewCoalLexer produces a new lexer instance for the optional input antlr.CharStream.
func NewCoalLexer(input antlr.CharStream) *CoalLexer {
	CoalLexerInit()
	l := new(CoalLexer)
