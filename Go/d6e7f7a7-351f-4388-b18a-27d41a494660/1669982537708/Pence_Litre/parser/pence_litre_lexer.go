...
var pence_litrelexerLexerStaticData struct {
	once                   sync.Once
	serializedATN          []int32
	channelNames           []string
	modeNames              []string
...
func pence_litrelexerLexerInit() {
	staticData := &pence_litrelexerLexerStaticData
...
// Pence_LitreLexerInit initializes any static state used to implement Pence_LitreLexer. By default the
// static state used to implement the lexer is lazily initialized during the first call to
// NewPence_LitreLexer(). You can call this function if you wish to initialize the static state ahead
// of time.
func Pence_LitreLexerInit() {
	staticData := &pence_litrelexerLexerStaticData
	staticData.once.Do(pence_litrelexerLexerInit)
}

// NewPence_LitreLexer produces a new lexer instance for the optional input antlr.CharStream.
func NewPence_LitreLexer(input antlr.CharStream) *Pence_LitreLexer {
	Pence_LitreLexerInit()
	l := new(Pence_LitreLexer)
	...
	l.GrammarFileName = "Pence_Litre.g4"
	// TODO: l.EOF = antlr.TokenEOF

	return l
}

// Pence_LitreLexer tokens.
const (
	Pence_LitreLexerPENCE_LITRE = 1
	Pence_LitreLexerOWNKEY      = 2
	Pence_LitreLexerSPLITKEY    = 3
	Pence_LitreLexerWS          = 4
)
