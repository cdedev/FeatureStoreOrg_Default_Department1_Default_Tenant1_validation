...
var underweightlexerLexerStaticData struct {
	once                   sync.Once
	serializedATN          []int32
	channelNames           []string
	modeNames              []string
...
func underweightlexerLexerInit() {
	staticData := &underweightlexerLexerStaticData
...
// UnderweightLexerInit initializes any static state used to implement UnderweightLexer. By default the
// static state used to implement the lexer is lazily initialized during the first call to
// NewUnderweightLexer(). You can call this function if you wish to initialize the static state ahead
// of time.
func UnderweightLexerInit() {
	staticData := &underweightlexerLexerStaticData
	staticData.once.Do(underweightlexerLexerInit)
}

// NewUnderweightLexer produces a new lexer instance for the optional input antlr.CharStream.
func NewUnderweightLexer(input antlr.CharStream) *UnderweightLexer {
	UnderweightLexerInit()
	l := new(UnderweightLexer)
	...
	l.GrammarFileName = "Underweight.g4"
	// TODO: l.EOF = antlr.TokenEOF

	return l
}

// UnderweightLexer tokens.
const (
	UnderweightLexerUNDERWEIGHT = 1
	UnderweightLexerOWNKEY      = 2
	UnderweightLexerSPLITKEY    = 3
	UnderweightLexerWS          = 4
)
