...
var barcodelexerLexerStaticData struct {
	once                   sync.Once
	serializedATN          []int32
	channelNames           []string
	modeNames              []string
...
func barcodelexerLexerInit() {
	staticData := &barcodelexerLexerStaticData
...
// BarcodeLexerInit initializes any static state used to implement BarcodeLexer. By default the
// static state used to implement the lexer is lazily initialized during the first call to
// NewBarcodeLexer(). You can call this function if you wish to initialize the static state ahead
// of time.
func BarcodeLexerInit() {
	staticData := &barcodelexerLexerStaticData
	staticData.once.Do(barcodelexerLexerInit)
}

// NewBarcodeLexer produces a new lexer instance for the optional input antlr.CharStream.
func NewBarcodeLexer(input antlr.CharStream) *BarcodeLexer {
	BarcodeLexerInit()
	l := new(BarcodeLexer)
...
// BarcodeLexer tokens.
const (
	BarcodeLexerBARCODE  = 1
	BarcodeLexerOWNKEY   = 2
	BarcodeLexerSPLITKEY = 3
	BarcodeLexerWS       = 4
)
