...
var costlexerLexerStaticData struct {
	once                   sync.Once
	serializedATN          []int32
	channelNames           []string
	modeNames              []string
...
func costlexerLexerInit() {
	staticData := &costlexerLexerStaticData
...
// CostLexerInit initializes any static state used to implement CostLexer. By default the
// static state used to implement the lexer is lazily initialized during the first call to
// NewCostLexer(). You can call this function if you wish to initialize the static state ahead
// of time.
func CostLexerInit() {
	staticData := &costlexerLexerStaticData
	staticData.once.Do(costlexerLexerInit)
}

// NewCostLexer produces a new lexer instance for the optional input antlr.CharStream.
func NewCostLexer(input antlr.CharStream) *CostLexer {
	CostLexerInit()
	l := new(CostLexer)
