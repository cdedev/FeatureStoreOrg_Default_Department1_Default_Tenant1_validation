...
type WindDirectionLexer struct {
	*antlr.BaseLexer
	channelNames []string
	modeNames    []string
	// TODO: EOF string
...
var winddirectionlexerLexerStaticData struct {
	once                   sync.Once
	serializedATN          []int32
	channelNames           []string
	modeNames              []string
...
func winddirectionlexerLexerInit() {
	staticData := &winddirectionlexerLexerStaticData
...
// WindDirectionLexerInit initializes any static state used to implement WindDirectionLexer. By default the
// static state used to implement the lexer is lazily initialized during the first call to
// NewWindDirectionLexer(). You can call this function if you wish to initialize the static state ahead
// of time.
func WindDirectionLexerInit() {
	staticData := &winddirectionlexerLexerStaticData
	staticData.once.Do(winddirectionlexerLexerInit)
}

// NewWindDirectionLexer produces a new lexer instance for the optional input antlr.CharStream.
func NewWindDirectionLexer(input antlr.CharStream) *WindDirectionLexer {
	WindDirectionLexerInit()
	l := new(WindDirectionLexer)
	...
	l.GrammarFileName = "WindDirection.g4"
	// TODO: l.EOF = antlr.TokenEOF

	return l
}

// WindDirectionLexer tokens.
const (
	WindDirectionLexerWINDDIRECTION = 1
	WindDirectionLexerOWNKEY        = 2
	WindDirectionLexerSPLITKEY      = 3
	WindDirectionLexerWS            = 4
)
