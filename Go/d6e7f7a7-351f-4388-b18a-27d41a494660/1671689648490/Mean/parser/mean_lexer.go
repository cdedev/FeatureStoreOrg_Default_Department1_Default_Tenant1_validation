...
var meanlexerLexerStaticData struct {
	once                   sync.Once
	serializedATN          []int32
	channelNames           []string
	modeNames              []string
...
func meanlexerLexerInit() {
	staticData := &meanlexerLexerStaticData
...
// MeanLexerInit initializes any static state used to implement MeanLexer. By default the
// static state used to implement the lexer is lazily initialized during the first call to
// NewMeanLexer(). You can call this function if you wish to initialize the static state ahead
// of time.
func MeanLexerInit() {
	staticData := &meanlexerLexerStaticData
	staticData.once.Do(meanlexerLexerInit)
}

// NewMeanLexer produces a new lexer instance for the optional input antlr.CharStream.
func NewMeanLexer(input antlr.CharStream) *MeanLexer {
	MeanLexerInit()
	l := new(MeanLexer)
