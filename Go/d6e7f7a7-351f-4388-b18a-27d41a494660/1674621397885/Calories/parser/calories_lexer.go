...
var calorieslexerLexerStaticData struct {
	once                   sync.Once
	serializedATN          []int32
	channelNames           []string
	modeNames              []string
...
func calorieslexerLexerInit() {
	staticData := &calorieslexerLexerStaticData
...
// CaloriesLexerInit initializes any static state used to implement CaloriesLexer. By default the
// static state used to implement the lexer is lazily initialized during the first call to
// NewCaloriesLexer(). You can call this function if you wish to initialize the static state ahead
// of time.
func CaloriesLexerInit() {
	staticData := &calorieslexerLexerStaticData
	staticData.once.Do(calorieslexerLexerInit)
}

// NewCaloriesLexer produces a new lexer instance for the optional input antlr.CharStream.
func NewCaloriesLexer(input antlr.CharStream) *CaloriesLexer {
	CaloriesLexerInit()
	l := new(CaloriesLexer)
	...
	l.GrammarFileName = "Calories.g4"
	// TODO: l.EOF = antlr.TokenEOF

	return l
}

// CaloriesLexer tokens.
const (
	CaloriesLexerCALORIES = 1
	CaloriesLexerOWNKEY   = 2
	CaloriesLexerSPLITKEY = 3
	CaloriesLexerWS       = 4
)
