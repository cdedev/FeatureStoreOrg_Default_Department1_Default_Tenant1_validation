...
var loantermlexerLexerStaticData struct {
	once                   sync.Once
	serializedATN          []int32
	channelNames           []string
	modeNames              []string
...
func loantermlexerLexerInit() {
	staticData := &loantermlexerLexerStaticData
...
// LoanTermLexerInit initializes any static state used to implement LoanTermLexer. By default the
// static state used to implement the lexer is lazily initialized during the first call to
// NewLoanTermLexer(). You can call this function if you wish to initialize the static state ahead
// of time.
func LoanTermLexerInit() {
	staticData := &loantermlexerLexerStaticData
	staticData.once.Do(loantermlexerLexerInit)
}

// NewLoanTermLexer produces a new lexer instance for the optional input antlr.CharStream.
func NewLoanTermLexer(input antlr.CharStream) *LoanTermLexer {
	LoanTermLexerInit()
	l := new(LoanTermLexer)
	...
	l.GrammarFileName = "LoanTerm.g4"
	// TODO: l.EOF = antlr.TokenEOF

	return l
}

// LoanTermLexer tokens.
const (
	LoanTermLexerLOANTERM = 1
	LoanTermLexerOWNKEY   = 2
	LoanTermLexerSPLITKEY = 3
	LoanTermLexerWS       = 4
)
