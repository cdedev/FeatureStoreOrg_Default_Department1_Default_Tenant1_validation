...
type DriverPresentLexer struct {
	*antlr.BaseLexer
	channelNames []string
	modeNames    []string
	// TODO: EOF string
...
var driverpresentlexerLexerStaticData struct {
	once                   sync.Once
	serializedATN          []int32
	channelNames           []string
	modeNames              []string
...
func driverpresentlexerLexerInit() {
	staticData := &driverpresentlexerLexerStaticData
...
// DriverPresentLexerInit initializes any static state used to implement DriverPresentLexer. By default the
// static state used to implement the lexer is lazily initialized during the first call to
// NewDriverPresentLexer(). You can call this function if you wish to initialize the static state ahead
// of time.
func DriverPresentLexerInit() {
	staticData := &driverpresentlexerLexerStaticData
	staticData.once.Do(driverpresentlexerLexerInit)
}

// NewDriverPresentLexer produces a new lexer instance for the optional input antlr.CharStream.
func NewDriverPresentLexer(input antlr.CharStream) *DriverPresentLexer {
	DriverPresentLexerInit()
	l := new(DriverPresentLexer)
	...
	l.GrammarFileName = "DriverPresent.g4"
	// TODO: l.EOF = antlr.TokenEOF

	return l
}

// DriverPresentLexer tokens.
const (
	DriverPresentLexerDRIVERPRESENT = 1
	DriverPresentLexerOWNKEY        = 2
	DriverPresentLexerSPLITKEY      = 3
	DriverPresentLexerWS            = 4
)
