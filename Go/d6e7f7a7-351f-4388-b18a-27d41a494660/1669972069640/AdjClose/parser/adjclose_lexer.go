...
var adjcloselexerLexerStaticData struct {
	once                   sync.Once
	serializedATN          []int32
	channelNames           []string
	modeNames              []string
...
func adjcloselexerLexerInit() {
	staticData := &adjcloselexerLexerStaticData
...
// AdjCloseLexerInit initializes any static state used to implement AdjCloseLexer. By default the
// static state used to implement the lexer is lazily initialized during the first call to
// NewAdjCloseLexer(). You can call this function if you wish to initialize the static state ahead
// of time.
func AdjCloseLexerInit() {
	staticData := &adjcloselexerLexerStaticData
	staticData.once.Do(adjcloselexerLexerInit)
}

// NewAdjCloseLexer produces a new lexer instance for the optional input antlr.CharStream.
func NewAdjCloseLexer(input antlr.CharStream) *AdjCloseLexer {
	AdjCloseLexerInit()
	l := new(AdjCloseLexer)
	...
	l.GrammarFileName = "AdjClose.g4"
	// TODO: l.EOF = antlr.TokenEOF

	return l
}

// AdjCloseLexer tokens.
const (
	AdjCloseLexerADJCLOSE = 1
	AdjCloseLexerOWNKEY   = 2
	AdjCloseLexerSPLITKEY = 3
	AdjCloseLexerWS       = 4
)
