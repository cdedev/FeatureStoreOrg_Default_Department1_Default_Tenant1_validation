...
var roomlexerLexerStaticData struct {
	once                   sync.Once
	serializedATN          []int32
	channelNames           []string
	modeNames              []string
...
func roomlexerLexerInit() {
	staticData := &roomlexerLexerStaticData
...
// RoomLexerInit initializes any static state used to implement RoomLexer. By default the
// static state used to implement the lexer is lazily initialized during the first call to
// NewRoomLexer(). You can call this function if you wish to initialize the static state ahead
// of time.
func RoomLexerInit() {
	staticData := &roomlexerLexerStaticData
	staticData.once.Do(roomlexerLexerInit)
}

// NewRoomLexer produces a new lexer instance for the optional input antlr.CharStream.
func NewRoomLexer(input antlr.CharStream) *RoomLexer {
	RoomLexerInit()
	l := new(RoomLexer)
