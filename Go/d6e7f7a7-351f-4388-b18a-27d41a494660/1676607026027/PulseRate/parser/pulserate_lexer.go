...
var pulseratelexerLexerStaticData struct {
	once                   sync.Once
	serializedATN          []int32
	channelNames           []string
	modeNames              []string
...
func pulseratelexerLexerInit() {
	staticData := &pulseratelexerLexerStaticData
...
// PulseRateLexerInit initializes any static state used to implement PulseRateLexer. By default the
// static state used to implement the lexer is lazily initialized during the first call to
// NewPulseRateLexer(). You can call this function if you wish to initialize the static state ahead
// of time.
func PulseRateLexerInit() {
	staticData := &pulseratelexerLexerStaticData
	staticData.once.Do(pulseratelexerLexerInit)
}

// NewPulseRateLexer produces a new lexer instance for the optional input antlr.CharStream.
func NewPulseRateLexer(input antlr.CharStream) *PulseRateLexer {
	PulseRateLexerInit()
	l := new(PulseRateLexer)
	...
	l.GrammarFileName = "PulseRate.g4"
	// TODO: l.EOF = antlr.TokenEOF

	return l
}

// PulseRateLexer tokens.
const (
	PulseRateLexerPULSERATE = 1
	PulseRateLexerOWNKEY    = 2
	PulseRateLexerSPLITKEY  = 3
	PulseRateLexerWS        = 4
)
