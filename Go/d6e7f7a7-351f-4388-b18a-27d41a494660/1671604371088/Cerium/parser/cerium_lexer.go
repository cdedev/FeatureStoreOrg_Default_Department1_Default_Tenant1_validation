...
var ceriumlexerLexerStaticData struct {
	once                   sync.Once
	serializedATN          []int32
	channelNames           []string
	modeNames              []string
...
func ceriumlexerLexerInit() {
	staticData := &ceriumlexerLexerStaticData
...
// CeriumLexerInit initializes any static state used to implement CeriumLexer. By default the
// static state used to implement the lexer is lazily initialized during the first call to
// NewCeriumLexer(). You can call this function if you wish to initialize the static state ahead
// of time.
func CeriumLexerInit() {
	staticData := &ceriumlexerLexerStaticData
	staticData.once.Do(ceriumlexerLexerInit)
}

// NewCeriumLexer produces a new lexer instance for the optional input antlr.CharStream.
func NewCeriumLexer(input antlr.CharStream) *CeriumLexer {
	CeriumLexerInit()
	l := new(CeriumLexer)
