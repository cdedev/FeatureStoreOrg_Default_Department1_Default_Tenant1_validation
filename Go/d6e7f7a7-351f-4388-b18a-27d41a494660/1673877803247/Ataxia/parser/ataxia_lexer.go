...
var ataxialexerLexerStaticData struct {
	once                   sync.Once
	serializedATN          []int32
	channelNames           []string
	modeNames              []string
...
func ataxialexerLexerInit() {
	staticData := &ataxialexerLexerStaticData
...
// AtaxiaLexerInit initializes any static state used to implement AtaxiaLexer. By default the
// static state used to implement the lexer is lazily initialized during the first call to
// NewAtaxiaLexer(). You can call this function if you wish to initialize the static state ahead
// of time.
func AtaxiaLexerInit() {
	staticData := &ataxialexerLexerStaticData
	staticData.once.Do(ataxialexerLexerInit)
}

// NewAtaxiaLexer produces a new lexer instance for the optional input antlr.CharStream.
func NewAtaxiaLexer(input antlr.CharStream) *AtaxiaLexer {
	AtaxiaLexerInit()
	l := new(AtaxiaLexer)
