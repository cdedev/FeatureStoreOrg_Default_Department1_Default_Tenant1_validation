...
var widthlexerLexerStaticData struct {
	once                   sync.Once
	serializedATN          []int32
	channelNames           []string
	modeNames              []string
...
func widthlexerLexerInit() {
	staticData := &widthlexerLexerStaticData
...
// WidthLexerInit initializes any static state used to implement WidthLexer. By default the
// static state used to implement the lexer is lazily initialized during the first call to
// NewWidthLexer(). You can call this function if you wish to initialize the static state ahead
// of time.
func WidthLexerInit() {
	staticData := &widthlexerLexerStaticData
	staticData.once.Do(widthlexerLexerInit)
}

// NewWidthLexer produces a new lexer instance for the optional input antlr.CharStream.
func NewWidthLexer(input antlr.CharStream) *WidthLexer {
	WidthLexerInit()
	l := new(WidthLexer)
