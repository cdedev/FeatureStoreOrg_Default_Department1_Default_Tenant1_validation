...
var headachelexerLexerStaticData struct {
	once                   sync.Once
	serializedATN          []int32
	channelNames           []string
	modeNames              []string
...
func headachelexerLexerInit() {
	staticData := &headachelexerLexerStaticData
...
// HeadacheLexerInit initializes any static state used to implement HeadacheLexer. By default the
// static state used to implement the lexer is lazily initialized during the first call to
// NewHeadacheLexer(). You can call this function if you wish to initialize the static state ahead
// of time.
func HeadacheLexerInit() {
	staticData := &headachelexerLexerStaticData
	staticData.once.Do(headachelexerLexerInit)
}

// NewHeadacheLexer produces a new lexer instance for the optional input antlr.CharStream.
func NewHeadacheLexer(input antlr.CharStream) *HeadacheLexer {
	HeadacheLexerInit()
	l := new(HeadacheLexer)
	...
	l.GrammarFileName = "Headache.g4"
	// TODO: l.EOF = antlr.TokenEOF

	return l
}

// HeadacheLexer tokens.
const (
	HeadacheLexerHEADACHE = 1
	HeadacheLexerOWNKEY   = 2
	HeadacheLexerSPLITKEY = 3
	HeadacheLexerWS       = 4
)
