...
var radiuslexerLexerStaticData struct {
	once                   sync.Once
	serializedATN          []int32
	channelNames           []string
	modeNames              []string
...
func radiuslexerLexerInit() {
	staticData := &radiuslexerLexerStaticData
...
// RadiusLexerInit initializes any static state used to implement RadiusLexer. By default the
// static state used to implement the lexer is lazily initialized during the first call to
// NewRadiusLexer(). You can call this function if you wish to initialize the static state ahead
// of time.
func RadiusLexerInit() {
	staticData := &radiuslexerLexerStaticData
	staticData.once.Do(radiuslexerLexerInit)
}

// NewRadiusLexer produces a new lexer instance for the optional input antlr.CharStream.
func NewRadiusLexer(input antlr.CharStream) *RadiusLexer {
	RadiusLexerInit()
	l := new(RadiusLexer)
