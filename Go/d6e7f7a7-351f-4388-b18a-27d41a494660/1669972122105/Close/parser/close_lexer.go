...
var closelexerLexerStaticData struct {
	once                   sync.Once
	serializedATN          []int32
	channelNames           []string
	modeNames              []string
...
func closelexerLexerInit() {
	staticData := &closelexerLexerStaticData
...
// CloseLexerInit initializes any static state used to implement CloseLexer. By default the
// static state used to implement the lexer is lazily initialized during the first call to
// NewCloseLexer(). You can call this function if you wish to initialize the static state ahead
// of time.
func CloseLexerInit() {
	staticData := &closelexerLexerStaticData
	staticData.once.Do(closelexerLexerInit)
}

// NewCloseLexer produces a new lexer instance for the optional input antlr.CharStream.
func NewCloseLexer(input antlr.CharStream) *CloseLexer {
	CloseLexerInit()
	l := new(CloseLexer)
