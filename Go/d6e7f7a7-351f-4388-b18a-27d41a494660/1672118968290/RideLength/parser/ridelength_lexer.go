...
var ridelengthlexerLexerStaticData struct {
	once                   sync.Once
	serializedATN          []int32
	channelNames           []string
	modeNames              []string
...
func ridelengthlexerLexerInit() {
	staticData := &ridelengthlexerLexerStaticData
...
// RideLengthLexerInit initializes any static state used to implement RideLengthLexer. By default the
// static state used to implement the lexer is lazily initialized during the first call to
// NewRideLengthLexer(). You can call this function if you wish to initialize the static state ahead
// of time.
func RideLengthLexerInit() {
	staticData := &ridelengthlexerLexerStaticData
	staticData.once.Do(ridelengthlexerLexerInit)
}

// NewRideLengthLexer produces a new lexer instance for the optional input antlr.CharStream.
func NewRideLengthLexer(input antlr.CharStream) *RideLengthLexer {
	RideLengthLexerInit()
	l := new(RideLengthLexer)
	...
	l.GrammarFileName = "RideLength.g4"
	// TODO: l.EOF = antlr.TokenEOF

	return l
}

// RideLengthLexer tokens.
const (
	RideLengthLexerRIDELENGTH = 1
	RideLengthLexerOWNKEY     = 2
	RideLengthLexerSPLITKEY   = 3
	RideLengthLexerWS         = 4
)
