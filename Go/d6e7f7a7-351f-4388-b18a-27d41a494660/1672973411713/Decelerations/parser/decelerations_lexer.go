...
type DecelerationsLexer struct {
	*antlr.BaseLexer
	channelNames []string
	modeNames    []string
	// TODO: EOF string
...
var decelerationslexerLexerStaticData struct {
	once                   sync.Once
	serializedATN          []int32
	channelNames           []string
	modeNames              []string
...
func decelerationslexerLexerInit() {
	staticData := &decelerationslexerLexerStaticData
...
// DecelerationsLexerInit initializes any static state used to implement DecelerationsLexer. By default the
// static state used to implement the lexer is lazily initialized during the first call to
// NewDecelerationsLexer(). You can call this function if you wish to initialize the static state ahead
// of time.
func DecelerationsLexerInit() {
	staticData := &decelerationslexerLexerStaticData
	staticData.once.Do(decelerationslexerLexerInit)
}

// NewDecelerationsLexer produces a new lexer instance for the optional input antlr.CharStream.
func NewDecelerationsLexer(input antlr.CharStream) *DecelerationsLexer {
	DecelerationsLexerInit()
	l := new(DecelerationsLexer)
	...
	l.GrammarFileName = "Decelerations.g4"
	// TODO: l.EOF = antlr.TokenEOF

	return l
}

// DecelerationsLexer tokens.
const (
	DecelerationsLexerDECELERATIONS = 1
	DecelerationsLexerOWNKEY        = 2
	DecelerationsLexerSPLITKEY      = 3
	DecelerationsLexerWS            = 4
)
