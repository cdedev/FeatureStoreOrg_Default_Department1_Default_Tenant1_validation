...
var sheeplexerLexerStaticData struct {
	once                   sync.Once
	serializedATN          []int32
	channelNames           []string
	modeNames              []string
...
func sheeplexerLexerInit() {
	staticData := &sheeplexerLexerStaticData
...
// SheepLexerInit initializes any static state used to implement SheepLexer. By default the
// static state used to implement the lexer is lazily initialized during the first call to
// NewSheepLexer(). You can call this function if you wish to initialize the static state ahead
// of time.
func SheepLexerInit() {
	staticData := &sheeplexerLexerStaticData
	staticData.once.Do(sheeplexerLexerInit)
}

// NewSheepLexer produces a new lexer instance for the optional input antlr.CharStream.
func NewSheepLexer(input antlr.CharStream) *SheepLexer {
	SheepLexerInit()
	l := new(SheepLexer)
