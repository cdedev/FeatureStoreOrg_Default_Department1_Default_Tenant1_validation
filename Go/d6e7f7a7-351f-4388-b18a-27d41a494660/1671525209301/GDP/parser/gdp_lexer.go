...
var gdplexerLexerStaticData struct {
	once                   sync.Once
	serializedATN          []int32
	channelNames           []string
	modeNames              []string
...
func gdplexerLexerInit() {
	staticData := &gdplexerLexerStaticData
...
// GDPLexerInit initializes any static state used to implement GDPLexer. By default the
// static state used to implement the lexer is lazily initialized during the first call to
// NewGDPLexer(). You can call this function if you wish to initialize the static state ahead
// of time.
func GDPLexerInit() {
	staticData := &gdplexerLexerStaticData
	staticData.once.Do(gdplexerLexerInit)
}

// NewGDPLexer produces a new lexer instance for the optional input antlr.CharStream.
func NewGDPLexer(input antlr.CharStream) *GDPLexer {
	GDPLexerInit()
	l := new(GDPLexer)
