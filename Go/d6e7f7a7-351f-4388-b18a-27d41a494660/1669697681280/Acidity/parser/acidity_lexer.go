...
var aciditylexerLexerStaticData struct {
	once                   sync.Once
	serializedATN          []int32
	channelNames           []string
	modeNames              []string
...
func aciditylexerLexerInit() {
	staticData := &aciditylexerLexerStaticData
...
// AcidityLexerInit initializes any static state used to implement AcidityLexer. By default the
// static state used to implement the lexer is lazily initialized during the first call to
// NewAcidityLexer(). You can call this function if you wish to initialize the static state ahead
// of time.
func AcidityLexerInit() {
	staticData := &aciditylexerLexerStaticData
	staticData.once.Do(aciditylexerLexerInit)
}

// NewAcidityLexer produces a new lexer instance for the optional input antlr.CharStream.
func NewAcidityLexer(input antlr.CharStream) *AcidityLexer {
	AcidityLexerInit()
	l := new(AcidityLexer)
...
// AcidityLexer tokens.
const (
	AcidityLexerACIDITY  = 1
	AcidityLexerOWNKEY   = 2
	AcidityLexerSPLITKEY = 3
	AcidityLexerWS       = 4
)
