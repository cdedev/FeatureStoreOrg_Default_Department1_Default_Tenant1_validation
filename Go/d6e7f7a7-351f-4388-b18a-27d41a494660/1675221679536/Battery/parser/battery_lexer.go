...
var batterylexerLexerStaticData struct {
	once                   sync.Once
	serializedATN          []int32
	channelNames           []string
	modeNames              []string
...
func batterylexerLexerInit() {
	staticData := &batterylexerLexerStaticData
...
// BatteryLexerInit initializes any static state used to implement BatteryLexer. By default the
// static state used to implement the lexer is lazily initialized during the first call to
// NewBatteryLexer(). You can call this function if you wish to initialize the static state ahead
// of time.
func BatteryLexerInit() {
	staticData := &batterylexerLexerStaticData
	staticData.once.Do(batterylexerLexerInit)
}

// NewBatteryLexer produces a new lexer instance for the optional input antlr.CharStream.
func NewBatteryLexer(input antlr.CharStream) *BatteryLexer {
	BatteryLexerInit()
	l := new(BatteryLexer)
...
// BatteryLexer tokens.
const (
	BatteryLexerBATTERY  = 1
	BatteryLexerOWNKEY   = 2
	BatteryLexerSPLITKEY = 3
	BatteryLexerWS       = 4
)
