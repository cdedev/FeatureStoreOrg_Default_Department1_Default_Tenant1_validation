...
var turbiditylexerLexerStaticData struct {
	once                   sync.Once
	serializedATN          []int32
	channelNames           []string
	modeNames              []string
...
func turbiditylexerLexerInit() {
	staticData := &turbiditylexerLexerStaticData
...
// TurbidityLexerInit initializes any static state used to implement TurbidityLexer. By default the
// static state used to implement the lexer is lazily initialized during the first call to
// NewTurbidityLexer(). You can call this function if you wish to initialize the static state ahead
// of time.
func TurbidityLexerInit() {
	staticData := &turbiditylexerLexerStaticData
	staticData.once.Do(turbiditylexerLexerInit)
}

// NewTurbidityLexer produces a new lexer instance for the optional input antlr.CharStream.
func NewTurbidityLexer(input antlr.CharStream) *TurbidityLexer {
	TurbidityLexerInit()
	l := new(TurbidityLexer)
	...
	l.GrammarFileName = "Turbidity.g4"
	// TODO: l.EOF = antlr.TokenEOF

	return l
}

// TurbidityLexer tokens.
const (
	TurbidityLexerTURBIDITY = 1
	TurbidityLexerOWNKEY    = 2
	TurbidityLexerSPLITKEY  = 3
	TurbidityLexerWS        = 4
)
